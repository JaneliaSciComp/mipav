...
import nibib.spim.PlugInDialogGenerateFusion542c;
...
public class PlugInGenerateFusion542c implements PlugInGeneric {
    ...
    public void run() {
        PlugInDialogGenerateFusion542c test = new PlugInDialogGenerateFusion542c(false);
