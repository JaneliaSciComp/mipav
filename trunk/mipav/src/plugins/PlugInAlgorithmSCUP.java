...
public class PlugInAlgorithmSCUP extends AlgorithmBase {
    ...
    public void runAlgorithm() {
        ...
        tempImage1 = new ModelImage(destImage.getType(), destImage.getExtents(), "TEMP IMAGE", destImage
                .getUserInterface());
        ...
        tempImage2 = new ModelImage(destImage.getType(), destImage.getExtents(), "TEMP IMAGE2", destImage
                .getUserInterface());
        ...
        tempImage3 = new ModelImage(destImage.getType(), destImage.getExtents(), "TEMP IMAGE", destImage
                .getUserInterface());
