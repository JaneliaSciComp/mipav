...
public class PlugInDialogBRICS_Mapper extends JFrame implements ActionListener, ChangeListener, ItemListener, TreeSelectionListener, MouseListener,
    ...
    public PlugInDialogBRICS_Mapper () {
        ...
        final int response = JOptionPane.showConfirmDialog(this, PlugInDialogBRICS_Mapper .PRIVACY_NOTICE, "Image Submission Package Creation Tool",
    ...
    private class ChooseDataStructDialog extends JDialog implements ActionListener {
        ...
        public ChooseDataStructDialog(final PlugInDialogBRICS_Mapper owner) {
            super(owner, true);
