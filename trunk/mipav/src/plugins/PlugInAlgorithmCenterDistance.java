...
public class PlugInAlgorithmCenterDistance extends AlgorithmBase {
     ...
     * @param  greenMin
     * @param  greenFraction
     * @param  cellNumber    DOCUMENT ME!
     * @param  greenRegionNumber      DOCUMENT ME!
     */
    public PlugInAlgorithmCenterDistance(ModelImage srcImg, float mergingDistance, int greenMin, float greenFraction,
                                         int cellNumber, int greenRegionNumber) {
        super(null, srcImg);
        this.mergingDistance = mergingDistance;
        this.greenMin = greenMin;
        this.greenFraction = greenFraction;
        this.cellNumber = cellNumber;
        this.greenRegionNumber = greenNumber;
    }
    ...
    private void calc2D() {
        ...
        if (nVOIs > 0) {
            // Replace cellNumber with the number of contour VOIs
            cellNumber = nVOIs;
        }
