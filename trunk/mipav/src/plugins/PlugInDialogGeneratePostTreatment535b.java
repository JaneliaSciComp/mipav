 ...
 */
public class PlugInDialogGeneratePostTreatment535b extends JDialogScriptableBase implements AlgorithmInterface {
    ...
    private PlugInAlgorithmGeneratePostTreatment535b generatePostAlgo = null;
     ...
     */
    public PlugInDialogGeneratePostTreatment535b() { }
     ...
     */
    public PlugInDialogGeneratePostTreatment535b(Frame theParentFrame, ModelImage im) {
...
//  ~ Methods --------------------------------------------------------------------------------------------------------
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        if (algorithm instanceof PlugInAlgorithmGeneratePostTreatment535b) {
    ...
    protected void callAlgorithm() {
        ...
        try {
            ...
            generatePostAlgo = new PlugInAlgorithmGeneratePostTreatment535b(image1, image1Intensity, image1Scale, image1Noise,
    ...
    private void init() {
        ...
        setTitle("Generate post treatment map 535b");
        try {
