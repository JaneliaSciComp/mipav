 ...
 */
public class PlugInDialogProcessPostTreatment535a extends JDialogScriptableBase implements AlgorithmInterface {
     ...
     */
    public PlugInDialogProcessPostTreatment535a() { }
     ...
     */
    public PlugInDialogProcessPostTreatment535a(Frame theParentFrame, ModelImage im) {
...
//  ~ Methods --------------------------------------------------------------------------------------------------------
    ...
    private void init() {
        ...
        setTitle("Process post treatment map");
        try {
        ...
        getContentPane().add(null, BorderLayout.CENTER);
