 ...
 */
public class PlugInDialogGeneratePostTreatment535c extends JDialogScriptableBase implements AlgorithmInterface {
    ...
    private PlugInAlgorithmGeneratePostTreatment535c generatePostAlgo = null;
     ...
     */
    public PlugInDialogGeneratePostTreatment535c() { }
     ...
     */
    public PlugInDialogGeneratePostTreatment535c(Frame theParentFrame, ModelImage im) {
...
//  ~ Methods --------------------------------------------------------------------------------------------------------
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        if (algorithm instanceof PlugInAlgorithmGeneratePostTreatment535c) {
    ...
    protected void callAlgorithm() {
        ...
        try {
            ...
            generatePostAlgo = new PlugInAlgorithmGeneratePostTreatment535c(image1, image1Intensity, image1Scale, image1Noise,
