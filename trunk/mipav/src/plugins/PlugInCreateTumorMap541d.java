...
public class PlugInCreateTumorMap541d implements PlugInGeneric {

	public static final String[] CATEGORY = {"Parametric Maps", "Simulation", "541d"};
     ...
     */
    public void run() {
        new PlugInDialogCreateTumorMap541d(false);
