...
public class PlugInSCUP implements PlugInAlgorithm {
    ...
    public void run(ViewUserInterface UI, Frame parentFrame, ModelImage image) {
        ...
        if (parentFrame instanceof ViewJFrameImage) {
            new PlugInDialogSCUP(parentFrame, image);
        } else {
            MipavUtil.displayError("PlugIn Segmentation Cleanup of OAI data.");
        }
    }
}
