 ...
 * 
 * $Logfile: /mipav/src/plugins/PlugInDialogRegionDistance.java $ $Revision: 21 $
 * $Date: 1/25/06 4:59p $
 * 
 */
public class PlugInDialogRegionDistance extends JDialogBase implements AlgorithmInterface, ScriptableInterface {
    ...
    /**
     * Constructor used for instantiation during script execution (required for
     * dynamic loading).
     */
     ...
     * 
     * @param parser
     *            the script parser we get the state from
     * @throws IllegalArgumentException
     *             if there is something wrong with the arguments in the script
     */
    ...
    /**
     * Accessor that sets the redMin variable, for minimum pixel number in a red
     * voi
     * 
     * @param redMin
     *            minimum number of pixels in a red voi
     */
    ...
    /**
     * Accessor that set the redFraction variable, for portion of red pixels
     * considered by fuzzy c means segmentation
     * 
     * @param redFraction
     *            float
     */
    ...
    /**
     * Accessor that sets the redNumber variable, for number of red vois in a
     * nucleus
     * 
     * @param redNumber
     *            the number of red vois in a nucleus
     */
    ...
    /**
     * Accessor that sets the greenMin variable, for minimum pixel number in a
     * green voi
     * 
     * @param greenMin
    ...
    /**
     * Accessor that set the greenFraction variable, for portion of green pixels
     * considered by fuzzy c means segmentation
     * 
     * @param greenFraction
     *            float
    ...
    /**
     * Accessor that sets the greenNumber variable, for number of green vois in
     * a nucleus
     * 
     * @param greenNumber
     *            the number of green vois in a nucleus
     */
    ...
    /**
     * Accessor that sets the blueMin variable, for minimum pixel number in a
     * nucleus
     * 
     * @param blueMin
     *            the minimum number of pixels in a nucleus
     */
    ...
    /**
     * If a script is being recorded and the algorithm is done, add an entry for
     * this algorithm.
     * 
     * @param algo
     *            the algorithm to make an entry for
     */
        ...
        if (algo.isCompleted()) {
            if (userInterface.isScriptRecording()) {
                ...
                userInterface.getScriptDialog().append(
                        "PlugInDialogRegionDistance " + userInterface.getScriptDialog().getVar(image.getImageName())
                                + " " + getParameterString(" ") + "\n");
            }
        }
    }
     ...
     * algorithm based on what type of image this is and whether or not there is
     * a separate destination image.
     */
