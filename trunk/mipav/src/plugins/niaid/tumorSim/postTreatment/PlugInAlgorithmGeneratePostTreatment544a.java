...
public class PlugInAlgorithmGeneratePostTreatment544a extends AlgorithmBase {
     ...
     * @param normalTissue 
     */
    public PlugInAlgorithmGeneratePostTreatment544a(ModelImage image1, ModelImage image1aTumor, double image1Intensity, double image1IntensityStd, double image1Scale, double image1Noise, 
    ...
    public void runAlgorithm() {
        ...
        if(image1cVOI) {
            PlugInAlgorithmCreateTumorMap544a.createVOI(image1c, image1Intensity-stdDevNum*image1IntensityStd, image1Intensity+stdDevNum*image1IntensityStd);
        }
        ...
        if(image2cVOI) {
            PlugInAlgorithmCreateTumorMap544a.createVOI(image2c, image2Intensity-stdDevNum*image2IntensityStd, image2Intensity+stdDevNum*image2IntensityStd);
        }
        ...
        if(postVOI) {
            ...
            PlugInAlgorithmCreateTumorMap544a.createVOI(postTreatment, postIntensity-stdDevNum*postStdDev, postIntensity+stdDevNum*postStdDev);
        }
