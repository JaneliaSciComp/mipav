...
public class PlugInAlgorithmCreateTumorMap544c extends AlgorithmBase {
    ...
    private PlugInDialogCreateTumorMap544c.TumorSimMode simMode;
    ...
    public PlugInAlgorithmCreateTumorMap544c() {
     ...
     *
     */
	public PlugInAlgorithmCreateTumorMap544c(int xyDim, int zDim, double xyRes,
            double zRes, double initRadius, double tumorChange,
            PlugInDialogCreateTumorMap544c.TumorSimMode simMode, 
...
private class RayleighRandom extends Random {
    ...
    public static void main(String[] args) {
        PlugInAlgorithmCreateTumorMap544c p = new PlugInAlgorithmCreateTumorMap544c();
