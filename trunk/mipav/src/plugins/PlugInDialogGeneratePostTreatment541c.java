 ...
 */
public class PlugInDialogGeneratePostTreatment541c extends JDialogScriptableBase implements AlgorithmInterface {
    ...
    private PlugInAlgorithmGeneratePostTreatment541c generatePostAlgo = null;
     ...
     */
    public PlugInDialogGeneratePostTreatment541c() { }
     ...
     */
    public PlugInDialogGeneratePostTreatment541c(Frame theParentFrame, ModelImage im) {
...
//  ~ Methods --------------------------------------------------------------------------------------------------------
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        if (algorithm instanceof PlugInAlgorithmGeneratePostTreatment541c) {
    ...
    protected void callAlgorithm() {
        ...
        try {
            ...
            generatePostAlgo = new PlugInAlgorithmGeneratePostTreatment541c(image1, image1Intensity, image1Scale, image1Noise,
    ...
    private void init() {
        ...
        setTitle("Generate post treatment map 541c");
        try {
