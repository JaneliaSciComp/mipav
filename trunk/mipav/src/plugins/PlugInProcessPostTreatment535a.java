...
public class PlugInProcessPostTreatment535a implements PlugInAlgorithm {

    public static final String[] CATEGORY = {"Dana Farber Project", "Simulation"};
    ...
    public void run(Frame parentFrame, ModelImage image) {
        ...
        if (parentFrame instanceof ViewJFrameImage) {
            new PlugInDialogProcessPostTreatment535a(parentFrame, image);
        } else {
            MipavUtil.displayError("PlugInDialogProcessPostTreatment only runs on an image frame.");
        }
    }
}
