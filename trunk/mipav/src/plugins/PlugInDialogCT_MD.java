...
*
*   $Logfile: /mipav/src/plugins/PlugInDialogCT_MD.java $
*   $Revision: 10 $
*   $Date: 1/25/06 4:59p $
*
*/
public class PlugInDialogCT_MD extends JDialogBase implements AlgorithmInterface {
	...
	*/
	public void 		setCorrectionValue(float num)			{correctionVal = num;}
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (ctSegAlgo.isCompleted() == true) {
        	if (userInterface.isScriptRecording()) {
        		userInterface.getScriptDialog().append("Flow " + userInterface.getScriptDialog().getVar(image.getImageName()) + " "
        		                    + correctionVal + "\n");
        	}
        }
        dispose();
	...
	private void callAlgorithm() {
        ...
        if (image.getNDims() == 2 ) {                  // source image is 2D
            ...
            try{
                ...
                //ctSegAlgo = new PlugInAlgorithmFlowWrapFix(resultImage, image, iters, kernelSize, kernelShape, stdDev, regionFlag);
