...
import niaid.tumorSim.simParams.PlugInDialogSimulateParams544a;
...
public class PlugInSimulateParams544a implements PlugInGeneric {
     ...
     */
    public void run() {
        new PlugInDialogSimulateParams544a(false);
