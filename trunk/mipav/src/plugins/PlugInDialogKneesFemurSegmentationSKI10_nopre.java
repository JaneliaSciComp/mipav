 ...
 *
 */
public class PlugInDialogKneesFemurSegmentationSKI10_nopre implements AlgorithmInterface
{
    ...
    private PlugInAlgorithmKneesFemurSegmentationSKI10_nopre subCorticalAlgo;
    
    /**
     * Constructor of Brain Subcortical Dialog.  Called from the MIPAV menu. 
     * @param theParentFrame  parent frame.
     */
    public PlugInDialogKneesFemurSegmentationSKI10_nopre(Frame theParentFrame) {
     ...
     */
    public PlugInDialogKneesFemurSegmentationSKI10_nopre(Frame theParentFrame, String _inputDir, String _outputDir) {
    	inputDir = _inputDir;
	...
	public void callAlgorithm() {
		...
		subCorticalAlgo = new PlugInAlgorithmKneesFemurSegmentationSKI10_nopre(inputDir, outputDir, this);
	    subCorticalAlgo.run();
	}
