...
import nibib.spim.PlugInDialogGenerateFusion;
 ...
 */
public class PlugInGenerateFusion implements PlugInGeneric {
    ...
    public void run() {
        PlugInDialogGenerateFusion test = new PlugInDialogGenerateFusion(false);
