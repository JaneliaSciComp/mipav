...
public class PlugInAlgorithmCreateVolume extends AlgorithmBase {
     ...
     * @param  TNI          DOCUMENT ME!
     * @param  NIPP         DOCUMENT ME!
     * @param  numRepIm     DOCUMENT ME!
     * @param  numBlanks    DOCUMENT ME!
     */
    public PlugInAlgorithmCreateVolume(ModelImage srcImage, ModelImage resultImage, int curPos, int TNI, int NIPP,
                                       int numRepIm, int numBlanks) {
