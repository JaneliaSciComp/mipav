...
public class ViewJPopupVOI extends JPanel implements ActionListener, PopupMenuListener, MouseListener {
    ...
    private static final long serialVersionUID = 2822585493869019752L;
    ...
    public ViewJPopupVOI(ViewJComponentEditImage comp) {
        ...
        popup.add(ViewMenuBuilder.buildMenuItem("Crop image", "cropImage", 0, this, null, true));
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        try {
             ...
             */
                ...
                new JDialogCrop(component.getActiveImage().getParentFrame(), component.getActiveImage(),
    ...
    private void checkPopup(MouseEvent event) {
        ...
        if (event.isPopupTrigger()) {
            itemClose.setEnabled(isVOIOpen());
                ...
                for (int j = 0; j < curves.length; j++) {
                    ...
                    for (int k = 0; k < curves[j].size(); k++) {
                        ...
                        if (tester.isActive()) {
                            ...
                            if ((tester instanceof VOIContour) && !((VOIContour) tester).isClosed()) {
                                return true;
                            } else {
                                return false;
                            }
