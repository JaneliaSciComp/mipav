...
public class WidgetFactory {
     ...
     * @return a new button
     *
    public static final JButton buildButton(String cmd, String tooltip, String iconBase, ActionListener listener) {
        JButton button = new JButton(MipavUtil.getIcon(iconBase + ".gif"));
        button.addActionListener(listener);
        button.addItemListener(new ButtonActivationBorder());
        button.setActionCommand(cmd);
        if (cmd != null) {
            KeyStroke k = ViewUserInterface.getReference().getShortcut(cmd);
            if (k != null)
                button.setMnemonic(k.getKeyCode());
        }
     ...
     *
    public static final JToggleButton buildToggleButton(String cmd, String tooltip, String iconBase, ButtonGroup group,
        ...
        button.setToolTipText(tooltip);
        button.setBorder(buildPressedButtonBorder());
        button.setBorderPainted(false);
     ...
     * @return a new togglable button
     *
    public static final JToggleButton buildToggleButton(String cmd, int mnemonic, String tooltip, String iconBase,
            ButtonGroup group, ActionListener listener) {
        JToggleButton button = buildToggleButton(cmd, tooltip, iconBase, group, listener);
        button.setMnemonic(mnemonic);
        return button;
    }*/

    private static final class ButtonActivationBorder implements ItemListener {
    ...
    // TODO scrollbar
    public static final JScrollPane JScrollPane(JComponent component, int preferredWidth, int preferredHeight) {
