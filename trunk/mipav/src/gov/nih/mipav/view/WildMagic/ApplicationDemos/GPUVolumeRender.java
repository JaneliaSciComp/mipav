    ...
    implements GLEventListener, KeyListener, MouseMotionListener
{
    public GPUVolumeRender( ModelImage kImage, ModelLUT kLUTa )
    {
        ...
        VertexProgramCatalog.SetActive(new VertexProgramCatalog("Main"));       
        PixelProgramCatalog.SetActive(new PixelProgramCatalog("Main"));
...
//         VolumeTextures kWorld = new VolumeTextures( null );        
...
//     }
    ...
    public void display(GLAutoDrawable arg0) {
        ...
        if (m_pkRenderer.BeginScene())
        {
            ...
            m_spkVolumeNode.DetachEffect( m_spkVolumeTexture );
            ...
            m_spkVolumeNode.AttachEffect( m_spkVolumeTexture );
            m_kCuller.ComputeVisibleSet(m_spkScene);
...
//                           "VolumeImage");
        ...
        VertexShader pkVShader = new VertexShader("MIP");
        PixelShader pkPShader = new PixelShader("MIP");
        ...
        m_spkMIP = new ShaderEffect(1);
        m_spkMIP.SetVShader(0,pkVShader);
        m_spkMIP.SetPShader(0,pkPShader);

        m_pkRenderer.LoadResources(m_spkMIP);
        Program pkProgram = m_spkMIP.GetPProgram(0);
        pkProgram.GetUC("stepsize").SetDataSource(m_afstepsize);


//         // setup ddr shader effect:
//         pkVShader = new VertexShader("DDR");
//         pkPShader = new PixelShader("DDR");
//         pkPShader.SetTextureQuantity(4);
//         pkPShader.SetImageName(0,"VolumeImage");
//         pkPShader.SetTexture(0,m_pkVolumeTarget);
//         pkPShader.SetImageName(1,"SceneImage");
//         pkPShader.SetTexture(1,m_pkSceneTarget);
//         pkPShader.SetImageName(2,"ColorMap");
//         pkPShader.SetTexture(2,m_pkColorMapTarget);
//         pkPShader.SetImageName(3,"OpacityMap");
//         pkPShader.SetTexture(3,m_pkOpacityMapTarget);

//         m_spkDDR = new ShaderEffect(1);
//         m_spkDDR.SetVShader(0,pkVShader);
//         m_spkDDR.SetPShader(0,pkPShader);

//         m_pkRenderer.LoadResources(m_spkDDR);
//         pkProgram = m_spkDDR.GetPProgram(0);
//         pkProgram.GetUC("stepsize").SetDataSource(m_afstepsize);

        m_spkVolumeTexture = m_spkMIP;
...
/*
                    pkVB.TCoord3(iUnit,0, new Vector3f(0,0,0));
                    pkVB.TCoord3(iUnit,1, new Vector3f(fMaxX/fMax,0,0));
                    pkVB.TCoord3(iUnit,2, new Vector3f(fMaxX/fMax,fMaxY/fMax,0));
                    pkVB.TCoord3(iUnit,3, new Vector3f(0,fMaxY/fMax,0));
                    pkVB.TCoord3(iUnit,4, new Vector3f(0,0,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,5, new Vector3f(fMaxX/fMax,0,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,6, new Vector3f(fMaxX/fMax,fMaxY/fMax,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,7, new Vector3f(0,fMaxY/fMax,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,8, new Vector3f(0,fMaxY/fMax,0));
                    pkVB.TCoord3(iUnit,9, new Vector3f(fMaxX/fMax,fMaxY/fMax,0));
                    pkVB.TCoord3(iUnit,10, new Vector3f(fMaxX/fMax,fMaxY/fMax,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,11, new Vector3f(0,fMaxY/fMax,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,12, new Vector3f(0,0,0));
                    pkVB.TCoord3(iUnit,13, new Vector3f(fMaxX/fMax,0,0));
                    pkVB.TCoord3(iUnit,14, new Vector3f(fMaxX/fMax,0,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,15, new Vector3f(0,0,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,16, new Vector3f(fMaxX/fMax,0,0));
                    pkVB.TCoord3(iUnit,17, new Vector3f(fMaxX/fMax,fMaxY/fMax,0));
                    pkVB.TCoord3(iUnit,18, new Vector3f(fMaxX/fMax,fMaxY/fMax,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,19, new Vector3f(fMaxX/fMax,0,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,20, new Vector3f(0,0,0));
                    pkVB.TCoord3(iUnit,21, new Vector3f(0,fMaxY/fMax,0));
                    pkVB.TCoord3(iUnit,22, new Vector3f(0,fMaxY/fMax,fMaxZ/fMax));
                    pkVB.TCoord3(iUnit,23, new Vector3f(0,0,fMaxZ/fMax));
*/
                }
            }
        }
        ...
        //TriMesh kMesh = kSM.Box(fMaxX/fMax,fMaxY/fMax,fMaxZ/fMax);

//         kMesh.VBuffer.TCoord3(0,0, new Vector3f(0f,0f,0f));
//         kMesh.VBuffer.TCoord3(0,1, new Vector3f(m_fTexRangeX,0f,0f));
//         kMesh.VBuffer.TCoord3(0,2, new Vector3f(m_fTexRangeX,m_fTexRangeY,0f));
//         kMesh.VBuffer.TCoord3(0,3, new Vector3f(0f,m_fTexRangeY,0f));
//         kMesh.VBuffer.TCoord3(0,4, new Vector3f(0f,0f,m_fTexRangeZ));
//         kMesh.VBuffer.TCoord3(0,5, new Vector3f(m_fTexRangeX,0f,m_fTexRangeZ));
//         kMesh.VBuffer.TCoord3(0,6, new Vector3f(m_fTexRangeX,m_fTexRangeY,m_fTexRangeZ));
//         kMesh.VBuffer.TCoord3(0,7, new Vector3f(0f,m_fTexRangeY,m_fTexRangeZ));
    ...
    public byte[] calcImageNormals() {
        ...
        byte[] acData = new byte[akNormalTmp.length*4];
        for (int i = 0; i < akNormalTmp.length; i++) {
            acData[i*4+0] = (byte)(akNormal[i].X()*255);
            acData[i*4+1] = (byte)(akNormal[i].Y()*255);
            acData[i*4+2] = (byte)(akNormal[i].Z()*255);
            acData[i*4+3] = (byte)((afData[i]-fMin)/(fMax-fMin)*255);
    ...
    private void InitClippingPlanes(int iXBound, int iYBound, int iZBound)
    {
        ...
        kClipView.Position3( 1, new Vector3f( 0, 0, fZ ) );
        kClipView.Position3( 2, new Vector3f( 0, fY, fZ ) );
        kClipView.Position3( 3, new Vector3f( 0, fY, 0 ) );
        ...
        kClipView.Position3( 0, new Vector3f( fX, 0, 0 ) );
        kClipView.Position3( 1, new Vector3f( fX, 0, fZ ) );
        kClipView.Position3( 2, new Vector3f( fX, fY, fZ ) );
        kClipView.Position3( 3, new Vector3f( fX, fY, 0 ) );
        ...
        kClipView.Position3( 0, new Vector3f( 0, 0, 0 ) );
        kClipView.Position3( 1, new Vector3f( 0, 0, fZ ) );
        kClipView.Position3( 2, new Vector3f( fX, 0, fZ ) );
        kClipView.Position3( 3, new Vector3f( fX, 0, 0 ) );
        ...
        kClipView.Position3( 0, new Vector3f( 0, fY, 0 ) );
        kClipView.Position3( 1, new Vector3f( 0, fY, fZ ) );
        kClipView.Position3( 2, new Vector3f( fX, fY, fZ ) );
        kClipView.Position3( 3, new Vector3f( fX, fY, 0 ) );
        ...
        kClipView.Position3( 0, new Vector3f( 0, 0, 0 ) );
        kClipView.Position3( 1, new Vector3f( 0, fY, 0 ) );
        kClipView.Position3( 2, new Vector3f( fX, fY, 0 ) );
        kClipView.Position3( 3, new Vector3f( fX, 0, 0 ) );
        ...
        kClipView.Position3( 0, new Vector3f( 0, 0, fZ ) );
        kClipView.Position3( 1, new Vector3f( 0, fY, fZ ) );
        kClipView.Position3( 2, new Vector3f( fX, fY, fZ ) );
        kClipView.Position3( 3, new Vector3f( fX, 0, fZ ) );
    ...
    private ShaderEffect m_spkMIP;
    private ShaderEffect m_spkDDR;

    private ModelImage m_kImage;

    private float m_fTexRangeX = 1.0f;
    private float m_fTexRangeY = 1.0f;
    private float m_fTexRangeZ = 1.0f;
