...
public class HSLPickWidget {
  ...
  //======================================================== HSLPickWidget
//======================================================================
  public HSLPickWidget(gluvvGlobal _gluvv) {
    gluvv = _gluvv;
    hue = .3f;
    sat = 1f;
    lev = .5f;
  ...
  public HSLPickWidget(HSLPickWidget pw, gluvvGlobal _gluvv) {
    gluvv = _gluvv;
    hue = pw.hue;
    sat = pw.sat;
    lev = pw.lev;
...
//===================================================== set color
//===============================================================
  public void setColor(float h, float s, float l)
  {
          hue = h;
          sat = s;
          lev = l;
