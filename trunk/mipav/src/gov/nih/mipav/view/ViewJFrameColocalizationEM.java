 ...
 *
 * <p>The file menu only has 1 simple function - a close ViewJFramColocalization structure function.</p>
 *
 * <p>ViewJFrameColocalizationEM is called in AlgorithmColocalizationEM. ViewJFrameColocalizationEM calls
 * ViewJComponentColocalizationEM</p>
 */
public class ViewJFrameColocalizationEM extends ViewJFrameBase implements ChangeListener, ItemListener {
    ...
    public ViewJFrameColocalizationEM(ModelImage _imageA, ModelLUT _LUTa, ModelImage _imageB, ModelLUT _LUTb,
                                      ModelRGB _RGBTA, ModelImage destImage, ViewJFrameBase controlFrame,
                                      boolean useRed, boolean useGreen, boolean useBlue, double min1, double max1,
                                      double min2, double max2, double scale1, double scale2, int leftPad, int rightPad,
                                      int bottomPad, int topPad, double[][] mean, double[] halfMajor,
    ...
    private void buildScrollPane() {
        ...
        try {
            ...
            componentImage = new ViewJComponentColocalizationEM(controlFrame, imageA, imageB, destImage, LUTdest,
                                                                imageBufferDest, useRed, useGreen, useBlue, min1, max1,
                                                                min2, max2, scale1, scale2, pixBufferDest,
                                                                paintBufferDest, zoom, extents, logMagDisplay, leftPad,
                                                                rightPad, bottomPad, topPad, mean, halfMajor, halfMinor,
                                                                theta);
