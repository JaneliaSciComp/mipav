...
public class ViewJFrameFastMarching2
    ...
    implements KeyListener, Runnable
{
    ...
    public void run () 
    {
        ...
        boolean[] abMask = null;
        int iXBound = imageA.getExtents()[0];
        int iYBound = imageA.getExtents()[1];
        ...
        LseSegShapeDetection2 kSegmenter = new LseSegShapeDetection2(iXBound,iYBound,
                                                                     fXSpacing,fYSpacing,
                                                                     afImage,abMask);
        ...
        int iXSeed = 81, iYSeed = 114;  // left ventricle
