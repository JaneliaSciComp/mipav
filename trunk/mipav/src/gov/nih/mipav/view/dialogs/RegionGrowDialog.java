...
/**
 * Interface for dialogs which gather region grow information and then
 * update a list of listeners who want to know about the region grow.
...
public interface RegionGrowDialog {
     ...
     * @return  The value to be added to the seed intensity that defines
     ...
     * @return  The value to be subtracted to the seed redintensity that defines
     *          the lower intensity red value that the region can grow into.
     */
    float getLowerBoundR();

    /**
     * Accessor to the upper bound red slider.
     * @return  The value to be added to the seed red intensity that defines
     *          the upper intensity red value that the region can grow into.
     */
    float getUpperBoundR();

    /**
     * Accessor to the lower bound green slider.
     * @return  The value to be subtracted to the seed green intensity that defines
     *          the lower intensity green value that the region can grow into.
     */
    float getLowerBoundG();

    /**
     * Accessor to the upper bound green slider.
     * @return  The value to be added to the seed green intensity that defines
     *          the upper intensity green value that the region can grow into.
     */
    float getUpperBoundG();

    /**
     * Accessor to the lower bound blue slider.
     * @return  The value to be subtracted to the seed blue intensity that defines
     *          the lower intensity blue value that the region can grow into.
     */
    float getLowerBoundB();

    /**
     * Accessor to the upper bound blue slider.
     * @return  The value to be added to the seed blue intensity that defines
     *          the upper intensity blue value that the region can grow into.
     */
