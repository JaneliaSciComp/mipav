 ...
 */
public class JDialogShortestPathWatershed extends JDialogScriptableBase
     ...
     */
    public JDialogShortestPathWatershed() { }
     ...
     */
    public JDialogShortestPathWatershed(Frame theParentFrame, ModelImage im) {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmShortestPathWatershed) {
            System.err.println("Shortest Path Watershed elapsed: " + algorithm.getElapsedTime());
            image.clearMask();
    ...
    protected void callAlgorithm() {
        try {
         ...
         // save the completion status for later
            ...
            System.gc();
            MipavUtil.displayError("Dialog Shortest Path Watershed: unable to allocate enough memory");
    ...
    private void init() {
        ...
        setTitle("Shortest Path Watershed");
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("Applies Shortest Path watershed segmentation to the image.");
            }
            ...
            public String getShortLabel() {
                return new String("ShortestPathWatershedSegmentation");
            }

            public String getLabel() {
                return new String("Shortest Path Watershed Segmentation");
            }
