 ...
 */
public class JDialogDenoisingBLS_GSM extends JDialogScriptableBase implements AlgorithmInterface, ItemListener, ActionDiscovery, ScriptableActionInterface {
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("Applies a denoising BLS GSM algorithim to an image.");
            }
            ...
            public String getShortLabel() {
                return new String("denoisingBLSGSM");
            }

            public String getLabel() {
                return new String("Denoising BLS GSM");
            }
    ...
    public ParameterTable createInputParameters() {
        ...
        try {
            ...
            table.put(new ParameterFloat("noise_std_dev", 1));
            table.put(new ParameterBoolean("use_power_spectral_density", false));
            table.put(new ParameterInt("local_neighborhood_x", 3));
            table.put(new ParameterInt("local_neighborhood_y", 3));
            table.put(new ParameterBoolean("use_parent", true));
            table.put(new ParameterBoolean("use_boundary",true));
            table.put(new ParameterInt("number_of_scales", 4));
            table.put(new ParameterInt("number_of_orientations", 3));
            table.put(new ParameterBoolean("include_covariance", true));
            table.put(new ParameterBoolean("do_optimize", true));
            table.put(new ParameterInt("wavelet_method", 1));
            table.put(new ParameterInt("wavelet_filter", 4));
