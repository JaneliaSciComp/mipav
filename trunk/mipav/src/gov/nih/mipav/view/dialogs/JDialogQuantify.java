...
public class JDialogQuantify
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (command.equals("OK")) {
      ...
      try {
        JFileChooser chooser = new JFileChooser(image.getFileInfo(0).
                                                getFileDirectory());
  ...
  /**
   *	Once all the necessary variables are set, call the quantify mask
   *	algorithm using the previously set file name.
   */
  private void callAlgorithm() {
    ...
    try {
      ...
      MipavUtil.displayError(
          "Dialog Quantify: unable to allocate enough memory");
      return;
    }
  }
