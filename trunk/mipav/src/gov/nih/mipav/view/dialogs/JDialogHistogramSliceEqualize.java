...
/**
 * Dialog to get user input reference slice.  All other slices transformed to Equalize histogram of
 * reference slice. Algorithms are executed in their own thread.
 */
public class JDialogHistogramSliceEqualize extends JDialogScriptableBase implements AlgorithmInterface {
    ...
    /** DOCUMENT ME! */
    private AlgorithmHistogramSliceEqualize equalizeHistogramSliceAlgo = null;
     ...
     */
    public JDialogHistogramSliceEqualize() { }
     ...
     */
    public JDialogHistogramSliceEqualize(Frame theParentFrame, ModelImage im) {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmHistogramSliceEqualize) {
            srcImage.clearMask();

            if ((equalizeHistogramSliceAlgo.isCompleted() == true) && (resultImage != null)) {
                ...
                Vector imageFrames = srcImage.getImageFrameVector();
        ...
        equalizeHistogramSliceAlgo.finalize();
        equalizeHistogramSliceAlgo = null;
        dispose();
    }
    ...
    protected void callAlgorithm() {
        String name = makeImageName(srcImage.getImageName(), "_histSliceEqualize");
        ...
        if (displayLoc == NEW) {
            ...
            try {
                ...
                // Make algorithm
                equalizeHistogramSliceAlgo = new AlgorithmHistogramSliceEqualize(resultImage, srcImage, referenceSlice);

                // This is very important. Adding this object as a listener allows the algorithm to
                // notify this object when it has completed of failed. See algorithm performed event.
                // This is made possible by implementing AlgorithmedPerformed interface
                equalizeHistogramSliceAlgo.addListener(this);

                createProgressBar(srcImage.getImageName(), equalizeHistogramSliceAlgo);
                ...
                if (isRunInSeparateThread()) {
                    ...
                    if (equalizeHistogramSliceAlgo.startMethod(Thread.MIN_PRIORITY) == false) {
                        MipavUtil.displayError("A thread is already running on this object");
                    }
                } else {
                    equalizeHistogramSliceAlgo.run();
                }
                ...
                System.gc();
                MipavUtil.displayError("Dialog Histogram slice Equalize: unable to allocate enough memory");
            ...
            try {
                ...
                equalizeHistogramSliceAlgo = new AlgorithmHistogramSliceEqualize(srcImage, referenceSlice);
                ...
                // These next lines set the titles in all frames where the Equalize image is displayed to
    ...
    private void init() {
        ...
        setTitle("Histogram slice Equalization");
