...
public class JDialogRecordLUT extends JDialogBase {
    ...
    public JDialogRecordLUT( ModelImage _image, ModelLUT _lut ) {
        ...
        /*
         try {
         _image.getParentFrame().setIconImage(MipavUtil.getIconImage("histolut.gif"));
    ...
    public void buildLUTPanel() {
        ...
        compLUT = new ViewJComponentLUTTable( image, lut, new Dimension( 130, lut.getExtents()[1] ), ViewJComponentLUTTable.VERTICAL );
        compLUT.show( null );
        ...
        lutTablePanel.setBounds(34, 20, compLUT.getSize().width + 2 * borderSize, compLUT.getSize().height + 2 * borderSize);
        updateLUT( lut );

    }

    /**
     * Switching the different types of LUT view invoke this method
     * to update the the LUT view.
