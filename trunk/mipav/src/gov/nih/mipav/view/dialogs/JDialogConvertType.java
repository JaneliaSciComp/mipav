...
public class JDialogConvertType extends JDialogBase
    ...
    private void init() {
        ...
        String tempStr = new String(
                "  Start input range ( " + makeString( (float) inMin, 12 ) + " - " + makeString( (float) inMax, 12 )
                + " )." );
        ...
        tempStr = new String(
                "  End input range ( " + makeString( (float) inMin, 12 ) + " - " + makeString( (float) inMax, 12 )
                + " )." );
            ...
            if ( displayLoc == NEW ) {
                try {
                    ...
                    resultImage = new ModelImage( dataType, destExtents,
                            makeImageName( image.getImageName(), "_changed" ), userInterface );
