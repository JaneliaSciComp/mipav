...
public class JDialogRegistrationOAR2D
  ...
  private int numMinima=numMinima_def;
    ...
    /** If true the dialog for this instance of JDialogRegistrationOAR2D will
     * not activate the AlgorithmRegOAR2D: */
    ...
    private JTextField rotationText, translationText,
        xscaleText, yscaleText, scaleStepsText;
   ...
   *	@param iInterp default display interpolation choice.
   ...
   *	@param iScaleStepsBF default number of steps to divide scale range
   *	brute-force registration.
   *	@param iTranslationBF default translation range for brute-force registration.
   */
  public JDialogRegistrationOAR2D(Frame theParentFrame,
                                  ModelImage ref,
                                  ModelImage match,
                                  int iCost,
                                  int iDOF,
  ...
  /**
   *	Initializes the GUI components, based on the preset values set by the
   *	class calling the constructor. Then displays the dialog.
   */
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    /* Sets the brute force parameters: */
        ...
        if (testParameter(tmpStr, 0, Math.max(matchImage.getExtents()[0],
                                              matchImage.getExtents()[1] ) ) ) {
  ...
  /**
   * Builds the bruteForceDialog so the user can set the brute-force
   ...
   */
   private JDialog buildBruteForceDialog() {
     ...
     JLabel rotationInstruct =
         new JLabel("Value may be zero for no rotation optimization.", JLabel.RIGHT);
     ...
     JLabel translationInstruct =
         new JLabel("Value may be zero for no translation optimization.", JLabel.RIGHT);
     ...
     JLabel xscaleInstruct =
         new JLabel("Value may be zero for no scale in X optimization.", JLabel.RIGHT);
     ...
     JLabel yscaleInstruct =
         new JLabel("Value may be zero for no scale in Y optimization.", JLabel.RIGHT);
     ...
     JLabel scaleStepsBoundLabel = new JLabel("Number of steps for testing scales: ",
                                              JLabel.LEFT);
     ...
     JLabel scaleStepsInstruct =
         new JLabel("Value may be zero for no scale in optimization.", JLabel.RIGHT);
     ...
     Rectangle dialogBounds = this.getBounds();
     bruteForceDialog.
         setLocation((int)(Toolkit.getDefaultToolkit().getScreenSize().width*0.75-dialogBounds.width/2),
                     Toolkit.getDefaultToolkit().getScreenSize().height/2-dialogBounds.height/2);
