...
public class JDialogDICOMDeleteTagEditor extends JDialogBase {
     ...
     */
    public JDialogDICOMDeleteTagEditor(Dialog parent, String _tagKey, FileDicomTagTable _tagTable, boolean modal, boolean isStandalone) {
        super(parent, modal);
        ...
        if(isStandalone) {
        	setTitle("Delete tag (" + tagKey + "): " + tagTable.get(tagKey).getName());
        }
