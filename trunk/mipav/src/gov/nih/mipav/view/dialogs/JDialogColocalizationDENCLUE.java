...
public class JDialogColocalizationDENCLUE extends JDialogBase implements AlgorithmInterface {
    ...
    private static final long serialVersionUID = -308684437006461697L;
    ...
    /**
     * Creates a new JDialogColocalizationDENCLUE object.
     *
            ...
            if (secondImage != null) {
                ...
                if (UI.isScriptRecording()) {
                    ...
                    UI.getScriptDialog().append(UI.getScriptDialog().getVar(resultImage.getImageName()) + " " + bin1 +
                                                " " + bin2 + " " + threshold1 + " " + threshold2 + " " + doOr + " " +
                                                leftPad + " " + rightPad + " " + bottomPad + " " + topPad + " " +
                                                entireImage + " " + register + " " + cost + " " + gaussians + " " +
                                                iterations + "\n");
                }
                ...
                if (UI.isScriptRecording()) {
                    ...
                    UI.getScriptDialog().append(UI.getScriptDialog().getVar(resultImage.getImageName()) + " " + bin1 +
                                                " " + bin2 + " " + threshold1 + " " + threshold2 + " " + doOr + " " +
                                                leftPad + " " + rightPad + " " + bottomPad + " " + topPad + " " +
                                                useRed + " " + useGreen + " " + useBlue + " " + entireImage + " " +
