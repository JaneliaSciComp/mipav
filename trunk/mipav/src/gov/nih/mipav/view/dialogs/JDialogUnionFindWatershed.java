 ...
 *
 * @version  0.1 September 16, 2016
 * @author   William Gandler
 * @see      AlgorithmUnionFindWatershed
 */
public class JDialogUnionFindWatershed extends JDialogScriptableBase
    ...
    /** DOCUMENT ME! */
    private AlgorithmUnionFindWatershed watershedAlgo;
     ...
     */
    public JDialogUnionFindWatershed() { }
     ...
     */
    public JDialogUnionFindWatershed(Frame theParentFrame, ModelImage im) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals("OK")) {
            ...
            //MipavUtil.showWebHelp("Segmentation:_UnionFind_Watershed");
        } else {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmUnionFindWatershed) {
            System.err.println("Union Find Watershed elapsed: " + algorithm.getElapsedTime());
            image.clearMask();
    ...
    protected void callAlgorithm() {
        try {
           ...
           watershedAlgo = new AlgorithmUnionFindWatershed(resultImage, image, neighbor8, limitBins, binNumber);
         ...
         // save the completion status for later
            ...
            System.gc();
            MipavUtil.displayError("Dialog Union Find Watershed: unable to allocate enough memory");
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("Applies Union Find watershed segmentation to the image.");
            }
            ...
            public String getShortLabel() {
                return new String("UnionFindWatershedSegmentation");
            }

            public String getLabel() {
                return new String("Union Find Watershed Segmentation");
            }
