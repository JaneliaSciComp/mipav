 ...
 *
 * @version  0.1 July 6, 2016
 * @author   William Gandler
 * @see      AlgorithmEfficientWatershed
 */
public class JDialogEfficientWatershed extends JDialogScriptableBase
    ...
    /** DOCUMENT ME! */
    private AlgorithmEfficientWatershed watershedAlgo;
     ...
     */
    public JDialogEfficientWatershed() { }
     ...
     */
    public JDialogEfficientWatershed(Frame theParentFrame, ModelImage im) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals("OK")) {
            ...
            //MipavUtil.showWebHelp("Segmentation:_Efficient_Watershed");
        } else {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmEfficientWatershed) {
            System.err.println("Efficient Watershed elapsed: " + algorithm.getElapsedTime());
            image.clearMask();
    ...
    protected void callAlgorithm() {
        try {
         ...
         // save the completion status for later
            ...
            System.gc();
            MipavUtil.displayError("Dialog Efficient Watershed: unable to allocate enough memory");
    ...
    private void init() {
        ...
        JLabel label2D = new JLabel("2D segmentation neighbors:");
        label2D.setFont(serif12);
        label2D.setForeground(Color.black);
        neighborPanel.add(label2D, gbcScale);
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("Applies efficient watershed segmentation to the image.");
            }
            ...
            public String getShortLabel() {
                return new String("EfficientWatershedSegmentation");
            }

            public String getLabel() {
                return new String("Efficient Watershed Segmentation");
            }
