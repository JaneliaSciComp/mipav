...
public class JDialogSelectChannelSequence extends JDialogBase
{
     ...
     * @param channelOrder int[] - an array of ints indicating the channel order. Valid values range from 0 to 3,
     * and correspond to the ARGB interleave.
     */
    ...
    /**
     * Invoked when an action occurs. If the user clicks "OK", ViewOpenImageSequence.newChannelMap is
     * called on the parent object. This effectively rearranges the channel ordering of the TIFF
     * sequence in the parent object.
     *
