...
public class JDialogFillObjects extends JDialogBase
        ...
        if ( image.getNDims() == 2 ) { // source image is 2D
            ...
            if ( displayLoc == NEW ) {
                try {
                    ...
                    // new ViewJFrameImage( tempImage, null, new Dimension( 300, 300 ), tempImage.getUserInterface(), false );
                ...
                /*
                 ...
                 //  AlgorithmMorphology2D.FILL_OBJECTS, 0, 0, 0, 0, regionFlag);
                 resultImage = (ModelImage) image.clone();
                 resultImage.setImageName(name);
                 ...
                 AlgorithmChangeType changeTypeAlgo = new AlgorithmChangeType( ubyteImage, resultImage, 0, 1, 0, 1, false );
                 changeTypeAlgo.run();

                 // Make algorithm
                 idObjectsAlgo2D = new AlgorithmMorphology2D(ubyteImage, kernel, 0,
        ...
        if ( algo.isCompleted() ) {
            if ( userInterface.isScriptRecording() ) {
                ...
                userInterface.getScriptDialog().append(
                        "FillObjects " + userInterface.getScriptDialog().getVar( image.getImageName() ) + " " );
