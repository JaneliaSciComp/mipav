 ...
 *
 */
public class JDialogGaborFilter
    extends JDialogBase
    ...
    if (displayLoc == NEW) {
      try {
        ...
        FrequencyFilterAlgo = new AlgorithmFrequencyFilter(resultImage, image,
            freqU, freqV, sigmaU, sigmaV, theta, createGabor);
      ...
      try {
        ...
        FrequencyFilterAlgo = new AlgorithmFrequencyFilter(image, freqU, freqV,
                sigmaU, sigmaV, theta, createGabor);
