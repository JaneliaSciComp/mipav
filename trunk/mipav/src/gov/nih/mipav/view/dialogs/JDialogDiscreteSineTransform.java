...
public class JDialogDiscreteSineTransform extends JDialogScriptableBase implements AlgorithmInterface{
    ...
    private void init() {
        ...
        JPanel processorPanel = new JPanel(new GridBagLayout());
        processorPanel.setBorder(buildTitledBorder("Processor parameters"));
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        processorPanel.add(singleButton, gbc);
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        processorPanel.add(multiButton, gbc);
