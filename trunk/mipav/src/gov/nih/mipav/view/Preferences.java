...
/**
 *   This class reads the MIPAV preference file.  The preference file stores a number of user specific parameters
 *   of the application. It is stored in the  < user directory >/mipav directory so that it can be read and written
 *   to by the user. It is a text file and can be manually edited - not recommended.
 */
public class Preferences {
    ...
    /** Constant that indicates whether the triplanar frame should wait for a mouse released
     *  event before repainting all 9 tri-planar images. Inserted here because repainting 9
     * images in real time gets to be tedious.
     */
    ...
    /**
     * Constant that indicates whether the triplanar frame should use the old 2x2 layout or
     * the newer 3x1 layout.
     */
 ...
 //       defaultProps.setProperty("MenuAcceleratorFontColor", "");
     ...
     */
    public final static String getPreferencesDir() {
     ...
     */
    public final static void setPreferencesFileName( String fileName ) {
     ...
     *   @param key    the property key.
     */
    public final static void removeProperty(String key) {
        if (mipavProps == null) read();
     ...
     *   If this property has not been set, then the image Directory is returned.
     *   <p>
     *   @return    directory name for the property PluginUserDir or the directory
     *               name for the property ImageDirectory if PluginUserDir is not set.
     */
    public final static String getPluginUserDir() {
    ...
    /**
     * Returns the default script directory.
     * if null, returns the user's current working directory + "scripts"
     * @return script dir
     */
    public final static String getScriptsDirectory() {
    ...
    /**
     * Builds a hashtable of actioncommands (keys) with associated keystrokes
     * from the Preferences file
     * @return Hashtable
     */
    public final static void buildShortcutTable() {
    ...
    private static final String buildDefaultShortcuts() {
     ...
     */
    public final static void saveShortcuts() {
   ...
   /**
    * Sets the current keystroke shortcut for assignment once a command
    * has been passed in
   ...
   /**
    * Adds a new shortcut to the hashtable.  if there is already a command predefined for the
    * keystroke set from <code>setShortcut()</code>, it will be removed then replaced with the new command.
   ...
   public static void removeShortcut(String commandToRemove) {
    ...
    /**
     *   Gets the image overlay codes (they identify what to display in the corners of the image),
     ...
     *
     */
    public final static String[] getOverlays(boolean isDicom) {
     ...
     */
    public final static String[] getOverlayNames(boolean isDicom) {
        String[] overlays = new String[16];
     ...
     *   @param isDicom if true identifies the tags as a list of DICOMOverlays else
     *                  identifies the tags as ImageOverlays (i.e., it is not a DICOM image)
     *   @param overlays an array of 16 strings (4 for each corner) that identifies what is to be
     *                  displayed in the image.
     */
    public final static void setOverlays(boolean isDicom, String[] overlays) {
        String str = "";

        for (int i = 0; i < 16; i++) {
            if (overlays[i] != null &&
                !overlays[i].equals(JDialogOverlay.BLANK_OVERLAY)) {
                str += overlays[i] + ";";
            }
            else {
                str += "-;";
    ...
    /**
     * Sets the labels for each overlay position.  The labels can be user input
     * with any text and will be displayed before the overlay values
     * @param isDicom boolean is the image DICOM
     * @param overlays String[] array of strings (16) for each of the overlay positions
     */
    public final static void setOverlayNames(boolean isDicom, String[] overlays) {
        String str = "";
     ...
     */
    public final static void setShowImageOverlays(boolean doShow) {
     ...
     */
    public final static void setShowDICOMOverlays(boolean doShow) {
    ...
    public static boolean setDICOMBrowserTableConfiguration(Vector newConfiguration) {
        if (newConfiguration == null) {
            MipavUtil.displayInfo(
                "Unable to save configuration to preferences file.");
            return false;
        }
    ...
    /**
     *  Accessor to get the TRIM parameter (trimming VOIcontour of points). Default value is 0.3 which trims
     *  some of the points of the contours.
     *  @return the trim value.
     */
    public final static float getTrim() {
     ...
     */
    public final static String getIconName() {
    ...
    /** Gets the boolean state of the property, where in the preferences file
     * the &quot;yes&quot;, &quot;on&quot;, &quot;true&quot; all return
     * <code>true</code>, but anything else (or non-existent property) returns
     * <code>false</code>.  This method is provided for semantic preference,
     * but is exactly the same as (in fact, calls) <code>isPreference</code>.
     * @see #isPreference(String)
     * @return boolean <code>true</code> when the named property has the
     *    String the &quot;yes&quot;, &quot;on&quot;, &quot;true&quot;.
     *    <code>false</code> for any other string, or if the property does not
     *    exist.
     * @param propertyName Name of a property in preferences to check.
     */
    public final static boolean is(String propertyName) {
     ...
     * the &quot;yes&quot;, &quot;on&quot;, &quot;true&quot; all return
     * <code>true</code>, but anything else (or non-existent property) returns
     * <code>false</code>.  While not as intuitive, perhaps, as some of the
     * specially named property-retrieval methods (eg.,
     * <code>isSplashScreen</code>), this method can be used to replace all of
     * those methods when the preferences property is known.  It can also
     * be convenient for limited-use properties used in debugging.
     * @return boolean <code>true</code> when the named property has the
     *    String the &quot;yes&quot;, &quot;on&quot;, &quot;true&quot;.
     *    <code>false</code> for any other string, or if the property does not
     *    exist.
     * @param propertyName Name of a property in preferences to check.
     */
    public final static boolean isPreference(String propertyName) {
     ...
     * Note that this just checks for some value, not necessarily a &quot;true&quot; value.
     * @param propertyName the name of the property to check for
     * @return <code>true</code> if there is some preference set for the given property name
     */
    public final static boolean isPreferenceSet(String propertyName) {
        if (propertyName == null) {
            debug("Property name: null.", Preferences.DEBUG_MINOR);
            return false;
        }
     ...
     */
    public final static void debug(String string, int level) {
     ...
     * @param string String string to be output
     */
    public final static void debug(String string) {
     ...
     *   (and in preferences v2, if debug level is zero, returns false.
     *   Returns true if debug level is greater than 0.)
     *   <p>
     *   debug level is the amount of output given for debugging mipav.
     *   @return    returns true if either debug flag is true or level is greater than zero
     *                 and false if either debug flag is false or level is zero.
     */
    public final static boolean isDebug() {
        ...
        if (str == null) {
            // do nothing
            System.err.println(
                "Preferences debug: string is null. No property DEBUG");
        }
        else {
            try {
                ...
                if (str.equalsIgnoreCase("true") || str.equalsIgnoreCase("on")
                    || str.equalsIgnoreCase("yes")) { // debug YES
                    return true;
                }
            }
     ...
     */
    public final static boolean debugLevel(int level) {
        ...
        if (str == null) {
            ...
            while (st.hasMoreTokens()) {
                ...
                try {
                    if (index == level) {
                        if (token.equalsIgnoreCase("TRUE") || token.equalsIgnoreCase("on") || token.equalsIgnoreCase("yes")) {
                            return true;
                        }
                        else {
                            return false;
     ...
     */
    public final static boolean[] getDebugLevels() {
    ...
    public static String getIP(String AETitle) {
        ...
        while (getProperty(key) != null) {
            ...
            key = key.substring(0, 6)
                + (Integer.valueOf(key.substring(6)).intValue() + 1);
        }
    ...
    public static String getDefaultStorageKey() {
        ...
        while (getProperty(key) != null) {
            ...
            key = key.substring(0, 7)
                + (Integer.valueOf(key.substring(7)).intValue() + 1);
        }
        return defaultKey;
    }
     ...
     */
    public static final void saveDialogDefaults(String dialogName,
    ...
    public static final String getDICOMSaveDictionary() {
        ...
        String defaultKey = System.getProperties().getProperty("user.home") +
                File.separator + "mipav" + File.separator + "dicomsave.dictionary";
    ...
    /**
     *  Gets the names of the last X number of images that were loaded from the Preferences
     *  file.  Shortens the names so the menu isn't too wide.
            ...
            try {
                ...
                for (int i = 0; i < images.length; i++) {
                    if (images[i].length() > 25) {
                        ...
                        String temp = images[i].substring(0, index2 + 1) +
                            "..."
                            + images[i].substring(index);
                        ...
                        while (temp.length() < 25) {
                            ...
                            temp = images[i].substring(0, index2 + 1) + "..."
                                + images[i].substring(index);
    ...
    /**
     * Sets the debug levels (lowest is index 0) on/off
     * levels[0] is MINOR
     * levels[1] is ALGORITHM
     * levels[2] is FILEIO
     ...
     *   If it is a duplicate, moves it up on the list.
    ...
    /**
     *   @deprecated
     *   Gets the last four projects that were loaded from the Preferences
     *   file.  Shortens the names so the menu isn't too wide.
     *   @return Array of strings representing the last projects that were
     *   loaded, max of four.
     */
            ...
            try {
                ...
                for (int i = 0; i < projects.length; i++) {
                    if (projects[i].length() > 25) {
                        ...
                        String temp = projects[i].substring(0, index2 + 1) +
                            "..."
                            + projects[i].substring(index);
                        ...
                        while (temp.length() < 25) {
                            name = temp;
                            index = temp2.lastIndexOf(File.separatorChar);
                            temp = projects[i].substring(0, index2 + 1) + "..."
                                + projects[i].substring(index);
    ...
    /**
     *   @deprecated
     *   Returns the project of "last four projects" at the given index.
     *   Index should be between 0 and 3.
    ...
    /**
     *   Sets the last project loaded in the Preferences file.
     *   If it is a duplicate, moves it up on the list.
    ...
    /**
     * Used by ViewOpenImageSequence to save the user's most recent slices, channels, time points, and ordering
     * that were specified in the component.
     *
     ...
     */
    public static final void setLastOpenSequenceParams(String slices,
        String channels, String timePoints, String ordering) {
     ...
     * @return String - the value that was saved to the preferences file, represented by a String, of the
     * number of slices that were used in the corresponding text box of this frame the last time the value
     * was saved
     */
     ...
     * @return String - the value that was saved to the preferences file, represented by a String, of the
     * number of channels that were used in the corresponding text box of this frame the last time the value
     * was saved
     */
     ...
     * @return String - the value that was saved to the preferences file, represented by a String, of the
     * number of time points that were used in the corresponding text box of this frame the last time the value
     * was saved
     */
     ...
     * @return String - the value that was saved to the preferences file, represented by a String, of the
     * Z-C-T ordering of data that was used in the corresponding text box of this frame the last time the value
     * was saved
     */
    ...
    /**
     * Used by ViewOpenImageSequence to save its subsample dimensions for the next time it is opened. The
     * dimension is actually saved as its two parts, width and height
    ...
    public static final Dimension getSubsampleDimensions() {
        ...
        try {
            ...
            subsampleDimension = new Dimension(Integer.parseInt(subsampleWidth),
                                               Integer.parseInt(subsampleHeight));
        }
