...
public class Preferences {
    ...
    /** Constant that indicates the NDAR Imaging public meta-file dump directory */
    public static final String PREF_NDAR_IMAGING_META_DIR_PUBLIC = "ndarImagingMetaDirPublic";
    
    /** Constant that indicates the NDAR Imaging private meta-file dump directory */
    public static final String PREF_NDAR_IMAGING_META_DIR_PRIVATE = "ndarImagingMetaDirPrivate";
    
    /** Constant that indicates the NDAR Imaging public image dump directory */
    public static final String PREF_NDAR_IMAGING_DIR_PUBLIC = "ndarImagingDirPrivate";
