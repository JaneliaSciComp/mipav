...
public class ViewJComponentColocalizationEM extends ViewJComponentBase  {
    ...
    *   @param theta
    */
    public ViewJComponentColocalizationEM(ViewJFrameBase _frame,
                                   ModelImage _imageA,
                                   ModelImage _imageB,
        ...
        try {
            ...
            if (imgDest != null) {
                ...
                for (j = 0; j < mean.length; j++) {
                    ...
                    g2D.rotate(theta[j]);
                    ellipse = new Ellipse2D.Double((int)(-halfBig + 0.5),
                               (int)(-halfSmall + 0.5),
                               (int)(2.0 * halfBig + 0.5),
                               (int)(2.0 * halfSmall + 0.5));
                    g2D.draw(ellipse);
                    g2D.setColor(Color.green);
                    ellipse2 = new Ellipse2D.Double((int)(-2.0 * halfBig + 0.5),
                               (int)(-2.0 * halfSmall + 0.5),
                               (int)(4.0 * halfBig + 0.5),
                               (int)(4.0 * halfSmall + 0.5));
                    g2D.draw(ellipse2);
                    g2D.setColor(Color.red);
                    ellipse3 = new Ellipse2D.Double((int)(-3.0 * halfBig + 0.5),
                               (int)(-3.0 * halfSmall + 0.5),
                               (int)(6.0 * halfBig + 0.5),
                               (int)(6.0 * halfSmall + 0.5));
                    g2D.draw(ellipse3);
