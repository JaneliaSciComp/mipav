...
public class ViewImageFileFilter extends javax.swing.filechooser.FileFilter {
    ...
    public boolean accept(String extension) {
        ...
        if ((filterType == MISC) &&
            ...
            return true;
        } else if ((filterType == MATRIX) && ((extension.equals("mtx")) || (extension.equals("mat")) || (extension.equals("xfm")))) {
            return true;
            ...
            return true;
                       ...
                       ( extension.equals("sur") || extension.equals("wrl") || 
                         ...
                         extension.equals("vtp") || extension.equals("stla")||
                         extension.equals("stlb"))) {
            return true;
