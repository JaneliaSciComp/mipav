...
/**
*       This is an icon which is a block of color with bounds specified 
*       in the constructor.  It is from <U>Graphic Java Mastering the 
*       JFC Volume II:  Swing</U>, by David Geary, published by Sun Microsystems
*       Press 1999, page 1085.
*
...
class ColorIcon implements Icon {
    ...
    /**
    *  Constructor  Makes a color icon with the default color of gray and
    *               default width and height values of 50 and 15, respectively.
    */
    public ColorIcon() {
