...
import gov.nih.mipav.view.srb.SRBTreeCellRenderer;
...
//----------------------------------------------------------------------
     ...
     */
    public JSRBTree( GeneralFile root )
        throws IOException
    {
        this( root, null, null );
    }
     ...
     */
    public JSRBTree( GeneralFile[] roots )
        throws IOException
    {
     ...
     * when available.
     */
    public JSRBTree( GeneralFile root, MetaDataSelect selects[] )
        throws IOException
    {
     ...
     * when available.
     */
    public JSRBTree( GeneralFile[] roots, MetaDataSelect selects[] )
        throws IOException
    {
     ...
     * displayed.
     */
    public JSRBTree( GeneralFile root, MetaDataCondition conditions[],
     ...
     * displayed.
     */
    public JSRBTree( GeneralFile[] roots, MetaDataCondition conditions[],
        MetaDataSelect selects[] )
        throws IOException
    {
        createJargonTree( roots, conditions, selects );
...
//----------------------------------------------------------------------
    /**
     * The (sub-)roots of this JTree. JSRBTree's can display more then one
...
//----------------------------------------------------------------------
        ...
        throws IOException
    {
        ...
        /**
         * To display the metadata values gathered by the SRBTreeModel selects[],
        ...
        /**
         * To edit the metadata values gathered by the SRBTreeModel selects[],
  ...
  public void useDefaultPopupMenu( boolean useDefault )
    ...
    popup = new JPopupMenu();
        ...
        /*
            The optimization code of the SRBTreeModel stores the directory
            ...
            Requiring we add a refresh option. See also SRBTreeModel.
        */
...
//----------------------------------------------------------------------
     ...
     * A test constructor.
     */
    private JSRBTree( String[] args,  MetaDataSelect selects[] )
