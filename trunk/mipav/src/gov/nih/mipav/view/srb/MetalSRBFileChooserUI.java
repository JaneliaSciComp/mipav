 ...
 * @author Jeff Dinkins
 */
public class MetalSRBFileChooserUI extends BasicSRBFileChooserUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new MetalSRBFileChooserUI((SRBFileChooser) c);
    }

    public MetalSRBFileChooserUI(SRBFileChooser filechooser) {
        super(filechooser);
    }
    ...
    private class MetalFileChooserUIAccessor implements
            SRBFilePane.SRBFileChooserUIAccessor {
        public SRBFileChooser getFileChooser() {
            return MetalSRBFileChooserUI.this.getFileChooser();
        }

        public BasicSRBDirectoryModel getModel() {
            return MetalSRBFileChooserUI.this.getModel();
        }

        public JPanel createList() {
            return MetalSRBFileChooserUI.this.createList(getFileChooser());
        }

        public JPanel createDetailsView() {
            return MetalSRBFileChooserUI.this
                    .createDetailsView(getFileChooser());
        }

        public boolean isDirectorySelected() {
            return MetalSRBFileChooserUI.this.isDirectorySelected();
        }

        public SRBFile getDirectory() {
            return MetalSRBFileChooserUI.this.getDirectory();
        }
        ...
        public Action getApproveSelectionAction() {
            return MetalSRBFileChooserUI.this.getApproveSelectionAction();
        }

        public Action getNewFolderAction() {
            return MetalSRBFileChooserUI.this.getNewFolderAction();
        }

        public MouseListener createDoubleClickListener(JList list) {
            return MetalSRBFileChooserUI.this.createDoubleClickListener(
                    getFileChooser(), list);
        }
    ...
    public void installComponents(SRBFileChooser fc) {
        ...
        filePane = new SRBFilePane(new MetalFileChooserUIAccessor());
        ...
        // Home Button
        SRBFile homeDir = fsv.getHomeDirectory();
        ...
        listViewButton.addActionListener(filePane
                .getViewTypeAction(SRBFilePane.VIEWTYPE_LIST));
        ...
        detailsViewButton.addActionListener(filePane
                .getViewTypeAction(SRBFilePane.VIEWTYPE_DETAILS));
        ...
        filePane.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent e) {
                if ("viewType".equals(e.getPropertyName())) {
                    ...
                    switch (viewType) {
                    case SRBFilePane.VIEWTYPE_LIST:
                        listViewButton.setSelected(true);
                        break;

                    case SRBFilePane.VIEWTYPE_DETAILS:
    ...
    protected ActionMap createActionMap() {
        ...
        SRBFilePane.addActionsToMap(map, filePane.getActions());
        return map;
    }

    protected JPanel createList(SRBFileChooser fc) {
        return filePane.createList();
    }

    protected JPanel createDetailsView(SRBFileChooser fc) {
    ...
    /**
     * Returns the preferred size of the specified <code>SRBFileChooser</code>.
    ...
    /**
     * Returns the minimum size of the <code>SRBFileChooser</code>.
     * 
     * @param c
     *            a <code>SRBFileChooser</code>
    ...
    /**
     * Returns the maximum size of the <code>SRBFileChooser</code>.
     * 
     * @param c
     *            a <code>SRBFileChooser</code>
    ...
    private String fileNameString(SRBFile file) {
        if (file == null) {
            return null;
        } else {
    ...
    private String fileNameString(SRBFile[] files) {
    ...
    private void doDialogTypeChanged(PropertyChangeEvent e) {
        ...
        approveButton.setText(getApproveButtonText(chooser));
        approveButton.setToolTipText(getApproveButtonToolTipText(chooser));
        if (chooser.getDialogType() == SRBFileChooser.SAVE_DIALOG) {
            ...
            public void propertyChange(PropertyChangeEvent e) {
                ...
                if (s.equals(SRBFileChooser.SELECTED_FILE_CHANGED_PROPERTY)) {
                    doSelectedFileChanged(e);
                        ...
                        .equals(SRBFileChooser.SELECTED_FILES_CHANGED_PROPERTY)) {
                    doSelectedFilesChanged(e);
                } else if (s.equals(SRBFileChooser.DIRECTORY_CHANGED_PROPERTY)) {
                    doDirectoryChanged(e);
                } else if (s
                        .equals(SRBFileChooser.FILE_FILTER_CHANGED_PROPERTY)) {
                    doFilterChanged(e);
                } else if (s
                        .equals(SRBFileChooser.FILE_SELECTION_MODE_CHANGED_PROPERTY)) {
                    doFileSelectionModeChanged(e);
                } else if (s.equals(SRBFileChooser.ACCESSORY_CHANGED_PROPERTY)) {
                    doAccessoryChanged(e);
                } else if (s
                        .equals(SRBFileChooser.APPROVE_BUTTON_TEXT_CHANGED_PROPERTY)
                        || s
                                .equals(SRBFileChooser.APPROVE_BUTTON_TOOL_TIP_TEXT_CHANGED_PROPERTY)) {
                    doApproveButtonTextChanged(e);
                } else if (s
                        .equals(SRBFileChooser.DIALOG_TYPE_CHANGED_PROPERTY)) {
                    doDialogTypeChanged(e);
                } else if (s
                        .equals(SRBFileChooser.APPROVE_BUTTON_MNEMONIC_CHANGED_PROPERTY)) {
                    doApproveButtonMnemonicChanged(e);
                } else if (s
                        .equals(SRBFileChooser.CONTROL_BUTTONS_ARE_SHOWN_CHANGED_PROPERTY)) {
    ...
    class DirectoryComboBoxRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object value,
            ...
            SRBFile directory = (SRBFile) value;
    ...
    protected class DirectoryComboBoxModel extends AbstractListModel implements
        ...
        SRBFile selectedDirectory = null;
        ...
        public DirectoryComboBoxModel() {
            ...
            // selectedDirectory
            SRBFile dir = getFileChooser().getCurrentDirectory();
            if (dir != null) {
                addItem(dir);
            }
        }
         ...
         */
        private void addItem(SRBFile directory) {
            ...
            SRBFile canonical = null;
            try {
                canonical = (SRBFile) directory.getCanonicalFile();
            } catch (IOException e) {
                // Maybe drive is not ready. Can't abort here.
                canonical = directory;
            }

            // create SRBFile instances of each directory leading up to the top
            SRBFile f = canonical;
            Vector path = new Vector(10);
            do {
                path.addElement(f);
            } while ((f = (SRBFile) f.getParentFile()) != null);

            int pathCount = path.size();
            // Insert chain at appropriate place in vector
            for (int i = 0; i < pathCount; i++) {
                f = (SRBFile) path.get(i);
        ...
        private void calculateDepths() {
            ...
            for (int i = 0; i < depths.length; i++) {
                SRBFile dir = (SRBFile) directories.get(i);
                SRBFile parent = (SRBFile) dir.getParentFile();
                depths[i] = 0;
                if (parent != null) {
                    for (int j = i - 1; j >= 0; j--) {
                        if (parent.equals((SRBFile) directories.get(j))) {
                            depths[i] = depths[j] + 1;
                            break;
                        }
                    }
        ...
        public void setSelectedItem(Object selectedDirectory) {
            this.selectedDirectory = (SRBFile) selectedDirectory;
    ...
    public class FilterComboBoxRenderer extends DefaultListCellRenderer {
        public Component getListCellRendererComponent(JList list, Object value,
            ...
            if (value != null && value instanceof SRBFileFilter) {
                setText(((SRBFileFilter) value).getDescription());
            }
    ...
    protected class FilterComboBoxModel extends AbstractListModel implements
        ...
        protected SRBFileFilter[] filters;
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (prop == SRBFileChooser.CHOOSABLE_FILE_FILTER_CHANGED_PROPERTY) {
                filters = (SRBFileFilter[]) e.getNewValue();
                fireContentsChanged(this, -1, -1);
            } else if (prop == SRBFileChooser.FILE_FILTER_CHANGED_PROPERTY) {
                fireContentsChanged(this, -1, -1);
            }
        }
        ...
        public void setSelectedItem(Object filter) {
            if (filter != null) {
                getFileChooser().setFileFilter((SRBFileFilter) filter);
                setFileName(null);
                fireContentsChanged(this, -1, -1);
            }
        }
        ...
        public Object getSelectedItem() {
            ...
            // NOTE: we shouldnt' have to do this, since SRBFileChooser adds
            // the filter to the choosable filters list when the filter
            // is set. Lets be paranoid just in case someone overrides
            // setFileFilter in SRBFileChooser.
            SRBFileFilter currentFilter = getFileChooser().getFileFilter();
            boolean found = false;
    ...
    protected class DirectoryComboBoxAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            SRBFile f = (SRBFile) directoryComboBox.getSelectedItem();
