 ...
 * opaque and unless you subclass paint you should not change this. See <a
 * href="http://java.sun.com/docs/books/tutorial/uiswing/components/tree.html">How
 * to Use Trees</a> in <em>The Java Tutorial</em> for examples of customizing
 * node display using this class.
 * <p>
 * 
...
public class SRBTreeCellRenderer extends JLabel implements TreeCellRenderer {
    ...
    /**
     * Returns a new instance of SRBTreeCellRenderer. Alignment is set to
     ...
     * has the effect of letting the font of the JTree show through. On the
     * other hand, if <code>font</code> is non-null, and not a
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value,
            ...
            boolean hasFocus) {
        String stringValue = convertValueToText(value, sel, expanded,
                leaf, row, hasFocus);
     ...
     */
    private String convertValueToText(Object value, boolean selected, boolean expanded, boolean leaf, int row, boolean hasFocus) {
        if (value != null) {
            String aValue  = null;
