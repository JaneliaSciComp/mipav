...
public class CustomUIBuilder {
    ...
    public static final UIParams PARAM_SAVE_VOI_INTENSITIES = new UIParams("Save intensities in VOI to...", "SaveVOIIntensities", UIParams.INVALID_MNEMONIC, null, "save");
