...
/**
 * This is a control to run a script on an active image or an image file. It calls the script parser on the image after
 * setting up appropriate variables in the parser.
 *
...
public class ViewControlsScript {
    ...
    /**
     * Converts a non-active script into an active on the fly and returns the modified active script string.
     *
