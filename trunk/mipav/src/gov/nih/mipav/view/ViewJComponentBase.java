...
public abstract class ViewJComponentBase extends JComponent {
    ...
    /** DOCUMENT ME! */
    protected boolean[] axisFlip = new boolean[3]; // axis flip represents the ACTUAL axis, regardless of how its
                                                   // ordered
    ...
    public ViewJComponentBase(int[] extents, int orientation) {
        ...
        } else if (orientation == SAGITTAL) { // orientation == ZY
    ...
    /**
     * Creates a new ViewJComponentBase object.
     *
     * @param  extents         width and height of component
     * @param  orientation     NA, XY, XZ, or ZY
     * @param  hasOrientation  true if image known to be in axial orientation and is displayed in ViewJFrameTriImage
     * @param  orient          a 3 integer array giving the orientation of each axis
     */
    public ViewJComponentBase(int[] extents, int orientation, boolean hasOrientation, int[] orient) {
        img = null;
