...
import gov.nih.mipav.view.WildMagic.LibGraphics.Rendering.WireframeState;
 ...
 */
public class JPanelGeodesic_WM extends JPanelRendererBase {
     ...
     */
    public JPanelGeodesic_WM(VolumeViewer parent) {
        super(parent);
        init();
