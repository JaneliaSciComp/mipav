...
/**
 */
public class JDialogStereoControls extends JDialogBase implements ChangeListener {
     ...
     */
    public JDialogStereoControls(Frame theParentFrame, VolumeViewer kParent, float initVal) {
