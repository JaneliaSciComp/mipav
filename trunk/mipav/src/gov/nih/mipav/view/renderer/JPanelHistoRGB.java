 ...
 * This control panel manipulate the Histogram RGB LUT table for the color images.
 * @version    1.0
...
public class JPanelHistoRGB
     ...
     */
    public JPanelHistoRGB( ModelImage _imageA, ModelImage _imageB,
     ...
     */
    public JPanelHistoRGB( ViewJComponentRegistration _regComponent,
    ...
    private void buildMenu() {/*
         ...
         menuBar.add(
         menuObj.makeMenu( "File", 'F',
         new JComponent[] {
         menuObj.buildMenuItem( "Open LUT", "OpenLUT",
         KeyStroke.getKeyStroke( 'O', Event.CTRL_MASK, false ), "open.gif" ),
         menuObj.buildMenuItem( "Save LUT", "SaveLUT", KeyStroke.getKeyStroke( 'S', Event.CTRL_MASK, false ),
         "save.gif" ),
         menuObj.buildMenuItem( "Open Transfer Functions", "OpenFuncts", null, "open.gif" ),
         menuObj.buildMenuItem( "Save Transfer Functions", "SaveFuncts", null, "save.gif" ),
         separator,
         menuObj.buildMenuItem( "Close LUT", "CloseLUT", KeyStroke.getKeyStroke( 'X', Event.CTRL_MASK, false ),
         null ) } ) );
         menuBar.add(
         menuObj.makeMenu( "Utilities", 'U',
         new JComponent[] {
