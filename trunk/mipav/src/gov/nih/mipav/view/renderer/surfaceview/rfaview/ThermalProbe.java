 ...
 * <p>Description: Thermal probe has its own geometry and type of burning.  This class
 *    builds the geometry shape of the thermal probe.  </p>
 @author Ruida Cheng
 */
public class ThermalProbe {
  ...
  protected PickCanvas pickCanvas;
    ...
    /**
     * Initialize the therml probe's geometry shapes and indictor probe's
     * geometry shapes.
     */
    protected void init() {
