...
/**
 * This is an abstract class. This class defines the basic functionality of the
 * renders, such as the LUT and bounding box and image rotation, etc. It was
 * extended by the surface render, surface plotter and the volume render.
 *
 * @version 0.1 Oct 1, 1998
 * @author Matthew J. McAuliffe, Ph.D.
 */
public abstract class RenderViewBase extends VolumeCanvas3D implements ViewImageUpdateInterface, ActionListener,
        MouseBehaviorCallback, ChangeListener {
    ...
    /**
     * The BranchGroup to which the standard behaviors are attached, zoom and
     * rotate.
     */
    protected BranchGroup objBehaviorBG;

    /**
     * A TransformGroup object to which all the scene objects are attached,
     * including 3D images, surface, behavior, and lights.
     */
    protected TransformGroup sceneRootTG;

    /**
     * Triplanar view branch group, which hold the three plane view and the
     * slice box frame view.
     */
    protected BranchGroup triPlanarViewBG;

    /**
     * The SimpleUniverse object which is the parent of everything else in the
     * scene.
     */
    protected SimpleUniverse universe;

    /**
     * The Canvas3D object on which the surfaces are drawn and where the picking
     * happens.
     */
     ...
     * root has a single child, a TransformGroup, that manages all of the actual
     * scene objects.
     */
    ...
    /**
     * A BoundingSphere that contains the entire scene. This bound is used for
     * all scheduling, including lighting and mouse behaviors.
     */
   ...
   /** Image volume size and x, y, z extents. */
     ...
     *            The current image A.
     * @param _imageB
     *            The current image B, or <code>null</code> if there isn't
     *            one.
     * @param _config
     *            The graphics config to use when rendering
     */
     ...
     *
     * @param xBox
     *            X dimension of box frame.
     * @param yBox
     *            Y dimension of box frame.
     * @param zBox
     *            Z dimension of box frame.
     */
    protected void createBoxFrame(float xBox, float yBox, float zBox) {
        ...
        /*
         * Check added for when creatBoxFrame is called more than once (when the
         * Render Target Image size changes). sceneRootTG should only be added
         * if it is not already in the scene graph.
         */
    ...
    /**
     * Accessor for the transform group of the scene, which is the parent of
    ...
    /**
     * Accessor for the branch group of this 3D object, the parent of the
     * transform group.
     *
     ...
     *
     * @return A private object extension specific to the class that extends
     *         this one.
     */
    ...
    public boolean writeImage() {
        ...
        try {
            ...
            extents[1] = yDim;
            extents[2] = 1;
            captureImage = new ModelImage(ModelStorageBase.ARGB, extents, "Screen capture", ViewUserInterface
                    .getReference());
    ...
    /**
     * Called when the camera button is clicked. This method brings up the
     ...
     *
     * @param value
     *            amount [0,100] that is the percentage of Image A to be
     *            displayed and (1-percentage) of Image B to be displayed
     */
     ...
     * Also, the rotation is based on the 3D object's location.
     */
    public class Matrix {
        ...
        /**
         * Rotate along the y axis with given sin, cos value of the rotation
         * angle.
         *
         * @param sin
         *            float
        ...
        /**
         * Rotate along the z axis with given sin, cos value of the rotation
         * angle.
         *
         * @param sin
         *            float
         ...
         *
         * @param point
         *            Vector3f rotation axis
         * @param axis
         *            Vector3f rotation reference point
         * @param angle
         *            in degree.
         */
     ...
     */
    public final static Vector3f[] getNormals() {
        return akNormal;
    }
