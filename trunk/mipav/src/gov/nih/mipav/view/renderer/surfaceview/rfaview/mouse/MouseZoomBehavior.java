...
/*
 ...
 The old if statement says if the mouse is dragged and the middle button
 and not the right button is pressed.
 The new if statement says if the mouse is dragged and the middle button
 and the right button are both pressed.

 Added condition for the mouse pressed

 Added the ability to zoom based on user rotations and positions
