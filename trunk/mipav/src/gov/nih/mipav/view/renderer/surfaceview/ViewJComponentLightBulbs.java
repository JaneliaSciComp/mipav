...
/**
 *  Holds parent BranchGroup and an array of 8 spheres that
 *  represent the lights on the surface.
 */
public class ViewJComponentLightBulbs {
     ...
     * @return int Index of the corresponding light object in the array,
     * or -1 if picked shape does not correspond to any light object.
     */
    ...
    public void setLightAttributes( int index, GeneralLight kLight ) {
        ...
        setLightColor(index,
                      kLight.isEnabled() ? kLight.getIntensifiedColor() : s_kBlack);
    }
