 ...
 * @version  1.0
 */
public class JPanelVolOpacityRGBWM extends JPanelVolOpacityBaseWM {
     ...
     */
    public JPanelVolOpacityRGBWM(JavaApplication3DWM theParentFrame, ModelImage _imageA, ModelImage _imageB) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals("Linear")) {
            ViewJComponentVolOpacityBaseWM selectedComponent = getSelectedComponent();
    ...
    private void buildPanelA() {
        ...
        componentOpacityA = new ViewJComponentVolOpacityRGBWM(this, histogramARed, imageA);
    ...
    private void buildPanelB() {
        ...
        // Make a display version of the histogram
        componentOpacityB = new ViewJComponentVolOpacityRGBWM(this, histogramBRed, imageB);
    ...
    private void buildPanelGM_A() {
        ...
        // Make a display version of the histogram
        componentOpacityGM_A = new ViewJComponentVolOpacityRGBWM(this, histogramGM_ARed, gradMagRescale_A);
    ...
    private void buildPanelGM_B() {
        ...
        // Make a display version of the histogram
        componentOpacityGM_B = new ViewJComponentVolOpacityRGBWM(this, histogramGM_BRed, gradMagRescale_B);
