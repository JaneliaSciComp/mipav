 ...
 *     The basic functionalities include auto and manual snapshot 3D images, and
 *     create a film clip from the captuered 3D images.
 *		@version    0.1 May, 2003
 *		@author     Matthew J. McAuliffe, Ph.D.
 *      @author     Ruida Cheng
 */
public class JPanelCamera extends JPanelRendererBase
    ...
    public void actionPerformed( ActionEvent event ) {
        ...
        if ( command.equals( "Start" ) ) {
            ...
            parentScene.resetImage();
        } else if ( command.equals( "Stop" ) ) {} else if ( command.equals( "Close" ) ) {
            if ( parentScene != null ) {
    ...
    class StandardMouse extends Thread {
        ...
        public synchronized void run() {
            while ( pressed ) {
                ...
                if ( source == leftUpButtonEmpty || source == leftDownButtonEmpty || source == middleRightButtonEmpty
                        || source == middleLeftButtonEmpty ) {
                    return;
