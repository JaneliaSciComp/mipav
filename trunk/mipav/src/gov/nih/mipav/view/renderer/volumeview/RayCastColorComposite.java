...
/**
 * Ray traced rendering of the volume using composition of colors
 * and alpha values at each voxel.
 */

public class RayCastColorComposite
    extends RayCastColor
{
    /** Allocate arrays to store interpolated RGBA values along the
     * ray in order from front-to-back.
     */
