 ...
 */
public class JPanelVolOpacityWM extends JPanelVolOpacityBaseWM {
     ...
     */
    public JPanelVolOpacityWM(JavaApplication3DWM theParentFrame, ModelImage _imgA, ModelImage _imgB) {
    ...
    private void buildPanelA() {
        ...
        componentOpacityA = new ViewJComponentVolOpacityWM(this, histogramA, imageA);
    ...
    private void buildPanelB() {
        ...
        // Make a display version of the histogram
        componentOpacityB = new ViewJComponentVolOpacityWM(this, histogramB, imageB);
    ...
    private void buildPanelGM_A() {
        ...
        // Make a display version of the histogram
        componentOpacityGM_A = new ViewJComponentVolOpacityWM(this, histogramGM_A, gradMagRescale_A);
    ...
    private void buildPanelGM_B() {
        ...
        // Make a display version of the histogram
        componentOpacityGM_B = new ViewJComponentVolOpacityWM(this, histogramGM_B, gradMagRescale_B);
