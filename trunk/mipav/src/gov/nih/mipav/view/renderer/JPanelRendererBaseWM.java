 ...
 * @author   Ruida Cheng
 */
public abstract class JPanelRendererBaseWM extends JPanel
    ...
    /** Raycast based renderer reference, raycast renderer or shear warp renderer. */
    protected GPUVolumeRenderWM rayBasedRenderWM;

    /** Render base. */
    protected JavaApplication3DWM renderBase;
     ...
     */
    public JPanelRendererBaseWM(JavaApplication3DWM parent) {
        renderBase = parent;
     ...
     * @param  _rayBasedRender  VolumeRenderer reference
     */
    public void setRayBasedRender(GPUVolumeRenderWM _rayBasedRender) {
     ...
     */
    public void setSurfaceRender(JavaApplication3DWM _renderBase) {
