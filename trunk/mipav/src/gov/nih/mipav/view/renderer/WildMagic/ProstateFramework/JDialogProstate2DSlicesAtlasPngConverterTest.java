 ...
 * Extract the test case png files from 3D prostate image.  
 * The trained png slices is composed from a group of slices in the other fold. 
 * For the test case, each test case has its own directory to run against HED deep learning model. 
 * 
 * @author Ruida Cheng
 * 
 */
public class JDialogProstate2DSlicesAtlasPngConverterTest extends JDialogBase
	 ...
	 */
	public JDialogProstate2DSlicesAtlasPngConverterTest(Frame theParentFrame) {
