...
implements GLEventListener, KeyListener, MouseMotionListener,  MouseListener, NavigationBehavior.Callback
{
	...
	private int annotatePtsCounter = 0;
	private Vector<Vector3f> annotatePtsList = new Vector<Vector3f>();
	/** Color for the parts of the path that have not yet been visited (Dark Green) */
    private ColorRGB m_kNormalColorPathUnvisited = new ColorRGB(1.0f, 0.0f, 0.0f);
    /** Fly path curve. */
    private FlyPathGraphCurve m_kFlyPathGraphCurve = null; 

    private boolean isPathPlanningEnabled = false;
    private boolean isMouseControlEnabled = true;
    private boolean isAnnotateEnabled = false;
    private Node kPolyNode;
	private Polyline kPoly;
    private Polyline kGeometryBranchPath;
