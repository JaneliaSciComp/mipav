...
/**
 * ImageInstanceBrainSubcorticalDir is the class that hold a single brain subcortical image instance. 
 ...
 *
 */
public class ImageInstanceBrainSubcorticalDir {
   ...
   public JDialogBrainSubcorticalDir parentDialog;
   
   /** 2nd dataset instance */ 
   public ImageInstanceBrainSubcorticalDir instanceB;
    ...
    */  
	 public ImageInstanceBrainSubcorticalDir(int _caseNumber, String _fileName, String _directory, Vector _regSection, JDialogBrainSubcorticalDir parent) {
	 ...
	 */
	  ...
	  */
	public void registration(ImageInstanceBrainSubcorticalDir _instanceB) {
		int cost = 1;
		int DOF = 6;
		int interp = 0;
