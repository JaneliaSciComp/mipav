 ...
 * @author  Ruida Cheng
 */
public class JPanelClipWM extends JPanelRendererBaseWM
     ...
     */
    public JPanelClipWM(GPUVolumeRenderWM parent, float xBox, float yBox, float zBox) {
        super(parent);
        rayBasedRenderWM = parent;
        xDim = ((GPUVolumeRenderWM)renderBase).getImage().getExtents()[0];
        yDim = ((GPUVolumeRenderWM)renderBase).getImage().getExtents()[1];
        zDim = ((GPUVolumeRenderWM)renderBase).getImage().getExtents()[2];
        xSlice = (xDim - 1) / 2;
        ySlice = (yDim - 1) / 2;
        zSlice = (zDim - 1) / 2;
        this.xBox = xBox;
        ...
        initSphereBranch();
        backupImage(((GPUVolumeRenderWM)renderBase).getImage(), ((GPUVolumeRenderWM)renderBase).getImageB());
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if ((source == extractButtonA) || (source == extractButtonS)) {
            ...
            ModelImage img = ((GPUVolumeRenderWM)renderBase).getImage();
            ...
            ModelImage resultImage = new ModelImage(((GPUVolumeRenderWM)renderBase).getImage().getType(), ext, "Image plane");
    ...
    public void cropVolume() {
        ...
        ModelImage imgA = ((GPUVolumeRenderWM) renderBase).getImage();
        double minA = imgA.getMin();
        ModelImage imgB = ((GPUVolumeRenderWM) renderBase).getImageB();
        ...
        // ((GPUVolumeRenderWM) renderBase).updateData();
        ((GPUVolumeRenderWM) renderBase).getParentFrame().updateImages();
    }
    ...
    public void saveCropImage() {
        ...
        ModelImage kImageA = ((GPUVolumeRenderWM) renderBase).getImage();
        ModelImage kImageB = ((GPUVolumeRenderWM) renderBase).getImageB();
