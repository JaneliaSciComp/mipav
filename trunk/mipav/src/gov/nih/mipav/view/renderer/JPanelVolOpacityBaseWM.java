 ...
 */
public class JPanelVolOpacityBaseWM extends JPanelRendererBaseWM implements ChangeListener, MouseListener {
    ...
    protected ViewJComponentVolOpacityBaseWM componentOpacityA;

    /** Reference to compoment opacity control B. */
    protected ViewJComponentVolOpacityBaseWM componentOpacityB;

    /** Reference to compoment opacity control A GM Rescale. */
    protected ViewJComponentVolOpacityBaseWM componentOpacityGM_A;

    /** Reference to compoment opacity control B GM Rescale. */
    protected ViewJComponentVolOpacityBaseWM componentOpacityGM_B;
     ...
     */
    public JPanelVolOpacityBaseWM(JavaApplication3DWM theParentFrame) {
     ...
     */
    public ViewJComponentVolOpacityBaseWM getCompA() {
     ...
     */
    public ViewJComponentVolOpacityBaseWM getCompA_GM() {
     ...
     */
    public ViewJComponentVolOpacityBaseWM getCompB() {
     ...
     */
    public ViewJComponentVolOpacityBaseWM getCompB_GM() {
     ...
     */
    public JavaApplication3DWM getParentFrame() {
     ...
     */
    public ViewJComponentVolOpacityBaseWM getSelectedComponent() {
     ...
     */
    public ViewJComponentVolOpacityBaseWM getSelectedComponent(int _whichComp) {
     ...
     */
    public void updateSlider(ViewJComponentVolOpacityBaseWM childComponent) {
    ...
    public void update()
    {
        if ( renderBase instanceof JavaApplication3DWM )
        {
            ((JavaApplication3DWM)renderBase).updateParent();
        }
    }
}
