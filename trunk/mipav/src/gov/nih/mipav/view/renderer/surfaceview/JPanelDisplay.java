...
/**
 *   The display panel control the red bounding box frame ( on/off ),
 *   texture aligned rendering mode, cubic controk, perspective and parrallel viewing mode,
 *   and back ground color.
 */
public class JPanelDisplay extends JPanelRendererBase
    ...
    /**
     * When the user enter the coarse and fine value, invoke this event
     * to update fine or coarse sampling.
     * @param evt  key event
     */
    ...
    /**
     * Enable the the fine or coarse labels and text fields with
     * given flag value.
