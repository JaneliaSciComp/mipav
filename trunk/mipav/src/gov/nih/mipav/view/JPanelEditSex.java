...
public class JPanelEditSex extends JPanelEdit {
    ...
    /**
    *   allows the user to select a DICOM allowable sex: Male, Female, Other;
    *   also allows "no value" and will return "" when asked about that value.
    *
    *   @param initialText
    */
    ...
    /**
    *   returns an empty String when the panel has been set to "No Value"
