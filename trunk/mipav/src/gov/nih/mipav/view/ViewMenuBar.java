...
public class ViewMenuBar {
    ...
    protected JMenu makeFileMenu() {
        return menuBuilder.makeMenu("File", 'F', false, new JComponent[] {
                                    menuBuilder.makeMenu("Open", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("Image(A)", "OpenNewImage", 0, "open.gif", true),
            // menuBuilder.buildMenuItem("Multi-file(A)", "OpenImageStack", null, "open.gif"),
            menuBuilder.buildMenuItem("Leica series(A)", "loadLeica", 0, "open.gif", true),
            menuBuilder.buildMenuItem("Open image sequence", "openImgSeq", 0, "open.gif", true),
            menuBuilder.buildMenuItem("Create blank image(A)", "CreateBlankImage", 0, "open.gif", true)}),
                                    separator,
                                    menuBuilder.makeMenu("Load", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("Image(B) from frame", "ComponentLoadB", 0, "frame.gif", true),
            menuBuilder.buildMenuItem("Image(B) from file", "LoadB", 0, "open.gif", true),
            menuBuilder.buildMenuItem("Blank image(B)", "LoadBlankB", 0, "open.gif", true), }),
                                    separator,
            ...
            Preferences.is(Preferences.PREF_AUTOSTART_DICOM_RECEIVER)),
                                    separator,
                                    menuBuilder.makeMenu("Scripts", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("Record script", "RecordScript", 0, null, false),
            menuBuilder.buildMenuItem("Run script", "RunScript", 0, null, false)}), separator,
                                    menuBuilder.buildMenuItem("Open graph", "OpenNewGraph", 0, "open.gif", true),

                                    separator, menuBuilder.buildMenuItem("Close image(B)", "CloseImageB", 0, null, true),
                                    separator,
                                    menuBuilder.buildQuickList(), separator,
                                    menuBuilder.buildMenuItem("DCCIE image conversion", "dccieconvert", 0, null, true),
                                    menuBuilder.buildMenuItem("Convert old XML", "convertXML", 0, null, true), separator,
                                    menuBuilder.buildMenuItem("Exit - MIPAV", "Exit", 'x', null, true)});
    }
    ...
    protected JMenu makeEditMenu() {
        return menuBuilder.makeMenu("Edit", 'E', false, new JComponent[] {
                                    menuBuilder.buildMenuItem("Undo VOI", "undoVOI", 0, "undopaint.gif", true), separator,
                                    ...
                                    menuBuilder.buildMenuItem("Paste VOI", "pasteVOI", 0, "pastepaint.gif", true), separator,
                                    menuBuilder.buildMenuItem("Select all VOIs", "selectAllVOIs", 0, null, true)
                                    // menuBuilder.buildMenuItem("Delete VOI", "deleteVOI", null, "delete.gif"),
                                    // separator,
    ...
    protected JMenu makeVOIMenu() {
        return menuBuilder.makeMenu("VOI", 'V', false, new JComponent[] {
                                    menuBuilder.makeMenu("New VOI", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("Point", "Point", 0, "pointROI.gif", true),
            menuBuilder.buildMenuItem("Line", "Line", 0, "linear.gif", true),
            menuBuilder.buildMenuItem("Rectangle", "RectVOI", 0, "rect.gif", true),
            menuBuilder.buildMenuItem("Ellipse", "EllipseVOI", 0, "circle.gif", true),
            menuBuilder.buildMenuItem("Polygon", "PolygonVOI", 0, "polygon.gif", true),
            menuBuilder.buildMenuItem("Level set", "LevelSetVOI", 0, "contour.gif", true),
            menuBuilder.buildMenuItem("3D rectangle", "Rect3DVOI", 0, "cube.gif", true)}),
                                    separator,
                                    menuBuilder.makeMenu("Open VOI", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("Open VOI", "Open VOI", 0, "open.gif", true),
            menuBuilder.buildMenuItem("Open all VOIs", "Open all VOIs", 0, "open.gif", true),
            menuBuilder.buildMenuItem("Open all VOIs from...", "Open all VOIs from...", 0, "open.gif", true)}),
                                    separator,
                                    menuBuilder.makeMenu("Save VOI", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("Save selected contours", "SaveSelectedContours", 0, "save.gif", true),
            menuBuilder.buildMenuItem("Save selected contours as", "SaveSelectedContoursAs", 0,
                                      "save.gif", true),
            ...
            menuBuilder.buildMenuItem("Save all VOIs to...", "Save all VOIs to...", 0, "save.gif", true)}),
                                    separator,
                                    menuBuilder.buildMenuItem("Group VOIs", "GroupVOIs", 0, null, true),
                                    menuBuilder.makeMenu("VOI order", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("Bring VOI to front", "BringToFront", 0, "front.gif", true),
            menuBuilder.buildMenuItem("Send VOI to back", "SendToBack", 0, "back.gif", true),
            menuBuilder.buildMenuItem("Bring VOI forward", "BringForward", 0, "forward.gif", true),
            menuBuilder.buildMenuItem("Send VOI backward", "SendBackward", 0, "backward.gif", true)}),
                                    menuBuilder.makeMenu("Contour order", true,
            new JMenuItem[] {
            menuBuilder.buildMenuItem("Bring contour to front", "BringContourToFront", 0,
                                      "front.gif", true),
            menuBuilder
            .buildMenuItem("Send contour to back", "SendContourToBack", 0, "back.gif", true),
            ...
            menuBuilder.buildMenuItem("To next slice", "PropVOIUp", 0, "voipropu.gif", true),
            menuBuilder.buildMenuItem("To previous slice", "PropVOIDown", 0, "voipropd.gif", true),
            menuBuilder.buildMenuItem("To all slices", "PropVOIAll", 0, "voipropall.gif", true)}),
                                    menuBuilder.buildMenuItem("Ungroup VOIs", "UngroupVOIs", 0, null, true),
                                    separator,
                                    menuBuilder.makeMenu("VOI -> Mask", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("VOI(s) to binary mask", "BinaryMask", 0, null, false),
            ...
            menuBuilder.buildMenuItem("VOI(s) to ubyte mask", "UnsignedByteMask", 0, null, false)}),
                                    // separator,
                                    ...
                                    menuBuilder.buildMenuItem("Paint -> Short mask", "PaintToShortMask", 0, null, true),
                                    menuBuilder.buildCheckBoxMenuItem("Allow VOI holes (XOR)", "XOR", Preferences.is(Preferences.PREF_USE_VOI_XOR)),
                                    separator,
            ...
            menuBuilder.buildMenuItem("Active contour", "Snake", 0, null, true),
            menuBuilder.buildMenuItem("Active GVF", "AGVF", 0, null, true),
            menuBuilder.buildMenuItem("Spline active contour", "BSnake", 0, null, true),
            menuBuilder.buildMenuItem("Spline GVF", "GVF", 0, null, true)}),
                                    separator,
                                    menuBuilder.buildMenuItem("Cardiology VOI", "Cardio", 0, null, true),
                                    separator,
                                    menuBuilder.makeMenu("Graph", true, new JMenuItem[] {
            menuBuilder.buildMenuItem("Boundary intensity", "boundaryIntensity", 0, null, true),
            menuBuilder.buildMenuItem("2.5D total intensity", "totalIntensity", 0, null, true),
            menuBuilder.buildMenuItem("2.5D average intensity", "avgIntensity", 0, null, true)}),
    ...
    protected JMenu makeAlgorithmsMenu() {
        return menuBuilder.makeMenu("Algorithms", 'A', false, new JComponent[] {
            ...
            menuBuilder.buildMenuItem("Anonymize face", "Anonymize face (BET)", 0, null, false),
            menuBuilder.buildMenuItem("Extract brain surface (BET)", "extractBrainSurfaceBET", 0, null, false),
            menuBuilder.buildMenuItem("Extract brain surface (BSE)", "extractBrainSurfaceBSE", 0, null, false),
            ...
            // menuBuilder.buildMenuItem("Adaptive smooth", "adaptiveSmooth", 0, null, false),
            ...
            menuBuilder.buildMenuItem("Unsharp mask", null, 0, null, false), }),
                                    menuBuilder.makeMenu("Filters (wavelet)", false, new JMenuItem[] { // menuBuilder.buildMenuItem("Maxima", null,
            // null, null),
            ...
            new JMenuItem[] {menuBuilder.buildMenuItem(
                "Gaussian blur", "GaussianBlurITK", 0, null, false)}),
            ...
            menuBuilder.makeMenu("Colocalization", false, new JMenuItem[] {
                                 ...
                                 menuBuilder.buildMenuItem("Orthogonal regression", "colocRegression", 0, null, false)}),
            ...
            menuBuilder.makeMenu("Restoration", false, new JMenuItem[] {
                                 ...
                                 menuBuilder.buildMenuItem("Iterative blind deconvolution", null, 0, null, false)}), }),
            ...
            menuBuilder.buildMenuItem("Skeletonize3D Voronoi", "SkelGeom3D", 0, null, false),
            menuBuilder.buildMenuItem("Ultimate erode", null, 0, null, false), }),
                                    // menuBuilder.buildMenuItem("Plot surface", null, 0, null, false),
                                    // menuBuilder.buildMenuItem("Point area average intensities", "Point area", 0, null, false),
            ...
            // menuBuilder.buildMenuItem("AFNI - Shear", "MRIShear", 0, null, false),
            // menuBuilder.buildMenuItem("AIR linear", null, 0, null, false),
            // menuBuilder.buildMenuItem("Chamfer", null, 0, null, false),
            // menuBuilder.buildMenuItem("AIR nonlinear", null, 0, null, false),
            menuBuilder.buildMenuItem("Align patient position", "Patient Position", 0, null, false),
            menuBuilder.buildMenuItem("B-Spline automatic registration 2D/3D", "BSplineReg", 0, null, false),
            menuBuilder.buildMenuItem("B-Spline automatic registration 2.5D", "BSplineReg25D", 0, null, false),
            ...
            menuBuilder.buildMenuItem("Time series optimized automatic registration", "TSOAR", 0, null, false),
            // menuBuilder.buildMenuItem("Turbo", "Turbo", 0, null, false),
            ...
            // menuBuilder.buildMenuItem("Extract object surface", "extractObjectSurface", 0, null, false),
            ...
            menuBuilder.buildMenuItem("Threshold", null, 0, null, false),
            menuBuilder.buildMenuItem("Watershed", null, 0, null, false), }),
                                    // menuBuilder.buildMenuItem("Non-parametric", "nonparametric", 0, null, false)}),
    ...
    protected JMenu makeUtilitiesMenu() {
        return menuBuilder.makeMenu("Utilities", 'U', false, new JMenuItem[] {
            ...
            menuBuilder.buildMenuItem("Using VOI", "Crop", 0, null, false)}),
                                    ...
                                    menuBuilder.makeMenu("Flip", false, new JMenuItem[] {
            menuBuilder.buildMenuItem("Horizontal", "FlipY", 0, "fliphoriz.gif", true),
            menuBuilder.buildMenuItem("Vertical", "FlipX", 0, "flipvert.gif", true)}),
            ...
            menuBuilder.buildMenuItem("Inverse slice order", "InverseOrder", 0, null, false),
            menuBuilder.buildMenuItem("Pad with slices", "padding", 0, null, false),
    ...
    protected JMenu makeImageMenu() {
        ...
        return menuBuilder.makeMenu("Image", 'I', false, new JComponent[] {
            ...
            menuBuilder.buildMenuItem("View header", "AboutImage", 0, null, false),
            menuBuilder.buildMenuItem("Edit attributes", "EditImageInfo", 0, null, false)}),
    ...
    protected JMenu makeHelpMenu() {
        return menuBuilder.makeMenu("Help", 'H', false, new JComponent[] {
                                    ...
                                    menuBuilder.buildMenuItem("Help topics", "Help", 0, null, true),
                                    separator,
