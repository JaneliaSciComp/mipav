...
public class ViewMenuBar {
	 ...
	 * 
	 * @param listener
	 *            The class that wants to listen to plugin menu actions.
	 * @param numberOfDimensions
	 *            Dimensionality of image (2D, 3D, 4D...)
	 * @param type
	 *            Data type from <code>ModelStorageBase</code>, byte, short,
	 *            argb, etc.
	 * @param isDicomImage
	 *            Whether the image this menu bar is for is a dicom image.
	 * 
	...
	public JMenu makeAlgorithmsMenu() {
		return menuBuilder.makeMenu("Algorithms", 'A', false,
				new JComponent[] { menuBuilder.buildMenuItem("Autocorrelation coefficients", "ACC", 0, null, false),
						menuBuilder.buildMenuItem("Autocovariance coefficients", "ACCOV", 0, null, false),
						menuBuilder.makeMenu("Brain tools", false, new JMenuItem[] { menuBuilder
								.buildMenuItem("Anonymize (beta)", "Anonymize face", 0, null, false),
				...
				menuBuilder.makeMenu("Filters (spatial)", false,
						new JMenuItem[] { menuBuilder.buildMenuItem("Anisotropic diffusion", null, 0, null, false),
								...
								menuBuilder.makeMenu("Curvature", false,
								...
								menuBuilder.buildMenuItem("Regularized isotropic diffusion", "RegIsoDiff", 0, null,
										false),
				...
				menuBuilder.makeMenu("Fuzzy", false,
						new JMenuItem[] {
								menuBuilder.buildMenuItem("Edge extraction by FIRE operators", "fireEdgeExtraction", 0,
										null, false),
						menuBuilder.buildMenuItem("Fuzzy minimization", "fuzzyMin", 0, null, false),
						menuBuilder.buildMenuItem("Fuzzy minimization De and Chatterji", "FuzzMinDeAndChatterji", 0,
								null, false),
				...
				menuBuilder.makeMenu("Histogram tools", false,
						...
						menuBuilder.makeMenu("Histogram equalization", false,
								new JMenuItem[] { menuBuilder.buildMenuItem("Neighborhood adaptive", "performNAHE", 0,
										null, false),
				...
				menuBuilder
						.makeMenu("Hough transform", false,
								new JMenuItem[] {
										menuBuilder
												.buildMenuItem("Cardioid detection", "HoughCardioid", 0, null, false),
										...
										menuBuilder.buildMenuItem("Hyperbola detection", "HoughHyperbola", 0, null,
												false),
				...
				// menuBuilder.makeMenu("Insight toolkit (auto ITK)", false, new
				// JMenuItem[] {}),
				menuBuilder.makeMenu("Microscopy", false, new JMenuItem[] {
						menuBuilder.makeMenu("Colocalization", false, new JMenuItem[] {
								menuBuilder.buildMenuItem("Expectation maximization", "colocEM", 0, null, false),
				...
				menuBuilder.makeMenu("Morphological", false,
						new JMenuItem[] {
								...
								menuBuilder
										.makeMenu("Distance Maps", false,
												new JMenuItem[] {
														menuBuilder.buildMenuItem("BG distance map", null, 0, null,
																false),
												menuBuilder.buildMenuItem("FG distance map", null, 0, null, false),
												menuBuilder.buildMenuItem("BG + FG distance map", null, 0, null,
														false) }),
				...
				// menuBuilder.buildMenuItem("Plot surface", null, 0, null,
				// false),
				...
				// null, false),
						...
						// null, false),
								...
								menuBuilder.buildMenuItem("B-Spline automatic registration 2D/3D", "BSplineReg", 0,
										null, false),
								menuBuilder.buildMenuItem("B-Spline automatic registration 2.5D", "BSplineReg25D", 0,
										null, false),
								menuBuilder.buildMenuItem("Constrained optimized automatic registration", "COAR", 0,
										null, false),
								menuBuilder.buildMenuItem("Diffeomorphic demons", "diffDemons", 0, null, false),
								menuBuilder.buildMenuItem("Display pixel similarity cost functions", "COSTS", 0, null,
										false),
								menuBuilder.makeMenu("Landmark", false,
										new JMenuItem[] {
												menuBuilder.buildMenuItem("Least squares", "LeastSquares", 0,
														"reglsq.gif", false),
										menuBuilder.buildMenuItem("Thin plate spline", "TPSpline", 0, "regtsp.gif",
												false), }),
								...
								menuBuilder.buildMenuItem("Optimized automatic registration 2.5D", "OAR25D", 0, null,
										false),
						...
						// "extractObjectSurface", 0, null, false),
								menuBuilder
										.makeMenu("Fuzzy C-means", false,
												new JMenuItem[] {
														menuBuilder.buildMenuItem("Multispectral", null, 0, null,
																false),
						...
						menuBuilder.makeMenu("Threshold", false, new JMenuItem[] {
								...
								menuBuilder.buildMenuItem("Theshold using standard deviation", "threshStdDev", 0, null,
						                ...
						                menuBuilder.makeMenu("Watershed", false, new JMenuItem[] {
												...
												menuBuilder.buildMenuItem("Shortest Path Watershed", "ShortestPathWatershed", 0, null, false),
										...
										menuBuilder.makeMenu("ITK", false,
												new JMenuItem[] {
														menuBuilder.buildMenuItem("Levelset Diffusion",
																"DiffusionLevelsetITK", 0, null, false),
														menuBuilder.buildMenuItem("Levelset Geodesic Active Contour",
																"GeodesicActiveContourLevelsetITK", 0, null, false),
														menuBuilder.buildMenuItem("Levelset Threshold",
																"ThresholdLevelsetITK", 0, null, false), }),
										menuBuilder.makeMenu("Studies", false,
												new JMenuItem[] {
														menuBuilder.makeMenu("TBI", false,
																new JMenuItem[] {
																		menuBuilder.buildMenuItem("Convert VOIs",
																				"convertVOI_TBI", 0, null, false),
																menuBuilder.buildMenuItem("Surface Reconstruction",
																		"surfaceReconstructTBI", 0, null, false), }),
												menuBuilder.makeMenu("Prostate VOI", true,
														new JMenuItem[] {
																menuBuilder.buildMenuItem("Merge VOIs",
																		"ProstateMergedVOIs", 0, null, false),
														menuBuilder.buildMenuItem("Surface Reconstruction",
																"ProstateReconstruct", 0, null, false),
														menuBuilder.buildMenuItem("Save Features",
																"ProstateFeaturesSave", 0, null, false),
														menuBuilder.buildMenuItem("Save Test Features",
																"ProstateFeaturesTest", 0, null, false),
														menuBuilder.buildMenuItem("Training", "ProstateFeaturesTrain",
																0, null, false),
														menuBuilder.buildMenuItem("Classification",
																"ProstateFeaturesClassification", 0, null, false),
														menuBuilder.buildMenuItem("Load Mask", "LoadProstateMask", 0,
																null, false),
														menuBuilder.buildMenuItem("Extract Surface", "ProstateExtract",
																0, null, false),
														menuBuilder.buildMenuItem("Open other orientation",
																"NewVOIOtherOrientation", 0, null, false),
														menuBuilder.buildMenuItem("semi-auto B-Spline",
																"SemiAutoBSpline", 0, null, false),
														menuBuilder.buildMenuItem("semi-auto B-Spline & Fuzzy-C",
																"SemiAutoBSplineFuzzyC", 0, null, false) }),
												menuBuilder.makeMenu("Prostate Seg Auto", true,
														new JMenuItem[] {
																menuBuilder.buildMenuItem("Atlas", "generateAtlasImage",
																		0, null, false),
														menuBuilder.buildMenuItem("Extract Features",
																"extractCEFeature", 0, null, false),
														menuBuilder.buildMenuItem("EndSlices", "generateEndingSlices",
																0, null, false),

														menuBuilder.buildMenuItem("Save Features", "ProstateFeaturesSave2D", 0,
																null, false),
														menuBuilder.buildMenuItem("Save Boundary Feature",
																"ProstateBoundaryFeatureSave", 0, null, false),
														menuBuilder.buildMenuItem("Save Test Features",
																"ProstateFeaturesTest2D", 0, null, false),
														menuBuilder.buildMenuItem("Training",
																"ProstateFeaturesTrain", 0, null, false),
														menuBuilder.buildMenuItem("Training Boundary",
																"ProstateBoundaryFeatureTrain", 0, null, false),
														menuBuilder.buildMenuItem("Rename AAM Group Dir",
																"RenameAAMDir", 0, null, false),
														menuBuilder.buildMenuItem("AAM Group training",
																"aamGroups", 0, null, false),
														...
														menuBuilder.buildMenuItem("deepCNNTrain", "deepCNNTrain", 0, null, false),
														menuBuilder.buildMenuItem("deepCNNTest", "deepCNNTest", 0, null, false),
														menuBuilder.buildMenuItem("deepCNNConvert", "deepCNNConvert", 0, null, false),
														menuBuilder.buildMenuItem("deepCNNMap", "deepCNNMap", 0, null, false),
														menuBuilder.buildMenuItem("hedCNNMap",
														                    "hedCNNMap", 0, null, false)
														}),
										menuBuilder.buildMenuItem("Save Features", "ProstateFeaturesSave2D", 0,
												null, false),
																menuBuilder.buildMenuItem("Save Boundary Feature",
									  ...
									  menuBuilder.makeMenu("Knees", true,
		   		                                new JMenuItem[] {
		   		                                		menuBuilder.buildMenuItem("Knees DP Training", "KneesDPTrain", 0,
		   		                                                null, false),
		   		                                		menuBuilder.buildMenuItem("Knees DP Test", "KneesDPTest", 0,
		   		                                                null, false),
		   		                                		menuBuilder.buildMenuItem("Knees Create Map", "KneesDPMap", 0,
		   		                                                null, false),
		   		                                		menuBuilder.buildMenuItem("Knees Atlas", "KneesAtlas", 0,
		   		                                                null, false),
				...
				// menuBuilder.buildMenuItem("Non-parametric", "nonparametric",
				// 0, null,
				// false)}),
				// menuBuilder.buildMenuItem("Stereo depth", "StereoDepth", 0,
				// null, false),
						menuBuilder.makeMenu("Shading correction", false,
								new JMenuItem[] {
										// Of 3 shading correction methods only
										// entropy minimization works on color
										menuBuilder.buildMenuItem("Entropy minimization", "entropyMin", 0, null, false),
										menuBuilder.buildMenuItem("Inhomogeneity N3 correction", "N3Correction", 0,
												null, false),
								menuBuilder.buildMenuItem("Inhomogeneity N4 correction", "N4Correction", 0, null,
										false) }),
						...
						menuBuilder.makeMenu("Spatial statistics", false,
								new JMenuItem[] {
										menuBuilder.buildMenuItem("Circle pattern generation", "CircleGen", 0, null,
												false),
								menuBuilder.buildMenuItem("Sphere pattern generation", "SphereGen", 0, null, false), }),
						menuBuilder
								.makeMenu("Transformation tools", false,
										new JMenuItem[] {
								...
								menuBuilder.buildMenuItem("Nearly circle to circle", "NearlyCircleToCircle", 0, null,
										false),
								menuBuilder.buildMenuItem("Polygon to circle", "PolygonToCircle", 0, null, false),
	 ...
	 * 
	 * @param isAnImageOpen
	 *            Whether MIPAV has an image open (determines whether the menu
	 *            is enabled).
	 * 
	...
	public JMenu makeCaptureMenu(final boolean isAnImageOpen) {
		final JMenu captureMenu = menuBuilder.makeMenu("Capture/print image", true,
				new JComponent[] {
	 ...
	 * @param paramVector
	 *            a vector of UIParams objects (can be lifted from
	 *            CustomUIBuilder
	...
	public JMenu makeDicomMenu() {
		return menuBuilder
				.makeMenu("DICOM", true,
						new JComponent[] { menuBuilder.buildMenuItem("DICOM browser", "BrowseDICOM", 0, null, true),
								...
								menuBuilder.buildMenuItem("Anonymize DICOM directory", "AnonymizeDirectory", 0, null,
										true),
				menuBuilder.buildMenuItem("DICOM database access", "QueryDatabase", 0, "database.gif", true),
				menuBuilder.buildCheckBoxMenuItem("Activate DICOM receiver", "Dicom",
	...
	public JMenu makeDiffusionTensorMenu() {
		return menuBuilder.makeMenu("Diffusion tensor imaging", true,
				new JComponent[] { menuBuilder.buildMenuItem("Create list file", "createListFile", 0, "open.gif", true),
	 ...
	 * 
	 * @param isAnImageOpen
	 *            indicates whether an image has been opened in MIPAV yet (false
	 *            if calling from ViewUserInterface, true otherwise)
	 * 
	...
	public JMenu makeFileMenu(final boolean isAnImageOpen) {
		...
		final JMenuItem saveImageAsItem = menuBuilder.buildMenuItem("Save image as", "SaveImageAs", 0, "save.gif",
				true);
		final JMenuItem saveAllImagesItem = menuBuilder.buildMenuItem("Save all open images", "SaveAllImages", 0,
				"save.gif", true);
		...
		return menuBuilder.makeMenu("File", 'F', false, new JComponent[] {
				...
				menuBuilder.buildMenuItem("Exit", "Exit", 'x', null, true) });
	}
	...
	public JMenu makeHelpMenu() {
		return menuBuilder.makeMenu("Help", 'H', false,
				new JComponent[] { menuBuilder.buildMenuItem("About MIPAV", "About", 0, null, false),
	...
	public JMenu makeSystemsAnalysisMenu() {
		return menuBuilder
				.makeMenu("Systems analysis", 'S', false,
						new JComponent[] {
								menuBuilder.makeMenu("DTI", false,
										new JMenuItem[] {
												menuBuilder.buildMenuItem("DTI Pipeline", "dtiPipeline", 0, null,
														false),
										menuBuilder.buildMenuItem("Estimate tensor", "estimateTensor", 0, null, false),
										// menuBuilder.buildMenuItem("Fiber
										// tracking / Statistics",
										// "fiberTracking", 0, null, false),
										menuBuilder.buildMenuItem("DTI Color Display", "dtiColor", 0, null, false) }),
				// menuBuilder.buildMenuItem("Visualization",
				// "dtiVisualization", 0, null, false)}),
				menuBuilder.buildMenuItem("Graph/Network visualization", "HyperGraph", 0, null, false),
				menuBuilder.buildMenuItem("K-means", "KMeans", 0, null,
						false), menuBuilder
								...
								menuBuilder.makeMenu("Quantitative MRI", false,
										new JMenuItem[] {
												menuBuilder.makeMenu("T1", false,
														new JMenuItem[] { menuBuilder.buildMenuItem("TreT1", "treT1", 0,
																null, false) }),
												menuBuilder.makeMenu("T2", false,
														new JMenuItem[] { menuBuilder.buildMenuItem("TreT2", "treT2", 0,
																null, false) }),
												menuBuilder.makeMenu("DCE", false,
														new JMenuItem[] {
																menuBuilder.buildMenuItem("S2M2", "s2m2", 0, null,
																		false),
	 ...
	 * 
	 * @param isDicomImage
	 *            Whether the image this menu is attached to is a dicom image.
	 * 
	...
	public JMenu makeImageMenu(final boolean isDicomImage) {
		...
		return menuBuilder.makeMenu("Image", 'I', false,
				new JComponent[] {
						menuBuilder.makeMenu("Viewers", true,
								new JMenuItem[] { menuBuilder.buildMenuItem("Animate", "Animate", 0, "movie.gif", true),
										menuBuilder.buildMenuItem("Cine (movie)", "Cine (movie)", 0, "movie.gif", true),
										menuBuilder.buildMenuItem("Light box", "Light box", 0, "lightbox_16x16.gif",
												true),
				...
				menuBuilder.makeMenu("Attributes", true,
						new JMenuItem[] {
								...
								menuBuilder.buildMenuItem("Edit attributes", "EditImageInfo", 0, "attributes.gif",
										false),
						menuBuilder.buildMenuItem("Data provenance", "ImageDataProvenance", 0, null, true) }),
				menuBuilder.makeMenu("Zoom", true,
						new JMenuItem[] { menuBuilder.buildMenuItem("0.5X", "UnMagImage", 0, "zoomout.gif", true),
				...
				// menuBuilder.buildCheckBoxMenuItem("Show image/DICOM overlay",
	...
	public JMenu makeLoadBMenu(final boolean isAnImageOpen) {
		final JMenu loadMenu = menuBuilder.makeMenu("Load image (B)", true,
				new JMenuItem[] { menuBuilder.buildMenuItem("From frame", "ComponentLoadB", 0, "frame.gif", true),
		...
		return menuBuilder
				.makeMenu("LUT", 'L', false,
						new JComponent[] {
								...
								menuBuilder.buildMenuItem("Save LUT as...", null, 0, "save.gif", true), menuBuilder
										.buildMenuItem("Save functions as...", null, 0, "save.gif", true),
				ViewMenuBar.separator,
				menuBuilder.buildMenuItem("Histogram - LUT...", "DisplayLUT", 0, "histolut.gif", true), });
	}
	...
	public JMenu makeScriptingMenu() {
		return menuBuilder.makeMenu("Scripts", false,
				new JMenuItem[] { menuBuilder.buildMenuItem("Record script", "RecordScript", 0, null, false),
	...
	public JMenu makeToolbarsMenu() {
		...
		// default the VOI and Image toolbars to on if the user hasn't
		...
		return menuBuilder.makeMenu("Toolbars", 'T', false,
				new JMenuItem[] { menuBuilder.buildCheckBoxMenuItem("Image toolbar", "ImageToolbar", showImageToolbar),
	...
	public JMenu makeUtilitiesMenu() {
		return menuBuilder
				.makeMenu("Utilities", 'U', false,
						new JMenuItem[] {
								menuBuilder.makeMenu("3D slice tools", false,
										new JMenuItem[] {
												menuBuilder.buildMenuItem("Concat Multiple 2D to 3D", "Concat", 0, null,
														false),
										menuBuilder.buildMenuItem("Extract slices", null, 0, null, false),
										menuBuilder.buildMenuItem("Insert missing slices", "InsertMSlices", 0, null,
												false), menuBuilder.buildMenuItem("Insert slice", null, 0, null, false),
						...
						menuBuilder.buildMenuItem("Replace blanks with averages", "ReplaceBlankWithAvg", 0, null,
								false), menuBuilder.buildMenuItem("Replace slice", null, 0, null, false),
						menuBuilder.buildMenuItem("Swap slices", null, 0, null, false), }),
				menuBuilder.makeMenu("4D volume tools", false,
						new JMenuItem[] {
				...
				menuBuilder.makeMenu("Concatenate", false,
						new JMenuItem[] {
								menuBuilder.buildMenuItem("Concat Multiple 2D to 3D", "Concat", 0, null, false),
								menuBuilder.buildMenuItem("Concat Multiple 3D to 3D", "ConvertMultiple3Dto3D", 0, null,
										false),
						menuBuilder.buildMenuItem("Concat Multiple 3D to 4D", "ConvertMultiple3Dto4D", 0, null,
								false) }),

				menuBuilder.makeMenu("Conversion tools", false,
						new JMenuItem[] { menuBuilder.buildMenuItem("Convert type", null, 0, null, false),
						...
						menuBuilder.buildMenuItem("RGB -> Gray", null, 0, null, false),
								...
								menuBuilder.makeMenu("Crop", false,
										new JMenuItem[] {
												menuBuilder.buildMenuItem("Using boundary parameters",
				...
				// null, false),
								...
								menuBuilder.buildMenuItem("Generate isolines", "writeIsolines", 0, null, false),
								menuBuilder.buildMenuItem("Image calculator", "Calculator", 0, null, false),
								menuBuilder.buildMenuItem("Image calculator - Bulk Images", "BulkCalculator", 0, null,
										false),
				...
				menuBuilder.buildMenuItem("Intensity Projection", "maximumIntensityProjection", 0, null, false),
								...
								menuBuilder.makeMenu("Mosaic", false, new JMenuItem[] {
										...
										menuBuilder.buildMenuItem("Mosaic to 4D volume", "MosaicTo4D", 0, null,
												false), }),
								...
								menuBuilder.makeMenu("Quantify", false,
										new JMenuItem[] {
												menuBuilder.buildMenuItem("Quantify using mask", "Quantify", 0, null,
														false),
								...
								menuBuilder
										.makeMenu("Rotate", false,
												new JMenuItem[] {
														menuBuilder.buildMenuItem("X axis 180", "RotateX180", 0, null,
																false),
												...
												menuBuilder.buildMenuItem("Z axis +90", "RotateZPlus", 0, null,
														false),
										menuBuilder.buildMenuItem("Z axis -90", "RotateZMinus", 0, null, false) }),

				menuBuilder.buildMenuItem("Subtract VOI background", "SubVOI", 0, null, false), menuBuilder
						.buildMenuItem("Tilt (gantry) correction", "TiltCorrection", 0, null, false) });
	...
	public JMenu makeVOIMenu() {
		return menuBuilder.makeMenu("VOI", 'V', false,
				...
				menuBuilder.makeMenu("New VOI", true,
						new JMenuItem[] { menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_POINT, true),
								...
								menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_BSPLINE, true),
						...
						menuBuilder.makeMenu("Open VOI", true,
								new JMenuItem[] {
										...
										menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_OPEN_VOI_IMAGEJ_ALL_FROM, true),
						...
						menuBuilder.makeMenu("Save VOI", true,
								new JMenuItem[] {
										menuBuilder.buildMenuItem(
												CustomUIBuilder.PARAM_EXPORT_SELECTED_CONTOURS_AS_POLYGON, true),
						...
						menuBuilder.makeMenu("Edit VOI", true,
								new JMenuItem[] { menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_UNDO, true),
						...
						menuBuilder.makeMenu("Contour order", true,
								new JMenuItem[] { menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_CONTOUR_FRONT, true),
						...
						menuBuilder.makeMenu("VOI conversion", true,
								...
								menuBuilder.buildMenuItem("VOI -> All to Unsigned byte mask", "UnsignedByteMask", 0,
										null, false),
								menuBuilder.buildMenuItem("VOI -> Selected to Binary mask", "BinaryMaskSelected", 0,
										null, false),
								menuBuilder.buildMenuItem("VOI -> Selected to Short mask", "ShortMaskSelected", 0, null,
										false),
						...
						menuBuilder.makeMenu("Mask conversion", true,
								new JMenuItem[] { menuBuilder.buildMenuItem("Mask -> VOI", "MaskToVOI", 0, null, false),
						...
						menuBuilder.makeMenu("Paint conversion", true,
								...
								menuBuilder.buildMenuItem("Paint -> Short mask", "PaintToShortMask", 0, null,
										false), }),
						// menuBuilder.buildCheckBoxMenuItem("Allow VOI holes
						// (XOR)", "XOR", Preferences
						...
						menuBuilder
								.makeMenu("Propagate", true,
										new JMenuItem[] {
												...
												menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_PROPAGATE_DOWN,
														true),
								menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_PROPAGATE_ALL, true) }),
						menuBuilder.makeMenu("Evolve boundary 2D", true,
								new JMenuItem[] { menuBuilder.buildMenuItem("Active contour", "Snake", 0, null, false),
						...
						menuBuilder.makeMenu("Flip VOI", true,
								new JMenuItem[] { menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_FLIPY, true),
						...
						ViewMenuBar.separator, menuBuilder.buildMenuItem("Smooth VOI", "SmoothVOI", 0, null, true),
						menuBuilder.buildMenuItem("Transform VOI", "TransformVOI", 0, null, true),
						menuBuilder.buildMenuItem("Trim parameter", "Trim", 0, null, true), ViewMenuBar.separator,
						...
						ViewMenuBar.separator, menuBuilder.buildMenuItem("Boolean VOIs", "BooleanVOIs", 0, null, true),
						ViewMenuBar.separator,
						menuBuilder.buildMenuItem("VOI indentations 2D", "IndentationVOIs2D", 0, null, true),
						ViewMenuBar.separator,
						menuBuilder.makeMenu("Graph", true,
								new JMenuItem[] { menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_GRAPH_OPEN, true),
										menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_GRAPH_BOUNDARY_CURVATURE,
												false),
								menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_GRAPH_BOUNDARY_INTENSITY, false),
								menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_GRAPH_TOTAL_INTENSITY, false),
								menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_GRAPH_AVERAGE_INTENSITY, false),
								menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_GRAPH_TOTAL_INTENSITY_THRESHOLD,
										false),
								menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_GRAPH_AVERAGE_INTENSITY_THRESHOLD,
										false) }),
						ViewMenuBar.separator,
						// menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_PROPERTIES,
						// false),
						// menuBuilder.buildMenuItem(CustomUIBuilder.PARAM_VOI_STATISTICS,
						// false),
	...
	public JMenu makeVOIMenu(boolean displayLatticeMenu) {
		JMenu menu = menuBuilder.makeMenu("VOI", 'V', false,
				new JComponent[] {
				...
				menuBuilder.makeMenu("New VOI", true,
						...
						menuBuilder.makeMenu("Worm Annotations", true,
								new JMenuItem[] {
										menuBuilder.buildRadioButtonMenuItem("Add Annotations", "AddAnnotations", false,
												new ButtonGroup()),
	...
	protected void enableAllMenuItems() {
		...
		// menuBuilder.setMenuItemEnabled("Optimized automatic registration
		// 3.5D", true);
