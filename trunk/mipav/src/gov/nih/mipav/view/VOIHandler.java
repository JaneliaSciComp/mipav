...
public class VOIHandler extends JComponent implements MouseListener, MouseMotionListener {
     ...
     */
    public VOIHandler(final ViewJComponentEditImage comp) {
        this.compImage = comp;
     ...
     */
    public void addVOIUpdateListener(final UpdateVOISelectionListener listener) {
    ...
    public void calcPLineSliceDistances() {
        ...
        final ViewVOIVector VOIs = compImage.getActiveImage().getVOIs();
     ...
     */
    public void changeVOIOrder(boolean doContour, final int direction) {

        if ( (direction != VOIHandler.FORWARD) && (direction != VOIHandler.BACKWARD) && (direction != VOIHandler.FRONT)
                && (direction != VOIHandler.BACK)) {
            return;
        }
            ...
            for (i = 0; i < nVOI; i++) {
                ...
                if (VOIs.VOIAt(i).isActive() && VOIs.VOIAt(i).isVisible()) {
                    ...
                    if ( !doContour) {
                        ...
                        if (direction == VOIHandler.FORWARD) {
                        ...
                        } else if (direction == VOIHandler.BACKWARD) {
                        ...
                        } else if (direction == VOIHandler.FRONT) {
                            VOIs.add((VOI) VOIs.VOIAt(i).clone());
                            VOIs.removeElementAt(i);

                        } else if (direction == VOIHandler.BACK) {
                        ...
                        for (int j = 0; j < curves[compImage.getSlice()].size(); j++) {
                            ...
                            if (selectedCurve.isActive()) {
                                ...
                                final VOIBase curveClone = (VOIBase) selectedCurve.clone();
    ...
    public boolean convertPointToPoly() {
        ...
        // first determine if there is more than one point on more than one
        // compImage.getSlice()/frame

        final ViewVOIVector VOIs = compImage.getActiveImage().getVOIs();
        final int nVOI = VOIs.size();
        final int xDim = compImage.getActiveImage().getExtents()[0];
        final int yDim = compImage.getActiveImage().getExtents()[1];
        int zDim = 1;
        ...
        for (int i = 0; i < nVOI; i++) {
            final int curveType = VOIs.VOIAt(i).getCurveType();
    ...
    public void copyVOIforUndo() {
        ...
        this.undoVOI = (VOI) (VOIs.elementAt(i)).clone();
    }
    ...
    public boolean copyVOItoClipBrd() {
        ...
        if ( !doLPS) {
            for (i = 0; i < nVOI; i++) {
                if (VOIs.VOIAt(i).isActive() == true) {
                    voi = (VOI) (VOIs.elementAt(i)).clone();
            ...
            for (i = 0; i < nVOI; i++) {
                ...
                if (VOIs.VOIAt(i).isActive() == true) {
                    ...
                    final Vector<Vector3f> scannerVector = new Vector<Vector3f>();
                    ...
                    for (int s = 0; s < zDim; s++) {
                        ...
                        for (int j = 0; j < numCurves; j++) {
                            ...
                            for (int k = 0; k < numPoints; k++) {
                                ...
                                inPoint.X = (tempBase.elementAt(k)).X;
                                inPoint.Y = (tempBase.elementAt(k)).Y;
                                inPoint.Z = s;
                                ...
                                // System.err.println("Scanner point: " +
                                // outPoint);
                            }
                        }
                    }
     ...
     */
    public void deleteContour(final VOI voi, final int zSlice) {
        int j;
        int nCurves;
        Vector[] curves;
     ...
     */
    public void deleteSelectedVOI(final boolean contoursOnly) {
        int i, s, nVOI;
            ...
            if (VOIs.VOIAt(i).isActive() == true) {
                ...
                if (contoursOnly) {
                    ...
                    if (VOIs.VOIAt(i).isEmpty() == true) {
                        ...
                        final int id = (compImage.getActiveImage().getVOIs().size() > 0) ? ( ( (compImage
                                .getActiveImage().getVOIs().lastElement())).getID() + 1) : 0;
                        final int lastUID = (compImage.getActiveImage().getVOIs().size() > 0) ? ( ( (compImage
                                .getActiveImage().getVOIs().lastElement())).getUID() + 1) : -1;
     ...
     */
    public void drawVOIs(final Graphics graphics) {
        final ViewVOIVector VOIs = compImage.getActiveImage().getVOIs();
        ...
        if (compImage.getOrientation() == FileInfoBase.UNKNOWN_ORIENT) {
            ...
            if (VOIs != null) {
                ...
                if (compImage.getSlice() != -99) {
                    if ( (compImage.getActiveImage().getFileInfo(0) != null)
                        ...
                        final float originX = compImage.getActiveImage().getFileInfo(0).getOrigin()[0];
                        final float originY = compImage.getActiveImage().getFileInfo(0).getOrigin()[1];

                        for (int i = 0; i < nVOI; i++) {
                            VOIs.VOIAt(i).drawSelf(compImage.getZoomX(), compImage.getZoomY(),
                                    compImage.getResolutionX(), compImage.getResolutionY(), originX, originY,
                                    ...
                                    compImage.getActiveImage().getFileInfo(0), compImage.getActiveImage().getNDims(),
                                    graphics);
                        }
                    }
                }
            ...
            if (mode == ViewJComponentBase.LEVELSET) {

                if (rbLevelSet.getLevelSetPolygon() != null) {
                    graphics.setColor(Color.yellow);
                    graphics.drawPolygon(zoomPolygon(rbLevelSet.getLevelSetPolygon(), compImage.getZoomX()
                            * compImage.getResolutionX(), compImage.getZoomY() * compImage.getResolutionY()));
                }
            }
     ...
     */
    public void fireVOISelectionChange(final VOI voi, final VOIBase curve) {
     ...
     */
    public void graph25VOI_CalcInten(final boolean totalIntensity, final boolean useThreshold, final float threshold) {
        int i, j, s;
        int nVOI;
        ViewVOIVector VOIs;
        VOI v;
        ...
        if (compImage.getActiveImage().getNDims() == 3) {
                        ...
                        if (VOIs.VOIAt(i).isActive() && (VOIs.VOIAt(i).isVisible() == true)) {
                            ...
                            if (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR) {
                                ...
                                for (s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                    ...
                                    try {
                                        compImage.getActiveImage().exportData(s * length * 4, length * 4, graphImgBuff); // locks
                                                                                                                            // and
                                        // releases lock
                                        ...
                                        for (int c = 0; c < 3; c++) {
                                            ...
                                            for (j = 0, intensitySum = 0; j < VOIs.VOIAt(i).getCurves()[s].size(); j++) {
                                                ...
                                                if (useThreshold) {
                                                    intensitySum += ((VOIContour) (VOIs.VOIAt(i).getCurves()[s]
                                                            .elementAt(j))).calcRGBIntensityThreshold(graphImgBuff,
                                                            compImage.getActiveImage().getExtents()[0], c, threshold);
                                                } else {
                                                    intensitySum += ((VOIContour) (VOIs.VOIAt(i).getCurves()[s]
                                                            .elementAt(j))).calcRGBIntensity(graphImgBuff, compImage
                                                            .getActiveImage().getExtents()[0], c);
                                                }
                                ...
                                final ViewJFrameGraph contourGraph = new ViewJFrameGraph(rgbPositions, rgbIntensities,
                                        "Intensity Graph", v, FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage
                                                .getActiveImage().getFileInfo(0).getUnitsOfMeasure(2)));

                                contourGraph
                                        .setDefaultDirectory(ViewUserInterface.getReference().getDefaultDirectory());
                        ...
                        if (VOIs.VOIAt(i).isActive() && (VOIs.VOIAt(i).isVisible() == true)) {
                            ...
                            if (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR) {
                                ...
                                for (s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                    ...
                                    try {
                                        numPixels = 0;
                                        compImage.getActiveImage().exportData(s * length, length, graphImgBuff); // locks
                                                                                                                    // and
                                        // releases
                                        ...
                                        for (j = 0, intensitySum = 0; j < VOIs.VOIAt(i).getCurves()[s].size(); j++) {
                                            ...
                                            if (useThreshold) {
                                                intensitySum += ((VOIContour) (VOIs.VOIAt(i).getCurves()[s]
                                                        .elementAt(j))).calcIntensityThreshold(graphImgBuff, compImage
                                                        .getActiveImage().getExtents()[0], threshold);

                                            } else {
                                                intensitySum += ((VOIContour) (VOIs.VOIAt(i).getCurves()[s]
                                                        .elementAt(j))).calcIntensity(graphImgBuff, compImage
                                ...
                                final ViewJFrameGraph contourGraph = new ViewJFrameGraph(position, intensity,
                                        "Intensity Graph", v, FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage
                                                .getActiveImage().getFileInfo(0).getUnitsOfMeasure(0)), null);
                                ...
                                final ModelImage image = compImage.getImageA();
                                final AlgorithmVOIProps algoVOI = new AlgorithmVOIProps(image, getActiveVOIs(image));
                                algoVOI.run();
                                final float min = algoVOI.getMinIntensity();
                                final float max = algoVOI.getMaxIntensity();
                                final float totalInten = algoVOI.getSumIntensities();
                                final float meanInten = algoVOI.getAvgInten();
                                final float stdDevInten = algoVOI.getStdDev();

                                ViewUserInterface.getReference().setDataText(
                                        "VOI \tmin \tmax \ttotal \tmean \tstandard deviation " + "\n");
                                ViewUserInterface.getReference().setDataText(
                                        "\t" + min + "\t" + max + "\t" + totalInten + "\t" + meanInten + "\t"
                                                + stdDevInten + "\n");
            ...
            final int xDim = compImage.getActiveImage().getExtents()[0];
            final int yDim = compImage.getActiveImage().getExtents()[1];
            final int zDim = compImage.getActiveImage().getExtents()[2];
            ...
            if (compImage.getActiveImage().getFileInfo()[0].getFileFormat() == FileUtility.DICOM) {
                ...
                if (frameRefTimeString != null) {
                    ...
                    if (frameRefTimeFound) {
                        final int response = JOptionPane.showConfirmDialog(UI.getMainFrame(), new String(
                                "Do you wish to use the frame reference time for the graph x axis?"),
                                "Frame Reference Time?", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                        if (response == JOptionPane.YES_OPTION) {
                            useFrameRefTime = true;
                        }
                    } // if (frameRefTimeFound)
                } // if (frameRefTimeString != null)
            } // if (compImage.getActiveImage().getFileInfo()[0].getFileFormat()
            // == FileUtility.DICOM)
                ...
                for (i = 0; i < nVOI; i++) {
                    ...
                    if (VOIs.VOIAt(i).isActive() && (VOIs.VOIAt(i).isVisible() == true)) {
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR) {
                            ...
                            for (int t = 0; t < compImage.getActiveImage().getExtents()[3]; t++) {
                                ...
                                try {
                                    ...
                                    for (s = 0, intensitySum = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                        compImage.getActiveImage().exportData(
                                                (t * xDim * yDim * zDim) + (s * xDim * yDim), length, graphImgBuff); // locks
                                        // and
                                        // releases
                                        // lock
                                        ...
                                        for (j = 0; j < VOIs.VOIAt(i).getCurves()[s].size(); j++) {
                                            intensitySum += ((VOIContour) (VOIs.VOIAt(i).getCurves()[s].elementAt(j)))
                                                    .calcIntensity(graphImgBuff, compImage.getActiveImage()
                                                            .getExtents()[0]);
                                            numPixels += ((VOIContour) (VOIs.VOIAt(i).getCurves()[s].elementAt(j)))
                                                    .getLastNumPixels();
                                        }
                                    ...
                                    if (useFrameRefTime) {
                                        ...
                                        frameRefTimeString = ((String) fileInfo.getTagTable().getValue("0054,1300"))
                                                .trim();
                                        if (frameRefTimeString != null) {
                                            try {
                                                frameReferenceTime = new Integer(frameRefTimeString).intValue();
                            ...
                            final ViewJFrameGraph contourGraph = new ViewJFrameGraph(position, intensity,
                                    "Intensity Graph", v, FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage
                                            .getActiveImage().getFileInfo(0).getUnitsOfMeasure(3)), null);
     ...
     */
    public void graphPointVOI(final VOI v, final VOIPoint voiPt, final int j, final boolean useFrameRefTime) {
        int t, s;
        Vector3f pt;
        ...
        if (compImage.getActiveImage().getNDims() == 3) {
                ...
                for (s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                    ...
                    for (int c = 0; c < 3; c++) {
                        ...
                        ptRGBIntensities[c][s] = compImage.getActiveImage().getFloat(
                                ( (4 * ( (s * compImage.getActiveImage().getSliceSize())
                                        + ((int) pt.Y * compImage.getActiveImage().getExtents()[0]) + (int) pt.X))
                                        + c + 1));
                    }
                }

                if (v.getContourGraph() == null) {
                    final ViewJFrameGraph contourGraph = new ViewJFrameGraph(ptRGBPositions, ptRGBIntensities,
                            "Intensity Graph", v, FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage()
                    ...
                    v.getContourGraph().setUnitsInLabel(
                            FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage().getFileInfo(0)
                                    .getUnitsOfMeasure(0)));
                ...
                try {
                    ...
                    for (s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                        ...
                        ptIntensity[s] = compImage.getActiveImage().getFloat(
                                (int) ( (s * compImage.getActiveImage().getSliceSize())
                                        + (pt.Y * compImage.getActiveImage().getExtents()[0]) + pt.X));
                    }

                    if (v.getContourGraph() == null) {
                        final ViewJFrameGraph contourGraph = new ViewJFrameGraph(ptPosition, ptIntensity,
                                "Intensity Graph", v, FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage
                                        .getActiveImage().getFileInfo(0).getUnitsOfMeasure(0)), null);
            ...
            try {
                ...
                if (v.getContourGraph() == null) {
                    final ViewJFrameGraph contourGraph = new ViewJFrameGraph(ptPosition, ptIntensity,
                            "Intensity Graph", v, FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage()
                                    .getFileInfo(0).getUnitsOfMeasure(3)), null);
                    contourGraph.setDefaultDirectory(ViewUserInterface.getReference().getDefaultDirectory());
                    contourGraph.setVisible(false);
                    v.setContourGraph(contourGraph);
                    ...
                    v.getContourGraph().setUnitsInLabel(
                            FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage().getFileInfo(0)
                                    .getUnitsOfMeasure(3)));
                    v.getContourGraph().replaceFunction(ptPosition, ptIntensity, null, v, j);
                } else {
                    v.getContourGraph().setUnitsInLabel(
                            FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage().getFileInfo(0)
                                    .getUnitsOfMeasure(3)));
                        ...
                        if ( (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR)
                            ...
                            for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                                ...
                                if ( ((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                        .isActive()) {
                                    length = MipavMath.round( ((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage
                                            .getSlice()].elementAt(j))).getLengthPtToPt(compImage.getActiveImage()
                                            .getFileInfo(0).getResolutions()));

                                    if (compImage.getActiveImage().getFileInfo(0).getResolutions()[0] > 0) {
                                        length = MipavMath.round(length
                                    ...
                                    for (int c = 0; c < 3; c++) {
                                        pt = ((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()]
                                                .elementAt(j))).findPositionAndIntensityRGB(rgbPositions[c],
                                                rgbIntensities[c], c, compImage.getActiveImageBuffer(), compImage
                                                        .getActiveImage().getResolutions(compImage.getSlice()),
                                                compImage.getActiveImage().getExtents()[0], compImage.getActiveImage()
                                                        .getExtents()[1]);
                            ...
                            final ViewJFrameGraph contourGraph = new ViewJFrameGraph(rgbPos, rgbInten,
                                    "Intensity Graph");

                            contourGraph.setUnitsInLabel(FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage
                                    .getActiveImage().getFileInfo(0).getUnitsOfMeasure(0)));
                            contourGraph.setDefaultDirectory(ViewUserInterface.getReference().getDefaultDirectory());
                            contourGraph.setVisible(true);

                            ViewUserInterface.getReference().setDataText(
                                    "VOI perimiter\t\tmean \tstandard deviation " + "\n");
                            ViewUserInterface.getReference().setDataText(
                                    "Red\t\t" + rgbMeanInten[0] + "\t" + rgbStdDevInten[0] + "\n");
                            ViewUserInterface.getReference().setDataText(
                                    "Green\t\t" + rgbMeanInten[1] + "\t" + rgbStdDevInten[1] + "\n");
                            ViewUserInterface.getReference().setDataText(
                                    "Blue\t\t" + rgbMeanInten[2] + "\t" + rgbStdDevInten[2] + "\n");
                            ...
                            for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                                ...
                                if ( ((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                    ...
                                    pt = ((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                            .findPositionAndIntensity(position, intensity, compImage
                                                    .getActiveImageBuffer(),
                                                    compImage.getActiveImage().getFileInfo()[compImage.getSlice()]
                                                            .getResolutions(),
                                                    compImage.getActiveImage().getExtents()[0], compImage
                                                            .getActiveImage().getExtents()[1], xyCoords);

                                    final float[] pos = new float[pt];
                                    final float[] inten = new float[pt];
                                    ...
                                    final ViewJFrameGraph contourGraph = new ViewJFrameGraph(pos, inten,
                                            "Contour VOI Graph", xyCoords);

                                    contourGraph.setUnitsInLabel(FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage
                                            .getActiveImage().getFileInfo(0).getUnitsOfMeasure(0)));
                                    contourGraph.setDefaultDirectory(ViewUserInterface.getReference()
                                            .getDefaultDirectory());
                                    contourGraph.setVisible(true);

                                    /*
                                     * ViewUserInterface.getReference() .setDataText( "VOI perimiter\t\ttotal \tmean
                                     * \tstandard deviation " + "\n"); ViewUserInterface.getReference() .setDataText(
     ...
     * 
     * <p>
     * Arrow key = move active VOI CTRL + left/right = cycle through VOI's contours CTRL + up/down = cycle through VOIs
     * Shift + arrow key = move active contour's active point CTRL + Shift + arrow key = cycle through active contour's
     * active points
     * </p>
     * 
     * @param e KeyEvent
     */
    public void handleArrowKeysVOI(final KeyEvent e) {
     ...
     */
    public boolean isNewVoiNeeded(final int voiType) {
    ...
    public void mouseClicked(final MouseEvent mouseEvent) {
        ...
        int xS, yS;
        xS = compImage.getScaledX(mouseEvent.getX()); // zoomed x. Used as
        // cursor
        yS = compImage.getScaledY(mouseEvent.getY()); // zoomed y. Used as
        // cursor

        if ( (xS < 0) || (xS >= compImage.getActiveImage().getExtents()[0]) || // Check
                // for
                // validity
        ...
        if ( (mouseEvent.getClickCount() == 1) && (mode == ViewJComponentBase.DEFAULT)) {
            selectAllVOIs(false);
            // fireVOISelectionChange(null);
            // lastPointVOI = -1; // next mouseClick will deactivate point VOI
            // unless reselected
    ...
    public void mouseDragged(final MouseEvent mouseEvent) {
        ...
        int xDim, yDim;
        int zDim = 1;
        final float[] lineX = new float[2];
        final float[] lineY = new float[2];
        final float[] lineZ = new float[2];
        float[] position;
        float[] intensity;
        int sliceNum;
        ...
        if (mode == ViewJComponentBase.MOVE) {
            ...
            for (i = 0; i < nVOI; i++) {
                ...
                if (VOIs.VOIAt(i).isActive()) {
                    ...
                    if ( ( (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR)
                            ...
                            || (VOIs.VOIAt(i).getCurveType() == VOI.PROTRACTOR) || (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE_SLICE))
                        ...
                        if ( (VOIs.VOIAt(i).getContourGraph() != null) && VOIs.VOIAt(i).getContourGraph().isVisible()
                            ...
                            VOI v;
                            float intensitySum;
                            final int length = compImage.getActiveImage().getSliceSize();
                            int s;
                            int numPixels;
                            boolean foundCurve;
                            ...
                            final float[][] rgbPositions = VOIs.VOIAt(i).getRGBPositions();
                            final float[][] rgbIntensities = VOIs.VOIAt(i).getRGBIntensities();
                                ...
                                if (compImage.getActiveImage().isColorImage() == true) {
                                    ...
                                    try {
                                        ...
                                        for (s = 0, foundCurve = false; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                            ...
                                            try {
                                                ...
                                                for (int c = 0; c < 3; c++) {
                                                    ...
                                                    for (j = 0, intensitySum = 0; j < VOIs.VOIAt(i).getCurves()[s]
                                                            .size(); j++) {
                                                        ...
                                                        if ( ((VOIContour) VOIs.VOIAt(i).getCurves()[s].elementAt(j))
                                                            ...
                                                            if ( !foundCurve) {
                                                                compImage.getActiveImage().exportData(s * length * 4,
                                                                        length * 4, graphImgBuff);
                                                            } // locks and
                                                            // releases lock

                                                            intensitySum += ((VOIContour) (VOIs.VOIAt(i).getCurves()[s]
                                                                    .elementAt(j))).calcRGBIntensity(graphImgBuff,
                                                                    compImage.getActiveImage().getExtents()[0], c);
                                                            numPixels += ((VOIContour) (VOIs.VOIAt(i).getCurves()[s]
                                        ...
                                        VOIs.VOIAt(i).getContourGraph().setUnitsInLabel(
                                                FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage()
                                                        .getFileInfo(0).getUnitsOfMeasure(0)));
                                    ...
                                    try {
                                        ...
                                        for (s = 0, foundCurve = false; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                            ...
                                            try {
                                                ...
                                                for (j = 0, intensitySum = 0; j < VOIs.VOIAt(i).getCurves()[s].size(); j++) {
                                                    final boolean isActive = ((VOIContour) (VOIs.VOIAt(i).getCurves()[s]
                                ...
                                try {
                                    ...
                                    for (int t = 0; t < compImage.getActiveImage().getExtents()[3]; t++) {
                                        ...
                                        try {
                                            ...
                                            for (s = 0, intensitySum = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                                compImage.getActiveImage().exportData(
                                                        (t * xDim * yDim * zDim) + (s * xDim * yDim), length,
                                                        graphImgBuff); // locks
                                                // and
                                                // releases
                                                // lock
                                    ...
                                    if (compImage.getActiveImage().getNDims() == 3) {
                                        ...
                                        if (compImage.getActiveImage().isColorImage() == true) {
                                            ...
                                            for (int s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                                pt = ((VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()]
                                                        .elementAt(j))).exportPoint();

                                                for (int c = 0; c < 3; c++) {

                                                    if ( (ptRGBPositions != null) && (ptRGBIntensities != null)) {
                                                        ptRGBPositions[c][s] = s;
                                                        ptRGBIntensities[c][s] = compImage.getActiveImage()
                                                                .getFloat(
                                                                        (int) ( (4 * ( (s
                                                                                * compImage.getActiveImage()
                                                                                        .getExtents()[0] * compImage
                                                                                .getActiveImage().getExtents()[1])
                                                                                + (pt.Y * compImage.getActiveImage()
                                                                                        .getExtents()[0]) + pt.X))
                                                                                + c + 1));
                                                    }
                                                }
            ...
            return;
        } else if (mode == ViewJComponentBase.MOVE_POINT) { // rubberband a
            // point
            ...
            if (mouseEvent.isShiftDown() == false) {
                final Graphics g = compImage.getGraphics();

                for (i = 0; i < nVOI; i++) {

                    if (VOIs.VOIAt(i).isActive() && (VOIs.VOIAt(i).getCurveType() != VOI.POINT)) {

                        // Hides the cursor during dragging so it doesn't get in
                        // the way.
                        compImage.setCursor(MipavUtil.blankCursor);

                        VOIs.VOIAt(i).rubberbandVOI(xS, yS, compImage.getSlice(), xDim, yDim, false,
                                compImage.getZoomX(), compImage.getZoomY(), compImage.getResolutionX(),
                                compImage.getResolutionY(), g);

                        if (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE_SLICE) {
                            final Vector3f pt = VOIs.VOIAt(i).exportPSlicePoint(compImage.getSlice());
            ...
            return;
        } else if (mode == ViewJComponentBase.RETRACE) {
            final Graphics g = compImage.getGraphics();
            ...
            for (i = 0; i < nVOI; i++) {
                ...
                if (VOIs.VOIAt(i).isActive()) {
                    try {
                        ...
                        ((VOIContour) (VOIs.VOIAt(i).getActiveContour(compImage.getSlice()))).retraceContour(compImage
                                .getZoomX(), compImage.getZoomY(), compImage.getResolutionX(), compImage
                                .getResolutionY(), compImage.getActiveImage().getFileInfo(0).getResolutions(), xS, yS,
                                g, VOIs.VOIAt(i).getThickness());
                        compImage.setCursorMode(ViewJComponentBase.RETRACE);
            ...
            return;
        } else if (mode == ViewJComponentBase.PAINT_VOI) {
            compImage.performPaint(mouseEvent, mouseMods == InputEvent.BUTTON3_MASK);
            if (compImage.getActiveImage().getTriImageFrame() == null) {
                compImage.getActiveImage().notifyImageDisplayListeners();
            } else {
                compImage.getActiveImage().notifyImageDisplayListeners_notTriFrame();
            }
        } else if (mode == ViewJComponentBase.ERASER_PAINT) {
            compImage.performPaint(mouseEvent, mouseMods == InputEvent.BUTTON3_MASK);
            if (compImage.getActiveImage().getTriImageFrame() == null) {
                compImage.getActiveImage().notifyImageDisplayListeners();
            } else {
    ...
    public void mouseMoved(final MouseEvent mouseEvent) {
        ...
        if ( (mode == ViewJComponentBase.ZOOMING_IN) || (mode == ViewJComponentBase.ZOOMING_OUT)) {

            // if we are in zoom mode, we don't care about any of the other
            // things
            // that are happening here, in fact, zoom breaks if we don't return
            return;
        }
        if (mode == ViewJComponentBase.VOI_3D) {
            return;
        }
        ...
        if ( (mode == ViewJComponentBase.PAINT_VOI) && mouseEvent.isShiftDown()) {
        ...
        if ( (xS < 0) || (xS >= compImage.getActiveImage().getExtents()[0]) || // Check
                ...
                // is
                // within
                (yS < 0) || (yS >= compImage.getActiveImage().getExtents()[1])) { // the
            // image
            // bounds
            compImage.getGraphics().dispose();
        ...
        if (mode == ViewJComponentBase.MAG_REGION) {
            compImage.repaint();

            return;
        } else if (mode == ViewJComponentBase.WIN_REGION) {
            compImage.repaint();

            return;
        } else if ( (mode == ViewJComponentBase.PAINT_VOI) || (mode == ViewJComponentBase.ERASER_PAINT)) {
        ...
        if ( (mode == ViewJComponentBase.RECTANGLE) || (mode == ViewJComponentBase.ELLIPSE)
                || (mode == ViewJComponentBase.LINE) || (mode == ViewJComponentBase.RECTANGLE3D)
                || (mode == ViewJComponentBase.POINT_VOI) || (mode == ViewJComponentBase.POLYLINE)
                || (mode == ViewJComponentBase.LEVELSET) || (mode == ViewJComponentBase.PAINT_VOI)
                || (mode == ViewJComponentBase.DROPPER_PAINT) || (mode == ViewJComponentBase.ERASER_PAINT)
                || (mode == ViewJComponentBase.QUICK_LUT) || (mode == ViewJComponentBase.PROTRACTOR)
                || (mode == ViewJComponentBase.LIVEWIRE) || (mode == ViewJComponentBase.ANNOTATION)
                || (mode == ViewJComponentBase.POLYLINE_SLICE_VOI) || (mode == ViewJComponentBase.PAINT_CAN)
            ...
            // System.err.println("returning from mouseMoved with mode of: " +
            // mode);
            return;
        }

        VOIs = compImage.getActiveImage().getVOIs(); // Get the VOIs from the
        // active image.
        nVOI = 0;
        ...
        if (VOIs != null) {
            ...
            for (i = 0; i < nVOI; i++) {
                ...
                if (VOIs.VOIAt(i).isActive() && VOIs.VOIAt(i).isVisible()) {
                    ...
                    if (mouseEvent.isShiftDown()
                        ...
                        if ( (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR)
                            ...
                            // BEN LINK CHANGE can delete point from bounding
                            // box'd contour
                            // if ( VOIs.VOIAt( i ).getBoundingBoxFlag() ==
                            // false ) {
                            compImage.setCursorMode(ViewJComponentBase.DELETE_POINT);

                            // } else { compImage.setMode( MOVE_POINT ); }
                            // Displays contour with the active point
                            // highlighted
                            // VOIs.VOIAt(i).drawVertices(compImage.getZoomX(),
                            // getZoomY(),
                            // compImage.getResolutionX(),
                            // compImage.getResolutionY(), compImage.getSlice(),
                            // g);
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE_SLICE) {
                            ...
                            compImage.setCursorMode(ViewJComponentBase.MOVE_POINT);
                            compImage.getGraphics().dispose();
                            ...
                            // don't bother redrawing for a line ... point is
                            // not highlighted
                    ...
                    // see if the mouse is near the line in between the points
                    // of the contour/polyline/polyline_slice
                        ...
                        if ( (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR)
                            ...
                            compImage.setCursorMode(ViewJComponentBase.NEW_POINT);
                            compImage.getGraphics().dispose();
                ...
                } // end of if( VOIs.VOIAt(i).isActive() &&
                // VOIs.VOIAt(i).isVisible() && VOIs.VOIAt(i).getShowUp())
        ...
        for (i = 0; i < nVOI; i++) {
            ...
            if ( (curveType == VOI.CONTOUR) || (curveType == VOI.POLYLINE) || (curveType == VOI.PROTRACTOR)
                ...
                curves = ( (VOIs.elementAt(i))).getCurves();

                for (j = 0; j < curves[compImage.getSlice()].size(); j++) {
                    boolean isContained = false;

                    if ( (curveType == VOI.CONTOUR) || (curveType == VOI.POLYLINE)) {
                        isContained = ((VOIContour) (curves[compImage.getSlice()].elementAt(j)))
                                .contains(xS, yS, false);
                    } else if (curveType == VOI.PROTRACTOR) {
                        ...
                        isContained = ((VOIText) (curves[compImage.getSlice()].elementAt(j))).contains(xS, yS,
                                compImage.getZoomX(), compImage.getZoomY(), compImage.getActiveImage().getFileInfo(0)
                                        .getResolutions(), g);
                    }

                    if (VOIs.VOIAt(i).isVisible() && isContained) {
                        compImage.setCursorMode(ViewJComponentBase.MOVE);
        ...
        compImage.setCursorMode(ViewJComponentBase.DEFAULT);
    ...
    public void mousePressed(final MouseEvent mouseEvent) {
        ...
        if (mode != ViewJComponentBase.DEFAULT) {
            VOIs = compImage.getActiveImage().getVOIs();
            nVOI = VOIs.size();
        ...
        try {
            ...
            if (mode == ViewJComponentBase.DROPPER_PAINT) {
                // shouldnt be here
            }

            if (mode == ViewJComponentBase.ERASER_PAINT) {
                // shouldnt be here
            } else if (mode == ViewJComponentBase.PAINT_VOI) {
                // shouldnt be here
            }

            if ( (mode == ViewJComponentBase.MAG_REGION) && (mouseEvent.getModifiers() == InputEvent.BUTTON3_MASK)) {
                // shouldnt be here
            }

            if ( (mode == ViewJComponentBase.WIN_REGION) && (mouseEvent.getModifiers() == InputEvent.BUTTON3_MASK)) {
                // shouldnt be here
            }
                    ...
                    if (VOIs.VOIAt(i).isActive() && (VOIs.VOIAt(i).isVisible() == true)) {
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.LINE) {
                            ...
                            for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                                ...
                                if ( ((VOILine) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                        .nearLine(xS, yS)) {

                                    // if CTRL was held down, then print out the
                                    // Line's information to the
                                    // DATA window
                                    if ( (mouseEvent.getModifiers() & (InputEvent.CTRL_DOWN_MASK | InputEvent.CTRL_MASK)) != 0) {
                                        Vector3f startPt = null;
                                        Vector3f endPt = null;

                                        startPt = ((VOILine) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()]
                                                .elementAt(j))).elementAt(0);
                                        endPt = ((VOILine) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()]
                                                .elementAt(j))).elementAt(1);

                                        final double angle = ((VOILine) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()]
                                                .elementAt(j))).getAngle();
                                        ...
                                        if ( (compImage.getActiveImage().getFileInfo(0).getOrigin()[0] != 0)
                                            ...
                                            final String[] startValues = ViewJComponentEditImage
                                                    .getScannerPositionLabels(compImage.getActiveImage(), new Vector3f(
                                                            startPt.X, startPt.Y, compImage.getSlice()));
                                            final String[] endValues = ViewJComponentEditImage
                                                    .getScannerPositionLabels(compImage.getActiveImage(), new Vector3f(
                                                            endPt.X, endPt.Y, compImage.getSlice()));

                                            if ( (startValues != null) && (endValues != null)) {
                                                ViewUserInterface.getReference().setDataText(
                                                        "Line: " + tmpString2 + ", Position(start): " + startValues[0]
                                                                + " " + startValues[1] + " " + startValues[2]
                                                                + ", Position(end): " + endValues[0] + " "
                                                                + endValues[1] + " " + endValues[2] + "\n");
                                            } else {
                                                ViewUserInterface.getReference().setDataText(
                                                        "Line: " + tmpString2 + ", Position(start): "
                                                                + (int) (startPt.X) + " " + (int) (startPt.Y)
                                                                + ", Position(end): " + (int) (endPt.X) + " "
                                                                + (int) (endPt.Y) + "\n");

                                            }
                                        } else {
                                            ViewUserInterface.getReference().setDataText(
                                                    "Line: " + tmpString2 + ", Position(start): " + (int) (startPt.X)
                                                            + " " + (int) (startPt.Y) + ", Position(end): "
                                                            + (int) (endPt.X) + " " + (int) (endPt.Y) + "\n");
                                        }

                                        // do not pop up graph here, instead
                                        // return
                                        return;
                                    } else {
                                        graphLineVOI(i, j);
    ...
    public void mouseReleased(final MouseEvent mouseEvent) {
        ...
        final int xS = compImage.getScaledX(mouseEvent.getX()); // zoomed x. Used as
        // cursor
        final int yS = compImage.getScaledY(mouseEvent.getY()); // zoomed y. Used as
        // cursor
        final int xR = mouseEvent.getX();
        final int yR = mouseEvent.getY();
        ...
        // clicking with the right mouse button in a regular image frame updates
        // the image's
        // tri-image frame (if one is open) to show that point in all of the
        // components
        if ( (mouseEvent.getModifiers() & InputEvent.BUTTON2_MASK) != 0) {
            final ViewJFrameTriImage triFrame = compImage.getActiveImage().getTriImageFrame();
        ...
        if (mode == ViewJComponentBase.POINT_VOI) {
                ...
                if (isNewVoiNeeded(VOI.POINT)) { // create new VOI
                    ...
                    try {
                        ...
                        if (compImage.getActiveImage().getVOIs().size() > 0) {
                            colorID = ( (compImage.getActiveImage().getVOIs().lastElement())).getID() + 1;
                        }
                    ...
                    graphPointVOI(newPtVOI, ((VOIPoint) (VOIs.VOIAt(voiID).getCurves()[compImage.getSlice()]
                            .elementAt(0))), 0, false);

                    if ( ! ( (mouseEvent.isShiftDown() == true) || Preferences
                            .is(Preferences.PREF_CONTINUOUS_VOI_CONTOUR))) {
                        compImage.setCursorMode(ViewJComponentBase.DEFAULT);
                    }
                    ...
                    if ( ! ( (VOIs.VOIAt(i).getContourGraph() != null) && (compImage.getActiveImage().isColorImage() == true))) {
                        graphPointVOI(VOIs.VOIAt(i), ((VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()]
                                .elementAt(index - 1))), index - 1, false);
                    }
            ...
            } // end of if ((mouseEvent.getModifiers() &
            // mouseEvent.BUTTON1_MASK) != 0)
        } // end of else if (mode == POINT_VOI)
        else if (mode == ViewJComponentBase.POLYLINE_SLICE_VOI) {
            ...
            if ( (mouseEvent.getModifiers() & InputEvent.BUTTON1_MASK) != 0) {
                ...
                if (isNewVoiNeeded(VOI.POLYLINE_SLICE)) { // create new VOI
                    ...
                    try {
                        ...
                        if (compImage.getActiveImage().getNDims() > 2) {
                            newPolySliceVOI = new VOI((short) colorID, "Polyline_slice", compImage.getActiveImage()
                                    .getExtents()[2], VOI.POLYLINE_SLICE, -1.0f);
                        } else {
                    ...
                    allActive = true;
                    ( (newPolySliceVOI.getCurves()[compImage.getSlice()].elementAt(0))).setActive(true);

                    updateVOIColor(newPolySliceVOI.getColor(), newPolySliceVOI.getUID());
                    // ( (VOIPoint)
                    // (VOIs.VOIAt(voiID).getCurves()[compImage.getSlice()].elementAt(0))).setActive(true);

                    compImage.getActiveImage().notifyImageDisplayListeners();

                    // System.err.println("click count: " +
        ...
        } else if (mode == ViewJComponentBase.ANNOTATION) {
            ...
            if ( (mouseEvent.getModifiers() & InputEvent.BUTTON1_MASK) != 0) {
                ...
                // decide where to put the second point (arrow tip) so that it
                // is within bounds
                final int[] extents = compImage.getActiveImage().getExtents();
                ...
                // pop up a dialog that allows text input, color, and font
                // formatting
        ...
        } else if ( (mode == ViewJComponentBase.POLYLINE) || (mode == ViewJComponentBase.LIVEWIRE)) {
            return;
            // compImage.setMode(DEFAULT);
        } else if (mode == ViewJComponentBase.LEVELSET) {} else if (mode == ViewJComponentBase.RECTANGLE) {} else if (mode == ViewJComponentBase.RECTANGLE3D) {} else if (mode == ViewJComponentBase.ELLIPSE) {} else if (mode == ViewJComponentBase.LINE) {} else if (mode == ViewJComponentBase.PROTRACTOR) {} else if (mode == ViewJComponentBase.NEW_POINT) { // impossible
            // for LINE
            ...
            if ( ( (mouseEvent.isShiftDown() == true))) {
                ...
                // Handle differently for POLYLINE_SLICE type VOIs...insert new
                // VOIPoint structures
                if (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE_SLICE) {
            ...
            } else if (mouseEvent.getModifiers() == InputEvent.BUTTON1_MASK) {
                nVOI = VOIs.size();
                ...
                final int index = VOIs.VOIAt(i).getActiveContourIndex(compImage.getSlice());
                ...
                if (VOIs.VOIAt(i).isVisible()) {
                    ...
                    if ( ( (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR) || (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE))
                        ...
                        if ( (VOIs.VOIAt(i).getContourGraph() != null) && VOIs.VOIAt(i).getContourGraph().isVisible()) {
                            ...
                            int numPixels;
                            boolean foundCurve;
                            final float[] position = VOIs.VOIAt(i).getPosition();
                            final float[] intensity = VOIs.VOIAt(i).getIntensity();
                            final float[][] rgbPositions = VOIs.VOIAt(i).getRGBPositions();
                            final float[][] rgbIntensities = VOIs.VOIAt(i).getRGBIntensities();
        ...
        } else if (mode == ViewJComponentBase.DELETE_POINT) { // impossible
            // for LINE
            nVOI = VOIs.size();
            ...
            compImage.getActiveImage().notifyImageDisplayListeners();
            compImage.setCursorMode(ViewJComponentBase.MOVE_POINT);
        } else if ( (mode == ViewJComponentBase.PAINT_CAN) || (mode == ViewJComponentBase.PAINT_VASC)) {
            return;
        } else if (mode == ViewJComponentBase.MOVE) {
            final Graphics g = compImage.getGraphics();
            nVOI = VOIs.size();
            ...
            for (i = 0; i < nVOI; i++) {
                ...
                for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                    ...
                    selectedCurve = (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j));

                    if (selectedCurve instanceof VOIPoint) {

                        if (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE_SLICE) {
                            if (VOIs.VOIAt(i).nearLine(xS, yS, compImage.getSlice())
                                    || ((VOIPoint) selectedCurve).nearPoint(xR, yR, compImage.getZoomX(), compImage
                                            .getResolutionX(), compImage.getResolutionY())) {
                                VOIs.VOIAt(i).setActive(true);
                                VOIs.VOIAt(i).setAllActive(true);
                        ...
                        } else if ( ((VOIPoint) selectedCurve).nearPoint(xR, yR, compImage.getZoomX(), compImage
                                .getResolutionX(), compImage.getResolutionY())) {

                            // points are not true curves, but we want to check
                            // if we
                            // released mouse over it. we'll at least set the
                            // point active.
                            if (mouseEvent.isShiftDown()) {
                                allActive = true;

                                // if true set all points in VOI active - move
                                // all points
                                VOIs.VOIAt(i).setAllActive(true);
                                updateVOIColor(VOIs.VOIAt(i).getColor(), VOIs.VOIAt(i).getUID());
                                voiID = VOIs.VOIAt(i).getID();
                                ...
                                final Vector3f pt = ((VOIPoint) (selectedCurve)).exportPoint();
                        ...
                        if (mouseEvent.getClickCount() == 2) {
                            new JDialogAnnotation(compImage.getActiveImage(), VOIs.VOIAt(i), compImage.getSlice(),
                                    true, false);
                        }
                        ...
                        if (mousePressIsShiftDown) {
                            ...
                            // and we are done with this VOI. Skip the rest of
                            // the curves
                            j = VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size();
                        } else {
                            allActive = false;

                            // toggle isActive (or if VOI was dragged, leave
                            // active)
                            final boolean toggle = !selectedCurve.isActive() || wasDragging
                            ...
                            if ( !mouseEvent.isControlDown() && toggle) {
                                ...
                                for (k = 0; k < nVOI; k++) {
                                    VOIs.VOIAt(k).setAllActive(false); // deactivate
                                    // all
                                    // VOIs
                                }
                            ...
                            // VOIs.VOIAt( i ).setActive( toggle ); // set the
                            // current active // move single contour
                            // updateVOIColor( VOIs.VOIAt( i ).getColor(),
                            // VOIs.VOIAt( i ).getUID() );

                            selectedCurve.setActive(toggle); // set its curve to
                            // active (for
                            // display)
                        ...
                        fireVOISelectionChange(VOIs.VOIAt(i), selectedCurve);
                    } else if ( !mouseEvent.isControlDown() && !mouseEvent.isPopupTrigger()) { // selected curve
                        // was not
            ...
            compImage.getGraphics().dispose();
            compImage.getActiveImage().notifyImageDisplayListeners();
        } else if (mode == ViewJComponentBase.MOVE_POINT) {
            ...
            for (i = 0; i < nVOI; i++) {
                ...
                if ( (VOIs.VOIAt(i).isActive() && (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR))
                    ...
                    for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                        ...
                        if ( ( (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).isActive()) {
                            final Vector3f pt = ( (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                    .getActivePt();
                            compImage.setPixelInformationAtLocation((int) pt.X, (int) pt.Y);
            ...
            compImage.getActiveImage().notifyImageDisplayListeners();
        } else if (mode == ViewJComponentBase.QUICK_LUT) {
     ...
     */
    public void paintSolidVOIinImage(final Graphics graphics) {
        final ViewVOIVector VOIs = compImage.getActiveImage().getVOIs();
    ...
    public void pasteVOI() {
        ...
        final ViewVOIVector clippedVOIs = ViewUserInterface.getReference().getClippedVOIs();
        final int numClipped = clippedVOIs.size();
        ...
        for (int k = 0; k < numClipped; k++) {
            ...
            try {
                ...
                // if the VOI is from 3D image and Preferences.PREF_VOI_LPS_SAVE
                // is active (scanner)
                if (isFrom2D == false && doLPS) {
                    final Vector[] curves = newVOI.getCurves();
                    final Vector[] newCurves = new Vector[compImage.getActiveImage().getExtents()[2]];
                    ...
                    VOIBase tempBase;
                    int numCurves = 0;
                    final Vector scannerVector = (Vector) scannerVectors.elementAt(k);
                    int scannerIndex = 0;
                    Vector3f inPoint = null;
                    final Vector3f outPoint = new Vector3f();

                    int slice = -1;

                    for (final Vector element : curves) {
                        numCurves = element.size();

                        int numPoints = 0;

                        for (int j = 0; j < numCurves; j++) {
                            tempBase = (VOIBase) element.elementAt(j);
                            numPoints = tempBase.size();

                            // System.err.println("number of points: " +
                            // numPoints);
                            slice = -1;
                            ...
                            for (int c = 0; c < numPoints; c++, scannerIndex++) {
                                ...
                                // System.err.println("In point (scanner): " +
                                // inPoint);
                                ...
                                (tempBase.elementAt(c)).X = outPoint.X;
                                (tempBase.elementAt(c)).Y = outPoint.Y;
                                (tempBase.elementAt(c)).Z = outPoint.Z;

                                // System.err.println("Out point is: " +
                                // outPoint);

                                if ( (slice != -1) && (slice != MipavMath.round(outPoint.Z))) {

                                    // error...shouldnt be different slices
                                    // System.err.println("ERROR: slice is " +
                                    // slice + ", while outPoint.Z is " +
                                    // MipavMath.round(outPoint.Z));
                                    MipavUtil
                                            .displayError("VOI's contour points do not fall on the same slices: aborting");
            ...
            if ( (imageXExt <= (x[1] - x[0])) || (imageYExt <= (y[1] - y[0])) || (imageXExt <= x[0])
                    || (imageXExt <= x[1]) || (imageYExt <= y[0]) || (imageYExt <= y[1])) { // checks
                // to
                // make
                // sure
                // if
                // voi
                // can fit
                MipavUtil.displayError("Cannot paste VOI : Out of image bounds."); // in
                // image
                // in
                // x
                // and
            ...
            if ( !doLPS) {
                final int currentSlice = compImage.getSlice();
                final int zDif = (int) (z[1] - z[0]) + 1;
                if (zDif > 1) {
            ...
            do {
                ...
                for (int i = 0; i < compImage.getActiveImage().getVOIs().size(); i++) {
                    ...
                    if (ID == (compImage.getActiveImage().getVOIs().elementAt(i)).getID()) {
                        ID++;
                        test = 0;
                    }
                }
            ...
            if (compImage.getActiveImage().getExtents().length > 2) {
                zExt = compImage.getActiveImage().getExtents()[2]; // gets the Z
                // dimensions
                // of the
                // active
                // image
            ...
            final float hue = (float) ( ( ( (ID) * 35) % 360) / 360.0);
            ...
            if (doLPS) {
                ...
                if ( (newVOI.getCurveType() == VOI.POLYLINE_SLICE)) {
                    ...
                    Vector3f oldPt;
                    final float[] xt = new float[1];
                    final float[] yt = new float[1];
                    final float[] zt = new float[1];

                    final Vector polyVector = newVOI.getSortedPolyPoints();

                    final int adjZ = (int) ((VOI.PolyPointHolder) polyVector.elementAt(0)).getPoint().Z;
                    final int diff = currentSlice - adjZ;
                    ...
                    final VOIText vText = (VOIText) newVOI.getCurves()[(int) z[0]].elementAt(0);
                    final VOIText newText = new VOIText();
                    ...
                    final Vector3f oldPt1 = vText.elementAt(0);
                    final Vector3f oldPt2 = vText.elementAt(1);

                    final Vector3f pt1 = new Vector3f(oldPt1.X, oldPt1.Y, currentSlice);
                    final Vector3f pt2 = new Vector3f(oldPt2.X, oldPt2.Y, currentSlice);
                    ...
                    for (int cSlice = (int) z[0]; cSlice <= z[1]; cSlice++, currentSlice++) {
                        // System.err.println("currentSlice: " + currentSlice +
                        // ", cSlice: " + cSlice + ", tCount: " +
                        // (currentSlice));
     ...
     */
    public boolean propVOI(final int direction, final boolean active) {
        int i, j;
        int nVOI;
        int nCurves;
        Polygon[] gons = null;
        ...
        if ( (compImage.getSlice() < (compImage.getActiveImage().getExtents()[2] - 1)) && (direction > 0)) { // Propagate
                                                                                                                // up
            nVOI = VOIs.size();
            ...
            if ( !doPoint) {
                ...
                if (active) {
                    ...
                    if (VOIs.VOIAt(i).getLevel() == VOI.NOT_A_LEVELSET) {
                        MipavUtil.displayError("You can only use active propogation with a levelset VOI.");

                        return false;
                    } else {
                        final RubberbandLevelSet rubber = new RubberbandLevelSet(compImage);

                        removeMouseListener(rubber);
                        removeMouseMotionListener(rubber);
                        compImage.show(compImage.getTimeSlice(), compImage.getSlice() + 1, null, null, true, compImage
                                .getInterpMode());

                        final Polygon gon = rubber.findNextLevelSet(VOIs.VOIAt(i).getLevel(), gons[j]);
                        ...
                        if (gon == null) {
                            MipavUtil
                                    .displayError("Active propogation returned no viable contour.\nUse regular propogation.");
                        ...
                        ((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice() + 1].lastElement()))
                                .setActive(true);
        ...
        else if ( (compImage.getSlice() > 0) && (direction < 0)) { // propagate
            // down
            nVOI = VOIs.size();
                        ...
                        if (compImage.getActiveImage().isColorImage() == true) {
                            ...
                            for (int s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                ...
                                for (int c = 0; c < 3; c++) {
                                    ptRGBPositions[c][s] = s;
                                    ptRGBIntensities[c][s] = compImage.getActiveImage().getFloat(
                                            (int) ( (4 * ( (s * compImage.getActiveImage().getSliceSize())
                                                    + (pt.Y * compImage.getActiveImage().getExtents()[0]) + pt.X))
                                                    + c + 1));
                                }
                            }
                            ...
                            // VOIs.VOIAt(i).getContourGraph().update(ptPosition,
                            // ptIntensity, j);
                            graphPointVOI(VOIs.VOIAt(i), (VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()]
                                    .elementAt(j)), j, false);
                        }
     ...
     * @param listener DOCUMENT ME!
     */
    public void removeVOIUpdateListener(final UpdateVOISelectionListener listener) {
     ...
     */
    public void selectAllVOIs(final boolean doSelect) {
        int i;
        int nVOI;
        final ViewVOIVector VOIs = compImage.getActiveImage().getVOIs();
     ...
     */
    public void setActiveVOI_ID(final int active) {
        ...
        if ( (compImage.getActiveImage().getNDims() == 4)
            ...
            if (frameRefTimeString != null) {
                try {
                    ...
                    Preferences.debug("Number format excepton from frame Reference Time String = " + frameRefTimeString
                            + "\n");
                }
     ...
     */
    public void setGridLabelingOn(final boolean doLabel) {
     ...
     */
    public void setGridLabelOrientation(final boolean or) {
     ...
     */
    public void setGridOverlay(final boolean flag) {
        gridOverlayOn = flag;
    }
     ...
     */
    public void setGridSpacingX(final float spacing) {
     ...
     * @param spacing float new grid spacing
     */
    public void setGridSpacingY(final float spacing) {
     ...
     * @param buf float[]
     */
    public void setImageGraphBuffer(final float[] buf) {
    ...
    public void setMode(final int mode) {
        ...
        final boolean isImageFrame = compImage.getFrame() instanceof ViewJFrameImage;
        ...
        switch (mode) {
            ...
            case ViewJComponentBase.SELECT:
                rubberband = rbRect;
                rubberband.setActive(true);
                compImage.setCursor(MipavUtil.defaultCursor);
                break;

            case ViewJComponentBase.POINT_VOI:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.RECTANGLE:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.ELLIPSE:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.RECTANGLE3D:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.NEW_VOI:
                compImage.setCursor(compImage.crosshairCursor);
                if (isImageFrame) {
                    compImage.getFrame().getControls().getTools().setPointerSelected();
                }
            ...
            case ViewJComponentBase.POLYLINE:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.LIVEWIRE:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.LEVELSET:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.LINE:
                ...
                compImage.setCursor(compImage.crosshairCursor);
                break;
            case ViewJComponentBase.SPLIT_VOI:
                ((RubberbandLine) rbLine).setSplit(true);
                rubberband = rbLine;
                rubberband.setActive(true);
                compImage.setCursor(compImage.crosshairCursor);
                break;
            case ViewJComponentBase.PROTRACTOR:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.MOVE:
                compImage.setCursor(MipavUtil.moveCursor);
                break;

            case ViewJComponentBase.MOVE_POINT:
                compImage.setCursor(compImage.crosshairCursor);
                break;

            case ViewJComponentBase.NEW_POINT:
                compImage.setCursor(MipavUtil.addPointCursor);
                break;

            case ViewJComponentBase.POLYLINE_SLICE_VOI:
                if (isImageFrame) {
            ...
            case ViewJComponentBase.DELETE_POINT:
                compImage.setCursor(compImage.crosshairCursor);
                break;
            ...
            case ViewJComponentBase.RETRACE:
                compImage.setCursor(compImage.crosshairCursor);
                break;
            ...
            case ViewJComponentBase.PAINT_CAN:
                compImage.setCursor(compImage.crosshairCursor);
                break;

            case ViewJComponentBase.PAINT_VASC:
                compImage.setCursor(compImage.crosshairCursor);
                break;

            case ViewJComponentBase.DROPPER_PAINT:
                compImage.setCursor(compImage.crosshairCursor);
                break;

            case ViewJComponentBase.ERASER_PAINT:
                compImage.setCursor(MipavUtil.blankCursor);
                compImage.getFrame().requestFocus();
                break;

            case ViewJComponentBase.MAG_REGION:
                compImage.setCursor(MipavUtil.magRegionCursor);
                break;

            case ViewJComponentBase.WIN_REGION:
                compImage.setCursor(MipavUtil.magRegionCursor);
                break;

            case ViewJComponentBase.QUICK_LUT:
                rubberband = rbRectQuick;
                rubberband.setActive(true);
                compImage.setCursor(MipavUtil.quickLUTcursor);
                break;

            case ViewJComponentBase.ANNOTATION:
            ...
            case ViewJComponentBase.ZOOMING_IN:

                Toolkit toolkit = Toolkit.getDefaultToolkit();
                final Cursor magnifyCursor = toolkit.createCustomCursor(MipavUtil.getIcon("zoomin.gif").getImage(),
                        new Point(10, 10), "zoomin");

                compImage.setCursor(magnifyCursor);
                break;

            case ViewJComponentBase.ZOOMING_OUT:
                toolkit = Toolkit.getDefaultToolkit();

                final Cursor unmagnifyCursor = toolkit.createCustomCursor(MipavUtil.getIcon("zoomout.gif").getImage(),
     ...
     */
    public void setModeLivewire(final int selection) {
        this.mode = ViewJComponentBase.LIVEWIRE;
        rubberband.setActive(false);
     ...
     */
    public void setModeLivewire(final float gradSigma, final float edgeLap, final float gradWeight,
            final float kernWeight, final boolean smoothVOIFlag) {
        this.mode = ViewJComponentBase.LIVEWIRE;
        rubberband.setActive(false);
        rbLivewire = new RubberbandLivewire(this, new float[] {gradSigma, gradSigma}, new float[] {edgeLap, edgeLap},
                kernWeight, gradWeight, smoothVOIFlag);
        rubberband = rbLivewire;
        rubberband.setActive(true);
        compImage.setCursor(compImage.crosshairCursor);
    }
     ...
     */
    public void setOverlay(final boolean flag) {
        overlayOn = flag;
    }
     ...
     */
    public void setPresetHue(final float presetHue) {
     ...
     */
    public void setVOI_ID(final int ID) {
        voiID = ID;
    }
     ...
     */
    public void setVOI_IDs(final int ID, final int UID) {
        voiID = ID;
    ...
    public void showColorDialog() {
        ...
        for (i = 0; i < nVOI; i++) {
            ...
            if ( (VOIs.VOIAt(i).isActive() == true)
                    && ( (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR)
                            || (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE)
                            || (VOIs.VOIAt(i).getCurveType() == VOI.POINT)
                            || (VOIs.VOIAt(i).getCurveType() == VOI.LINE) || (VOIs.VOIAt(i).getCurveType() == VOI.PROTRACTOR))) {
                break;
        ...
        colorChooser = new ViewJColorChooser(new Frame(), "Pick VOI color", new OKVOIColorListener(VOIs.VOIAt(i)),
                new ActionListener() {
    ...
    /**
     * Function (moved out from vjframeimage, for use by several classes) that determines if a compatible (current) voi
     * is present (otherwise need a new one)
     * 
     * @param VOIs
     * @param type
     * @param lastVOI_UID
     ...
     * @return
     */
    public boolean checkForVOICompatibility(final VOIVector VOIs, final int type, final ViewControlsImage controls) {

        // System.err.println("Type is: " + type);
        final int numVOI = VOIs.size();
        int lastType = -1;

        if (numVOI == 0) {
            return true;
        } else if (numVOI == 1) {
            lastType = ( (VOIs.elementAt(0))).getCurveType();
        } else {

            for (int i = 0; i < numVOI; i++) {

                if ( ( (VOIs.elementAt(i))).getUID() == lastVOI_UID) {
                    lastType = ( (VOIs.elementAt(i))).getCurveType();
        ...
        switch (type) {
            ...
            case VOI.POLYLINE:
                if ( (lastType != VOI.CONTOUR) && (lastType != VOI.POLYLINE)) {
                    final int id = ( ( (VOIs.lastElement())).getID() + 1);
     ...
     * @param voi DOCUMENT ME!
     */
    protected void fireVOISelectionChange(final VOI voi) {
     ...
     */
    protected void showGridOverlay(final Graphics g) {
        g.setColor(gridColor);

        final Insets insets = compImage.getFrame().getInsets();
        final int rightOffset = compImage.getBounds().width - insets.left;
        final int bottomOffset = compImage.getBounds().height - insets.bottom;
        float offset = 0;

        final int xDim = compImage.getActiveImage().getExtents()[0];
        final int yDim = compImage.getActiveImage().getExtents()[0];

        final float resX = compImage.getActiveImage().getResolutions(0)[0];
        final float resY = compImage.getActiveImage().getResolutions(0)[1];

        final float numVertical = (xDim * resX) / gridSpacingX;
        final float numHorizontal = (yDim * resY) / gridSpacingY;

        final float verticalSpacing = (xDim / numVertical) * compImage.getZoomX();
        final float horizontalSpacing = (yDim / numHorizontal) * compImage.getZoomY();
        ...
        if (gridLabelingOn) {
            ...
            final float xPadding = 2 + (2 * compImage.getZoomX());
            final float yPadding = 15 + (2 * compImage.getZoomY());
            ...
            for (i = 0; i < numHorizontal; i++, xOffset += horizontalSpacing) {
                ...
                for (j = 0, yOffset = 0; j < numVertical; j++, yOffset += verticalSpacing) {
                    ...
                    if ( (i == 0) || (j == 0)) {
                        ...
                        g.drawString(gridLabel, MipavMath.round(yOffset + xPadding), MipavMath
     ...
     */
    protected void showOverlay(final Graphics g) {
        ...
        if (compImage.getActiveImage().getFileInfo(0) instanceof FileInfoDicom) {
            ...
            final String[] dicomKeys = Preferences.getOverlays(true);
            ...
            final Insets insets = compImage.getFrame().getInsets();
            final int rightOffset = compImage.getBounds().width - insets.left;
            final int bottomOffset = compImage.getBounds().height - insets.bottom - 15;
             ...
             * compImage.drawStringBW(String.valueOf(values[0].charAt(i)), g, 5, (getHeight() / 2) - ((index - i) *
             * 15)); }
             * 
             * index = values[1].length() / 2;
             * 
             * for (int i = 0; i < values[1].length(); i++) {
             * compImage.drawStringBW(String.valueOf(values[1].charAt(i)), g, rightOffset - 10, (getHeight() / 2) -
             * ((index - i) * 15)); }
             * 
            ...
            final String[] attribs = Preferences.getOverlays(false);
     ...
     */
    protected void updateVOIColor(final Color voiColor, final int voiUID) {
     ...
     */
    protected void updateVOIColor(final int id, final int voiUID) {
     ...
     */
    protected void setLastVOI_UID(final int voiUID) {
        this.lastVOI_UID = voiUID;
    }
     ...
     */
    private String buildOverlayStrings(final FileInfoBase inf, final String name, final String attribString) {
        ...
        if (inf instanceof FileInfoDicom) {
            ...
            try {
                ...
                final Object val = ((FileInfoDicom) inf).getTagTable().getValue(attribString);
            ...
            final String[] atts = JDialogOverlay.attribStr;
     ...
     */
    private void cycleVOI(final int keyCode) {
        int end = 0;
        int size = 0;
        ...
        final boolean contourOnly = ( (keyCode == KeyEvent.VK_LEFT) || (keyCode == KeyEvent.VK_RIGHT));
            ...
            if (VOIs.VOIAt(i).isActive()) {
                ...
                if (contourOnly) {
                    ...
                    if (allActive) {
                        ...
                        // sketchy : ( (VOIBase)
                        // (VOIs.VOIAt(i).getCurves()[0].elementAt(0))).setActive(true);
                        compImage.getActiveImage().notifyImageDisplayListeners();
                    } else {
                        ...
                        for (int sl = 0; sl < end; sl++) {
                            ...
                            for (int j = 0; j < size; j++) {
                                ...
                                if ( ( (VOIs.VOIAt(i).getCurves()[sl].elementAt(j))).isActive()) {
                                    ( (VOIs.VOIAt(i).getCurves()[sl].elementAt(j))).setActive(false);
                                    ...
                                    ( (VOIs.VOIAt(i).getCurves()[sl].elementAt(index))).setActive(true);

                                    final Vector3f pt = ( (VOIs.VOIAt(i).getCurves()[sl].elementAt(index)))
                                            .getActivePt();
                ...
                // end if contourOnly
                    ...
                    for (int sl = 0; sl < end; sl++) {
                        ...
                        if (size > 0) {
                            ( (VOIs.VOIAt(index).getCurves()[sl].elementAt(0))).setActive(true);

                            final Vector3f pt = ( (VOIs.VOIAt(index).getCurves()[sl].elementAt(0))).getActivePt();
     ...
     */
    private void graphLineVOI(final int voiIndex, final int contourIndex) {
        float[] lineX = null;
        float[] lineY = null;
        float[] lineZ = null;
        lineX = new float[2];
        ...
        if (compImage.getActiveImage().isColorImage() == true) {
            ...
            for (int c = 0; c < 3; c++) {
                final int pt = ((VOILine) (VOIs.VOIAt(voiIndex).getCurves()[compImage.getSlice()]
                        .elementAt(contourIndex))).findPositionAndIntensityRGB(rgbPositions[c], rgbIntensities[c], c,
                        compImage.getActiveImageBuffer(), compImage.getActiveImage().getResolutions(
                                compImage.getSlice()), compImage.getActiveImage().getExtents()[0], compImage
                                .getActiveImage().getExtents()[1]);
            ...
            if (VOIs.VOIAt(voiIndex).getContourGraph() == null) {
                final ViewJFrameGraph contourGraph = new ViewJFrameGraph(rgbPos, rgbInten, "Intensity Graph", VOIs
                        .VOIAt(voiIndex), FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage()
                        .getFileInfo(0).getUnitsOfMeasure(0)));
                ...
                VOIs.VOIAt(voiIndex).getContourGraph().setUnitsInLabel(
                        FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage().getFileInfo(0)
                                .getUnitsOfMeasure(0)));
            ...
            final int pt = VOIs.VOIAt(voiIndex).findPositionAndIntensity(compImage.getSlice(), contourIndex, position,
                    intensity, compImage.getActiveImageBuffer(),
                    compImage.getActiveImage().getFileInfo()[compImage.getSlice()].getResolutions(),
                    compImage.getActiveImage().getExtents()[0], compImage.getActiveImage().getExtents()[1], xyCoords);
            final float[] pos = new float[pt];
            final float[] inten = new float[pt];
            final int[][] xyC = new int[pt][2];
            ...
            if (VOIs.VOIAt(voiIndex).getContourGraph() == null) {
                lineGraph = new ViewJFrameGraph(pos, inten, "Line VOI Graph", VOIs.VOIAt(voiIndex), FileInfoBase
                        .getUnitsOfMeasureAbbrevStr(compImage.getActiveImage().getFileInfo(0).getUnitsOfMeasure(0)),
                        xyC);
                ...
                VOIs.VOIAt(voiIndex).getContourGraph().setUnitsInLabel(
                        FileInfoBase.getUnitsOfMeasureAbbrevStr(compImage.getActiveImage().getFileInfo(0)
                                .getUnitsOfMeasure(0)));
                VOIs.VOIAt(voiIndex).getContourGraph().replaceFunction(pos, inten, xyC, VOIs.VOIAt(voiIndex),
                        contourIndex);
            }

            final boolean is2D = compImage.getImageA().is2DImage();

            ViewUserInterface.getReference().setDataText("Line\tmin \tmax \ttotal \tmean \tstandard deviation " + "\n");
            ViewUserInterface.getReference().setDataText(
                    "\t" + min + "\t" + max + "\t" + totalInten + "\t" + meanInten + "\t" + stdDevInten + "\n");
            /*
             * ViewUserInterface.getReference().setDataText( "Line\tcoordinates \tposition on curve \tintensity " +
             * "\n"); for(int i=0;i<pt;i++) { String coords = xyCoords[i][0] + "," + xyCoords[i][1]; if(!is2D) { coords =
             * coords + "," + zSlice; }
             * 
             * ViewUserInterface.getReference().setDataText( "\t" + coords + "\t" + pos[i] + "\t" + intensity[i] +
             * "\n");
             * 
             *  }
             */
     ...
     */
    private void handleVOIActivePt(final int keyCode, final boolean doMove) {
        int end = 0;
        ...
        for (int i = 0; i < nVOI; i++) {
            ...
            if (VOIs.VOIAt(i).isActive() && VOIs.VOIAt(i).isVisible()) {
                ...
                if ( ( (curveType == VOI.CONTOUR) || (curveType == VOI.POLYLINE) || (curveType == VOI.LINE)
                    ...
                    // System.err.println("Doin poly stuff...all active is: " +
                    // allActive);
                    if (allActive) {
                        ...
                        for (int sl = 0; sl < end; sl++) {
                            ...
                            for (int j = 0; j < VOIs.VOIAt(i).getCurves()[sl].size(); j++) {
                                ...
                                if ( ( (VOIs.VOIAt(i).getCurves()[sl].elementAt(j))).isActive()) {
                                    ...
                                    if (doMove) {
                                        ( (VOIs.VOIAt(i).getCurves()[sl].elementAt(j))).moveActivePt(keyCode, xDim,
                                                yDim);
                                    } else {
                                        ( (VOIs.VOIAt(i).getCurves()[sl].elementAt(j))).cycleActivePt(keyCode);
                                    }

                                    // show the active point's new (or dif
                                    // active pt) location

                                    final Vector3f pt = ( (VOIs.VOIAt(i).getCurves()[sl].elementAt(j))).getActivePt();
     ...
     */
    private void moveVOI(final int keyCode) {
        ...
        for (int i = 0; i < nVOI; i++) {
            ...
            if (VOIs.VOIAt(i).isActive() && VOIs.VOIAt(i).isVisible()) {
                ...
                if ( ( (curveType == VOI.CONTOUR) || (curveType == VOI.POLYLINE) || (curveType == VOI.LINE)
                        || (curveType == VOI.PROTRACTOR) || (curveType == VOI.POINT) || (curveType == VOI.POLYLINE_SLICE))) {
     ...
     */
    private Polygon zoomPolygon(final Polygon gon, final float zoomX, final float zoomY) {
    ...
    private class OKVOIColorListener implements ActionListener {
        ...
        public OKVOIColorListener(final VOI voi) {
            super();
            this.voi = voi;
        }
