                ...
                if (wntun) {
                   ...
                   if (lwork >= n*n+Math.max(4*n, bdspac)) {
                     ...
                     for (i = 1; i <= m; i += ldwrku) {
                      ...
                      // Compute A=Q*R
                      // (Workspace: need 2*n, prefer n+n*nb)
                      workiwork = new doubl[Math.max(4*n, Math.max(1, lwork-iwork+1))];
                   ...
                   if (wntvn) {
                      ...
                      if (lwork >= n*n+Math.max(4*n, bdspac)) {
                         ...
                         gi.dbdsqr('U', n, 0, n, 0, s, workie, arrDum,
                                   1, arr, ldwrkr, arrDum, 1,
                                   workiwork, info);
