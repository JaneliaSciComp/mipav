...
public class AlgorithmQuinticLagrangian extends AlgorithmBase {
     ...
     */
    public double quinticLagrangian2D(float x, float y) {
     ...
     * @return  the quintic Lagrangian interpolated data point
     */
    public double[] quinticLagrangian2DC(float x, float y) {
     ...
     */
    public final double quinticLagrangian3D(float x, float y, float z) {
     ...
     * @return  the quinticLagrangian3D interpolated data point
     */
    public double[] quinticLagrangian3DC(float x, float y, float z) {
