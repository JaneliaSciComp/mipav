package gov.nih.mipav.model.algorithms.asc;
    ...
    /**
    * A small class for storing the triangles of the vertex-triangle mesh that
    * represents isosurfaces.  The main support is for hash tables of triangles
    * that are used to eliminate duplicate triangles from a mesh.
    */
