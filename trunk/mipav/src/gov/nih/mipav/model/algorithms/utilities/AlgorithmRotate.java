    ...
    private void calcInPlace() {
        ...
        if ((srcImage.getFileInfo(0).getFileFormat() != FileUtility.DICOM) &&
            ...
            for (int i = 0; i < newNiftiInfo.length; i++) {
                ...
                newNiftiInfo[i].setAxisOrientation(newAxisOrients);
                newNiftiInfo[i].setResolutions(newResolutions);
            ...
            if (srcImage.getNDims() >= 3) {
                ...
                if ((newAxisOrients != null) && (newAxisOrients[0] != FileInfoBase.ORI_UNKNOWN_TYPE) &&
                    ...
                    niftiMatrix.set(0, 0, 0.0);
                    niftiMatrix.set(0, 1, 0.0);
                    niftiMatrix.set(0, 2, 0.0);
                    niftiMatrix.set(1, 0, 0.0);
                    niftiMatrix.set(1, 1, 0.0);
                    niftiMatrix.set(1, 2, 0.0);
                    niftiMatrix.set(2, 0, 0.0);
                    niftiMatrix.set(2, 1, 0.0);
                    niftiMatrix.set(2, 2, 0.0);

                    switch (newAxisOrients[0]) {

                        case FileInfoBase.ORI_R2L_TYPE:
                            niftiMatrix.set(0, 0, newResolutions[0]);
                            break;
                        ...
                        case FileInfoBase.ORI_A2P_TYPE:
                            niftiMatrix.set(1, 0, newResolutions[0]);
                            break;
                        ...
                        case FileInfoBase.ORI_I2S_TYPE:
                            niftiMatrix.set(2, 0, newResolutions[0]);
                            break;
                    ...
                    switch (newAxisOrients[1]) {

                        case FileInfoBase.ORI_R2L_TYPE:
                            niftiMatrix.set(0, 1, newResolutions[1]);
                            break;
                        ...
                        case FileInfoBase.ORI_A2P_TYPE:
                            niftiMatrix.set(1, 1, newResolutions[1]);
                            break;
                        ...
                        case FileInfoBase.ORI_I2S_TYPE:
                            niftiMatrix.set(2, 1, newResolutions[1]);
                            break;
                    ...
                    switch (newAxisOrients[2]) {
                        ...
                        case FileInfoBase.ORI_R2L_TYPE:
                            niftiMatrix.set(0, 2, newResolutions[2]);
                            break;
                        ...
                        case FileInfoBase.ORI_A2P_TYPE:
                            niftiMatrix.set(1, 2, newResolutions[2]);
                            break;
                        ...
                        case FileInfoBase.ORI_I2S_TYPE:
                            niftiMatrix.set(2, 2, newResolutions[2]);
                            break;
