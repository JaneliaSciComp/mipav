...
public class OpenCLAlgorithmGradientMagnitude extends OpenCLAlgorithmBase {
     ...
     */
    public OpenCLAlgorithmGradientMagnitude(ModelImage srcImg, float[] sigmas, boolean maskFlag, boolean img25D) {
     ...
     *                   images disregard this flag.
     */
    public OpenCLAlgorithmGradientMagnitude(ModelImage destImg, ModelImage srcImg, float[] sigmas, boolean maskFlag,
                                      boolean img25D) {
    ...
    private void gradientMagnitude25D()
	{
		...
		String source = readFile("src/kernels/GradientMagnitude.cl");
