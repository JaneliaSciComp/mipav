...
//  ~ Methods --------------------------------------------------------------------------------------------------------
    ...
    private void complexArgument() {
        ...
        double imagZC0[] = new double[1];
        double realZR0[] = new double[1];
        ...
        double w0 = 0.0;
        int ierr[] = new int[1];
        double realTemp[] = new double[1];
        double imagTemp[] = new double[1];
        ...
        if ((a0 == 0.0) || (a == 0.0) || (b == 0.0)) {
            ...
            imagZR[0] = 0.0;
            for (k = 1; k <= nm; k++) {
                zmlt(realZR[0], imagZR[0], (c-a+k-1.0)*(c-b+k-1.0)/(k*(c+k-1.0)), 0.0, realZR, imagZR);
                zmlt(realZR[0], imagZR[0], realZ, imagZ, realZR, imagZR);
                realResult[0] = realResult[0] + realZR[0];
                imagResult[0] = imagResult[0] + imagZR[0];
            } // for (k = 1; k <= nm; k++)
            ...
            if (x < 0.0) {
               ...
               imagZR0[0] = 0.0;
               for (k = 1; k <= 500; k++) {
                   zmlt(realZR0[0],imagZR0[0],(a+k-1.0)*(c-b+k-1.0)/(k*(c+k-1.0)),0.0,realZR0,imagZR0);
               ...
               zmlt(realZC0[0],imagZC0[0],realResult[0],imagResult[0],realResult,imagResult);
                ...
                if (Math.abs(c-a-b-mcab) < eps) {
                    ...
                    for (k = 1; k <= 500; k++) {
                        ...
                        zmlt(realZR0[0],imagZR0[0],1.0-realZ,-imagZ,realZR0,imagZR0);
                        zmlt(realZR1[0],imagZR1[0],(c-a+k-1)*(c-b+k-1)/(k*(c-a-b+k)),0.0,realZR1,imagZR1);
                        zmlt(realZR1[0],imagZR1[0],1.0-realZ,-imagZ,realZR1,imagZR1);
