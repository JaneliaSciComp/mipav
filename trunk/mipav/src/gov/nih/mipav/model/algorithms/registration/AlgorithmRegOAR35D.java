...
public class AlgorithmRegOAR35D extends AlgorithmBase {
    ...
    public void runAlgorithm() {
        ...
        for (int m = 0; m < endIndex; m++) {
            ...
            if (!fastMode) {
                ...
                if (calcCOG == true) {
                    Point3Dd cog = calculateCenterOfMass3D(simpleInput_1, simpleWeightI_1, doColor);
                    Point3Dd cogR = calculateCenterOfMass3D(simpleRef_1, simpleWeightR_1, doColor);
    ...
    private Vector[] levelEight(ModelSimpleImage ref, ModelSimpleImage input) {
        ...
        for (int i = 0; (i < coarseNum) && !threadStopped; i++) {
            ...
            for (int j = 0; (j < coarseNum) && !threadStopped; j++) {

                for (int k = 0; (k < coarseNum) && !threadStopped; k++) {
