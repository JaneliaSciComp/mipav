...
public class AlgorithmSimplexOpt extends AlgorithmBase {
    ...
    public AlgorithmSimplexOpt (double p[][], double functEvals[], int nDim,
                                AlgorithmOptimizeFunctionBase func){
    ...
    private final void swap(double a, double b) {
        double temp;
    ...
    */
    ...
    /**
    *   amotry
    *   extrapolates by factor fac through face of simplex across from
    *   high point, tries it, and replaces high point if new point is better.
    */
