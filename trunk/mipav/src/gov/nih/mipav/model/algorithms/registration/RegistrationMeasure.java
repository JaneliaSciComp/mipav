...
/**
 * This is an abstract class used to compute the measure of registration
 * between the specified target image and a registered source image.
 * This class create the registered source image to have the same dimensions
 * as the input target image.  The measure calculations do not require
 * the specification of the number of dimensions.
 */
public abstract class RegistrationMeasure {
    ...
    public void setImages(ModelSimpleImage kImageSrc, ModelSimpleImage kImageTrg) {
        ...
        m_kImageReg = new ModelSimpleImage(kImageTrg.extents,
                                           kImageTrg.resolutions);
     ...
     * @return ModelSimpleImage Information and data for the registered source
     * image values.  The size of this array is the same properties as the
     * target image.
     */
     ...
     * @return double Error measure value.  Range of value depends
     * on paricular implementation based on type of error measure.
     */
    ...
    // Has the same number of samples as does the target image.
