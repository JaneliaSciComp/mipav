...
public abstract class NLConstrainedEngineEP {
     ...
     */
    private void btrunc(boolean internalScaling, DoubleDouble[] work) {
...
mainLoop:
     ...
     * @return  DOCUMENT ME!
     */
    private DoubleDouble gndunc(boolean internalScaling, int[] pseudoRankMat, DoubleDouble[] work) {
     ...
     */
    private void pregn(DoubleDouble[] work, int mindim) {
    ...
    private void presub(DoubleDouble[] work) {
        ...
        if ((alfkm1.lt(stepb)) && (pgress.le(pgb1.multiply(d1km1.sqrt()))) && (pgress.le(pgb2.multiply(betkm1)))) {
            ...
            if ((rngkm1 > 1) && (work[rank - 1].gt(rabs.multiply(bn)))) {
                return;
            }
        }
        ...
        if ((work[rank - 1].gt(predb.multiply(bn))) && ((rlenb.multiply(w1[rank - 1])).lt(w1[rank]))) {
            return;
        }
     ...
     * @param  b  DOCUMENT ME!
     */
    private void strsl(DoubleDouble[] b) {
        ...
        b[pseudoRank - 1] = b[pseudoRank - 1].divide(covarMat[pseudoRank - 1][pseudoRank - 1]);
     ...
     */
    private void termuc(DoubleDouble aNorm) {
     ...
     * @return  DOCUMENT ME!
     */
    private int triunc(DoubleDouble tol, int constraintAct) {
