 ...
 */
public class AlgorithmHistogramSliceEqualize extends AlgorithmBase {
     ...
     */
    public AlgorithmHistogramSliceEqualize(ModelImage srcImg, int referenceSlice) {
        super(null, srcImg);
     ...
     * @param  referenceSlice
     */
    public AlgorithmHistogramSliceEqualize(ModelImage destImg, ModelImage srcImg, int referenceSlice) {
    ...
    private void calcInPlace() {
        ...
        try {
            ...
            errorCleanUp("AlgorithmHistogramSliceEqualize reports: source image locked", false);
            ...
            baseGreenBuffer = null;
            baseBlueBuffer = null;
            errorCleanUp("AlgorithmHistogramSliceEqualize reports: out of memory", true);
