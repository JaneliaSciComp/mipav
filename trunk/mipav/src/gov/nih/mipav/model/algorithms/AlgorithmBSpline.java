...
public class AlgorithmBSpline extends AlgorithmBase {
     ...
     */
    public double bSpline2D(int orderDx, int orderDy, float x, float y) {
     ...
     * @return  the Bspline interpolated data point
     */
    public double[] bSpline2DC(int orderDx, int orderDy, float x, float y) {
    ...
    public double bSpline3D(int orderDx, int orderDy, int orderDz, float x, float y, float z) {
        int i, j, k;
        int iindex;
    ...
    public double[] bSpline3DC(int orderDx, int orderDy, int orderDz, float x, float y, float z) {
        int i, j, k;
        int iindexA, iindexR, iindexG, iindexB;
        int i0, i1, i2, j0, j1, j2, k0, k1, k2, l0, l1, l2;
