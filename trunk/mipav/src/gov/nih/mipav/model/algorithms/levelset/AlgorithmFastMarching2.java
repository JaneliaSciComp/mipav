 ...
 * DOCUMENT ME!
 */
public class AlgorithmFastMarching2 extends AlgorithmBase {
    ...
    /**
     * Creates a new AlgorithmFastMarching2 object.
     *
     * @param  _image    reference to the source image
     */
    public AlgorithmFastMarching2(ModelImage _image) {
        super(null, _image);
    }
     ...
     */
    public AlgorithmFastMarching2(ModelImage _image, int iFilterType, 
    		int iIters, float fGMScale, 
