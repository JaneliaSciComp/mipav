   ...
   we require that a = sqrt(1.0-(b*b+c*c+d*d)) be nonnegative. */
    ...
    public boolean readHeader(String imageFileName, String fileDir, boolean niftiCompressed) throws IOException {
        ...
        if (extension0 == 0) {
            ...
            if(esize > 0 && esize%16 == 0) {
            	try {
            		readExtendedHeader(endianess, fileLength);
            	} catch(IOException e) {
    ...
    /**
     * Method for reading the extended header, for now just determines size and type.
     * 
     * @param endianess
     * @param fileLength
     * @throws IOException
     */
    private void readExtendedHeader(boolean endianess, long fileLength) throws IOException {
