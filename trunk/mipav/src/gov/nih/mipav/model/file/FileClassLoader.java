...
/** 
 *  MIPAV uses this class loader to load plug-ins from the plugins
 *	folder. It's based on the class of the same name from the
 *	"Java Class Libraries: Second Edition, Vol. 1"
 *	(http://java.sun.com/docs/books/chanlee/second_edition/vol1/).  
 *  and Wayne Rasband developer of NIHImage and ImageJ.
 *  Might be a problem with static variables in the plugin. 
 *  I don't use this code at this time.
 *
 *		@version    1.0
 */
