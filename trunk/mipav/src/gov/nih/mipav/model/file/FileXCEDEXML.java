...
public class FileXCEDEXML extends FileXML {
    ...
    public XCEDEElement read(String fileName, String directory, String xsdFileName){
        ...
        try {
            ...
            saxParser.setProperty( SAXParserImpl.JAXP_SCHEMA_SOURCE,
            ...
            {
                MipavUtil.
                    displayError( xsdFileName + ": \n" +
                                  kSAXError.getMessage().
                                  substring( kSAXError.getMessage().
                                             lastIndexOf(":") + 1 ) );
                return null;
            }
            ...
            Preferences.debug( "FileXML parse error: " +
                               error.getMessage() + "\n",
            ...
            if(currentKey.equals(XCEDEElement.XCEDE_ROOT_ELEMENT_PROJECTLEVEL)){
                ...
                if (ageType != null){
                    if(ageType.equals(XCEDEElement.XCEDE_AGE_TYPE_GESTATIONAL)
                        ...
                        MipavUtil.displayError("The age type must be "
                                + XCEDEElement.XCEDE_AGE_TYPE_GESTATIONAL + ", "
                ...
                if (ageUnits != null){
                    if(ageUnits.equals(XCEDEElement.XCEDE_AGE_UNITS_DAYS)
                        ...
                        MipavUtil.displayError("The age units must be "
                                + XCEDEElement.XCEDE_AGE_UNITS_DAYS + ", "
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException{
            ...
            if(currentKey.equals(XCEDEElement.XCEDE_ELEMENT_PROJECT)){
                ...
                if(elementBuffer.equals(XCEDEElement.XCEDE_SEX_FEMALE)
                    ...
                    MipavUtil.displayError("The value of sex element must be " + XCEDEElement.XCEDE_SEX_FEMALE + ", " + XCEDEElement.XCEDE_SEX_MALE + " and " + XCEDEElement.XCEDE_SEX_OTHER);
                    return;
                }
            }else if(currentKey.equals(XCEDEElement.XCEDE_ELEMENT_SPECIES)){
                ...
                if (elementBuffer.equals(XCEDEElement.XCEDE_BYTEORDER_LSBFIRST)
                    ...
                    MipavUtil.displayError("The value for the byte order must be msbfirst or lsbfirst: " + elementBuffer);
                    return;
                }
                ...
                currentElement.put(XCEDEElement.XCEDE_ELEMENT_DATAPOINTS, DataPoints.Float.parse(elementBuffer, "[\\s]+"));
                ...
                if (elementBuffer.equals(XCEDEElement.XCEDE_LATERALIZATION_LEFT)
                    ...
                    MipavUtil.displayError("The value of the lateralization must to be "
                                    ...
                                    + ", "
                                    + XCEDEElement.XCEDE_LATERALIZATION_RIGHT
                                    + " and "
                                    + XCEDEElement.XCEDE_LATERALIZATION_BILATERAL
                                    + elementBuffer);
                }
