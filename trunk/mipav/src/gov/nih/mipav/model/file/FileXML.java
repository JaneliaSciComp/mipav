...
/**
 * Abstract base class for reading/writing .XML file headers.  The XML reader
 * uses any schema (.XSD) file, pased into the readHeader function, for
 * parsing.
 */
abstract public class FileXML extends FileBase {

  /**
   * the file info storing xml specific information, abstract base class of
   * FileInfoImageXML or FileInfoSurfaceXML:
   */
  ...
  protected ViewUserInterface UI;
    ...
    /**
     * progress bar implementation (either through a JProgressBar or JPanel)
     * passed in for reading/saving file
     */
    ...
    /* readHeader parses the input XML file based on the input XSD file,
     * kFileXSD: */
    public FileInfoXML readHeader( String headerFileName,
                                   String headerDir,
                                   String kFileXSD )
    {
        ...
        try {
            ...
            try {
                xmlReader.parse( MipavUtil.convertToFileURL( headerDir +
                                                             File.separator +
                                                             headerFileName ) );
            } catch ( SAXException kSAXError )
            {
                MipavUtil.
                    displayError( kFileXSD + ": \n" +
