...
public class FileInfoImageXML extends FileInfoXML {
     ...
     *
     * <p>Description: Public class to hold several attributes for an investigator associated with the image (up to
     * three per)</p>
     *
     ...
     * <p>Title: Parameter</p>
     *
     * <p>Description: Public class to store information for a parameter associated with the image (infinite parameters
     * allowed per)</p>
     *
     * <p>Copyright: Copyright (c) 2004</p>
     *
     ...
     * <p>Title: PSet</p>
     *
     * <p>Description: Public class to store up to an infinite number of parameters... which will be in a Hashtable with
