...
public class FileCZI extends FileBase {
	...
	/** A triple of 2 x 4 byte IEE float, representing real and imaginary part of a complex number,
	 *  for the color channels blue, green, and red
	 */
    ...
    public ModelImage readImage(boolean multiFile, boolean one) throws IOException {
        ...
        String schemaType;
        int pixelType;
        String typeString[] = new String[14];
