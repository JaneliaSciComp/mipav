...
public class FileInfoNIFTI extends FileInfoBase {
    ...
    private String CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName = null;

    private int CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid = Integer.MIN_VALUE;

    private double CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude = Double.NaN;
    ...
    public void displayAboutInfo(final JDialogBase dlog, final TransMatrix matrix) {
        ...
        if (haveDcmMeta) {
            ...
            if (CsaSeriesMrPhoenixProtocolucScanRegionPosValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucScanRegionPosValid = " + CsaSeriesMrPhoenixProtocolucScanRegionPosValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucTablePositioningMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucTablePositioningMode = " + CsaSeriesMrPhoenixProtocolucTablePositioningMode + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsProtConsistencyInfotSystemType != null) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sProtConsistencyInfo.tSystemType = " + CsaSeriesMrPhoenixProtocolsProtConsistencyInfotSystemType
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsProtConsistencyInfoflNominalB0)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sProtConsistencyInfo.flNominalB0 = " + CsaSeriesMrPhoenixProtocolsProtConsistencyInfoflNominalB0
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsProtConsistencyInfoflGMax)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sProtConsistencyInfo.flGMax = " + CsaSeriesMrPhoenixProtocolsProtConsistencyInfoflGMax + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsProtConsistencyInfoflRiseTime)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sProtConsistencyInfo.flRiseTime = " + CsaSeriesMrPhoenixProtocolsProtConsistencyInfoflRiseTime
                        + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsGRADSPECbEddyCompensationValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.bEddyCompensationValid = " + CsaSeriesMrPhoenixProtocolsGRADSPECbEddyCompensationValid
                        + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsGRADSPECbB0CompensationValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.bB0CompensationValid = " + CsaSeriesMrPhoenixProtocolsGRADSPECbB0CompensationValid + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsGRADSPEClOffsetX != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.lOffsetX = " + CsaSeriesMrPhoenixProtocolsGRADSPEClOffsetX + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPEClOffsetY != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.lOffsetY = " + CsaSeriesMrPhoenixProtocolsGRADSPEClOffsetY + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPEClOffsetZ != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.lOffsetZ = " + CsaSeriesMrPhoenixProtocolsGRADSPEClOffsetZ + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECbOffsetValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.bOffsetValid = " + CsaSeriesMrPhoenixProtocolsGRADSPECbOffsetValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPEClDelayX != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.lDelayX = " + CsaSeriesMrPhoenixProtocolsGRADSPEClDelayX + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPEClDelayY != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.lDelayY = " + CsaSeriesMrPhoenixProtocolsGRADSPEClDelayY + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPEClDelayZ != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.lDelayZ = " + CsaSeriesMrPhoenixProtocolsGRADSPEClDelayZ + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECbDelayValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.bDelayValid = " + CsaSeriesMrPhoenixProtocolsGRADSPECbDelayValid + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsGRADSPECflSensitivityX)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.flSensitivityX = " + CsaSeriesMrPhoenixProtocolsGRADSPECflSensitivityX + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsGRADSPECflSensitivityY)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.flSensitivityY = " + CsaSeriesMrPhoenixProtocolsGRADSPECflSensitivityY + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsGRADSPECflSensitivityZ)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.flSensitivityZ = " + CsaSeriesMrPhoenixProtocolsGRADSPECflSensitivityZ + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECbSensitivityValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.bSensitivityValid = " + CsaSeriesMrPhoenixProtocolsGRADSPECbSensitivityValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent0 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.alShimCurrent[0] = " + CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent0 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent1 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.alShimCurrent[1] = " + CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent1 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent2 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.alShimCurrent[2] = " + CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent2 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent3 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.alShimCurrent[3] = " + CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent3 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent4 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.alShimCurrent[4] = " + CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent4 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECbShimCurrentValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.bShimCurrentValid = " + CsaSeriesMrPhoenixProtocolsGRADSPECbShimCurrentValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGRADSPECucMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGRADSPEC.ucMode = " + CsaSeriesMrPhoenixProtocolsGRADSPECucMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPECasNucleusInfo0tNucleus != null) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.asNucleusInfo[0].tNucleus = " + CsaSeriesMrPhoenixProtocolsTXSPECasNucleusInfo0tNucleus
                        + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPECasNucleusInfo0lFrequency != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.asNucleusInfo[0].lFrequency = " + CsaSeriesMrPhoenixProtocolsTXSPECasNucleusInfo0lFrequency
                        + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsTXSPECasNucleusInfo1lRFPAIndex != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.asNucleusInfo[1].lRFPAIndex = " + CsaSeriesMrPhoenixProtocolsTXSPECasNucleusInfo1lRFPAIndex
                        + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName != null) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.aRFPULSE[0].tName = " + CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.aRFPULSE[0].bAmplitudeValid = " + CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.aRFPULSE[0].flAmplitude = " + CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPEClNoOfTraPulses != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.lNoOfTraPulses = " + CsaSeriesMrPhoenixProtocolsTXSPEClNoOfTraPulses + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPEClBCExcitationMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.lBCExcitationMode = " + CsaSeriesMrPhoenixProtocolsTXSPEClBCExcitationMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPEClBCSeqExcitationMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.lBCSeqExcitationMode = " + CsaSeriesMrPhoenixProtocolsTXSPEClBCSeqExcitationMode + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsTXSPECflKDynMagnitudeMin)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.flKDynMagnitudeMin = " + CsaSeriesMrPhoenixProtocolsTXSPECflKDynMagnitudeMin + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsTXSPECflKDynMagnitudeMax)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.flKDynMagnitudeMax = " + CsaSeriesMrPhoenixProtocolsTXSPECflKDynMagnitudeMax + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsTXSPECflKDynMagnitudeClipLow)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.flKDynMagnitudeClipLow = " + CsaSeriesMrPhoenixProtocolsTXSPECflKDynMagnitudeClipLow + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsTXSPECflKDynMagnitudeClipHigh)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.flKDynMagnitudeClipHigh = " + CsaSeriesMrPhoenixProtocolsTXSPECflKDynMagnitudeClipHigh
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsTXSPECflKDynPhaseMax)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.flKDynPhaseMax = " + CsaSeriesMrPhoenixProtocolsTXSPECflKDynPhaseMax + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsTXSPECflKDynPhaseClip)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.flKDynPhaseClip = " + CsaSeriesMrPhoenixProtocolsTXSPECflKDynPhaseClip + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPECbKDynValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.bKDynValid = " + CsaSeriesMrPhoenixProtocolsTXSPECbKDynValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPECucRFPulseType != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.ucRFPulseType = " + CsaSeriesMrPhoenixProtocolsTXSPECucRFPulseType + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPECucExcitMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.ucExcitMode = " + CsaSeriesMrPhoenixProtocolsTXSPECucExcitMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPECucSimultaneousExcitation != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.ucSimultaneousExcitation = " + CsaSeriesMrPhoenixProtocolsTXSPECucSimultaneousExcitation
                        + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsTXSPECucBCExcitationModeValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sTXSPEC.ucBCExcitationModeValid = " + CsaSeriesMrPhoenixProtocolsTXSPECucBCExcitationModeValid
                        + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsRXSPEClGain != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sRXSPEC.lGain = " + CsaSeriesMrPhoenixProtocolsRXSPEClGain + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsRXSPECbGainValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sRXSPEC.bGainValid = " + CsaSeriesMrPhoenixProtocolsRXSPECbGainValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsRXSPECalDwellTime0 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sRXSPEC.alDwellTime[0] = " + CsaSeriesMrPhoenixProtocolsRXSPECalDwellTime0 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjFreMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjFreMode = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjFreMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjShimMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjShimMode = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjShimMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjWatSupMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjWatSupMode = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjWatSupMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjRFMapMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjRFMapMode = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjRFMapMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjMDSMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjMDSMode = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjMDSMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjTableTolerance != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjTableTolerance = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjTableTolerance + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjProtID != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjProtID = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjProtID + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjFreProtRelated != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjFreProtRelated = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjFreProtRelated + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesPositiondSag)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.sPosition.dSag = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesPositiondSag
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesPositiondCor)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.sPosition.dCor = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesPositiondCor
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesPositiondTra)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.sPosition.dTra = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesPositiondTra
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesNormaldSag)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.sNormal.dSag = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesNormaldSag
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesNormaldCor)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.sNormal.dCor = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesNormaldCor
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesNormaldTra)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.sNormal.dTra = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumesNormaldTra
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumedThickness)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.dThickness = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumedThickness + "\n");

            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumedPhaseFOV)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.dPhaseFOV = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumedPhaseFOV + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumedReadoutFOV)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.dReadoutFOV = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumedReadoutFOV + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumedInPlaneRot)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.sAdjVolume.dInPlaneRot = " + CsaSeriesMrPhoenixProtocolsAdjDatasAdjVolumedInPlaneRot + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAdjDatauiAdjVolumeValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAdjData.uiAdjVolumeValid = " + CsaSeriesMrPhoenixProtocolsAdjDatauiAdjVolumeValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucEnableNoiseAdjust != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucEnableNoiseAdjust = " + CsaSeriesMrPhoenixProtocolucEnableNoiseAdjust + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsSliceArrayanAsc != null) {
                for (i = 0; i < getExtents()[2] - 1; i++) {
                    if (CsaSeriesMrPhoenixProtocolsSliceArrayanAsc[i] != Integer.MIN_VALUE) {
                        dialog.append("CsaSeries.MrPhoenixProtocol.sSliceArray.anAsc[" + (i + 1) + "] = " + CsaSeriesMrPhoenixProtocolsSliceArrayanAsc[i]
                                + "\n");
                    }
                }
            }
            if (CsaSeriesMrPhoenixProtocolsSliceArrayanPos != null) {
                for (i = 0; i < getExtents()[2] - 1; i++) {
                    if (CsaSeriesMrPhoenixProtocolsSliceArrayanPos[i] != Integer.MIN_VALUE) {
                        dialog.append("CsaSeries.MrPhoenixProtocol.sSliceArray.anPos[" + (i + 1) + "] = " + CsaSeriesMrPhoenixProtocolsSliceArrayanPos[i]
                                + "\n");
                    }
                }
            }
            ...
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsSliceArraysTSatdThickness)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSliceArray.sTSat.dThickness = " + CsaSeriesMrPhoenixProtocolsSliceArraysTSatdThickness + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGroupArrayasGroup0nSize != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGroupArray.asGroup[0].nSize = " + CsaSeriesMrPhoenixProtocolsGroupArrayasGroup0nSize + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsGroupArrayanMember != null) {
                for (i = 0; i < getExtents()[2]; i++) {
                    if (CsaSeriesMrPhoenixProtocolsGroupArrayanMember[i] != Integer.MIN_VALUE) {
                        dialog.append("CsaSeries.MrPhoenixProtocol.sGroupArray.anMember[" + (i + 1) + "] = " + CsaSeriesMrPhoenixProtocolsGroupArrayanMember[i]
                                + "\n");
                    }
                }
            }
            if (CsaSeriesMrPhoenixProtocolsGroupArraylSize != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGroupArray.lSize = " + CsaSeriesMrPhoenixProtocolsGroupArraylSize + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsGroupArraysPSatdThickness)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGroupArray.sPSat.dThickness = " + CsaSeriesMrPhoenixProtocolsGroupArraysPSatdThickness + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsGroupArraysPSatdGap)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sGroupArray.sPSat.dGap = " + CsaSeriesMrPhoenixProtocolsGroupArraysPSatdGap + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAutoAligndAAMatrix != null) {
                for (i = 0; i < CsaSeriesMrPhoenixProtocolsAutoAligndAAMatrix.length; i++) {
                    if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsAutoAligndAAMatrix[i])) {
                        dialog.append("CsaSeries.MrPhoenixProtocol.sAutoAlign.dAAMatrix[" + i + "] = " + CsaSeriesMrPhoenixProtocolsAutoAligndAAMatrix[i]
                                + "\n");
                    }
                }
            } // if (CsaSeriesMrPhoenixProtocolsAutoAligndAAMatrix != null)
            if (CsaSeriesMrPhoenixProtocolsNavigatorParalBreathHoldMeas != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sNavigatorPara.lBreathHoldMeas = " + CsaSeriesMrPhoenixProtocolsNavigatorParalBreathHoldMeas + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsNavigatorParalRespComp != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sNavigatorPara.lRespComp = " + CsaSeriesMrPhoenixProtocolsNavigatorParalRespComp + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsBladeParadBladeCoverage)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sBladePara.dBladeCoverage = " + CsaSeriesMrPhoenixProtocolsBladeParadBladeCoverage + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsBladeParaucMotionCorr != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sBladePara.ucMotionCorr = " + CsaSeriesMrPhoenixProtocolsBladeParaucMotionCorr + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPrepPulsesucFatSat != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.ucFatSat = " + CsaSeriesMrPhoenixProtocolsPrepPulsesucFatSat + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPrepPulsesucWaterSat != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.ucWaterSat = " + CsaSeriesMrPhoenixProtocolsPrepPulsesucWaterSat + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPrepPulsesucInversion != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.ucInversion = " + CsaSeriesMrPhoenixProtocolsPrepPulsesucInversion + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPrepPulsesucSatRecovery != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.ucSatRecovery = " + CsaSeriesMrPhoenixProtocolsPrepPulsesucSatRecovery + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPrepPulsesucT2Prep != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.ucT2Prep = " + CsaSeriesMrPhoenixProtocolsPrepPulsesucT2Prep + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPrepPulsesucTIScout != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.ucTIScout = " + CsaSeriesMrPhoenixProtocolsPrepPulsesucTIScout + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPrepPulsesucFatSatMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.ucFatSatMode = " + CsaSeriesMrPhoenixProtocolsPrepPulsesucFatSatMode + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsPrepPulsesdDarkBloodThickness)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.dDarkBloodThickness = " + CsaSeriesMrPhoenixProtocolsPrepPulsesdDarkBloodThickness
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsPrepPulsesdDarkBloodFlipAngle)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.dDarkBloodFlipAngle = " + CsaSeriesMrPhoenixProtocolsPrepPulsesdDarkBloodFlipAngle
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsPrepPulsesdT2PrepDuration)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPrepPulses.dT2PrepDuration = " + CsaSeriesMrPhoenixProtocolsPrepPulsesdT2PrepDuration + "\n");
            }
            ...
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsKSpacedPhaseResolution)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.dPhaseResolution = " + CsaSeriesMrPhoenixProtocolsKSpacedPhaseResolution + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsKSpacedSliceResolution)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.dSliceResolution = " + CsaSeriesMrPhoenixProtocolsKSpacedSliceResolution + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsKSpacedAngioDynCentralRegionA)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.dAngioDynCentralRegionA = " + CsaSeriesMrPhoenixProtocolsKSpacedAngioDynCentralRegionA
                        + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsKSpacedAngioDynSamplingDensityB)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.dAngioDynSamplingDensityB = " + CsaSeriesMrPhoenixProtocolsKSpacedAngioDynSamplingDensityB
                        + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpacelBaseResolution != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.lBaseResolution = " + CsaSeriesMrPhoenixProtocolsKSpacelBaseResolution + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpacelPhaseEncodingLines != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.lPhaseEncodingLines = " + CsaSeriesMrPhoenixProtocolsKSpacelPhaseEncodingLines + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpacelPartitions != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.lPartitions = " + CsaSeriesMrPhoenixProtocolsKSpacelPartitions + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpacelImagesPerSlab != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.lImagesPerSlab = " + CsaSeriesMrPhoenixProtocolsKSpacelImagesPerSlab + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpacelRadialViews != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.lRadialViews = " + CsaSeriesMrPhoenixProtocolsKSpacelRadialViews + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpacelRadialInterleavesPerImage != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.lRadialInterleavesPerImage = " + CsaSeriesMrPhoenixProtocolsKSpacelRadialInterleavesPerImage
                        + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpacelLinesPerShot != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.lLinesPerShot = " + CsaSeriesMrPhoenixProtocolsKSpacelLinesPerShot + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceunReordering != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.unReordering = " + CsaSeriesMrPhoenixProtocolsKSpaceunReordering + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsKSpaceucPhasePartialFourier != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucPhasePartialFourier = " + CsaSeriesMrPhoenixProtocolsKSpaceucPhasePartialFourier + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceucSlicePartialFourier != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucSlicePartialFourier = " + CsaSeriesMrPhoenixProtocolsKSpaceucSlicePartialFourier + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceucAveragingMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucAveragingMode = " + CsaSeriesMrPhoenixProtocolsKSpaceucAveragingMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceucMultiSliceMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucMultiSliceMode = " + CsaSeriesMrPhoenixProtocolsKSpaceucMultiSliceMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceucDimension != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucDimension = " + CsaSeriesMrPhoenixProtocolsKSpaceucDimension + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceucTrajectory != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucTrajectory = " + CsaSeriesMrPhoenixProtocolsKSpaceucTrajectory + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceucViewSharing != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucViewSharing = " + CsaSeriesMrPhoenixProtocolsKSpaceucViewSharing + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceucAsymmetricEchoMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucAsymmetricEchoMode = " + CsaSeriesMrPhoenixProtocolsKSpaceucAsymmetricEchoMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsKSpaceucPOCS != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sKSpace.ucPOCS = " + CsaSeriesMrPhoenixProtocolsKSpaceucPOCS + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsFastImaginglEPIFactor != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sFastImaging.lEPIFactor = " + CsaSeriesMrPhoenixProtocolsFastImaginglEPIFactor + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsFastImaginglTurboFactor != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sFastImaging.lTurboFactor = " + CsaSeriesMrPhoenixProtocolsFastImaginglTurboFactor + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsFastImaginglSliceTurboFactor != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sFastImaging.lSliceTurboFactor = " + CsaSeriesMrPhoenixProtocolsFastImaginglSliceTurboFactor + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsFastImaginglSegments != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sFastImaging.lSegments = " + CsaSeriesMrPhoenixProtocolsFastImaginglSegments + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsFastImagingucSegmentationMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sFastImaging.ucSegmentationMode = " + CsaSeriesMrPhoenixProtocolsFastImagingucSegmentationMode
                        + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsFastImaginglShots != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sFastImaging.lShots = " + CsaSeriesMrPhoenixProtocolsFastImaginglShots + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsFastImaginglEchoTrainDuration != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sFastImaging.lEchoTrainDuration = " + CsaSeriesMrPhoenixProtocolsFastImaginglEchoTrainDuration
                        + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPhysioImaginglSignal1 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPhysioImaging.lSignal1 = " + CsaSeriesMrPhoenixProtocolsPhysioImaginglSignal1 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPhysioImaginglMethod1 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPhysioImaging.lMethod1 = " + CsaSeriesMrPhoenixProtocolsPhysioImaginglMethod1 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPhysioImaginglSignal2 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPhysioImaging.lSignal2 = " + CsaSeriesMrPhoenixProtocolsPhysioImaginglSignal2 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPhysioImaginglMethod2 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPhysioImaging.lMethod2 = " + CsaSeriesMrPhoenixProtocolsPhysioImaginglMethod2 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPhysioImaginglPhases != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPhysioImaging.lPhases = " + CsaSeriesMrPhoenixProtocolsPhysioImaginglPhases + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPhysioImaginglRetroGatedImages != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPhysioImaging.lRetroGatedImages = " + CsaSeriesMrPhoenixProtocolsPhysioImaginglRetroGatedImages
                        + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolsSpecParalPhaseCyclingType != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lPhaseCyclingType = " + CsaSeriesMrPhoenixProtocolsSpecParalPhaseCyclingType + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParalPhaseEncodingType != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lPhaseEncodingType = " + CsaSeriesMrPhoenixProtocolsSpecParalPhaseEncodingType + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParalRFExcitationBandwidth != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lRFExcitationBandwidth = " + CsaSeriesMrPhoenixProtocolsSpecParalRFExcitationBandwidth
                        + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParaucRemoveOversampling != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.ucRemoveOversampling = " + CsaSeriesMrPhoenixProtocolsSpecParaucRemoveOversampling + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParalAutoRefScanNo != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lAutoRefScanNo = " + CsaSeriesMrPhoenixProtocolsSpecParalAutoRefScanNo + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParalDecouplingType != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lDecouplingType = " + CsaSeriesMrPhoenixProtocolsSpecParalDecouplingType + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParalNOEType != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lNOEType = " + CsaSeriesMrPhoenixProtocolsSpecParalNOEType + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParalExcitationType != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lExcitationType = " + CsaSeriesMrPhoenixProtocolsSpecParalExcitationType + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParalSpecAppl != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lSpecAppl = " + CsaSeriesMrPhoenixProtocolsSpecParalSpecAppl + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsSpecParalSpectralSuppression != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sSpecPara.lSpectralSuppression = " + CsaSeriesMrPhoenixProtocolsSpecParalSpectralSuppression + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsDiffusionulMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sDiffusion.ulMode = " + CsaSeriesMrPhoenixProtocolsDiffusionulMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAngioucPCFlowMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAngio.ucPCFlowMode = " + CsaSeriesMrPhoenixProtocolsAngioucPCFlowMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAngioucTOFInflow != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAngio.ucTOFInflow = " + CsaSeriesMrPhoenixProtocolsAngioucTOFInflow + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAngiolDynamicReconMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAngio.lDynamicReconMode = " + CsaSeriesMrPhoenixProtocolsAngiolDynamicReconMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsAngiolTemporalInterpolation != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sAngio.lTemporalInterpolation = " + CsaSeriesMrPhoenixProtocolsAngiolTemporalInterpolation + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsRawFilterlSlope_256 != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sRawFilter.lSlope_256 = " + CsaSeriesMrPhoenixProtocolsRawFilterlSlope_256 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsRawFilterucOn != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sRawFilter.ucOn = " + CsaSeriesMrPhoenixProtocolsRawFilterucOn + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsRawFilterucMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sRawFilter.ucMode = " + CsaSeriesMrPhoenixProtocolsRawFilterucMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsDistortionCorrFilterucMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sDistortionCorrFilter.ucMode  = " + CsaSeriesMrPhoenixProtocolsDistortionCorrFilterucMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPatlAccelFactPE != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPat.lAccelFactPE = " + CsaSeriesMrPhoenixProtocolsPatlAccelFactPE + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPatlAccelFact3D != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPat.lAccelFact3D = " + CsaSeriesMrPhoenixProtocolsPatlAccelFact3D + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPatlRefLinesPE != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPat.lRefLinesPE = " + CsaSeriesMrPhoenixProtocolsPatlRefLinesPE + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPatucPATMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPat.ucPATMode = " + CsaSeriesMrPhoenixProtocolsPatucPATMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPatucRefScanMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPat.ucRefScanMode = " + CsaSeriesMrPhoenixProtocolsPatucRefScanMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsPatucTPatAverageAllFrames != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sPat.ucTPatAverageAllFrames = " + CsaSeriesMrPhoenixProtocolsPatucTPatAverageAllFrames + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsMDSulMdsModeMask != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sMDS.ulMdsModeMask = " + CsaSeriesMrPhoenixProtocolsMDSulMdsModeMask + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsMDSulMdsVariableResolution != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sMDS.ulMdsVariableResolution = " + CsaSeriesMrPhoenixProtocolsMDSulMdsVariableResolution + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsMDSlTableSpeedNumerator != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sMDS.lTableSpeedNumerator = " + CsaSeriesMrPhoenixProtocolsMDSlTableSpeedNumerator + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsMDSlmdsLinesPerSegment != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sMDS.lmdsLinesPerSegment = " + CsaSeriesMrPhoenixProtocolsMDSlmdsLinesPerSegment + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsMDSsMdsEndPosSBCS_mmdTra)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sMDS.sMdsEndPosSBCS_mmd.Tra = " + CsaSeriesMrPhoenixProtocolsMDSsMdsEndPosSBCS_mmdTra + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsMDSulMdsReconMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sMDS.ulMdsReconMode = " + CsaSeriesMrPhoenixProtocolsMDSulMdsReconMode + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsMDSdMdsRangeExtension)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sMDS.dMdsRangeExtension = " + CsaSeriesMrPhoenixProtocolsMDSdMdsRangeExtension + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucDisableChangeStoreImages != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucDisableChangeStoreImages = " + CsaSeriesMrPhoenixProtocolucDisableChangeStoreImages + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucAAMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucAAMode = " + CsaSeriesMrPhoenixProtocolucAAMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucAARegionMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucAARegionMode = " + CsaSeriesMrPhoenixProtocolucAARegionMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucAARefMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucAARefMode = " + CsaSeriesMrPhoenixProtocolucAARefMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucReconstructionMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucReconstructionMode = " + CsaSeriesMrPhoenixProtocolucReconstructionMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucOneSeriesForAllMeas != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucOneSeriesForAllMeas = " + CsaSeriesMrPhoenixProtocolucOneSeriesForAllMeas + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucPHAPSMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucPHAPSMode = " + CsaSeriesMrPhoenixProtocolucPHAPSMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucDixon != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucDixon = " + CsaSeriesMrPhoenixProtocolucDixon + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucDixonSaveOriginal != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucDixonSaveOriginal = " + CsaSeriesMrPhoenixProtocolucDixonSaveOriginal + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucWaitForPrepareCompletion != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucWaitForPrepareCompletion = " + CsaSeriesMrPhoenixProtocolucWaitForPrepareCompletion + "\n");
            }
            if (CsaSeriesMrPhoenixProtocollAverages != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.lAverages = " + CsaSeriesMrPhoenixProtocollAverages + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocoldAveragesDouble)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.dAveragesDouble = " + CsaSeriesMrPhoenixProtocoldAveragesDouble + "\n");
            }
            if (CsaSeriesMrPhoenixProtocollRepetitions != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.lRepetitions = " + CsaSeriesMrPhoenixProtocollRepetitions + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocoladFlipAngleDegree0)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.adFlipAngleDegree[0] = " + CsaSeriesMrPhoenixProtocoladFlipAngleDegree0 + "\n");
            }
            if (CsaSeriesMrPhoenixProtocollScanTimeSec != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.lScanTimeSec = " + CsaSeriesMrPhoenixProtocollScanTimeSec + "\n");
            }
            if (CsaSeriesMrPhoenixProtocollTotalScanTimeSec != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.lTotalScanTimeSec = " + CsaSeriesMrPhoenixProtocollTotalScanTimeSec + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocoldRefSNR)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.dRefSNR = " + CsaSeriesMrPhoenixProtocoldRefSNR + "\n");
            }
            if ( !Double.isNaN(CsaSeriesMrPhoenixProtocoldRefSNR_VOI)) {
                dialog.append("CsaSeries.MrPhoenixProtocol.dRefSNR_VOI = " + CsaSeriesMrPhoenixProtocoldRefSNR_VOI + "\n");
            }
            if (CsaSeriesMrPhoenixProtocoltdefaultEVAProt != null) {
                dialog.append("CsaSeries.MrPhoenixProtocol.tdefaultEVAProt = " + CsaSeriesMrPhoenixProtocoltdefaultEVAProt + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolasCoilSelectMeas0tNucleus != null) {
                dialog.append("CsaSeries.MrPhoenixProtocol.asCoilSelectMeas[0].tNucleus = " + CsaSeriesMrPhoenixProtocolasCoilSelectMeas0tNucleus + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolasCoilSelectMeas0iUsedRFactor != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.asCoilSelectMeas[0].iUsedRFactor = " + CsaSeriesMrPhoenixProtocolasCoilSelectMeas0iUsedRFactor
                        + "\n");
            }
            for (i = 0; i < 24; i++) {
            ...
            if (CsaSeriesMrPhoenixProtocolsEFISPECbEFIDataValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sEFISPEC.bEFIDataValid = " + CsaSeriesMrPhoenixProtocolsEFISPECbEFIDataValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsWiPMemBlockalFree != null) {
                for (i = 0; i < CsaSeriesMrPhoenixProtocolsWiPMemBlockalFree.length; i++) {
                    if (CsaSeriesMrPhoenixProtocolsWiPMemBlockalFree[i] != Integer.MIN_VALUE) {
                        dialog.append("CsaSeries.MrPhoenixProtocol.sWiPMemBlock.alFree[" + i + "] = " + CsaSeriesMrPhoenixProtocolsWiPMemBlockalFree[i] + "\n");
                    }
                }
            }
            if (CsaSeriesMrPhoenixProtocolsWiPMemBlockadFree != null) {
                for (i = 0; i < CsaSeriesMrPhoenixProtocolsWiPMemBlockadFree.length; i++) {
                    if ( !Double.isNaN(CsaSeriesMrPhoenixProtocolsWiPMemBlockadFree[i])) {
                        dialog.append("CsaSeries.MrPhoenixProtocol.sWiPMemBlock.adFree[" + i + "] = " + CsaSeriesMrPhoenixProtocolsWiPMemBlockadFree[i] + "\n");
                    }
                }
            }
            if (CsaSeriesMrPhoenixProtocolsWiPMemBlocktFree != null) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sWiPMemBlock.tFree = " + CsaSeriesMrPhoenixProtocolsWiPMemBlocktFree + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucBOLDParadigmArray != null) {
                for (i = 0; i < CsaSeriesMrPhoenixProtocolucBOLDParadigmArray.length; i++) {
                    dialog.append("CsaSeries.MrPhoenixProtocol.ucBOLDParadigmArray[" + i + "] = " + CsaSeriesMrPhoenixProtocolucBOLDParadigmArray[i] + "\n");
                }
            }
            if (CsaSeriesMrPhoenixProtocollParadigmPeriodicity != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.lParadigmPeriodicity = " + CsaSeriesMrPhoenixProtocollParadigmPeriodicity + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucCineMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucCineMode = " + CsaSeriesMrPhoenixProtocolucCineMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucSequenceType != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucSequenceType = " + CsaSeriesMrPhoenixProtocolucSequenceType + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucCoilCombineMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucCoilCombineMode = " + CsaSeriesMrPhoenixProtocolucCoilCombineMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucFlipAngleMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucFlipAngleMode = " + CsaSeriesMrPhoenixProtocolucFlipAngleMode + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolucReadOutMode != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucReadOutMode = " + CsaSeriesMrPhoenixProtocolucReadOutMode + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucBold3dPace != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucBold3dPace = " + CsaSeriesMrPhoenixProtocolucBold3dPace + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucForcePositioningOnNDIS != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucForcePositioningOnNDIS = " + CsaSeriesMrPhoenixProtocolucForcePositioningOnNDIS + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucInteractiveRealtime != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucInteractiveRealtime = " + CsaSeriesMrPhoenixProtocolucInteractiveRealtime + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucInternalTablePosValid != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucInternalTablePosValid = " + CsaSeriesMrPhoenixProtocolucInternalTablePosValid + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolsParametricMappingucParametricMap != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.sParametricMapping.ucParametricMap = " + CsaSeriesMrPhoenixProtocolsParametricMappingucParametricMap
                        + "\n");
            }
            ...
            if (CsaSeriesMrPhoenixProtocolWaitForUserStart != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.WaitForUserStart = " + CsaSeriesMrPhoenixProtocolWaitForUserStart + "\n");
            }
            if (CsaSeriesMrPhoenixProtocolucAutoAlignInit != Integer.MIN_VALUE) {
                dialog.append("CsaSeries.MrPhoenixProtocol.ucAutoAlignInit = " + CsaSeriesMrPhoenixProtocolucAutoAlignInit + "\n");
            }
            ...
            if (CsaImageSliceMeasurementDuration != null) {
                for (i = 0; i < CsaImageSliceMeasurementDuration.length; i++) {
                    if ( !Double.isNaN(CsaImageSliceMeasurementDuration[i])) {
                        dialog.append("CsaImage.SliceMeasurementDuration[" + i + "] = " + CsaImageSliceMeasurementDuration[i] + "\n");
                    }
                }
            }
                    ...
                    if (dcmmeta_reorient_transform[i] != null) {
                        for (j = 0; j < dcmmeta_reorient_transform[i].length; j++) {
                            if ( !Double.isNaN(dcmmeta_reorient_transform[i][j])) {
                                dialog.append("dcmmeta_reorient_transform[" + i + "][" + j + "] = " + dcmmeta_reorient_transform[i][j] + "\n");
                            }
                        }
                    }
                }
    ...
    public void setCsaSeriesRfWatchdogMask(final int CsaSeriesRfWatchdogMask) {
    ...
    public void setCsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent0(final int CsaSeriesMrPhoenixProtocolsGRADSPECalShimCurrent0) {
    ...
    public void setCsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName(final String CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName) {
        this.CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName = CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName;
    }

    public String getCsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName() {
        return CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0tName;
    }

    public void setCsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid(final int CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid) {
        this.CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid = CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid;
    }

    public int getCsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid() {
        return CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0bAmplitudeValid;
    }

    public void setCsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude(final double CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude) {
        this.CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude = CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude;
    }

    public double getCsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude() {
        return CsaSeriesMrPhoenixProtocolsTXSPECaRFPULSE0flAmplitude;
    }
    ...
    public void setCsaSeriesMrPhoenixProtocolsAutoAligndAAMatrix(final double CsaSeriesMrPhoenixProtocolsAutoAligndAAMatrix[]) {
    ...
    public void setCsaSeriesMrPhoenixProtocolucDisableChangeStoreImages(final int CsaSeriesMrPhoenixProtocolucDisableChangeStoreImages) {
    ...
    public void setDcmmeta_shape(final int dcmmeta_shape[]) {
