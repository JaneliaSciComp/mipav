...
public class FileSurfaceXML extends FileXML {
    ...
    private static final String[] m_kSurfaceStr = { "Unique-ID", "Material", "Type", "Mesh" };
    ...
    private static final String[] m_kMeshStr = { "Vertices", "Normals", "Connectivity" };
    ...
    public boolean writeHeader(String headerName, String headerDir, ModelTriangleMesh kMesh, Material kMaterial)
        ...
        closedTag(bw, m_kMeshStr[2], kSurfaceXMLHandler.getIndexString(aiIndex));
    ...
    private class SurfaceXMLHandler extends DefaultHandler {
        ...
        public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
            ...
            if (currentKey.equals("Unique-ID")) {
                ...
                if (m_akNormals != null) {
                    fileInfo.setMesh(m_akVertices, m_akNormals, m_aiIndex);
                } else {
                    fileInfo.setMesh(m_akVertices, null, m_aiIndex);
                }
            }
        }
         ...
         *
         * @param   kParseString  DOCUMENT ME!
         *
         * @return  DOCUMENT ME!
         */
