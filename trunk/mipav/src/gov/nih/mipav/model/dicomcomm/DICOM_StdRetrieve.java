...
public class DICOM_StdRetrieve extends DICOM_SOP {
    ...
    */
    ...
    /**
    *  Read a C-MOVE request  -
    *    this is used when acting like server and responding to a move request.
    */
    ...
    */
    public void write( DICOM_PDUService pdu,       DICOM_Object ddo,
                        byte[]          appTitle,  DICOM_Move   dcmMove) throws DICOM_Exception  {
        //int i =0;
        int ID;
        ...
        while (true) {
            ...
            if (Preferences.debugLevel(Preferences.DEBUG_COMMS))
                Preferences.debug(DICOM_Util.timeStamper() + " DICOM_StdRetrieve.write: MOVE response read completed.\n");
            if (Preferences.debugLevel(Preferences.DEBUG_COMMS))
