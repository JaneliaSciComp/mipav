...
// uniform sampler3D VolumeImageNew;
// uniform sampler1D ColorMapNew;
...
//             if ( UseImageNew != 0.0 )
//             {
//                 color = texture3D(VolumeImageNew,gl_TexCoord[0].xyz);
//             }
//             else
//             {
...
//             if ( UseLUTNew != 0.0 )
//             {
//                 LocalMaterialDiffuse.rgb = texture1D(ColorMapNew,color.r).rgb;
//             }
//             else
//             {
