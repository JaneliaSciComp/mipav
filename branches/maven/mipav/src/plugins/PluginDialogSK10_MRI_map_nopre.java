 ...
 *
 */
public class PluginDialogSK10_MRI_map_nopre implements AlgorithmInterface
{
    ...
    private PlugInAlgorithmSK10_MRI_map_nopre mappingAlgo;
    
    /**
     * Constructor of Brain Subcortical Dialog.  Called from the MIPAV menu. 
     * @param theParentFrame  parent frame.
     */
    public PluginDialogSK10_MRI_map_nopre(Frame theParentFrame) {
     ...
     */
    public PluginDialogSK10_MRI_map_nopre(Frame theParentFrame, String _inputDirImage, String _inputDirMap, String _outputDir) {
	...
	public void callAlgorithm() {
		...
		mappingAlgo = new PlugInAlgorithmSK10_MRI_map_nopre(inputDirImage, inputDirMap, outputDir, this);
	    mappingAlgo.run();
	}
