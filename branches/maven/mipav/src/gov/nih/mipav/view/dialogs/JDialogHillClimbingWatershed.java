 ...
 */
public class JDialogHillClimbingWatershed extends JDialogScriptableBase
     ...
     */
    public JDialogHillClimbingWatershed() { }
     ...
     */
    public JDialogHillClimbingWatershed(Frame theParentFrame, ModelImage im) {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmHillClimbingWatershed) {
            System.err.println("Hill Climbing Watershed elapsed: " + algorithm.getElapsedTime());
            image.clearMask();
    ...
    protected void callAlgorithm() {
        try {
         ...
         // save the completion status for later
            ...
            System.gc();
            MipavUtil.displayError("Dialog Hill Climbing Watershed: unable to allocate enough memory");
    ...
    private void init() {
        ...
        setTitle("Hill Climbing Watershed");
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("Applies Hill Climbing watershed segmentation to the image.");
            }
            ...
            public String getShortLabel() {
                return new String("HillClimbingWatershedSegmentation");
            }

            public String getLabel() {
                return new String("Hill Climbing Watershed Segmentation");
            }
