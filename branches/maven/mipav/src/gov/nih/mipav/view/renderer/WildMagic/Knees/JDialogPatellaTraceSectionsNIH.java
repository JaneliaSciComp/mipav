...
public class JDialogPatellaTraceSectionsNIH extends JDialogBase implements AlgorithmInterface {
	 ...
	 */
	public JDialogPatellaTraceSectionsNIH(Frame theParentFrame, ModelImage srcImage) {
	...
	private Vector2f traceSection6(float posX, float posY, float stepX, float stepY, Vector3f center, float degree, int sliceNumber, int currentStep,
		...
		while ( fuzzyCIntensity != 3 && distCurrent < distOuter) {
			...
			findWeakClass3 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class3Image, 3, Class3, false, xResult);
			findWeakClass2 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class2Image, 3, Class2, false, xResult);
		...
		while ( fuzzyCIntensity != 3 && distCurrent < distOuter) {
			...
			if ((sliceNumber <= startPt + tenPercent) || (sliceNumber >= endPt - tenPercent)) {
				while ( distCurrent < distOuter ) {
					...
					class3Intensity = class3Image.getDouble((int) posX, (int) posY);
					if (fuzzyCIntensity == 2 || fuzzyCIntensity == 3 || class1Intensity <= 0.1f || 
							class2Intensity >= 0.9f /* || class3Intensity >= 0.02f */ )
						break;
					posX += stepX;
					posY += stepY;
					currentStep++;
			...
			if ( degree > section1_degree_end - 15 ) {
				...
				xResult[0] = -1;
				findWeakEdge = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, fuzzyCImage, 3, FuzzyC, false, xResult);
				findWeakEdgeClass2 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class2Image, 3, Class2, false, xResult);
				findWeakEdgeClass3 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class3Image, 3, Class3, false, xResult);
			...
			class2Intensity = class2Image.getDouble((int) posX, (int) posY);
			class3Intensity = class3Image.getDouble((int) posX, (int) posY);
			if (class2Intensity >= 0.9f || class1Intensity < 0.1f /* || class3Intensity >= 0.02f */ ) {
				break;
			}
	...
	private Vector2f traceSection2(float posX, float posY, float stepX, float stepY, Vector3f center, float degree, int sliceNumber, int currentStep,
		...
		while (fuzzyCIntensity != 3  && distCurrent < distOuter) {
			...
			int []xResult = new int[1];
			xResult[0] = -1;
			findWeakEdge = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, fuzzyCImage, 3, FuzzyC, true, xResult);
			findWeakEdgeClass2 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class2Image, 3, Class2, false, xResult);
			findWeakEdgeClass3 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class3Image, 3, Class3, false, xResult);
			...
			if (findWeakEdge || findWeakEdgeClass2 || findWeakEdgeClass3) {
				...
				findWeakEdgeClass2 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class2Image, 3, Class2, false, xResult);
	...
	private Vector2f traceSection3(float posX, float posY, float stepX, float stepY, Vector3f center, float degree, int sliceNumber, int currentStep,
		...
		while ( fuzzyCIntensity != 3 && distCurrent < distOuter) {
			...
			if ( degree >= section3_degree_start && degree <= section3_degree_start + 20 ) {	
				...
				findWeakEdgeClass1 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class1Image, 5, Class1_weak, false, xResult);
				findWeakEdgeClass2 = false;
				...
				findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, fuzzyCImage, 5, FuzzyC, false, xResult);
			    findWeakEdgeClass3 = false;
			    findWeakEdgeClass3 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class3Image, 5, Class3, false, xResult);
			    if (findWeakEdgeClass1 || findWeakEdgeFuzzyC || findWeakEdgeClass3 || findWeakEdgeClass2 ) {
			    	float testX = posX, testY = posY;
					boolean lookFor3 = false;
					while (distCurrent < distOuter) {
						fuzzyCIntensity = fuzzyCImage.getDouble((int) testX, (int) testY);
					...
					findWeakEdgeClass1 = false;
					findWeakEdgeClass1 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class1Image, 5, Class1_weak, false, xResult);
					findWeakEdgeClass2 = false;
					findWeakEdgeClass2 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class2Image, 5, Class2, false, xResult);	
					findWeakEdgeFuzzyC = false;
					findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, fuzzyCImage, 5, FuzzyC, false, xResult);
				    findWeakEdgeClass3 = false;
			...
			if ( degree >= section3_degree_end-20 && degree <= section3_degree_end) {
				findWeakEdgeClass1 = false;
				findWeakEdgeClass1 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class1Image, 3, Class1_weak, false, xResult);
				findWeakEdgeClass2 = false;
				findWeakEdgeClass2 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class2Image, 3, Class2, false, xResult);	
				findWeakEdgeFuzzyC = false;
				findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, fuzzyCImage, 3, FuzzyC, false, xResult);
			    findWeakEdgeClass3 = false;
			    findWeakEdgeClass3 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class3Image, 3, Class3, false, xResult);
			    if (findWeakEdgeClass1 || findWeakEdgeFuzzyC || findWeakEdgeClass3 || findWeakEdgeClass2 ) {
			    	float testX = posX, testY = posY;
					...
					findWeakEdgeClass1 = false;
					findWeakEdgeClass1 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class1Image, 3, Class1_weak, false, xResult);
					findWeakEdgeClass2 = false;
					findWeakEdgeClass2 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class2Image, 3, Class2, false, xResult);	
					findWeakEdgeFuzzyC = false;
					findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, fuzzyCImage, 3, FuzzyC, false, xResult);
				    findWeakEdgeClass3 = false;
				    findWeakEdgeClass3 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class3Image, 3, Class3, false, xResult);
				    if (findWeakEdgeClass1 || findWeakEdgeFuzzyC || findWeakEdgeClass3 || findWeakEdgeClass2 ) {
				    	float testX = posX, testY = posY;
			...
			if (degree >= section3_degree_start && degree <= section3_degree_start + 20) {
				...
				xResult[0] = -1;
				findWeakEdgeClass1 = false;
				// findWeakEdgeClass1 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class1Image, 3, 0, Class1_weak, true, xResult);
				// findWeakEdgeFuzzyC = false;
				findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, fuzzyCImage, 3, 0, FuzzyC, true, xResult);
				findWeakEdgeClass3 = false;
			    findWeakEdgeClass3 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class3Image, 3, 0, Class3, true, xResult);
			    if (findWeakEdgeClass1 || findWeakEdgeFuzzyC || findWeakEdgeClass3) {
					break;
				} 
			}
			*/ 
		
			// look for corner edge
			/*
			boolean findCornerEdgeClass1 = false;
			boolean findCornerEdgeFuzzyC = false;
			boolean findCornerEdgeClass3 = false;
			xResult = new int[1];
			xResult[0] = -1;
			if ((degree >= section3_degree_start && degree <= section3_degree_start + 40)) {
				findCornerEdgeClass1 = findCornerEdgeOnImage((int)posX, (int) posY, class1Image, 5, 0, Class1_corner);
				findCornerEdgeFuzzyC = findCornerEdgeOnImage((int)posX, (int)posY, fuzzyCImage, 5, 0, FuzzyC);
				findCornerEdgeClass3 = findCornerEdgeOnImage((int)posX, (int)posY, class3Image, 5, 0, Class3);
              break;
			}
			*/
	...
	private Vector2f traceSection4(float posX, float posY, float stepX, float stepY, Vector3f center, float degree, int sliceNumber, int currentStep,
		...
		while ( fuzzyCIntensity != 3 && distCurrent < distOuter) {
			...
			findWeakEdge = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class1Image, 10, Class1_weak, true, xResult);
			findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, fuzzyCImage, 10, FuzzyC, true, xResult);
			...
			if (findWeakEdge || findWeakEdgeFuzzyC || findWeakEdgeClass3 || findWeakEdgeClass2) {
				float testX = posX, testY = posY;
				boolean lookFor3 = false;
				while (distCurrent < distOuter ) {
					fuzzyCIntensity = fuzzyCImage.getDouble((int) testX, (int) testY);
				...
				findWeakEdge = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class1Image, 15, Class1_weak, true, xResult);
				findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, fuzzyCImage, 15, FuzzyC, true, xResult);
				findWeakEdgeClass3 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class3Image, 15, Class3, true, xResult);
				findWeakEdgeClass2 = findWeakConnectedEdgeOnImageHorizontal((int)posX, (int)posY, class2Image, 15, Class2, true, xResult);
				if (findWeakEdge || findWeakEdgeFuzzyC || findWeakEdgeClass3 || findWeakEdgeClass2 ) {
					float testX = posX, testY = posY;
					boolean lookFor3 = false;
					while (distCurrent < distOuter) {
				...
				findWeakEdge = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class1Image, 5, 0, Class1_weak, true, xResult);
				findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, fuzzyCImage, 5, 0, FuzzyC, true, xResult);
				findWeakEdgeClass3 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class3Image, 5, 0, Class3, true, xResult);
				if (findWeakEdge || findWeakEdgeFuzzyC || findWeakEdgeClass3) {
					break;
				}
				*/ 
			}
	...
	private Vector2f traceSection5(float posX, float posY, float stepX, float stepY, Vector3f center, float degree, int sliceNumber, int currentStep,
		...
		while ( fuzzyCIntensity != 3 && distCurrent < distOuter ) {
			...
			if (degree > section5_degree_lowerHalf_end - 20 && degree <= section5_degree_lowerHalf_end )  {
				boolean findWeakEdge = false;
				boolean findWeakEdgeFuzzyC = false;
				boolean findWeakEdgeClass3 = false;
				boolean findWeakEdgeClass2 = false;
				int []xResult = new int[1];
				xResult[0] = -1;
				findWeakEdge = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class1Image, 5, Class1_weak, false, xResult);
				findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, fuzzyCImage, 5, FuzzyC, false, xResult);
			    findWeakEdgeClass3 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class3Image, 5, Class3, false, xResult);
			    findWeakEdgeClass2 = findWeakConnectedEdgeOnImageHorizontal((int) posX, (int) posY, class2Image, 5, Class2, false, xResult);
			    ...
			    if (findWeakEdge || findWeakEdgeFuzzyC || findWeakEdgeClass3 || findWeakEdgeClass2 ) {	
					...
					xResult = new int[1];
					xResult[0] = -1;
					findWeakEdge = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class1Image, 5, Class1_weak, false, xResult);
					findWeakEdgeFuzzyC = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, fuzzyCImage, 5, FuzzyC, false, xResult);
				    findWeakEdgeClass3 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class3Image, 5, Class3, false, xResult);
				    findWeakEdgeClass2 = findWeakConnectedEdgeOnImageVertical((int) posX, (int) posY, class2Image, 5, Class2, false, xResult);
	...
	private void tracingDFS(ModelImage fatImageSlice, ModelImage fuzzyCImage, ModelImage class1Image, ModelImage class2Image, ModelImage class3Image,
		...
		for (i = 0; i < nPtsCurrent; i++) {
			...
			tenPercent = (int) (totalSliceNumber * 0.1f);
	...
	private void findBoundingContour(int sliceNumber, VOI resultVOIBoundary, VOI resultVOIInner, VOI resultVOIOuter, Vector3f center, ModelImage fatImageSlice) {
		...
		for (i = 0; i < nPtsCurrent; i++) {
			...
			distanceInner = distance * (1d - 0.12d);
			...
			if (degree >= section1_degree_start && degree < section1_degree_end) {
				...
				distanceOuter = distance * (1d + 0.05d); // 0.09
	...
	private void tracingDFS_mid(ModelImage greImageSlice, ModelImage fatImageSliceMid, VOI boundary, VOI inner, VOI outer, boolean first) {
		...
		findBoundingContour(midPt, boundary, inner, outer, center, fatImageSliceMid);
