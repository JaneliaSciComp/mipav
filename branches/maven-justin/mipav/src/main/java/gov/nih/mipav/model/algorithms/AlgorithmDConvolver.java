 ...
 *
 * <p>Since this class extends the AlgorithmDConvolverBase class that extends the Thread class it can be run in its own thread by
 ...
 */
public class AlgorithmDConvolver extends AlgorithmBase {
    ...
    // Used with 2D AlgorithmDConvolverAnistropicDiffusion
    private boolean sqrtXY = false;
    
    // used with 3D AlgorithmDConvolverAnistropicDiffusion
    private boolean sqrtXYZ = false;
    
    // Used with 2D AlgorithmDConvolverNMSuppression
    private boolean nms2 = false;
    
    // Used with 2D AlgorithmDConvolverEdgeNMSuppression
    private boolean nms2e = false;
    
    // Used with 3D AlgorithmDConvolverNMSuppression
    private boolean nms3 = false;
    
    // Used with 3D AlgorithmDConvolverEdgeNMSuppression
    private boolean nms3e = false;
    
    // Used with 3D and 4D AlgorithmDConvolverGradientMagnitude
    ...
    // Used with AlgorithmDConvolverBilateralFilter
    ...
    public AlgorithmDConvolver(ModelImage srcImage, double[] kernel, int[] kExtents, boolean entireImage, boolean image25D){
    	super(null, srcImage);
    	kernelBuffer = kernel;
    ...
    public AlgorithmDConvolver(ModelImage srcImage, double[] kernelX, double[] kernelY,
    ...
    public AlgorithmDConvolver(ModelImage srcImage, double[] kernelX, double[] kernelY, double[] kernelZ,
    ...
    public AlgorithmDConvolver(ModelImage srcImage, double[] kernelX, double[] kernelY, double[] kernelXX,
                              double[] kernelXY, double[] kernelYY, int[] kExtents, boolean entireImage) {
        super(null, srcImage);
        kernelBufferX = kernelX;
        kernelBufferY = kernelY;
    ...
    public AlgorithmDConvolver(ModelImage srcImage, double[] kernelX, double[] kernelY, double[] kernelXX,
            double[] kernelXY, double[] kernelYY, double[] kernelXXX, double[] kernelXXY,
            double[] kernelXYY, double[] kernelYYY, int[] kExtents, boolean entireImage) {
        super(null, srcImage);
        kernelBufferX = kernelX;
        kernelBufferY = kernelY;
        kernelBufferXX = kernelXX;
    ...
    public AlgorithmDConvolver(ModelImage srcImage, double[] kernelX, double[] kernelY, double[] kernelZ, double[] kernelXX,
            double[] kernelXY, double[] kernelYY, double[] kernelXZ, double[] kernelYZ, double[] kernelZZ,
    ...
    public AlgorithmDConvolver(ModelImage srcImage, double[] kernelX, double[] kernelY, double[] kernelZ, double[] kernelXX,
            double[] kernelXY, double[] kernelYY, double[] kernelXZ, double[] kernelYZ, double[] kernelZZ,
            double[] kernelXXX, double[] kernelXXY, double[] kernelXYY, double[] kernelYYY, double[] kernelXXZ,
            double[] kernelXZZ, double[] kernelXYZ, double[] kernelYYZ, double[] kernelYZZ, double[] kernelZZZ,
            int[] kExtents, boolean entireImage) {
        super(null, srcImage);
        kernelBufferX = kernelX;
        kernelBufferY = kernelY;
    ...
    public AlgorithmDConvolver(ModelImage srcImage, double kernelX[], double kernelY[], double kernelZ[], double kernelX2[],
                              double kernelY2[], int kExtents[], boolean entireImage, boolean combined2D3D) {
        super(null, srcImage);
        kernelBufferX = kernelX;
        kernelBufferY = kernelY;
        kernelBufferZ = kernelZ;
     ...
     */
    public static final synchronized double convolve2DPt(int pix, int[] iExtents, double[] image, int[] kExtents,
                                                        double[] kernel) {
        ...
        for (j = startY; j < endY; j += xDim) {
            ...
            for (i = startX; i < endX; i++) {
                ...
                if ((j >= 0) && (j < yLimit) && ((i - j) >= 0) && ((i - j) < xDim)) {
                    ...
                    // Run same image twice from AlgorithmDConvolverLevelSetDiffusion and
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final synchronized double convolveBilateral2DPt(int pix, int[] iExtents, double[] image, int[] kExtents,
                                                        double[] kernel, double intensityGaussianDenom) {
        ...
        startY = offsetY * xDim;
        endY = startY + (yKDim * xDim);
        double centerIntensityValue = image[pix];
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final synchronized double convolve2DPtSqrtXY(int pix, int[] iExtents, double[] image, int[] kExtents,
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final synchronized double convolve2DPtNMS(int pix, int[] iExtents, double[] image, int[] kExtents,
                                                        double[] kernelX, double[] kernelY, double[] kernelXX,
                                                        double[] kernelXY, double[] kernelYY) {
        ...
        if ((normX > 0) && (normY > 0) && (normXX > 0) && (normXY > 0) && (normYY > 0)) {
            ...
            ptXY = sumXY/ normXY;
            ptYY = sumYY/ normYY;
            return ((ptX * ptX * ptXX) + (2.0 * ptX * ptY * ptXY) + (ptY * ptY * ptYY));
        } else {
            return 0.0;
        }
    }
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final synchronized double convolve2DPtNMSE(int pix, int[] iExtents, double[] image, int[] kExtents,
                                                        double[] kernelX, double[] kernelY, double[] kernelXXX,
                                                        double[] kernelXXY, double[] kernelXYY, double[] kernelYYY) {
        ...
        if ((normX > 0) && (normY > 0) && (normXXX > 0) && (normXXY > 0) && (normXYY > 0) && (normYYY > 0)) {
            ...
            return ((ptX * ptX * ptX * ptXXX) + (3.0 * ptX * ptX * ptY * ptXXY) +
     ...
     * A static function that convolves a kernel with an image at a position.
     *
     * @param   pt        doubleing point indicating location of convolution
     * @param   iExtents  image dimensions
     * @param   image     image data
     * @param   kExtents  kernel dimensions
     * @param   kernel    kernel data
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve2DPt(Vector2f pt, int[] iExtents, double[] image, int[] kExtents, double[] kernel) {
     ...
     *
     * @see     gov.nih.mipav.model.AlgorithmDConvolvers.AlgorithmDConvolverLapMedianess
     *
     * @param   pix       index indicating location of convolution
     * @param   iExtents  image dimensions
     * @param   image     image data
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve2DPtMed(int pix, int[] iExtents, double[] image, int[] kExtents, double[] kernel) {
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve2DRGBPt(int pix, int[] iExtents, double[] image, int[] kExtents, double[] kernel) {
     ...
     */
    public static final double[] convolveBilateral2DCIELabPt(int pix, int[] iExtents, double[] image, int[] kExtents, double[] kernel,
                                                          double intensityGaussianDenom) {
        ...
        startY = offsetY * offset;
        endY = startY + (yKDim * offset);
        double centerLValue = image[pix+1];
        double centeraValue = image[pix+2];
        double centerbValue = image[pix+3];
        double LValue;
        double aValue;
        double bValue;
        double intensityGaussian;
        ...
        if (norm > 0) {
            buf[0] = (double)(sumL / norm);
            buf[1] = (double)(suma / norm);
            buf[2] = (double)(sumb / norm);
        }
        return buf;
    }
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve2DRGBPtSqrtXY(int pix, int[] iExtents, double[] image, int[] kExtents,
                                                double[] kernelX, double[] kernelY) {
        ...
        if ((normX > 0) && (normY > 0)) {
            xPt = sumX/ normX;
            yPt = sumY/ normY;
            return Math.sqrt(xPt*xPt + yPt*yPt);
        } else {
            return 0.0;
        }
    }
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DPt(int pix, int[] iExtents, double[] image, int[] kExtents, double[] kernel) {
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolveBilateral3DPt(int pix, int[] iExtents, double[] image, int[] kExtents, double[] kernel,
                                                    double intensityGaussianDenom) {
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DPtXYZ(int pix, int[] iExtents, double[] image, int[] kExtents,
                                              double[] kernelX, double[] kernelY, double[] kernelZ) {
        ...
        if ((normX > 0) && (normY > 0) && (normZ > 0)) {
            ...
            ptY = sumY/normY;
            ptZ = sumZ/normZ;
            return Math.sqrt(ptX*ptX + ptY*ptY + ptZ*ptZ);
        } else {
            return 0.0;
        }
    }
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DPtNMS(int pix, int[] iExtents, double[] image, int[] kExtents,
                                              double[] kernelX, double[] kernelY, double[] kernelZ,
                                              double[] kernelXX, double[] kernelXY, double[] kernelYY,
                                              double[] kernelXZ, double[] kernelYZ, double[] kernelZZ) {
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DPtNMSE(int pix, int[] iExtents, double[] image, int[] kExtents,
                                              double[] kernelX, double[] kernelY, double[] kernelZ,
                                              double[] kernelXXX, double[] kernelXXY, double[] kernelXYY,
                                              double[] kernelYYY, double[] kernelXXZ, double[] kernelXZZ,
                                              double[] kernelXYZ, double[] kernelYYZ, double[] kernelYZZ,
                                              double[] kernelZZZ) {
     ...
     * @param oImage
     */
    public final static void convolveBlock3D(int start, int end, int lpv, double[] iImage, 
    		int[] iExtents, int[] kExtents, double[] kernel, ModelImage oImage){
...
//    	}
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DPt(double[] pt, int[] iExtents, double[] image, int[] kExtents, double[] kernel) {
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DPtMed(int pix, int[] iExtents, double[] image, int[] kExtents, double[] kernel) {
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DRGBPt(int pix, int[] iExtents, double[] image, int[] kExtents, double[] kernel) {
     ...
     * @return  the L*,a*,b* of the pixel after convolution with the kernel
     */
    public static final double[] convolveBilateral3DCIELabPt(int pix, int[] iExtents, double[] image, int[] kExtents, double[] kernel,
                                                            double intensityGaussianDenom) {
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DRGBPtXYZ(int pix, int[] iExtents, double[] image, int[] kExtents,
                                                 double[] kernelX, double[] kernelY, double[] kernelZ) {
     ...
     *          the image
     */
    public static final double convolveWhole2DPt(int pix, int[] iExtents, double[] image, int[] kExtents,
                                                double[] kernel) {
     ...
     *          the image
     */
    public static final double convolveWhole3DPt(int pix, int[] iExtents, double[] image, int[] kExtents,
                                                double[] kernel) {
     ...
     * @return  the value of the pixel after convolution with the kernel
     */
    public static final double convolve3DPt(Vector3f kPt, ModelImage kImage, int[] kExtents, double[] kernel) {
            ...
            for ( int y = startY; y <= endY; y++ ) {
                for ( int x = startX; x <= endX; x++) {
                    if ( (x >= 0) && (x < xDim) && (y >= 0) && (y < yDim) && (z >= 0) && (z < zDim) )
                    {
                        ...
                        (y - startY) * xKDim +
                        (x - startX);
                        sum += kernel[index] * kImage.getDouble(x,y,z);
    ...
    private final void convolve2D(int startSlice, int endSlice){
    	...
    	for (int s = startSlice; s < endSlice; s++) {
			...
			try {
				...
				errorCleanUp("AlgorithmDConvolver Convolver: Image(s) locked", false);
			...
			if (color == true) {
				...
				for (int i = 0, idx = start; (i < length) && !threadStopped; i += 4, idx += 4) {
					...
					if ((entireImage == true) || mask.get(i / 4)) {
						...
						if (red) {
							outputBuffer[idx + 1] = AlgorithmDConvolver
						...
						if (green) {
							outputBuffer[idx + 2] = AlgorithmDConvolver
						...
						if (blue) {
							outputBuffer[idx + 3] = AlgorithmDConvolver
				...
				for (int i = 0, idx = start; (i < length) && !threadStopped; i++, idx++) {
					...
					if ((entireImage == true) || mask.get(i)) {
						outputBuffer[idx] = AlgorithmDConvolver.convolve2DPt(i,
        ...
        for (int s = startSlice; s < endSlice; s++) {
            ...
            if (color == true) {
                for (int i = 0, idx = start; (i < length) && !threadStopped; i += 4, idx += 4) {
                    ...
                    if ((entireImage == true) || mask.get(i / 4)) {
                        outputBuffer[idx] = buffer[i]; // alpha
                        resultBuffer = AlgorithmDConvolver.convolveBilateral2DCIELabPt(i,
                ...
                for (int i = 0, idx = start; (i < length) && !threadStopped; i++, idx++) {
                    ...
                    if ((entireImage == true) || mask.get(i)) {
                        outputBuffer[idx] = AlgorithmDConvolver.convolveBilateral2DPt(i,
                                srcImage.getExtents(), buffer, kExtents,
            ...
            if (color == true) {
                ...
                for (int i = 0, idx = start; (i < length) && !threadStopped; i += 4, idx += 4) {
                    ...
                    if ((entireImage == true) || mask.get(i / 4)) {
                        ...
                        if (red) {
                            outputBuffer[2*idx + 2] = AlgorithmDConvolver
                                    .convolve2DRGBPt(i + 1, srcImage
                                            .getExtents(), buffer, kExtents,
                                            kernelBufferX);
                            outputBuffer[2*idx + 3] = AlgorithmDConvolver
                            .convolve2DRGBPt(i + 1, srcImage
                                    .getExtents(), buffer, kExtents,
                                    kernelBufferY);
                        } else {
                        ...
                        if (green) {
                            outputBuffer[2*idx + 4] = AlgorithmDConvolver
                                    .convolve2DRGBPt(i + 2, srcImage
                                            .getExtents(), buffer, kExtents,
                                            kernelBufferX);
                            outputBuffer[2*idx + 5] = AlgorithmDConvolver
                            .convolve2DRGBPt(i + 2, srcImage
                                    .getExtents(), buffer, kExtents,
                                    kernelBufferY);
                        } else {
                        ...
                        if (blue) {
                            outputBuffer[2*idx + 6] = AlgorithmDConvolver
                                    .convolve2DRGBPt(i + 3, srcImage
                                            .getExtents(), buffer, kExtents,
                                            kernelBufferX);
                            outputBuffer[2*idx + 7] = AlgorithmDConvolver
                            .convolve2DRGBPt(i + 3, srcImage
                                    .getExtents(), buffer, kExtents,
                                    kernelBufferY);
                        } else {
                ...
                for (int i = 0, idx = start; (i < length) && !threadStopped; i++, idx++) {
                    ...
                    if ((entireImage == true) || mask.get(i)) {
                        outputBuffer[2*idx] = AlgorithmDConvolver.convolve2DPt(i,
                                srcImage.getExtents(), buffer, kExtents,
                                kernelBufferX);
                        outputBuffer[2*idx+1] = AlgorithmDConvolver.convolve2DPt(i,
                                srcImage.getExtents(), buffer, kExtents,
                                kernelBufferY);
                    } else {
                        outputBuffer[2*idx] = buffer[i];
        ...
        for (int s = startSlice; s < endSlice; s++) {
            ...
            if (color == true) {
                ...
                for (int i = 0, idx = start; (i < length) && !threadStopped; i++, idx++) {
                    ...
                    if ((entireImage == true) || mask.get(i)) {
                        outputBuffer[idx] = AlgorithmDConvolver.convolve2DPtSqrtXY(i,
                                srcImage.getExtents(), buffer, kExtents,
                                kernelBufferX, kernelBufferY);
                    } else {
                        outputBuffer[idx] = buffer[i];
    ...
    private final void convolve2DNMS(int startSlice, int endSlice){
        ...
        for (int s = startSlice; s < endSlice; s++) {
            ...
            for (int i = 0, idx = start; (i < length) && !threadStopped; i++, idx++) {
                ...
                if ((entireImage == true) || mask.get(i)) {
                    outputBuffer[idx] = AlgorithmDConvolver.convolve2DPtNMS(i,
                            srcImage.getExtents(), buffer, kExtents,
    ...
    private final void convolve2DNMSE(int startSlice, int endSlice){
        ...
        for (int s = startSlice; s < endSlice; s++) {
            ...
            for (int i = 0, idx = start; (i < length) && !threadStopped; i++, idx++) {
                ...
                if ((entireImage == true) || mask.get(i)) {
                    outputBuffer[2*idx] = AlgorithmDConvolver.convolve2DPtNMS(i,
                            srcImage.getExtents(), buffer, kExtents,
                            kernelBufferX, kernelBufferY, kernelBufferXX,
                            kernelBufferXY, kernelBufferYY);
                    outputBuffer[2*idx+1] = AlgorithmDConvolver.convolve2DPtNMSE(i,
                            srcImage.getExtents(), buffer, kExtents,
    	...
    	if(srcImage.isColorImage()){
    		for (int i = start; (i < end) && !threadStopped; i += 4) {
    			...
    			if ((entireImage == true) || mask.get(i / 4)) {
    				...
    				if (red) {
    					outputBuffer[i+index + 1] = AlgorithmDConvolver
    				...
    				if (green) {
    					outputBuffer[i+index + 2] = AlgorithmDConvolver
    				...
    				if (blue) {
    					outputBuffer[i+index + 3] = AlgorithmDConvolver
			...
			for (int i = start; (i < end) && !threadStopped; i++) {
				...
				if ((entireImage == true) || mask.get(i)) {
					outputBuffer[i + index] = AlgorithmDConvolver.convolve3DPt(i,
    ...
    private final void convolve3DBilateral(int start, int end, double[] iImage, int index){
        ...
        if(srcImage.isColorImage()){
            for (int i = start; (i < end) && !threadStopped; i += 4) {
                ...
                if ((entireImage == true) || mask.get(i / 4)) {
                    outputBuffer[i+index] = iImage[i]; // alpha
                    resultBuffer = AlgorithmDConvolver.convolveBilateral3DCIELabPt(i,
            ...
            for (int i = start; (i < end) && !threadStopped; i++) {
                ...
                if ((entireImage == true) || mask.get(i)) {
                    outputBuffer[i + index] = AlgorithmDConvolver.convolveBilateral3DPt(i,
                            srcImage.getExtents(), iImage, kExtents,
                            kernelBuffer, intensityGaussianDenom);
                } else {
                    outputBuffer[i + index] = iImage[i];
    ...
    private final void convolve2D3D(int start, int end, double[] iImage, int index,
        ...
        double[] iImage2 = new double[sliceMod];
        if(srcImage.isColorImage()){
            for (int i = start; (i < end) && !threadStopped; i += 4) {
                progress += 4;
                if ((progress % progressModulus) == 0) {
            ...
            for (int i = start; (i < end) && !threadStopped; i++) {
                ...
                if ((i >= min3DLength) && (i < max3DLength)) {
                    if ((entireImage == true) || mask.get(i)) {
                        outputBuffer[i + index] = AlgorithmDConvolver.convolve3DPtXYZ(i,
                                srcImage.getExtents(), iImage, kExtents,
                                kernelBufferX, kernelBufferY, kernelBufferZ);
                    } else {
                        outputBuffer[i + index] = iImage[i];
                    ...
                    if ((entireImage == true) || mask.get(i)) {
                        outputBuffer[i+index] = AlgorithmDConvolver.convolve2DPtSqrtXY(i - i3,
    ...
    private final void convolve3DNMS(int start, int end, double[] iImage, int index){
        for (int i = start; (i < end) && !threadStopped; i++) {
            ...
            if ((entireImage == true) || mask.get(i)) {
                outputBuffer[i + index] = AlgorithmDConvolver.convolve3DPtNMS(i,
                        srcImage.getExtents(), iImage, kExtents,
    ...
    private final void convolve3DNMSE(int start, int end, double[] iImage, int index){
        for (int i = start; (i < end) && !threadStopped; i++) {
            ...
            if ((entireImage == true) || mask.get(i)) {
                outputBuffer[2*(i + index)] = AlgorithmDConvolver.convolve3DPtNMS(i,
                        srcImage.getExtents(), iImage, kExtents,
                        kernelBufferX, kernelBufferY, kernelBufferZ, kernelBufferXX, kernelBufferXY,
                        kernelBufferYY, kernelBufferXZ, kernelBufferYZ, kernelBufferZZ);
                outputBuffer[2*(i + index)+1] = AlgorithmDConvolver.convolve3DPtNMSE(i,
                        srcImage.getExtents(), iImage, kExtents,
    ...
    public void run2D() {
        ...
        int length = cFactor * srcImage.getSliceSize();
        if (nms2e) {
            outputBuffer = new double[2*length];
        }
        else if (doXY && (!sqrtXY)) {
            outputBuffer = new double[2*length];
        }
        else {
            outputBuffer = new double[length];
        }
        progress = 0;
    ...
    public void run3D() {
        ...
        if(this.image25D){
            ...
            if (nms2e) {
                outputBuffer = new double[2*totalLength];
            }
            else if (doXY && (!sqrtXY)) {
                outputBuffer = new double[2*totalLength];
            }
            else {
                outputBuffer = new double[totalLength];
            }
            progressModulus = totalLength / (maxProgressValue-minProgressValue);

            if(this.multiThreadingEnabled){
    			final CountDownLatch doneSignal = new CountDownLatch(nthreads);
    			final double step = nSlices / nthreads;
            ...
            try {
                ...
                buffer = null;
                errorCleanUp("AlgorithmDConvolver Convolver: Image(s) locked", true);

                return;
            } catch (OutOfMemoryError e) {
                buffer = null;
                errorCleanUp("AlgorithmDConvolver Convolver: Out of memory", true);
    ...
    public void run4D(){
        ...
        try {
            length = cFactor * srcImage.getSliceSize() * srcImage.getExtents()[2];
            buffer = new double[length];
            outputBuffer = new double[length*srcImage.getExtents()[3]];
        } catch (OutOfMemoryError e) {
            buffer = null;
            errorCleanUp("AlgorithmDConvolver Convolver: Out of memory", true);
        ...
        for (int t = 0; (t < end) && !threadStopped; t++) {
			...
			try {
				...
				displayError("AlgorithmDConvolver Convolver: Image(s) locked");
				setCompleted(false);
			...
			if (this.multiThreadingEnabled) {
				final CountDownLatch doneSignal = new CountDownLatch(nthreads);
				final double step = ((double) length) / nthreads;
				for (int j = 0; j < nthreads; j++) {
     ...
     */
    private static double getTrilinear(int i1, double dx, double dy, double dz, int[] iExtents, double[] image) {
     ...
     * @return  the trilinearly interpolated data value
     */
    public static byte[] getTrilinearC(int i1, double dx, double dy, double dz, int[] iExtents, byte[] image) {
