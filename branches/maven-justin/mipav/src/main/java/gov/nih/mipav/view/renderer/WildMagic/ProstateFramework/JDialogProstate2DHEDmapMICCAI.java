...
/**
 * This class generates the VOIs from HED prediction maps.  Only takes MRI image slices into concern, no CED involved. 
 * 
 * 
 * @author Ruida Cheng
 * 
 */
public class JDialogProstate2DHEDmapMICCAI extends JDialogBase
	 ...
	 */
	public JDialogProstate2DHEDmapMICCAI(Frame theParentFrame) {
	...
	private void readKeyImageDir() {
		...
		File fileDir_5_test = new File("/data/ruida/MICAI2012/test_prostate_mask_iter_69000");
