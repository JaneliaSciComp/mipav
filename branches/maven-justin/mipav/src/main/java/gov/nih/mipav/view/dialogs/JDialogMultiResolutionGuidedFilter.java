 ...
 *
 * @see  MultiGuidedFilter
 */
public class JDialogMultiResolutionGuidedFilter extends JDialogScriptableBase
    ...
    /** DOCUMENT ME! */
    private MultiGuidedFilter mrgFilterAlgo;
  ...
  //~ Constructors ---------------------------------------------------------------------------------------------------
     ...
     */
    public JDialogMultiResolutionGuidedFilter() { }
     ...
     */
    public JDialogMultiResolutionGuidedFilter(Frame theParentFrame, ModelImage im) {
    ...
    private void init() {
        ...
        setTitle("Multiresolution Guided Filter");
    ...
    protected void callAlgorithm() {
        String name = makeImageName(image.getImageName(), "_multiResGuided");
        int[] destExtents;
        ...
        if (displayLoc == NEW) {
            ...
            try {
                ...
                mrgFilterAlgo.addListener(this);
                createProgressBar(image.getImageName(), mrgFilterAlgo);
                ...
                if (isRunInSeparateThread()) {
                    ...
                    if (mrgFilterAlgo.startMethod(Thread.MIN_PRIORITY) == false) {
                ...
                MipavUtil.displayError("Dialog Multiresolution Guided Filter: unable to allocate enough memory");
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof MultiGuidedFilter) {
            image.clearMask();

            if ((mrgFilterAlgo.isCompleted() == true) && (resultImage != null)) {
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("Applies a Multiresolution Guided filter.");
            }
            ...
            public String getShortLabel() {
                return new String("MultiresGuided");
            }

            public String getLabel() {
                return new String("Multiresolution Guided");
            }
