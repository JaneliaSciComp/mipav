 ...
 * 2. converts the data into png slices for both training and testing. 
 * 
 * 
 * @author Ruida Cheng
 * 
 */
public class JDialogProstate2DSlicesAtlasPngConverterMICCAI extends JDialogBase
	 ...
	 */
	public JDialogProstate2DSlicesAtlasPngConverterMICCAI(Frame theParentFrame) {
