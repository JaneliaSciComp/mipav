...
//  ~ Methods --------------------------------------------------------------------------------------------------------
    ...
    private void segmentImage() {
        ...
        if(totalVOI != null) {
            ...
            rightCurve = ((VOIContour)rightMarrowVOI.getCurvesTemp()[0].get(0));
            ...
            leftCurve = ((VOIContour)leftMarrowVOI.getCurvesTemp()[0].get(0));
            leftCurve.getBounds(leftBoundsX, leftBoundsY, leftBoundsZ);
            
          //rightX should be to the LEFT of leftx in this orientation
            float rightX = ((VOIContour)rightMarrowVOI.getCurvesTemp()[0].get(0)).get(0).X;
            float leftX = ((VOIContour)leftMarrowVOI.getCurvesTemp()[0].get(0)).get(0).X;
