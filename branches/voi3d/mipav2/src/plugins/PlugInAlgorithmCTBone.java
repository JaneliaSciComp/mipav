...
//  ~ Methods --------------------------------------------------------------------------------------------------------
    ...
    private void segmentImage() {
        ...
        if(totalVOI != null) {
            ...
            rightCurve = ((VOIContour)rightBoneVOI.getCurvesTemp()[0].get(0));
            ...
            leftCurve = ((VOIContour)leftBoneVOI.getCurvesTemp()[0].get(0));
            leftCurve.getBounds(leftBoundsX, leftBoundsY, leftBoundsZ);
            
            //rightX should be to the LEFT of leftx in this orientation
            float rightX = ((VOIContour)rightBoneVOI.getCurvesTemp()[0].get(0)).get(0).X;
            float leftX = ((VOIContour)leftBoneVOI.getCurvesTemp()[0].get(0)).get(0).X;
    ...
    private VOI makeBoneVOI() {
        ...
        theVOI.setName("Bone");
        if (theVOI.getCurvesTemp()[0].size() != 4) {
