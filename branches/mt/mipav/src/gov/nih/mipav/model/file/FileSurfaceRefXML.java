 ...
 */
public class FileSurfaceRefXML extends FileXML {

    //~ Static fields/initializers -------------------------------------------------------------------------------------
    /** array of strings representing the tags under <Surface> in the xml schema. */
    private static final String[] m_kSurfaceStr = { "Unique-ID", "Material", "Type", "Opacity", "LevelDetail", "Filename" };

    /** array of strings representing the tags under <Material> in the xml schema. */
    private static final String[] m_kMaterialStr = { "Ambient", "Diffuse", "Emissive", "Specular", "Shininess" };
    ...
    public FileSurfaceRefXML(String fName, String fDir) {
        super(fName, fDir);
        fileInfo = new FileInfoSurfaceRefXML(fName, fDir, FileUtility.SURFACEREF_XML);
    }
     ...
     */
    public FileInfoSurfaceRefXML getFileInfo() {
        return (FileInfoSurfaceRefXML) fileInfo;
    }
     ...
     */
    public FileInfoSurfaceRefXML readSurfaceXML(String headerFileName, String headerDir) throws IOException {
        SurfaceRefXMLHandler kHandler = null;
        
        // Set the ContentHandler of the XMLReader
        kHandler = new SurfaceRefXMLHandler((FileInfoSurfaceRefXML) fileInfo);
        m_kHandler = kHandler;
    ...
    private class SurfaceRefXMLHandler extends DefaultHandler {
        ...
        FileInfoSurfaceRefXML fileInfo;
         ...
         */
        public SurfaceRefXMLHandler(FileInfoSurfaceRefXML fInfo) {
            fileInfo = fInfo;
        }
