 ...
 */
public class ViewJComponentVolOpacityRGBWM extends ViewJComponentVolOpacityBaseWM {
     ...
     */
    public ViewJComponentVolOpacityRGBWM(JPanelVolOpacityRGBWM opacityPanel, ModelHistogram _histo, ModelImage _image) {
