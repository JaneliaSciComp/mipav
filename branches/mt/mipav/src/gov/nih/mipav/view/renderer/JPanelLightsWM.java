 ...
 */
public class JPanelLightsWM extends JPanelRendererBaseWM implements ChangeListener, MouseListener, ListSelectionListener {
    ...
    private GPUVolumeRenderWM m_kRenderSurface;
     ...
     */
    public JPanelLightsWM(GPUVolumeRenderWM kRenderSurface) {

        super(kRenderSurface);
        // m_kPanelSurface = kPanelSurface;
        m_kRenderSurface = kRenderSurface;
        rayBasedRenderWM = kRenderSurface;

        ModelImage image = renderBase.getParentFrame().getImageA();
