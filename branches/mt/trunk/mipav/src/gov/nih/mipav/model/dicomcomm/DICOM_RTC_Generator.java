...
public class DICOM_RTC_Generator {
    ...
    private static Hashtable hashKeywordEntries() {
        Hashtable tagTable = DicomDictionary.getDicomTagTable();

        FileDicomTagInfo tag;
        int i = 1;

        Hashtable hashKeyword = new Hashtable(tagTable.size());
    ...
    private static Hashtable hashRTCentries(Hashtable kwEntries) {
        ...
        Hashtable hashRTCentries = new Hashtable(tagTable.size());
        Enumeration e = tagTable.elements();
        ...
        while (e.hasMoreElements()) {
            ...
            hashRTCentries.put(count,
                               "new RTCEntry(0x0" + Integer.toHexString(tag.getKey().getGroupNumber()) + ", 0x0" +
    ...
    private static Hashtable hashVREntries() {
        ...
        Hashtable hashVR = new Hashtable(tagTable.size());
        Enumeration e = tagTable.elements();
