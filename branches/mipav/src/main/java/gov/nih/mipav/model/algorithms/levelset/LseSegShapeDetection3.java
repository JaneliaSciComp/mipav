...
public class LseSegShapeDetection3 extends LseSegmenter
{
    //~ Instance fields ------------------------------------------------------
     ...
     */
    public LseSegShapeDetection3 (int iXBound, int iYBound, int iZBound,
        ...
        float fLaplacianWeight, float fTimeStep)
    {
        ...
        m_kLevelSetEvolver = new LseShapeDetection3(m_iXBound,m_iYBound,
            m_iZBound,m_fXSpacing,m_fYSpacing,m_fZSpacing,m_afSignedDistance,
            m_abSignedDistanceMask,m_fBorderValue,LsePdeFilter.PRESERVE_ZERO,
            m_afFeature,fPropagationWeight,fCurvatureWeight);
