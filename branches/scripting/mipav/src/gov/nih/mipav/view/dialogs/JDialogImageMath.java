    ...
    public void insertScriptLine(AlgorithmBase algo) {
        ...
        if (algo.isCompleted()) {
            ...
            if (userInterface.isScriptRecording()) {
                ...
                userInterface.getScriptDialog().append("ImageMath " +
        ...
        if (image.getNDims() <= 5) {
            ...
            if (displayLoc == NEW) {
                ...
                try {
                    ...
                    // Make algorithm
                    mathAlgo = new AlgorithmImageMath(resultImage, image, opType, value, valueI, clipMode, regionFlag);
                ...
                try {
                    ...
                    mathAlgo = new AlgorithmImageMath(image, opType, value, valueI, clipMode, regionFlag);
