...
public class ParameterInt extends Parameter {
     ...
     */
    public ParameterInt(String paramLabel, String paramTypeString, int paramValue) throws ParserException {
     ...
     * @throws  ParserException  If there is a problem creating the parameter.
     */
    public ParameterInt(String paramLabel, String paramTypeString, String paramValueString) throws ParserException {
        super(paramLabel, paramTypeString);
     ...
     * @throws  ParserException  If there is a problem creating the parameter.
     */
    public ParameterInt(String paramLabel, int paramType, int paramValue) throws ParserException {
     ...
     * @throws  ParserException  If there is a problem creating the parameter.
     */
    public ParameterInt(String paramLabel, int paramType, String paramValueString) throws ParserException {
        super(paramLabel, paramType);
        setValue(paramValueString);
    }
     ...
     * @throws  ParserException  If there is a problem changing the parameter value.
     */
    public void setValue(int paramValue) throws ParserException {
        value = paramValue;
    }
}
