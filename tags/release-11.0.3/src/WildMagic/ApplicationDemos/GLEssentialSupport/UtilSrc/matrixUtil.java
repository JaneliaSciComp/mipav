...
public class matrixUtil {
	...
	public static void mtxMultiply(float[] ret, final float[] lhs, final float[] rhs)
	{
		// [ 0 4  8 12 ]   [ 0 4  8 12 ]
		// [ 1 5  9 13 ] x [ 1 5  9 13 ]
		// [ 2 6 10 14 ]   [ 2 6 10 14 ]
	...
	public static void mtxLoadPerspective(float[] mtx, float fov, float aspect, float nearZ, float farZ)
	{
		float f = (float) (1.0f / Math.tan( (fov * (Math.PI/180)) / 2.0f));
	...
	public static void mtxLoadOrthographic(float[] mtx,
	...
	public static void mtxModifyObliqueProjection(float[] mtx, final float[] src, final float[] plane)
	{
		...
		float dot = vectorUtil.vec4DotProduct(plane, vec);
	...
	public static void mtxTranspose(float[] mtx, final float[] src)
	{
	...
	public static void mtxInvert(float[] mtx, final float[] src)
	{
		...
		for(i = 0; i != 4; i++)
		{
			...
			for (j = i + 1; j != 4; j++)
			{
				if(Math.abs(tmp[(i << 2) + j]) > Math.abs(val))
				{
					ind = j;
					val = tmp[(i << 2) + j];
				}
	...
	public static void mtxLoadIdentity(float[] mtx)
	{
		// [ 0 4  8 12 ]
		// [ 1 5  9 13 ]
		// [ 2 6 10 14 ]
	...
	public static void mtxLoadTranslate(float[] mtx, float xTrans, float yTrans, float zTrans)
	{
	...
	public static void mtxLoadScale(float[] mtx, float xScale, float yScale, float zScale)
	{
		// [ x 4  8 12 ]
		// [ 1 y  9 13 ]
		// [ 2 6  z 14 ]
	...
	public static void mtxLoadRotateX(float[] mtx, float rad)
	{
		// [ 0 4      8 12 ]
		// [ 1 cos -sin 13 ]
		// [ 2 sin cos  14 ]
		...
		mtx[10] = mtx[ 5] = (float) Math.cos(rad);
		mtx[ 6] = (float) Math.sin(rad);
		mtx[ 9] = -mtx[ 6];
	...
	public static void mtxLoadRotateY(float[] mtx, float rad)
	{
		// [ cos 4  -sin 12 ]
		// [ 1   5   9   13 ]
		// [ sin 6  cos  14 ]
		...
		mtx[ 0] = mtx[10] = (float) Math.cos(rad); 
		mtx[ 2] = (float) Math.sin(rad);
		mtx[ 8] = -mtx[2];
	...
	public static void mtxLoadRotateZ(float[] mtx, float rad)
	{
		// [ cos -sin 8 12 ]
		// [ sin cos  9 13 ]
		// [ 2   6   10 14 ]
		...
		mtx[ 0] = mtx[ 5] = (float) Math.cos(rad); 
		mtx[ 1] = (float) Math.sin(rad);
		mtx[ 4] = -mtx[1];
	...
	public static void mtxLoadRotate(float[] mtx, float deg, float xAxis, float yAxis, float zAxis)
	{
		...
		mtx[12] = mtx[13] = mtx[14] = 0.0f;
		mtx[15] = 1.0f;
	}


	public static void mtxTranslateApply(float[] mtx, float xTrans, float yTrans, float zTrans)
	{
		// [ 0 4  8 12 ]   [ 1 0 0 x ]
		// [ 1 5  9 13 ] x [ 0 1 0 y ]
		// [ 2 6 10 14 ]   [ 0 0 1 z ]
	...
	public static void mtxScaleApply(float[] mtx, float xScale, float yScale, float zScale)
	{ 
		// [ 0 4  8 12 ]   [ x 0 0 0 ]
		// [ 1 5  9 13 ] x [ 0 y 0 0 ] 
		// [ 2 6 10 14 ]   [ 0 0 z 0 ]
	...
	public static void mtxTranslateMatrix(float[] mtx, float xTrans, float yTrans, float zTrans)
	{
		// [ 1 0 0 x ]   [ 0 4  8 12 ]
		// [ 0 1 0 y ] x [ 1 5  9 13 ]
		// [ 0 0 1 z ]   [ 2 6 10 14 ]
	...
	public static void mtxRotateXApply(float[] mtx, float deg)
	{
		// [ 0 4  8 12 ]   [ 1  0    0  0 ]
	...
	public static void mtxRotateYApply(float[] mtx, float deg)
	{
	...
	public static void mtxRotateZApply(float[] mtx, float deg)
	{
	...
	public static void mtxRotateApply(float[] mtx, float deg, float xAxis, float yAxis, float zAxis)
	{	
	...
	public static void mtxScaleMatrix(float[] mtx, float xScale, float yScale, float zScale)
	{ 
		// [ x 0 0 0 ]   [ 0 4  8 12 ]
		// [ 0 y 0 0 ] x [ 1 5  9 13 ]
		// [ 0 0 z 0 ]   [ 2 6 10 14 ]
	...
	public static void mtxRotateXMatrix(float[] mtx, float rad)
	{
		// [ 1  0    0  0 ]   [ 0 4  8 12 ]
	...
	public static void mtxRotateYMatrix(float[] mtx, float rad)
	{
	...
	public static void mtxRotateZMatrix(float[] mtx, float rad)
	{
	...
	public static void mtxRotateMatrix(float[] mtx, float rad, float xAxis, float yAxis, float zAxis)
	{
		float[] rotMtx = new float[16];
	...
	public static void mtx3x3LoadIdentity(float[] mtx)
	{
	...
	public static void mtx3x3FromTopLeftOf4x4(float[] mtx, final float[] src)
	{    
		mtx[0] = src[0];
		mtx[1] = src[1];
		mtx[2] = src[2];
	...
	public static void mtx3x3Transpose(float[] mtx, final float[] src)
	{  
		float tmp;  
		mtx[0] = src[0];
		mtx[4] = src[4];
	...
	public static void mtx3x3Invert(float[] mtx, final float[] src)
	{    
		float[] cpy = new float[9];
		float det =
	...
	public static void mtx3x3Multiply(float[] mtx, final float[] lhs, final float[] rhs)
	{
