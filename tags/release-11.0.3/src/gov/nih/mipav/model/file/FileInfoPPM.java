...
public class FileInfoPPM extends FileInfoBase {
     ...
     * @param  format     the file format (Portable Pixmap Utilities)
     */
    public FileInfoPPM(String name, String directory, int format) {
