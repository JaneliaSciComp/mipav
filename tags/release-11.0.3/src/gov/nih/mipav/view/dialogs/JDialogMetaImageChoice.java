 ...
 * @version  1.0
 */
public class JDialogMetaImageChoice extends JDialogBase {
     ...
     */
    public JDialogMetaImageChoice(Frame theParentFrame) {
     ...
     */
    private void init() {
        setTitle("Choose type of MetaImage file");
        ...
        oneFile = new JRadioButton("Header and data in one .mha file", true);
        ...
        gbc.gridy = 1;
        twoFiles = new JRadioButton("Header in .mhd file and image in .raw file", false);
