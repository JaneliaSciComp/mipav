...
import nibib.spim.PlugInDialogGenerateFusion543c;
...
public class PlugInGenerateFusion543c implements PlugInGeneric {
    ...
    public void run() {
        PlugInDialogGenerateFusion543c test = new PlugInDialogGenerateFusion543c(false);
