...
import nibib.spim.PlugInDialogStageScan;
 ...
 */
public class PlugInStageScan implements PlugInGeneric {
    ...
    public void run() {
        PlugInDialogStageScan test = new PlugInDialogStageScan(false);
