...
public class PlugInDialogStrokeSegmentationListenerSIR extends JFrame implements ActionListener, WindowListener {
...
//    private int maxWaitTime = 15;
    ...
    private StrokeSegmentationDicomReceiverSIR dicomReceiver;
    ...
    public PlugInDialogStrokeSegmentationListenerSIR() {
    ...
    private void init() {
        ...
        JLabel labelNumSlices = new JLabel("Minimum number of expected slices per ADC/DWI/FLAIR volume");
...
//        minExpectedSlicesField.setText(intArrayToStr(minExpectedSlicesPWI));
//        gbc.fill = GridBagConstraints.NONE;
//        gbc.gridx++;
...
//        JLabel labelMaxWait = new JLabel("Maximum number of minutes to wait for PWI data before processing only ADC/DWI");
        JLabel labelMaxWait = new JLabel("Maximum number of minutes to wait for FLAIR data before processing only ADC/DWI");
...
//        minExpectedSlicesPWI = strToIntArray(minExpectedSlicesPWIField.getText());
    ...
    protected void callAlgorithm() {
        try {
            ...
            dicomReceiver = new StrokeSegmentationDicomReceiverSIR(ipAddress, port, ae, outputDir, reportDir, minExpectedSlices, /*minExpectedSlicesPWI,*/ maxWaitTime, doEmailReport, logOutputArea);
        } catch (IOException e) {
            e.printStackTrace();
