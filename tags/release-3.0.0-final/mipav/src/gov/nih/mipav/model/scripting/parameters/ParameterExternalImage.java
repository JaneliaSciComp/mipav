 ...
 * image parameter indicates that the image is not generated by other script actions; it must be specified externally
 * by whatever is running the script that this parameter is used in.
 */
