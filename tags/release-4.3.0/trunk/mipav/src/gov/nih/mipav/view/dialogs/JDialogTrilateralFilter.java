...
/**
 * Dialog to get user input, then call the algorithm. The user sets the stsandard deviation of the domain filter.
 *
 * @version  0.1 February 23, 2009
 * @author   William Gandler
 * @see      AlgorithmTrilateralFilter
 */
public class JDialogTrilateralFilter extends JDialogScriptableBase implements AlgorithmInterface, DialogDefaultsInterface {
