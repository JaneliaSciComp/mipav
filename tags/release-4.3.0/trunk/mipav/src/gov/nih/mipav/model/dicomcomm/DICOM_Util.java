...
public class DICOM_Util {
     ...
     * @throws  DICOM_Exception  DOCUMENT ME!
     */
    public static void determineSOPClassUIDAndPush(String UID, DICOM_Object dco, DICOM_Object ddo, DICOM_Object dcor)
            throws DICOM_Exception {

        if (UID == null) {
            UID = determineSOPClassUID(dco, ddo);
        }
    ...
    public static final String timeStamper() {
        ...
        timeStamp = "[" + addLeadingZeros(cal.get(Calendar.MONTH) + 1, 2) + "/" +
                    ...
                    addLeadingZeros(cal.get(Calendar.MINUTE), 2) + ":" + addLeadingZeros(cal.get(Calendar.SECOND), 2) +
    ...
    public static String unpadStringVal(byte[] byteArray) {
        ...
        if (byteArray.length > 0) {
            ...
            if ((byteArray.length % 2) == 0) { // even but possibly padded
                ...
                if ((byteArray[byteArray.length - 1] == 0) || (byteArray[byteArray.length - 1] == ' ')) { // data padded with a zero or space
