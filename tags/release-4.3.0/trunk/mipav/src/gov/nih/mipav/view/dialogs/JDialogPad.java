...
public class JDialogPad extends JDialogScriptableBase implements AlgorithmInterface {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmPad) {
    ...
    protected void callAlgorithm() {
        ...
        if (displayLoc == NEW) {
            ...
            try {
                ...
                padAlgo = new AlgorithmPad(resultImage, image, padValue, xBounds, yBounds, zBounds);
    ...
    protected JTextField determineNull() {
        ...
        try {
            ...
            MipavUtil.displayError("JDialogPadParam reports: Unknown Error");
    ...
    private void init() {
        ...
        valueLabel.setRequestFocusEnabled(false);
        gbc.gridwidth = 2; // GridBagConstraints.RELATIVE;
    ...
    private boolean setVariables() {
        ...
        try {
            ...
            padValue = Integer.parseInt(valueInput.getText()); // in intensity value 
