 ...
 */
public class JPanelSculptorWM extends JPanelRendererBaseWM {
    ...
    private GPUVolumeRenderWM m_kVolumeRendererGPU = null;
     ...
     */
    public JPanelSculptorWM(GPUVolumeRenderWM parent) {
        // super(parent);
        // surRender = (SurfaceRender) parent;
    	m_kVolumeRendererGPU = parent;
        init();
    ...
    public void disposeLocal(boolean flag) {
        ...
        if (m_kVolumeRendererGPU != null) {
        	// m_kVolumeRendererGPU.disdisposeLocal(false);
        	m_kVolumeRendererGPU = null;
        }
    }
     ...
     * @param  _rayBasedRender  VolumeRenderer
     */
    public void setVolumeSculptor(GPUVolumeRenderWM _rayBasedRender) {
