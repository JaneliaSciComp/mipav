 ...
 */
public abstract class ViewJComponentVolOpacityBaseWM extends JComponent implements MouseListener, MouseMotionListener {
    ...
    protected JPanelVolOpacityBaseWM parentPanel;
     ...
     */
    public ViewJComponentVolOpacityBaseWM(JPanelVolOpacityBaseWM parent, ModelHistogram histo, ModelImage image,
                                        Dimension compDim) {
    ...
    public void mouseDragged(MouseEvent mouseEvent) {
        ...
        if (parentPanel instanceof JPanelVolOpacityWM) {
            ((JPanelVolOpacityWM) parentPanel).updateSlider(this);
        } 
        /*
