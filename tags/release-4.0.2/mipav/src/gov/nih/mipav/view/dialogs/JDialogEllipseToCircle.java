...
public class JDialogEllipseToCircle extends JDialogBase implements AlgorithmInterface, ItemListener, WindowListener {
    ...
    /** DOCUMENT ME! */
    private AlgorithmEllipseToCircle ecAlgo = null;
     ...
     */
    public JDialogEllipseToCircle(Frame theParentFrame, ModelImage im) {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmEllipseToCircle) {
            Preferences.debug("Ellipse To Circle: " + algorithm.getElapsedTime());
            image.clearMask();

            if ((ecAlgo.isCompleted() == true) && (resultImage != null)) {
    ...
    private void callAlgorithm() {
        ...
        try {
            ...
            // Make algorithm
            ecAlgo = new AlgorithmEllipseToCircle(resultImage, image);

            // This is very important. Adding this object as a listener allows the algorithm to
            // notify this object when it has completed of failed. See algorithm performed event.
            // This is made possible by implementing AlgorithmedPerformed interface
            ecAlgo.addListener(this);
            ...
            if (isRunInSeparateThread()) {
                ...
                if (ecAlgo.startMethod(Thread.MIN_PRIORITY) == false) {
            ...
            System.gc();
            MipavUtil.displayError("Dialog Ellipse To Circle: unable to allocate enough memory");
