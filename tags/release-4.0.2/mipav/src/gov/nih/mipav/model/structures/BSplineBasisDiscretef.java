...
/**
 * This class is an implementation of an open uniform B-Spline with equally spaced samples taken over the input [0,1]
 * interval. The basis function evaluations are precomputed at each sample and for each control point so that getting
 * the position for an input value is simply a table lookup and does not involve any calculations.
 */
public class BSplineBasisDiscretef extends BSplineBasisf {
     ...
     * basis functions. These basis functions have been sampled equally over the [0,1] input interval.
     *
     * @param   iNumCtrlPoints  int Number of control points.
    ...
    /**
     * Return the position basis function evaluation which determines how much the specified control point affects the
     * specified sample.
     *
     * @param   iControl  int Index of a specified control point.
    ...
    /**
     * Return the first derivative basis function evaluation which determines how much the specified control point
     * affects the specified sample.
     *
     * @param   iControl  int Index of a specified control point.
     * @param   iSample   int Index of a specified sample.
     *
    ...
    /**
     * Return the second derivative basis function evaluation which determines how much the specified control point
     * affects the specified sample.
     *
     * @param   iControl  int Index of a specified control point.
     * @param   iSample   int Index of a specified sample.
