 ...
 * triangular matrix R so that A = Q*R.</P>
 *
 * <P>The QR decompostion always exists, even if the matrix does not have full rank, so the constructor will never fail.
 * The primary use of the QR decomposition is in the least squares solution of nonsquare systems of simultaneous linear
 * equations. This will fail if isFullRank() returns false.</P>
 */
...
public class QRDecomposition implements java.io.Serializable {
    ...
    private static final long serialVersionUID = -3313457907079024012L;
