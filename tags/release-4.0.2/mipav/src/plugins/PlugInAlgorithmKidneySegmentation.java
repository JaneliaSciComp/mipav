    ...
    private void calc3D() {
        ...
        for (rep = 0; rep <= 1; rep++) {
            ...
            if (areaCorrect) {
                ...
                curves3 = contourVOI3.getCurves();
                mask.clear();
                contourVOI3.createBinaryMask(mask, xDim, yDim, xor, onlyActive);
