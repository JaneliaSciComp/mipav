...
/**
 *	Provides functions to convolve an image with the second derivitive of
 *	the Gaussian function to obtain the Hessian matrix for a particular point on the image.
 *
