...
{
    /**
     * This method determines whether two String objects have the same characters
     * up to the beginning index of the last numerical sequence of numerals.
     */
     ...
     * The encompassing Vector will hold references to Vectors of String, which should
     * represent a set of related data. The related data is meant to have the same characters
     * up until the beginning index of the last numerical sequence of numerals.
     *
    ...
    /**
     * The purpose of this method is to find the index location of a String that is the
     * beginning of the last numerical sequence. For example, when passed the string "dicom84.dcm"
    ...
    /**
     * Alternative to lastNumericalSequenceBegin(String, int), this method should be called
     * if you don't already have the index of the end of the last numerical sequence in
    ...
    /**
     * The purpose of this method is to find the index location of a String that is the
     * end of the last numerical sequence. For example, when passed the string "dicom84.dcm"
    ...
    /**
     * The purpose of this method is to compare two filename strings on the basis of their
     * last numerical sequence. For example, the filenames "dicom84.dcm" and "dicom83.dcm"
     * will be compared to each other on the numbers 83 and 84.
     *
     * @param str1 String
     * @param str2 String
     * @return int
    ...
    /**
     * This method takes a sorted Vector of Vectors as a parameter. The encompassing Vector holds
     * references to Vectors of a particular set of Strings. These sets are sorted based on their last
     * numerical sequence of numerals. The rearranged Vector is then returned.
     *
     * @param vector Vector
     * @return Vector
     */
