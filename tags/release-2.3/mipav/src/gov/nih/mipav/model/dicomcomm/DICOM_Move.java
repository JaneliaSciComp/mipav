...
/**
 *  This is the DICOM move class that defines functions to compose and send move requests
 *  to the server found in the .preferences file.  It runs in a separate thread, so it
...
public class DICOM_Move implements Runnable {
    ...
    */
    ...
    /**
    *   Sets up the data object (IOD) for a patient root study level C-Move request
    *    given patID and study instance UID.
    ...
    */
    ...
    /**
    *   Set up the data object (IOD) for a patient root series level C-Move request
    *   given patID, study instance UID, and series instance UID.
    ...
    */
    ...
    /**
    *   Sets up the data object (IOD) for a patient root image level C-Move
    *   request given patID, study instance UID, series instance UID, and SOP Instance UID.
    ...
    */
    public DICOM_Object setMoveImageData(String patientID,
                                            String studyInstUID,
    ...
    */
    ...
    /**
    *   Sets up the neccessary parameters for sending a move request. Must be
