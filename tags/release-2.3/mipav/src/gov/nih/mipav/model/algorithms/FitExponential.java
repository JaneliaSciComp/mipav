...
/**
 *   FitExponential -fits an array of points to an exponential of the
 *   type y = a0 + a1*exp(a2*x).
 *
...
public class FitExponential extends NLEngine {
    ...
    /**
     *   		 Starts the analysis. For some reason a guess with the
     *            wrong sign for a2 will not converge. Therefore, try
     *            both sign and take the one with the lowest chi-squared
     *            value.
     */
    public void driver() {
        int i;
