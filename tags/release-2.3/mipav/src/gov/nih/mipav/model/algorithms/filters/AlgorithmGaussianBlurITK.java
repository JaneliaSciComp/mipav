 ...
 *
 */
public class AlgorithmGaussianBlurITK
     ...
     */
    public AlgorithmGaussianBlurITK(ModelImage destImg, ModelImage srcImg,
                                    float sigmas[], boolean img25D) {
    ...
    public void runAlgorithm() {
        ...
        // 2D or 2.5D
        if ( (2 == srcImage.getNDims()) ||
            (3 == srcImage.getNDims() && image25D)) {

            itkRecursiveGaussianImageFilterF2F2_Pointer kFilterX =
                itkRecursiveGaussianImageFilterF2F2.itkRecursiveGaussianImageFilterF2F2_New();
            itkRecursiveGaussianImageFilterF2F2_Pointer kFilterY =
                itkRecursiveGaussianImageFilterF2F2.itkRecursiveGaussianImageFilterF2F2_New();
            ...
            if (2 == srcImage.getNDims() && srcImage.isColorImage()) {
                ...
                if (null != destImage) {
                    ...
                    for (int iChannel = 0; iChannel < 4; iChannel++) {
                        ...
                        if (abProcessChannel[iChannel]) {
                            ...
                            InsightToolkitSupport.itkTransferImageColor2D(
                                kImageSrcITK,
                                kFilterOut.GetOutput(),
                                mask,
                                destImage,
                                iChannel);
                        }
                ...
                // store result back into the source image
                    ...
                    for (int iChannel = 0; iChannel < 4; iChannel++) {
                        if (abProcessChannel[iChannel]) {
                            itkImageF2 kImageSrcITK =
                                InsightToolkitSupport.itkCreateImageColor2D(srcImage, iChannel);
                            kFilterIn.SetInput(kImageSrcITK);
                            kFilterOut.Update();
            ...
            // Single channel 2D
                ...
                itkImageF2 kImageSrcITK =
                    InsightToolkitSupport.itkCreateImageSingle2D(srcImage);
                kFilterIn.SetInput(kImageSrcITK);
                kFilterOut.Update();
                ...
                if (null != destImage) {
                    ...
                    InsightToolkitSupport.itkTransferImageSingle2D(
                        kImageSrcITK,
                        kFilterOut.GetOutput(),
                        mask,
                        destImage);
            ...
            // Color 2.5D
                ...
                if (null != destImage) {
                    ...
                    for (int iSlice = 0; iSlice < iNumSlices; iSlice++) {
                        ...
                        for (int iChannel = 0; iChannel < 4; iChannel++) {
                            itkImageF2 kImageSrcITK =
                                InsightToolkitSupport.itkCreateImageColorSlice(srcImage, iSlice, iChannel);
                            ...
                            if (abProcessChannel[iChannel]) {
                                ...
                                InsightToolkitSupport.itkTransferImageColorSlice(
                                    kImageSrcITK,
                                    kFilterOut.GetOutput(),
                                    mask,
                                    destImage,
            ...
            // Single channel 2.5D
                ...
                if (null != destImage) {
                    ...
                    for (int iSlice = 0; iSlice < iNumSlices; iSlice++) {
                        ...
                        itkImageF2 kImageSrcITK =
                            InsightToolkitSupport.itkCreateImageSingleSlice(srcImage, iSlice);
                        kFilterIn.SetInput(kImageSrcITK);
                        kFilterOut.Update();

                        InsightToolkitSupport.itkTransferImageSingleSlice(
                            kImageSrcITK,
                            kFilterOut.GetOutput(),
                            mask,
                            destImage,
        ...
        // 3D
            ...
            itkRecursiveGaussianImageFilterF3F3_Pointer kFilterX =
                itkRecursiveGaussianImageFilterF3F3.itkRecursiveGaussianImageFilterF3F3_New();
            itkRecursiveGaussianImageFilterF3F3_Pointer kFilterY =
                itkRecursiveGaussianImageFilterF3F3.itkRecursiveGaussianImageFilterF3F3_New();
            itkRecursiveGaussianImageFilterF3F3_Pointer kFilterZ =
                itkRecursiveGaussianImageFilterF3F3.itkRecursiveGaussianImageFilterF3F3_New();
            ...
            if (srcImage.isColorImage()) {
                ...
                if (null != destImage) {
                    ...
                    for (int iChannel = 0; iChannel < 4; iChannel++) {
                        itkImageF3 kImageSrcITK =
                            InsightToolkitSupport.itkCreateImageColor3D(srcImage, iChannel);
                        ...
                        if (abProcessChannel[iChannel]) {
                            ...
                            InsightToolkitSupport.itkTransferImageColor3D(
                                kImageSrcITK,
                                kFilterOut.GetOutput(),
                                mask,
                                destImage,
            ...
            // Single channel 3D
                ...
                itkImageF3 kImageSrcITK =
                    InsightToolkitSupport.itkCreateImageSingle3D(srcImage);
                kFilterIn.SetInput(kImageSrcITK);
                kFilterOut.Update();
                ...
                if (null != destImage) {
                    ...
                    InsightToolkitSupport.itkTransferImageSingle3D(
                        kImageSrcITK,
                        kFilterOut.GetOutput(),
                        mask,
                        destImage);
