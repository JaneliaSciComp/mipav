...
/**
 * Runs threshold (lower and upper) on color images and replaces
 * values either outside (inverse) or inside (normal) with the fill values specified
 * @author Ben Link
 * @version 1.0
 */
public class AlgorithmThresholdDualRGB extends AlgorithmBase {
     ...
     */
    public AlgorithmThresholdDualRGB(ModelImage destImg, ModelImage srcImg, float[] thresholdR,
                                     float[] thresholdG, float[] thresholdB, float[] fillValues,
                                     boolean[] useChannels, boolean maskFlag, boolean isInverse) {
     ...
     * @param isInverse boolean replace values outside (true) or inside (false)
     */
    public AlgorithmThresholdDualRGB(ModelImage srcImage, float[] thresholdR,
                                     float[] thresholdG, float[] thresholdB, float[] fillValues,
                                     boolean[] useChannels, boolean maskFlag, boolean isInverse) {
        super(null, srcImage);
        this.thresholdR = thresholdR;
    ...
    private void constructLog() {
        historyString = new String("Threshold(" +
                                   String.valueOf(thresholdR[0]) + ", " +
                                   String.valueOf(thresholdR[1]) + ", " +
                                   String.valueOf(thresholdG[0]) + ", " +
                                   String.valueOf(thresholdG[1]) + ", " +
                                   String.valueOf(thresholdB[0]) + ", " +
                                   String.valueOf(thresholdB[1]) + ", " +
                                   String.valueOf(fillValues[0]) + ", " +
