...
/**
 *  Algorithm to create a 3D subset image from a 4D image.  The user specifies the
 *  dimension to remove - x, y, z, or t and the value of the removed dimension.
 */
                ...
                if ( srcImage.getFileInfo( 1 ) != null ) {
                    ...
                    if ( ( nextPositionCoords[0] != imagePositionCoords[0] )
                        ...
                        MipavUtil.displayWarning(
                                "Remove Slices does not support changes in\n" + "image position (DICOM tag 0020,0032)\n"
