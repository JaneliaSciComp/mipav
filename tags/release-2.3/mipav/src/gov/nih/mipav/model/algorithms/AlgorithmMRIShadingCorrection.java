...
public class AlgorithmMRIShadingCorrection extends AlgorithmBase {
  ...
  private int iters;
  // If true, don't use periphery pixels below threshold or pixels below
  // threshold connected to periphery pixels below threshold thru a 4 neighbor
  // chain of below threshold pixels.
  ...
  //     Physics in Medicine and Biology, Vol. 49, 2004, pp. 4119-4133.
     ...
     *   @param scaleY
     *   @param iters
     *   @param thresholdSelected
     *   @param thresholdLevel
     */
    public AlgorithmMRIShadingCorrection( ModelImage resultImage,
           ModelImage srcImage, float norm, float scaleX, float scaleY,
           int iters, boolean thresholdSelected, float thresholdLevel) {
    ...
    public AlgorithmMRIShadingCorrection(ModelImage srcImage,
           float norm, float scaleX, float scaleY, int iters,
          ...
          for (it = 1; it <= iters; it++) {
            ...
            if (backgroundPresent) {
              lapAlgo = new AlgorithmLaplacian(image2, lapSigmas,
                                               objectBuffer, image25D, ampFactor);
            }
            else {
              lapAlgo = new AlgorithmLaplacian(image2, lapSigmas,
