 ...
 *  The three mouse buttons act like a joystick.  Rotation is controlled
 *  with the left mouse button and the middle mouse button.  Zoom is
 *  controlled with the left mouse button; translation is controlled with
 ...
 *  Left  - rolls left          <br>
 *  <p>
 *  A slider in the dialog controls the speed of these changes.  Also, the
 *  further away from the center of the canvas the mouse event is, the faster
 *  it will occur.  So if the user points the mouse with the left mouse button
 *  at the very top of the canvas, the image will zoom out quickly.  If the user
 *  points the mouse with the left mouse button only slightly above the center of the
 *  canvas, the image will zoom out slowly.
 *
 */
public class FlyBehavior
  ...
  /**
   *   Processes the mouse event, setting yaw, pitch, roll, and
   *   velocity depending on mouse button and position.
  ...
  /**
   *   Sets up the new transform by creating transforms
   *   from the determined pitch, yaw, and roll angles and
   *   multiplying these with the velocity.
   */
