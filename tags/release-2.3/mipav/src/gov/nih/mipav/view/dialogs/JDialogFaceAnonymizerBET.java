...
import gov.nih.mipav.model.algorithms.AlgorithmFaceAnonymizerBET;
 ...
 * @author mccreedy
 */
public class JDialogFaceAnonymizerBET extends JDialogBase implements AlgorithmInterface, DialogDefaultsInterface,
        ScriptableInterface {
        ...
        if (algo.isCompleted()) {
            ...
            if (ui.isScriptRecording()) {
                ...
                ui.getScriptDialog().append(
                        "FaceAnonymizerBET " + ui.getScriptDialog().getVar(srcImage.getImageName()) + " ");
     ...
     */
    private static final int getFaceOrientation(ModelImage img) {
