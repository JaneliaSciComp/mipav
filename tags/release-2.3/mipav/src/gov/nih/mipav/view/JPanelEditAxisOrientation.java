...
*   of "Unknown" is not an option.  Analyze
...
public class JPanelEditAxisOrientation extends JPanelEdit {
    ...
    *   <table>
    *   <tr><td>tRight to Left          </td><td>0</td></tr>
    *   <tr><td>Left to Right           </td><td>1</td></tr>
    *   <tr><td>Posterior to Anterior   </td><td>2</td></tr>
    *   <tr><td>Anterior to Posterior   </td><td>3</td></tr>
    *   <tr><td>Inferior to Superior    </td><td>4</td></tr>
    *   <tr><td>Superior to Inferior    </td><td>5</td></tr>
    *   </table>
    *   @return an Integer.
    ...
    */
    public Object getCodedValue() {
        ...
        switch (orientationBox.getSelectedIndex()) {
            case 0: value = new Integer(FileInfoBase.ORI_UNKNOWN_TYPE); break;
            case 1: value = new Integer(FileInfoBase.ORI_R2L_TYPE);     break;
            case 2: value = new Integer(FileInfoBase.ORI_L2R_TYPE);     break;
            case 3: value = new Integer(FileInfoBase.ORI_P2A_TYPE);     break;
            case 4: value = new Integer(FileInfoBase.ORI_A2P_TYPE);     break;
            case 5: value = new Integer(FileInfoBase.ORI_I2S_TYPE);     break;
            case 6: value = new Integer(FileInfoBase.ORI_S2I_TYPE);     break;
        }
        return value;
    }
