 ...
 public class RubberbandPolyline extends Rubberband {
    ...
    */
    public void mouseReleased(MouseEvent mouseEvent) {
        ...
        // open - Polyline VOI
        if ((((ViewJComponentEditImage)(component)).getZoomX() >= 8.0f) &&
            isActive() && contour.size() > 2 &&
        ...
        // User clicked back again on first point.  closed - Polygon VOI
                 ...
                 (((ViewJComponentEditImage)(component)).getZoomX() >= 1.0f) &&
                 isActive() && contour.size() > 2 &&
        ...
        else if ((((ViewJComponentEditImage)(component)).getZoomX() < 1.0f) &&
                 isActive() && contour.size() > 2 &&
                 distance (xxS, (int)((Point3Df)(contour.elementAt(0))).x,
                           yyS, (int)((Point3Df)(contour.elementAt(0))).y) < (3 * (1.0/((ViewJComponentEditImage)(component)).getZoomX())) ) {
            open = false;
            done = true;
        }
