...
public class JDialogMagnificationControls extends JDialogBase implements ActionListener, ChangeListener, WindowListener {
    ...
    */
	public JDialogMagnificationControls (Frame theParentFrame, ViewJComponentEditImage im, float initZoom, String title) {
		...
		if (componentImage.getZoomX()*100 > max) max = (int)(componentImage.getZoomX()*100);
        ...
        gbc.gridx = 0; gbc.gridy = 0; gbc.weightx = 1; gbc.anchor = gbc.WEST; gbc.gridwidth = 1;
        dimPanel.add(widthLabel, gbc);
        gbc.gridx = 1; gbc.weightx = 1; gbc.fill = gbc.HORIZONTAL;
