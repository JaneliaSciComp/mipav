...
/**
 *   Dialog to call the inverse the order of 3D or 4D dataset. This dialog will not be
 ...
 *
 */
public class JDialogInverseOrder
    extends JDialogBase
  ...
  public void run() {
    ...
    try {
      ...
      MipavUtil.displayError(
          "Dialog Inverse order: unable to allocate enough memory");
      return;
    }
  }
