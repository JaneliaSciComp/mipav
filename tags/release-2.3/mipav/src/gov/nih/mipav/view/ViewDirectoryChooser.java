...
public class ViewDirectoryChooser {
    ...
    */
    ...
    /**
    *   Displays a dialog to select a directory, with
    *   the image directory as the default.
    ...
    */
    ...
    /**
    *   Displays a dialog to select a directory, with
    *   the script directory as the default.
    *   @return Directory chosen by user.
    */
    ...
    /**
    *   Shows the file dialogs with the given
    ...
    */
    private String chooseDirectory(String initialDirectory) {
        ...
        try {
    	    ...
    	    chooser.setLocation(Toolkit.getDefaultToolkit().getScreenSize().width/2, Toolkit.getDefaultToolkit().getScreenSize().height/2);
    ...
    */
    public String open(String fileName, boolean multiFile, FileInfoBase fileInfo) {
        ...
        if (UI.isScriptRecording()) {
        	if (image.getFileInfo(0).getFileFormat() != FileBase.RAW) { // RAW files need special info appended so it's done in that function.
