...
/**
 * Dialog to get the upper and lower bounds for the region grow used
 * by the paint functions.
 *
...
public class JDialogPaintGrow extends JDialogBase implements RegionGrowDialog, ChangeListener, KeyListener
{
    ...
    /**
     *  Creates new dialog and sets up GUI components.
     *  @param theParentFrame	Parent frame (the frame with the component image this dialog should perform region grows on).
     ...
     */
    public JDialogPaintGrow(Frame theParentFrame, Vector paintListeners,
                            boolean setRadioBoth, String leadString)
    {
        super(theParentFrame, false);
        paintGrowListeners = paintListeners;
        frame = theParentFrame;
    ...
    private JPanel buildStaticPanel()
    {
        ...
        if (frame instanceof ViewJFrameImage)
        {
            unitString = new String(
                ( (ViewJFrameImage) frame).getComponentImage().getActiveImage().getFileInfo()[0].sUnits[
                ( (ViewJFrameImage) frame).getComponentImage().getActiveImage().getFileInfo()[0].getUnitsOfMeasure(0)]);
        ...
        {
            unitString = new String(
                ( (ViewJFramePaintVasculature) frame).getComponentImage().getActiveImage().getFileInfo()[0].sUnits[
                ( (ViewJFramePaintVasculature) frame).getComponentImage().getActiveImage().getFileInfo()[0].
                getUnitsOfMeasure(0)]);
        ...
        {
            unitString = new String(
                ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).getActiveImage().getFileInfo()[0].sUnits[
                ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).getActiveImage().getFileInfo()[0].getUnitsOfMeasure(
                0)]);
            sizeString = unitString + "^3";
        }
        ...
        if (frame instanceof ViewJFrameImage)
        {
            if ( ( (ViewJFrameImage) frame).getComponentImage().getActiveImage().getType() ==
     ...
     *  @return          The value to be subtracted to the seed intensity the defines
     *                   the lower intensity value that the region can grow into.
     */
     ...
     *  @return          The value to be added to the seed intensity the defines
     *                   the upper intensity value that the region can grow into.
     */
     ...
     *  @return          The value to be subtracted to the seed red intensity the defines
     *                   the lower red intensity value that the region can grow into.
     */
     ...
     *  @return          The value to be added to the seed red intensity the defines
     *                   the upper red intensity value that the region can grow into.
     */
     ...
     *  @return          The value to be subtracted to the seed green intensity the defines
     *                   the lower green intensity value that the region can grow into.
     */
     ...
     *  @return          The value to be added to the seed green intensity the defines
     *                   the upper green intensity value that the region can grow into.
     */
     ...
     *  @return          The value to be subtracted to the seed blue intensity the defines
     *                   the lower blue intensity value that the region can grow into.
     */
     ...
     *  @return          The value to be added to the seed blue intensity the defines
     *                   the upper blue intensity value that the region can grow into.
     */
    ...
    public void actionPerformed(ActionEvent event)
    {
        ...
        if (command.equals("Close") || command.equals("Apply"))
        {
            ...
            else if (frame instanceof ViewJFrameTriImage)
            {
                ...
                if (!haveColor)
                {
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).setLess(lowSlider.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.CORONAL_A).setLess(lowSlider.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.SAGITTAL_A).setLess(lowSlider.getValue() / (float) 100);

                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).setMore(upSlider.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.CORONAL_A).setMore(upSlider.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.SAGITTAL_A).setMore(upSlider.getValue() / (float) 100);
                }
                if (haveRed)
                {
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).setLessR(lowSliderR.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.CORONAL_A).setLessR(lowSliderR.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.SAGITTAL_A).setLessR(lowSliderR.getValue() / (float) 100);

                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).setMoreR(upSliderR.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.CORONAL_A).setMoreR(upSliderR.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.SAGITTAL_A).setMoreR(upSliderR.getValue() / (float) 100);
                }
                if (haveGreen)
                {
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).setLessG(lowSliderG.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.CORONAL_A).setLessG(lowSliderG.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.SAGITTAL_A).setLessG(lowSliderG.getValue() / (float) 100);

                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).setMoreG(upSliderG.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.CORONAL_A).setMoreG(upSliderG.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.SAGITTAL_A).setMoreG(upSliderG.getValue() / (float) 100);
                }
                if (haveBlue)
                {
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).setLessB(lowSliderB.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.CORONAL_A).setLessB(lowSliderB.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.SAGITTAL_A).setLessB(lowSliderB.getValue() / (float) 100);

                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.AXIAL_A).setMoreB(upSliderB.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.CORONAL_A).setMoreB(upSliderB.getValue() / (float) 100);
                    ( (ViewJFrameTriImage) frame).getTriImage(ViewJFrameTriImage.SAGITTAL_A).setMoreB(upSliderB.getValue() / (float) 100);
                }
    ...
    public void stateChanged(ChangeEvent e)
    {
        ...
        if ( (upSlider != null && lowSlider != null) &&
            (source == upSlider || source == lowSlider) &&
        ...
        else if ( (upSliderR != null && lowSliderR != null) &&
                 (source == upSliderR || source == lowSliderR) &&
        ...
        else if ( (upSliderG != null && lowSliderG != null) &&
                 (source == upSliderG || source == lowSliderG) &&
        ...
        else if ( (upSliderB != null && lowSliderB != null) &&
                 (source == upSliderB || source == lowSliderB) &&
