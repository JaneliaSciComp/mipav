...
/**
 *	Class that holds the information about each surface; the BranchGroup which holds the surface subtree,
 *	the name of the surface in the dialog, the color of the surface, the shininess of the surface, the level
 *	of detail (for clod meshes), the number of triangles (changes with level of detail), the polygon mode
 *	(fill, line, or point), and a flag indicating if this is a clod mesh.
 */
public class SurfaceAttributes {
    ...
    /**
     *	Color of surface.  The element type is Color4f, although currently
     *	the alpha channel does not appear to be supported by Java3D materials
     *	(even though the Material API allows the alpha channel to be set for diffuse colors).
     */
     ...
     *	<code>false</code> that it is a standard triangle mesh; clod
    ...
    /**
     *	Constructs new attributes structure to hold information needed for displaying
     *	each surface.
     ...
     */
    public SurfaceAttributes( BranchGroup surface, String fullPath, String name, Color4f color, int shininess, int detailLevel,
            int polygonMode, int triangles, float volume, float area, boolean isClodMesh, BitSet surfaceMask ) {
     ...
     */
    public SurfaceAttributes( BranchGroup surface, String fullPath, String name, Color4f color, int shininess, int detailLevel,
            int polygonMode, int triangles, float volume, float area, boolean isClodMesh, float opacity, BitSet surfaceMask ) {
    ...
    /**
       ...
       */
    public SurfaceAttributes( BranchGroup surface, String fullPath, String name, Color4f color, int shininess, int detailLevel,
            int polygonMode, int triangles, float volume, float area, boolean isClodMesh, float opacity, boolean isVOIPt,
            BitSet surfaceMask ) {
    ...
    /**
       ...
       */
      public SurfaceAttributes( BranchGroup surface, String fullPath, String name, Color4f color, int shininess, int detailLevel,
              int polygonMode, int triangles, float volume, float area, boolean isClodMesh, float opacity, Point3f center, BitSet surfaceMask) {
           this( surface, fullPath, name, color, shininess, detailLevel, polygonMode, triangles, volume, area, isClodMesh, opacity, surfaceMask);
           this.center = center;
      }
