 ...
 *   @version    0.2
 */
public class JDialogFileInfoXML extends JDialogBase
  ...
  private Hashtable editorDialogTable;
    ...
    private Hashtable primaryTypeHolder, primaryEditorHolder,
        subjectTypeHolder, subjectEditorHolder,
        scanTypeHolder, scanEditorHolder,
        investigatorTypeHolder, investigatorEditorHolder;
    ...
    public void displayAboutInfo( FileInfoImageXML fileInfo ) {
        ...
        while( e.hasMoreElements() ) {
            ...
            surfaces.addSurface( fileInfo.getSurface( path ).getPath(), fileInfo.getSurface( path ).getOpacity(), fileInfo.getSurface( path ).getDisplay() );
        }
    ...
    public void appendParameter( String setDesc, String paramName,
        ...
        ( (PSetDisplay) setHashtable.get( setDesc ) ).addParameterData( paramName, paramDesc, valueType, value, date,
                time );
    }
            ...
            while ( eset.hasMoreElements() ) {
                ...
                for ( int i = 0; i < rows.length; i++ ) {
                    ...
                    int reply = JOptionPane.showConfirmDialog( this,
                            "Remove Parameter (" + paramNames[i] + ") from Set (" + psetdesc + ")?",
                            "Confirm Remove Parameter", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE );
