...
public class JDialogCentroidThreshold extends JDialogBase {
    ...
    */
	public JDialogCentroidThreshold(Frame theParentFrame, String _imageName,
	                                int _nClasses, float _min, float _max)
	{
        ...
        for (i = 0; i < nClasses; i++) {
            ...
            JLabel defaultLabel = new JLabel("Centroid[" + String.valueOf(i+1) +
                                  "] (" + String.valueOf(minimum) + " to " +
		    ...
		    defaultValuePanel.add(Box.createHorizontalStrut(10));
            defaultValueInput[i] = new JTextField(Float.toString(
                minimum + (maximum - minimum)*(i+1)/(nClasses+1)), 8);
