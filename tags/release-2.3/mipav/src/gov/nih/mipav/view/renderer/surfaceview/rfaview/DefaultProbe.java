 ...
 * <p>Description: The default probe is the cyan probe.  This class builds the default probe.
 *    It also defines the geometry shape of the default probe.</p>
 * @author Ruida Cheng
 */
public class DefaultProbe {
     ...
     *  Indicator is the green color probe.   I prefer switching the branch group rather
     *  than changing the java3d geometry appearance because the appearance changes waste time
     *  and memory.
     ...
     * @param flag boolean <code>true</code> means around the entry point, <code>false</code>
     *             around the origin.
     */
