...
/**
 * This class shows the dialog which conatains the project info as contained
 * in the FileInfoProject class.
 * <p>
 ...
 * to project info.
 * <p>
 * It merely brings up a JDialogEditor when "edit" button is clicked.
 * <p>
 * (based off parsonsd's JDialogFileInfoXML)
 *
...
public class JDialogFileInfoProject extends JDialogBase implements ActionListener {
    ...
    private String              parameterColumnNames[] = {"Name",
                                                          "Description",
                                                          "Value-Type",
                                                          "Value",
                                                          "Date",
    ...
    private String              infoColumnNames[] = {"Name",
                                                     "Description",
                                                     "Value-Type",
                                                     "Value"};
   ...
   /**
    * This method displays all the project info.
    * It calls parseDate and parseTime when needed
    * and translates other strings.
    ...
    */
    ...
    /**
     *   Class to hold one table, model, & label per parameter set
     *   There can be infinite parameter sets, and the sets are deletable,
     *   so each set display must be stored in a hashtable for easy access/deletion
     */
    public class PSetDisplay {
        ...
        /**
         * Creates a parameter set display with the given description
         ...
         */
        public void addParameterData(String paramName, String paramDesc, String valueType,
                                     String value, String date, String time) {
        ...
        private class HeaderListener implements MouseListener {
            ...
            /**
             *  When the user right clicks on a header, sorts the column.
             *  when the user left clicks, a popup menu gives the option
             *  to add a parameter to the table, triggering a JDialog
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if (source.equals(setTable.getTableHeader())
                    && e.getButton() == MouseEvent.BUTTON1) {
                    col = setTable.columnAtPoint(p);
                    if (e.isShiftDown()) sort(setModel, col, true);
                    else sort(setModel, col, false);
                }
                else if (source.equals(setTable.getTableHeader())
    ...
    /**
     *   Class to hold one table, model, & label per image
     *   There can be infinite images, and the images are deletable,
     *   so each image display must be stored in a hashtable for easy access/deletion
     */
    public class ImageDisplay {
        ...
        /**
         * Creates a image display with the given file name
         * that will be used as the key.
        ...
        private class HeaderListener implements MouseListener {
             ...
             *  When the user right clicks on a header, sorts the column.
             *  when the user left clicks, a popup menu gives the option
             *  to add a info item to the table, triggering a JDialog
             *  @param e       event that triggered this method
             */
            public void mouseClicked(MouseEvent e){
                Object source = e.getSource();
                ...
                if (source.equals(imageTable.getTableHeader())
                    && e.getButton() == MouseEvent.BUTTON1) {
                    col = imageTable.columnAtPoint(p);
                    if (e.isShiftDown()) sort(imageModel, col, true);
                    else sort(imageModel, col, false);
                }
                else if (source.equals(imageTable.getTableHeader())
                         && e.getButton() == MouseEvent.BUTTON3) {
     ...
     *               Eg., a JPanelEditDefault.  Specified by
     *               <ul>
     ...
     * @param time parameter time
     */
    public void appendParameter(String setDesc, String paramName,
                                String paramDesc, String valueType, String value, String date, String time) {
        if (date == null)
            date = new String("0000-01-01");
        if (time == null)
            time = new String("00:00:00-00:00");
        ((PSetDisplay) setHashtable.get(setDesc)).addParameterData(paramName, paramDesc,
     ...
     * @param value info value
     */
    public void appendInfo(String file, String name,
                           String desc, String valueType, String value) {
        ...
        if (e.getActionCommand().equals("Close"))  {              // close
            ...
            while (eset.hasMoreElements()) {
                ...
                for (int i = 0; i < rows.length; i++) {
                    ...
                    int reply = JOptionPane.showConfirmDialog(this,
                                                              "Remove Image Info (" + infoNames[i] +
                                                              ") from Image (" + file + ")?",
                                                              "Confirm Remove Image Information",
                                                              JOptionPane.YES_NO_OPTION,
                                                              JOptionPane.QUESTION_MESSAGE);
