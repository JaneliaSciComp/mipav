...
/**
 *   This class creates a simple dialog in which
 *   the user can specify a brightness integer and
 *   a contrast float using sliders.  Called from
 *   ViewJFrameAnimate.
 *
 ...
 *
 */
public class JDialogBrightness extends JDialogBase
