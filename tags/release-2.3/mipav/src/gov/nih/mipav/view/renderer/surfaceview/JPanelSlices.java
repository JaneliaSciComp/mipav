...
public class JPanelSlices extends JPanelRendererBase
    implements ChangeListener, MouseListener { // for slider changes (LOD change){
    ...
    /**
     *   Creates new dialog for turning slices bounding box
     *   frame on and off.
    ...
    /**
     *   Builds panel that has 3 sliders for the 3 planes shown, 3 checkboxes for showing
     *	the planes, 3 text boxes for the current values of the sliders, and a fourth
     *	slider and text box for the time dimension, if necessary.
     */
    ...
    /**
     *	Sets the x slider and the labels beside and beneath it to the
     *	state given by <code>flag</code>.
    ...
    /**
     *	Sets the y slider and the labels beside and beneath it to the
     *	state given by <code>flag</code>.
     *	@param flag if <code>true</code> enable, otherwise disable.
     */
    ...
    /**
     *	Sets the z slider and the labels beside and beneath it to the
     *	state given by <code>flag</code>.
     *	@param flag if <code>true</code> enable, otherwise disable.
     */
    ...
    /**
     *  When 3D texture volume render is invoked, disable all the slices
     *  and bounding frame boxes.
     */
    ...
    /**
     *  Sets the scene state appropriately, so that the slices that are supposed to
     *  be visible are showing, the ones that aren't are hidden, and the sliders are
     *  starting at the appropriate value.
    ...
    /* Sets the slice position based on a relative percentage of the X
     * dimension.
     * @param float, range from [0:1]
