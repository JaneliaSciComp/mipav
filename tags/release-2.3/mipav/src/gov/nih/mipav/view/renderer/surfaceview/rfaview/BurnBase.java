...
/**
 * <p>Title: BurnBase </p>
 * <p>Description: This class defined the basic bunring point image sence graph
 *     structure. </p>
 * @author     Ruida Cheng
 */
public class BurnBase {
    ...
    /**
     * Constructor.  Initializes the burning point image scene graph structure and builds three types of
     * burning point.
    ...
    /**
     *   Build the root of the burning point branch group, and attached the root to
     *   the parent scene root transform group.
     */
