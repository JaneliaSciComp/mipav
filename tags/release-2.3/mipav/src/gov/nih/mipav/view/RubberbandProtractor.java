    ...
    public void mouseReleased(MouseEvent mouseEvent) {
        ...
        if ( isActive() ) {
            ...
            if (beginx <= endx) {
                ...
                x[1] = (beginx + endx)/2; y[1] = (beginy + endy)/2; z[1] = slice;
                x[2] = endx;    y[2] = endy;    z[2] = slice;
            }
            else {
                x[0] = endx;    y[0] = endy;    z[0] = slice;
                x[1] = (beginx + endx)/2; y[1] = (beginy + endy)/2; z[1] = slice;
                x[2] = beginx;  y[2] = beginy;  z[2] = slice;
            }
                    ...
                    */
                    if ( image.getNDims() > 2 ) {
                        newVOI = new VOI((short)colorID, name,
                                        image.getExtents()[2],
                                        VOI.PROTRACTOR, presetHue);
                    }
                    else {
                        newVOI = new VOI((short)colorID, name, 1,
                                            VOI.PROTRACTOR, presetHue);
                    }
                }
