 ...
 * <p>Description: Regular probe has its own geometry and type of burning.  This class
 *    builds the geometry shape of the regular probe.  </p>
 * @author Ruida Cheng
 */
public class RegularProbe {
    ...
    /** Indicator is used by the regular probe to switch color between gray and green.
