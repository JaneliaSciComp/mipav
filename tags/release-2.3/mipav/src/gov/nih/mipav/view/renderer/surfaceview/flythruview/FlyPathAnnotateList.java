...
/**
 * Container which stores annotations which include the following:
 *  - point position and normal
 *  - branch and location along branch when point annotated
...
{
    /**
     * Single annotation item.  Must extend Object in order to be placed
     * into a container.
     */
    public class Item
        extends Object
    {
        /**
         * Constructor.  Only the shape and description can be changed
         * once initialized in the constructor, while all other member data
         * cannot be changed once initialized.
         * @param iBranch int Index of branch from which the item was
         * seen and annotated.
         * @param fNormalizedPathDist float Relative distance along the branch
         * (in the [0,1] range)  from which the item was seen and annotated.
         * @param bPathMoveForward boolean Flag set if the moving forward,
         * as opposed to in reverse, down the path.
         * @param kPointPosition Point3f Coordinates of the annotated point.
         * @param kPointNormal Vector3f Normal vector associated with the
         * annotated point.
         * @param kShape Shape3D Instance which contains the geometry and
         * appearance to use for rendering.
         * @param kDescription String Text description to set.
         */
        Item (int iBranch, float fNormalizedPathDist, boolean bPathMoveForward,
              Point3f kPointPosition, Vector3f kPointNormal,
              Shape3D kShape, String kDescription)
        {
            m_iBranch = iBranch;
        ...
        /**
         * Return the index of the branch from which the item was seen
         * and annotated.
        ...
        /**
         * Return the relative distance (in the [0,1] range) along the branch
         * path from which the item was seen and annotated.
         * @return float
         */
        ...
        /**
         * Return the flag indicating whether moving was forward, as
         * opposed to in reverse, down the path.
         ...
         * @param kPointPosition Point3f Filled in with the 3D coordinates
         * upon return.
         */
         ...
         * @param kPointNormal Vector3f Filled in with the normal vector
         * upon return.
         */
         ...
         * @return Shape3D Instance which contains the geometry and
         * appearance to use for rendering.
         */
        ...
        /**
         * Set the shape for rendering the annotated point to that
         * specified.
         * @param kShape Shape3D Instance which contains the geometry and
         * appearance to use for rendering.
         */
    ...
    /**
     * Create a new annotation item with the specified information and
     * add the item to the end of the list.  Set the item's appearance
     * and geometry based on the defaults.  Generate a description for
     * the item based on the number of items inserted already.
     * @param iBranch int Index of branch from which the item was
     * seen and annotated.
     * @param fNormalizedPathDist float Relative distance along the branch
     * (in the [0,1] range)  from which the item was seen and annotated.
     ...
     * annotated point.
     */
    public void addItem (int iBranch, float fNormalizedPathDist,
                         boolean bPathMoveForward, Point3f kPointPosition,
                         Vector3f kPointNormal)
    {
        String kDescription =
            new String("Point"+Integer.toString(m_iNextItemKey+1));

        addItem (new Item(iBranch, fNormalizedPathDist, bPathMoveForward,
                          kPointPosition, kPointNormal, m_kDefaultShape,
                          kDescription));
    }
    ...
    /**
     * Return access to the default shape to use for rendering all subsequent
     * annotated items.
     * @return Shape3D Instance which contains the geometry and
     * appearance to use for rendering.
     */
    ...
    /**
     * Set the default shape for rendering all subsequent annotated items
     * to that specified.
     * @param kShape Shape3D Instance which contains the geometry and
     * appearance to use for rendering.
     */
