...
public class PlugInAlgorithmISN
    ...
    public void runOrderRemapThenMatch() {
        ...
        for (i = 0; i < z; i++) {
            ...
            //System.out.println("diff = " + Math.abs(sliceAverage[i] - adjAvg) + " adjAvg = " + (0.15 * sliceAverage[i]) );
            if (Math.abs(sliceAverage[i] - adjAvg) > (0.15 * sliceAverage[i])) {
                ...
                try {
                    if (twoDIM == true) {
                        ...
                        //remap each original bright into average of adjacent slices * copy result. resulting in 2 images of same.
    ...
    public void runOrderMatchThenRemap() {
        ...
        for (i = 0; i < z; i++) {
            ...
            //System.out.println("diff = " + Math.abs(sliceAverage[i] - adjAvg) + " adjAvg = " + (0.15 * sliceAverage[i]) );
            //singling out the bright slice (matt's method)
            if (Math.abs(sliceAverage[i] - adjAvg) > (0.15 * sliceAverage[i])) {
                //System.out.println("Image Slice = " + i);
                try {
                    if (twoDIM == true) {
