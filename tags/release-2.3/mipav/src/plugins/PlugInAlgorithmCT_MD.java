...
public class PlugInAlgorithmCT_MD extends AlgorithmBase {
    ...
    */
    private void calcStoreInDest2D(){
        ...
        destImage.getUserInterface().getMessageFrame().append("Number of LDM pixels = " + ldMuscle , ViewJFrameMessage.DATA );
        destImage.getUserInterface().getMessageFrame().append("  Area = " + (ldMuscle*area) + " mm^2\n", ViewJFrameMessage.DATA );

        destImage.getUserInterface().getMessageFrame().append("Number of HDM pixels = " + hdMuscle , ViewJFrameMessage.DATA );
    ...
    */
    private void calcStoreInDest3D(){
        ...
        float vol = srcImage.getFileInfo()[0].getResolutions()[0] *
        ...
        destImage.getUserInterface().getMessageFrame().append("\n ************************ Totals ********************\n",
                                                               ViewJFrameMessage.DATA);
        destImage.getUserInterface().getMessageFrame().append("Number of totFat pixels = " + totFat , ViewJFrameMessage.DATA );
        destImage.getUserInterface().getMessageFrame().append("  Volume = " + (totFat*vol) + " mm^3\n", ViewJFrameMessage.DATA );

        destImage.getUserInterface().getMessageFrame().append("Number of LDM pixels = " + totLdMuscle , ViewJFrameMessage.DATA );
        destImage.getUserInterface().getMessageFrame().append("  Volume = " + (totLdMuscle*vol) + " mm^3\n", ViewJFrameMessage.DATA );

        destImage.getUserInterface().getMessageFrame().append("Number of HDM pixels = " + totHdMuscle , ViewJFrameMessage.DATA );
