 ...
 *
 * <P>The Java Matrix Class provides the fundamental operations of numerical linear algebra. Various constructors create
 ...
 *
 * <P>Five fundamental matrix decompositions, which consist of pairs or triples of matrices, permutation vectors, and
 * the like, produce results in five decomposition classes. These decompositions are accessed by the Matrix class to
...
public class Matrix implements Cloneable, java.io.Serializable {
    ...
    private static final long serialVersionUID = 3156823013960018552L;
     ...
     * Elements are separated by whitespace, all the elements for each row appear on a single line, the last row is
     ...
     * within columns of width characters.
     *
    ...
    /**
     * Linear algebraic matrix multiplication, matrix = matrix * B. Added by Delia McGarry 1/11/2000.
     *
     * @param      B  another matrix
     *
     * @exception  IllegalArgumentException  Matrix inner dimensions must agree.
