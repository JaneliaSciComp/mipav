...
public class DICOMDictionaryBuilder extends ModelSerialCloneable {
    ...
    private static final String genRTCjavadocComments = "\n" + "/** \n" +
                                                        " * RTC - Run Time Class (although it is actually statically " +
                                                        "defined here)  \n" +
                                                        ...
                                                        " * on the fly and receive a new integer hash index." +
                                                        " * <p>\n" +
    ...
    private static final String genRTCclassRTCtypecodeComments = "    /** \n" +
                                                                 ...
                                                                 "     * for example: getTypeCodeName( RTC.DD_PatientID ) " +
                                                                 "returns \"LO\" \n" +
    ...
    private static final String createDICOMFilesCommandLineHelp = "\n" + "Call with:\njava CreateDICOMFiles " +
                                                                  ...
                                                                  "\nNo arguments will generate a source file " +
                                                                  "\"RTC_DICOM.java\" from \"elmdict.tpl\" \n" +
    ...
    /**
     * Clones the DICOMHashtable and all its values. returns the clone, presumably to a FileInfoDicom as a template.
     *
    ...
    private static Hashtable hashRTCentries(Hashtable kwEntries) {
        ...
        while (e.hasMoreElements()) {
            Integer count = new Integer(i);
            tag = (FileDicomTag) e.nextElement();
            hashRTCentries.put(count,
                               "new RTCEntry(0x0" + Integer.toHexString(tag.getGroup()) + ", 0x0" +
    ...
    /**
     * Sorts the list of tags and returns it as an array order of an ordered list of the keys in the hashtable.
     *
