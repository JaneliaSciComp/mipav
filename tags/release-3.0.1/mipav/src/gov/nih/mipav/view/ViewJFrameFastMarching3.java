...
public class ViewJFrameFastMarching3
    extends ViewJFrameImage
    implements KeyListener, Runnable
{
    ...
    public void run () 
    {
        ...
        boolean[] abMask = null;
        LseSegShapeDetection3 kSegmenter = new LseSegShapeDetection3(iXBound,
           iYBound,iZBound,fXSpacing,fYSpacing,fZSpacing,afImage,abMask);
        ...
        kSegmenter.setPDEParameters(Float.MAX_VALUE,LsePdeFilter.UNIT,
            fTimeStep);
        kSegmenter.setDiffusionIterations(iDiffusionIterations);
        kSegmenter.setGradientMagnitudeScale(fGradientMagnitudeScale);
        kSegmenter.setSigmoidFilter(fSigmoidAlpha,fSigmoidBeta,fSigmoidMin,
            fSigmoidMax);
        ...
        kSegmenter.beginEvolution(fAdvectionWeight,fPropagationWeight,
            fCurvatureWeight,fLaplacianWeight,fEvolveTimeStep);
