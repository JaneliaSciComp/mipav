 ...
 *
 * @version  0.1 Ocotber 3, 2016
 * @author   William Gandler
 * @see      AlgorithmUnionFindComponentLabelling
 */
public class JDialogUnionFindComponentLabelling extends JDialogScriptableBase
    ...
    /** DOCUMENT ME! */
    private AlgorithmUnionFindComponentLabelling ufclAlgo;
     ...
     */
    public JDialogUnionFindComponentLabelling() { }
     ...
     */
    public JDialogUnionFindComponentLabelling(Frame theParentFrame, ModelImage im) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals("OK")) {
            ...
            //MipavUtil.showWebHelp("Segmentation:_Union_Find_Component_Labelling)");
        } else {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmUnionFindComponentLabelling) {
            System.err.println("Union Find Component Labelling elapsed: " + algorithm.getElapsedTime());
            image.clearMask();

            if ((ufclAlgo.isCompleted() == true) && (resultImage != null)) {
    ...
    protected void callAlgorithm() {
        try {
               ...
               resultImage = new ModelImage(ModelStorageBase.INTEGER, image.getExtents(), 
                        		image.getImageName() + "_labelling");
           
           ufclAlgo = new AlgorithmUnionFindComponentLabelling(resultImage, image, numNeighbor, limitBins, binNumber);

            // This is very important. Adding this object as a listener allows the algorithm to
            // notify this object when it has completed of failed. See algorithm performed event.
            // This is made possible by implementing AlgorithmedPerformed interface
            ufclAlgo.addListener(this);
            createProgressBar(image.getImageName(), ufclAlgo);
            ...
            if (isRunInSeparateThread()) {
                ...
                if (ufclAlgo.startMethod(Thread.MIN_PRIORITY) == false) {
         ...
         // save the completion status for later
            setComplete(ufclAlgo.isCompleted());

            System.gc();
            MipavUtil.displayError("Dialog Union Find Component Labelling: unable to allocate enough memory");
    ...
    private void init() {
        ...
        setTitle("Union Find Component Labelling");
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("Applies Union Find Component Labelling segmentation to the image.");
            }
            ...
            public String getShortLabel() {
                return new String("UnionFindComponentLabellingSegmentation");
            }

            public String getLabel() {
                return new String("Union Find Component Labelling Segmentation");
            }
