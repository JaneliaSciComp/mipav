    ...
    public void setSecondaryCaptureTags(boolean isMultiFrame, int dataType) {
    	...
    	if ((dataType == ModelStorageBase.FLOAT) || (dataType == ModelStorageBase.DOUBLE)) {
            ...
            getTagTable().setValue("0008,0018", "1.2.840.10008.5.1.4.1.1.30", 26);
    		 ...
    		 getTagTable().setValue("0002,0002", "1.2.840.10008.5.1.4.1.1.7.1" + String.valueOf(nullChar), 28);
    		 getTagTable().setValue("0002,0003", "1.2.840.10008.5.1.4.1.1.7.1" + String.valueOf(nullChar), 28);
    	     getTagTable().setValue("0008,0016", "1.2.840.10008.5.1.4.1.1.7.1" + String.valueOf(nullChar), 28);	
    	     getTagTable().setValue("0008,0018", "1.2.840.10008.5.1.4.1.1.7.1" + String.valueOf(nullChar), 28);
    	}
    	else if (isMultiFrame && dataType == ModelStorageBase.BYTE) {
    		getTagTable().setValue("0002,0002", "1.2.840.10008.5.1.4.1.1.7.2" + String.valueOf(nullChar), 28);
    		getTagTable().setValue("0002,0003", "1.2.840.10008.5.1.4.1.1.7.2" + String.valueOf(nullChar), 28);
   	        getTagTable().setValue("0008,0016", "1.2.840.10008.5.1.4.1.1.7.2" + String.valueOf(nullChar), 28);
   	        getTagTable().setValue("0008,0018", "1.2.840.10008.5.1.4.1.1.7.2" + String.valueOf(nullChar), 28);
    	}
    		...
    		getTagTable().setValue("0002,0002", "1.2.840.10008.5.1.4.1.1.7.3" + String.valueOf(nullChar), 28);
    		getTagTable().setValue("0002,0003", "1.2.840.10008.5.1.4.1.1.7.3" + String.valueOf(nullChar), 28);
   	        getTagTable().setValue("0008,0016", "1.2.840.10008.5.1.4.1.1.7.3" + String.valueOf(nullChar), 28);
   	        getTagTable().setValue("0008,0018", "1.2.840.10008.5.1.4.1.1.7.3" + String.valueOf(nullChar), 28);
    	}
    	else if (isMultiFrame && ((dataType == ModelStorageBase.ARGB) || (dataType == ModelStorageBase.ARGB_USHORT))) {
    		getTagTable().setValue("0002,0002", "1.2.840.10008.5.1.4.1.1.7.4" + String.valueOf(nullChar), 28);
    		getTagTable().setValue("0002,0003", "1.2.840.10008.5.1.4.1.1.7.4" + String.valueOf(nullChar), 28);
   	        getTagTable().setValue("0008,0016", "1.2.840.10008.5.1.4.1.1.7.4" + String.valueOf(nullChar), 28);
   	        getTagTable().setValue("0008,0018", "1.2.840.10008.5.1.4.1.1.7.4" + String.valueOf(nullChar), 28);
    	}
    	else {
            getTagTable().setValue("0002,0002", "1.2.840.10008.5.1.4.1.1.7" + String.valueOf(nullChar), 26);
            getTagTable().setValue("0002,0003", "1.2.840.10008.5.1.4.1.1.7" + String.valueOf(nullChar), 26);
            getTagTable().setValue("0008,0016", "1.2.840.10008.5.1.4.1.1.7" + String.valueOf(nullChar), 26);
