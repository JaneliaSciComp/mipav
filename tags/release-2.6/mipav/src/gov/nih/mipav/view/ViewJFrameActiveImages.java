 ...
 * @version  1.0
 */
public class ViewJFrameActiveImages extends JFrame implements ActionListener {

    //~ Static fields/initializers -------------------------------------------------------------------------------------

    /** Use serialVersionUID for interoperability. */
    private static final long serialVersionUID = 4658173982027437470L;
    ...
    /**
     * Creates a new ViewJFrameActiveImages object.
     *
    ...
    /**
     * Interface Stack defines a set of operations for manipulating a LIFO (Last In First Out) structure that can be
     * used to store references to objects. It has the following public methods:
     */
    interface Stack {
    ...
    public class ImageTableCellRenderer extends JLabel implements TableCellRenderer {
        ...
        /** Use serialVersionUID for interoperability. */
        private static final long serialVersionUID = 4888891965151331823L;
    ...
    /**
     * Title: VectorStack Description: VectorStack implements the Stack interface, providing a set of operations for
     * manipulating a LIFO (Last In First Out) structure that can be used to store references to objects.
     */
    public class VectorStack extends Vector implements Stack {

        /** Use serialVersionUID for interoperability. */
        private static final long serialVersionUID = -4482284583116270346L;
        ...
        /**
         * !empty(), removes and returns the value at the top of the stack; raises an exception if stack is empty.
         *
        ...
        /**
         * no constructor needed (default constructor calls the Vector default constructor).
         *
         * @param  value  DOCUMENT ME!
         */
