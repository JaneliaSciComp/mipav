...
public class ViewJComponentSurfaceVolume {
    ...
    /**
     * Access to retrieve the normal vectors associated with image A. If they have not been computed, then they are
     * computed now.
     *
     * @return  Vector3f[] Array of references to normal vectors corresponding to the samples in image A.
     */
    public Vector3f[] getNormalsImageA() {
        ...
        if (null == m_akNormalsImageA) {
            ...
            /**
             * Create array of normal vectors corresponding to the voxels in the volume.  The normal vector is computed
             * based on the gradient of the volume intensity values. @param afData float[] Input array of voxel values.
             * @param Vector3f[] Array of normal vectors corresponding to the input voxel intensity values.
             */
            ...
            for (iZ = 1; iZ < (iZBound - 1); iZ++) {
                ...
                for (iY = 1; iY < (iYBound - 1); iY++) {
                    ...
                    for (iX = 0; iX < iXBound; iX++) {
                        ...
                        fDY = (((bMinY ? afData[i] : afData[i - iOffY - iYBound]) -
                        ...
                        fDZ = (((bMinZ ? afData[i] : afData[i - iOffZ - iZBound]) -
