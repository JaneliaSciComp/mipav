...
/**
 * A small class for storing the vertices of the vertex-triangle mesh that represents isosurfaces. The main support is
 * for hash tables of vertices that are used to eliminate duplicate vertices from a mesh.
 */
public class ASC_Vertex3 extends Object implements Comparable {
    ...
    public static int ms_iSortOn = 0;
     ...
     *
     * @return  -1 for kObj0 < kObj1, 0 for kObj0 = kObj1, or +1 for kObj0 > kObj1
     */
    ...
    /**
     * Support for hashing into a map of vertices and for interface Comparator for ordered sets.
     *
