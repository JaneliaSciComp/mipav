...
/**
 * This structure contains the information about a project
 * including preferences and an image list (code based off of
 * FileInfoXML).
 *
...
public class FileInfoProject extends FileInfoBase {
    ...
    /**
     *  Public class to hold several attributes for an investigator
     *  associated with the project (up to three per)
     */
    ...
    /**
     *  Public class to store up to an infinite number of
    ...
    /**
     *  Public class to store information for a parameter associated with
     *  the project (infinite parameters allowed per)
     */
    ...
    /**
     * Updates the FileInfo with new image info
     * contained within the vector passed in
     * [0] is the file name of the image to be changed
     * [1] is the name of the image info item
     * [2] is the description of the image info item
     * [3] is the value type of the image info item
     * [4] is the value of the image info item
    ...
    /**
     * Adds (or updates) a parameter set (with parameters) to the information about the project.
     * For any i &lt; paramNames.size() there should be an entry in the other 3 parameter Vectors.
     ...
     */
    public final void addPSet( String setDesc, Vector paramNames, Vector paramDescs, Vector paramValueTypes, Vector paramValues ) {
    ...
    /**
     * Gets the value of a parameter set in the project information (use isSaveNeeded() to determine if a default was used).
