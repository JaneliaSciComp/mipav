 ...
 * The algorithm may not have completed sucessfully, so checking the value of <code>isCompleted()</code>
 * may be necessary.
 * 
...
public interface AlgorithmInterface  {
     ...
     * If the algorithm is run in a separate thread, this call will be made within that thread.  If not,
     * this call will be made from that same, shared thread.
