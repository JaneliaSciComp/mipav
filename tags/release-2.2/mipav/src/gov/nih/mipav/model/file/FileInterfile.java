...
public class FileInterfile extends FileBase  {
    ...
    */
    public FileInfoInterfile getFileInfo() { return fileInfo;}
    ...
    */
    ...
    /**
    *   Reads lines of the file and strips comments indicated
    *   by the ; symbol until a nonnull String results or the
    ...
    */
    private String readLine() throws IOException {
        ...
        while ((tempString == null) && (raFile.getFilePointer() < fileLength - 1)
               && (!foundEOF)) {
            try {
        ...
        try {
                ...
                if (lineString != null) {
                    ...
                    if (keyString.equalsIgnoreCase("DATAOFFSETINBYTES")) {
                        ...
                        if (valueString.equalsIgnoreCase("BIGENDIAN")) {
                            ...
                            raFile.close();
                            MipavUtil.displayError("Impossible value of " + valueString +
                                                  "for image data byte order");
                       ...
                       fileInfo.setScalingFactor1(valueString);
                        ...
                        if (valueString.equalsIgnoreCase("TRANSVERSE")) {
                            ...
                            raFile.close();
                            MipavUtil.displayError("Slice orientation has illegal value of " +
                                                   valueString);
                            throw new IOException();
                        }
                    } // else if (keyString.equalsIgnoreCase("SLICEORIENTATION"))
                        ...
                        if ((valueString == null) ||
                            (valueString.equalsIgnoreCase("M")) ||
                            (valueString.equalsIgnoreCase("F")) ||
                        ...
                        if ((valueString.equalsIgnoreCase("STATIC")) ||
                            ...
                            (valueString.equalsIgnoreCase("CURVE")) ||
                            (valueString.equalsIgnoreCase("ROI")) ||
                            (valueString.equalsIgnoreCase("PET")) ||
                        ...
                        fileInfo.setIsotopeName("1", valueString);
                             ...
                             (keyString.substring(0,25).equalsIgnoreCase
                                                        ("ISOTOPEBETAHALFLIFE(SEC)["))) {
                        index = keyString.indexOf("]");
                        if (index == -1) {
                            raFile.close();
                        ...
                        fileInfo.setBetaHalflife("1", valueString);
                             ...
                             (keyString.substring(0,26).equalsIgnoreCase
                                                        ("ISOTOPEGAMMAHALFLIFE(SEC)["))) {
                        index = keyString.indexOf("]");
                        if (index == -1) {
                            raFile.close();
                        ...
                        fileInfo.setGammaHalflife("1", valueString);
                             ...
                             (keyString.substring(0,23).equalsIgnoreCase
                                                        ("ISOTOPEBRANCHINGFACTOR["))) {
                        index = keyString.indexOf("]");
                        if (index == -1) {
                            raFile.close();
                      ...
                      //      (keyString.substring(0,23).equalsIgnoreCase("ENERGYWINDOWUPPERLEVEL[")))
                        ...
                        if ((valueString.equalsIgnoreCase("Y")) ||
                            (valueString.equalsIgnoreCase("N"))) {
                            fileInfo.setFloodCorrected(valueString);
                            haveFloodCorrected = true;
                        }
                        else {
                            raFile.close();
                            MipavUtil.displayError("Flood corrected has an illegal value of " +
                                                    valueString);
                            throw new IOException();
                        }
                    } // else if (keyString.equalsIgnoreCase("FLOODCORRECTED"))
                        ...
                        if ((valueString.equalsIgnoreCase("Y")) ||
                            ...
                            raFile.close();
                            MipavUtil.displayError("Decay corrected has an illegal value of " +
                                                    valueString);
                            throw new IOException();
                        }
                    } // else if (keyString.equalsIgnoreCase("DECAYCORRECTED"))
                        ...
                        if ((valueString.equalsIgnoreCase("EMISSION")) ||
                            ...
                            raFile.close();
                            MipavUtil.displayError("PET data type has an illegal value of " +
                                                    valueString);
                            throw new IOException();
                        }
                    } // else if (keyString.equalsIgnoreCase("PETDATATYPE"))
                        ...
                        if ((valueString.equalsIgnoreCase("RECONSTRUCTED")) ||
                            ...
                            raFile.close();
                            MipavUtil.displayError("Process status has an illegal value of " +
                                                    valueString);
                            throw new IOException();
                        }
                    } // else if (keyString.equalsIgnoreCase("PROCESSSTATUS"))
                        ...
                        if ((valueString.equalsIgnoreCase("PRONE")) ||
                            (valueString.equalsIgnoreCase("SUPINE")) ||
                            (valueString.equalsIgnoreCase("OTHER"))) {
                                fileInfo.setPatientRotation(valueString);
                        }
                        else {
                            raFile.close();
                            MipavUtil.displayError("Patient rotation has an illegal value of " +
                                                    valueString);
                            throw new IOException();
                        }
                    } // else if (keyString.equalsIgnoreCase("PATIENTROTATION"))
                        ...
                        if ((valueString.equalsIgnoreCase("Y")) ||
                            ...
                            raFile.close();
                            MipavUtil.displayError("Scatter corrected has an illegal value of " +
                                                    valueString);
                            throw new IOException();
                        }
                    } // else if (keyString.equalsIgnoreCase("SCATTERCORRECTED"))
                        ...
                        if ((valueString.equalsIgnoreCase("Y")) ||
                            ...
                            raFile.close();
                            MipavUtil.displayError("Oblique reconstruction has an illegal value of " +
                                                    valueString);
                            throw new IOException();
                        }
                    } // else if (keyString.equalsIgnoreCase("OBLIQUERECONSTRUCTION"))
            ...
            if (numberFormat == SIGNED_INTEGER) {
                if (bytesPerPixel == 1) {
                    ...
                    MipavUtil.displayError("Cannot handle signed integer with " + bytesPerPixel +
                                          " bytes");
                    throw new IOException();
                }
            }  // if (numberFormat == SIGNED_INTEGER)
                ...
                if (bytesPerPixel == 1) {
                    ...
                    MipavUtil.displayError("Cannot handle unsigned integer with " + bytesPerPixel +
                                          " bytes");
                    throw new IOException();
                }
            } // else if (numberFormat == UNSIGNED_INTEGER)
                ...
                if (bytesPerPixel == 4) {
                    ...
                    MipavUtil.displayError("Short float had " + bytesPerPixel +
                                          " bytes rather than the expected 4");
                    throw new IOException();
                }
            } // else if (numberFormat == SHORT_FLOAT)
                ...
                if (bytesPerPixel == 8) {
                    ...
                    MipavUtil.displayError("Long float had " + bytesPerPixel +
                                          " bytes rather than the expected 8");
                    throw new IOException();
                }
            } // else if (numberFormat == LONG_FLOAT)
            ...
            progressBar = new ViewJProgressBar(ViewUserInterface.getReference().getProgressBarPrefix() + fileName,
                                           ViewUserInterface.getReference().getProgressBarPrefix() + "Interfile image(s) ...", 0, 100,
                                           false, null, null);
    ...
    */
    public void writeImage(ModelImage image, FileWriteOptions options) throws IOException {
        ...
        if (dataFile.exists()) {
	        ...
	        int response =
	            JOptionPane.showConfirmDialog(UI.getMainFrame(),
        ...
        progressBar = new ViewJProgressBar(dataFileName, "Writing Interfile file...",
                ...
                if (isoNumber == 1) {
                    ...
                    if (betaHalflife != null) {
                        if (betaHalflife[i] != null) {
                            betaHalflife[i] = new String("isotope beta halflife (sec) := " +
                                                          betaHalflife[i] + "\r\n");
                    ...
                    if (gammaHalflife != null) {
                        if (gammaHalflife[i] != null) {
                            gammaHalflife[i] = new String("isotope gamma halflife (sec) := " +
                                                          gammaHalflife[i] + "\r\n");
                    ...
                    if (branchingFactor != null) {
                        if (branchingFactor[i] != null) {
                            branchingFactor[i] = new String("isotope branching factor := " +
                                                             branchingFactor[i] + "\r\n");
                    ...
                    if (isotopeName != null) {
                        if (isotopeName[i] != null) {
                            isotopeName[i] = new String("isotope name [" + (i+1) + "] := " +
                                                         isotopeName[i] + "\r\n");
                            lineBytes = isotopeName[i].getBytes();
                            raFile.write(lineBytes);
                        }
        ...
        if (!simple) {
            ...
            if (energyWindowsNumber != null) {
                ...
                energyWindowsNumber = new String("!number of energy windows := " +
                                                  energyWindowsNumber + "\r\n");
            ...
            for (i = 0; i < energyNumber; i++) {
                if (energyWindowName != null) {
                    if (energyWindowName[i] != null) {
                        energyWindowName[i] = new String("energy window [" + (i+1) + "] := " +
                                                          energyWindowName[i] + "\r\n");
                ...
                if (lowerLevel != null) {
                    if (lowerLevel[i] != null) {
                        lowerLevel[i] = new String("energy window lower level [" + (i+1) + "] := " +
                                                    lowerLevel[i] + "\r\n");
                ...
                if (upperLevel != null) {
                    if (upperLevel[i] != null) {
                        upperLevel[i] = new String("energy window upper level [" + (i+1) + "] := " +
                                                    upperLevel[i] + "\r\n");
        ...
        if (interfileDataType == null) {
            ...
            if (imagesPerEWindow != null) {
                lineBytes = new String("number of images/energy window := " +
                                        imagesPerEWindow + "\r\n").getBytes();
                raFile.write(lineBytes);
            ...
            for (i = 0; i < numberImagesPerEWindow; i++) {
                ...
                if (scalingFactor1String != null) {
                    if (scalingFactor1String[i] != null) {
                        lineBytes = new String("scaling factor (mm/pixel) [1] :=" +
                                                scalingFactor1String[i] + "\r\n").getBytes();
                        raFile.write(lineBytes);
                    }
                }
                if (scalingFactor2String != null) {
                    if (scalingFactor2String[i] != null) {
                        lineBytes = new String("scaling factor (mm/pixel) [2] :=" +
                                                scalingFactor2String[i] + "\r\n").getBytes();
                        raFile.write(lineBytes);
                    }
                }
            ...
            for (i = 0; i < fGroupNumber; i++) {
                ...
                if (frameGroupImages != null) {
                    if (frameGroupImages[i] != null) {
                        lineBytes = new String("!number of images this frame group := " +
                                                frameGroupImages[i] + "\r\n").getBytes();
                        raFile.write(lineBytes);
                    }
                }
                ...
                if (pauseBetweenImages != null) {
                    if (pauseBetweenImages[i] != null) {
                        lineBytes = new String("pause between images (sec) := " +
                ...
                if (pauseBetweenFrameGroups != null) {
                    if (pauseBetweenFrameGroups[i] != null) {
                        lineBytes = new String("pause between frame groups (sec) := " +
                ...
                if (maximumPixelCountInGroup != null) {
                    if (maximumPixelCountInGroup[i] != null) {
                        lineBytes = new String("!maximum pixel count in group := " +
        ...
        if (!simple) {
            ...
            if (detectorHeadNumber != null) {
                lineBytes = new String("number of detector heads := " +
                                        detectorHeadNumber + "\r\n").getBytes();
                raFile.write(lineBytes);
            }
            imagesPerEWindow = fileInfo.getImagesPerEWindow();
        ...
        if (haveGatedStudy) {
            ...
            if (observedCardiacCycles != null) {
                lineBytes = new String("number of cardiac cycles (observed) := " +
            ...
            lineBytes = new String("number of time windows := " +
                                    timeWindowsNumber + "\r\n").getBytes();
            raFile.write(lineBytes);
            ...
            for (i = 0; i < timeWindowsNumber; i++) {
                ...
                if (timeWindowImages != null) {
                    if (timeWindowImages[i] != null) {
                        lineBytes = new String("!number of images in time window := " +
                                                timeWindowImages[i] + "\r\n").getBytes();
                        raFile.write(lineBytes);
                    }
                }
                if (imageDuration != null) {
                    if (imageDuration[i] != null) {
                        lineBytes = new String("!image duration (sec) := " +
                                                 imageDuration[i] + "\r\n").getBytes();
                        raFile.write(lineBytes);
                    }
                }
                ...
                if (timeWindowLowerLimit != null) {
                    if (timeWindowLowerLimit[i] != null) {
                        lineBytes = new String("time window lower limit (sec) := " +
                ...
                if (timeWindowUpperLimit != null) {
                    if (timeWindowUpperLimit[i] != null) {
                        lineBytes = new String("time window upper limit (sec) := " +
                ...
                if (RRCycles != null) {
                    if (RRCycles[i] != null) {
                        lineBytes = new String("% R-R cycles acquired this window := " +
                                               RRCycles[i] + "\r\n").getBytes();
                        raFile.write(lineBytes);
                    }
                }
                ...
                if (acquiredStudyDuration != null) {
                    if (acquiredStudyDuration[i] != null) {
                        lineBytes = new String("study duration acquired (sec) := " +
        ...
        if ((!simple) && (!haveGatedStudy)) {
            ...
            if (startHorizontalBedPosition != null) {
                lineBytes = new String("start horizontal bed position (mm) := " +
            ...
            if (projectionNumber != null) {
                lineBytes = new String("!number of projections := " +
                                        projectionNumber + "\r\n").getBytes();
                raFile.write(lineBytes);
            }
            ...
            if (projectionTime != null) {
                lineBytes = new String("!time per projection (sec) := " +
                                        projectionTime + "\r\n").getBytes();
                raFile.write(lineBytes);
            }
            ...
            if (patientOrientation != null) {
                lineBytes = new String("patient orientation := " +
                                        patientOrientation + "\r\n").getBytes();
                raFile.write(lineBytes);
            }
            ...
            if (reconstructionMethod != null) {
                lineBytes = new String("method of reconstruction := " +
            ...
            if (referenceFrameNumber != null) {
                lineBytes = new String("number of reference frame := " +
            ...
            if (sliceThickness != null) {
                lineBytes = new String("slice thickness (pixels) := " +
                                        sliceThickness + "\r\n").getBytes();
                raFile.write(lineBytes);
            }
            centerCenter = fileInfo.getCenterCenter();
            if (centerCenter != null) {
                lineBytes = new String("centre-centre slice separation (pixels) := " +
                                        centerCenter + "\r\n").getBytes();
                raFile.write(lineBytes);
            }
            ...
            if (indexNestingLevel != null) {
                lineBytes = new String("index nesting level := " +
                                        indexNestingLevel + "\r\n").getBytes();
                raFile.write(lineBytes);
            ...
            for (i = 0; i < iLevel; i++) {
                if (imageDuration != null) {
                    if (imageDuration[i] != null) {
                        lineBytes = new String("image duration (sec) [" + (i+1) + "] := " +
                                                imageDuration[i] + "\r\n").getBytes();
                        raFile.write(lineBytes);
                    }
                }
        ...
        if (image.getType() == ModelStorageBase.BOOLEAN) {
            ...
            for (t = tBegin; t <= tEnd; t++) {
                timeOffset = t*volSize;
                for (z = zBegin; z <= zEnd; z++,sliceNum++) {
                    fileRW.writeImage(image,timeOffset+z*bufferSize,timeOffset+z*bufferSize+bufferSize,0);
                    progressBar.updateValue(100 * sliceNum/sliceTotal, false);
                }
            }
