...
/**
 * <p>Title: AlgorithmDCCIEConversion </p>
 * <p>Description: Recursively traverses a directory and its subfolders,
 *    converting all 3D DICOM  or uncompressed AVI files to AVI with MP42 Compression </p>
 * @author Ben Link
 * @version 1.0
 */
...
public class AlgorithmDCCIEConversion extends AlgorithmBase {
     ...
     */
    public AlgorithmDCCIEConversion( ViewUserInterface ui, String dir, String outputDir,
                                     int compression, boolean doDICOM ) {
        this.dirPath = dir;
    ...
    public void runAlgorithm() {
        ...
        progressBar = new ViewJProgressBar( "DCCIE Conversion", "Searching for images", 0, 100, false, null,
                null );
    ...
    private void runConversion( String fileName ) {
        ...
        if (fileName.endsWith(".tif") || fileName.endsWith(".TIF") ||
            ...
            File outputFile = new File(newDirectory + File.separator + fileName.substring(fileName.lastIndexOf(File.separator), fileName.length()));
        ...
        try {
            ...
            if ( inputImage == null ) {
                ...
                try {
                    patientID = (String) ( (FileDicomTag) ( (FileInfoDicom) inputImage.getFileInfo( 0 ) ).getEntry( "0010,0020" ) ).getValue(
                            false );
