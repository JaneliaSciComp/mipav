...
public class AlgorithmConvert3Dto4D extends AlgorithmBase {
     ...
     * @param volumeLength  the 3D image will be chopped upto to volumes of this length
     *                      volumeLength should divide evenly  (without remainder) into
     *                      the 3rd dimension length of the original image.
    ...
    private void constructLog() {
        historyString = new String(
                "Convert3Dto4D(" + volumeLength + ", " + resol3 + ", " + resol4 + ", " + resolUnit3 + ", " + resolUnit4
                + ", " + ")\n" );
    }
