...
*  Modify to handle MRGE files from a GE signa-5 with IMGF starting at locating 3228 and
*  image data starting at location 8424.  Follows file format thru lenUsrDefData field;
*  then varies from format.
*/
...
public class FileGESigna5X extends FileBase{
    ...
    */
    public FileInfoGESigna5X getFileInfo(){ return fileInfo;}

    public int getStartAdjust() {return startAdjust;}
