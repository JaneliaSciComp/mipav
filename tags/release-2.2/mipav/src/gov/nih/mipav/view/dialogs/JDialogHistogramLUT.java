...
/**
 *   Dialog to call the histogram algorithm. This dialog will not be
...
public class JDialogHistogramLUT extends JDialogBase implements AlgorithmInterface
{
    ...
    /**
     *   Creates new histogram dialog.  Does not actually display
     *   dialog - constructDialog is called from ViewJFrameImage if
     *   there are VOI regions in the image.  Otherwise, histogramLUT
     *   is called directly.
     ...
     */
    public JDialogHistogramLUT(Frame theParentFrame, ModelImage imA, ModelImage imB,
                               ModelLUT _LUTa, ModelLUT _LUTb, ViewUserInterface UI)
    {
     ...
     *   @param UI               Pointer to the user interface.
     */
    public JDialogHistogramLUT(Frame theParentFrame, ViewJComponentRegistration _regComponent,
                               ModelImage imA, ModelImage imB,
                               ModelLUT _LUTa, ModelLUT _LUTb, ViewUserInterface UI)
    {
     ...
     *   @param _LUTb            RGB LUT associated with image B (can be null).
     *   @param UI               Pointer to the user interface.
     */
    public JDialogHistogramLUT(Frame theParentFrame, ModelImage imA, ModelImage imB,
                               ModelRGB _RGBa, ModelRGB _RGBb, ViewUserInterface UI)
    {
        super(theParentFrame, true);
        imageA = imA;
        imageB = imB;
    ...
    /**
     *   Creates a dialog to choose if histogram should be over all of image
     *   or just VOI regions.
     */
    ...
    public void histogramLUT(boolean entireFlag)
    {
        ...
        if (imageA.isColorImage() == false)
        {
            ...
            {
                histoLUTFrame = new ViewJFrameHistoLUT((ViewJFrameColocalizationRegression) parentFrame, imageA, null, LUTa, null, true);
            }
            else if (colocalizationEMFrame)
            {
                histoLUTFrame = new ViewJFrameHistoLUT((ViewJFrameColocalizationEM) parentFrame, imageA, null, LUTa, null, true);
            }
