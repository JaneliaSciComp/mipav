 ...
 *
 */
public class JDialogNMSuppression
    extends JDialogBase
    ...
    if (image.getNDims() == 2) { // source image is 2D
      ...
      if (displayLoc == NEW) {
        try {
          ...
          // Make algorithm
          nmSuppressionAlgo = new AlgorithmNMSuppression(resultImage, image,
              sigmas, regionFlag, false);
          ...
          MipavUtil.displayError(
              "Dialog NMSuppression: unable to allocate enough memory");
          if (resultImage != null) {
        ...
        try {
          ...
          nmSuppressionAlgo = new AlgorithmNMSuppression(image, sigmas,
              regionFlag, false);
            // This is very important. Adding this object as a listener allows the algorithm to
            // notify this object when it has completed of failed. See algorithm performed event.
            // This is made possible by implementing AlgorithmedPerformed interface
