...
/**
 *   Dialog to call the AlgorithmConvert3Dto4D to convert a 3D data set
 *   into a 4D data set.
 ...
 *
 */
public class JDialogConvert3Dto4D
    extends JDialogBase
  ...
  // Script records a closeFrame from the line
  // ((ViewJFrameBase) parentFrame).close(); which calls ViewJFrameImage.close().
  // If executing script, don't call close() here or both this close()
  // and the closeFrame would occur.
  ...
  public void callAlgorithm() {
    ...
    try {
      System.gc();
      // Make algorithm
      convert3Dto4DAlgo = new AlgorithmConvert3Dto4D(image, volumeLength,
          res3, res4, measure3, measure4);
      ...
      MipavUtil.displayError(
          "JDialogConvert3Dto4D: unable to allocate enough memory");
      return;
    }
  }
