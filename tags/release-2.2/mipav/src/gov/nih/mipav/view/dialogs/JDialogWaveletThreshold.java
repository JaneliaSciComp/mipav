 ...
 *
 */
public class JDialogWaveletThreshold
    extends JDialogBase
  ...
  // that user only sees changes due to the number of
  ...
  private boolean setVariables() {
    ...
    cNum = Integer.valueOf( (String) coefficientCombo.getSelectedItem()).
        intValue();
  ...
  /**
   *	Once all the necessary variables are set, call the UnsharpMark
    ...
    if (image.getNDims() == 2) { // source image is 2D
      ...
      if (displayLoc == NEW) {
        try {
          ...
          // Make algorithm
          waveletAlgo = new AlgorithmWaveletThreshold(resultImage, image, PWT,
              cNum,
              thresholdType, threshold, doWaveletImage,
              userInterface);
          ...
          MipavUtil.displayError(
              "Dialog WaveletThreshold: unable to allocate enough memory");
          if (resultImage != null) {
        ...
        try {
          ...
          waveletAlgo = new AlgorithmWaveletThreshold(image, PWT, cNum,
              thresholdType,
              threshold, doWaveletImage, userInterface);
          // This is very important. Adding this object as a listener allows the algorithm to
          // notify this object when it has completed of failed. See algorithm performed event.
          // This is made possible by implementing AlgorithmedPerformed interface
          waveletAlgo.addListener(this);
           ...
           if (doWaveletImage) {
             ...
             if (waveletImage != null) {
               ...
               try {
                 ...
                 MipavUtil.displayError(
                     "Out of memory: Unable to open wavelet image frame");
               }
             }
             else {
