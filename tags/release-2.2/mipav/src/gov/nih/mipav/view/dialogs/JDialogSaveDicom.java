...
/**
*   Simple dialog to tell the program important information necessary for
*   saving the DICOM file.
...
public class JDialogSaveDicom extends JDialogBase {
    ...
    private     String[] modalities = { "Biomagnetic Imaging",
   	                                    "Color Flow Doppler",
    ...
    private     String[] positions = {  "Unknown", "Head-First Prone", "Head-First Supine",
                                        "Feet First-Prone", "Feet First-Supine",
                                        "HF-Decubitus Right", "HF-Decubitus Left",
                                        "FF-Decubitus Right", "FF-Decubitus Left"};
    private     String[] parts     = {  "Unknown", "Skull", "CSpine", "TSpine", "LSpine", "SSpine",
                                        "Coccyx", "Chest", "Clavicle", "Breast", "Abdomen", "Pelvis",
                                        "Hip", "Shoulder", "Elbow", "Knee", "Ankle", "Hand", "Foot",
    ...
    *    sets the information, doing error checking for every tag.
    *    @param event      Event that triggers this function.
    */
    public void actionPerformed(ActionEvent event) {
        if (event.getActionCommand().equals("OK")) {
            if (checkTag(studyUID.getText(), "UI") &&
                checkTag(seriesUID.getText(), "UI") &&
                checkTag(patientName.getText(), "PN") &&
                checkTag(patientID.getText(), "LO") &&
                checkTag(patientBirthDate.getText(), "DA") &&
                checkTag(patientBirthDate.getText(), "TM") &&
                checkTag(patientOtherIDs.getText(), "LO") &&
                checkTag(patientOtherNames.getText(), "PN") &&
                checkTag(patientEthnicGroup.getText(), "SH") &&
                checkTag(patientComments.getText(), "LT") &&
                checkTag(patientOrientation.getText(), "Orient") &&
                checkTag(studyDate.getText(), "DA") &&
                checkTag(studyTime.getText(), "TM") &&
                checkTag(studyRefPhy.getText(), "PN") &&
                checkTag(studyID.getText(), "SH") &&
                checkTag(studyAccNumber.getText(), "SH") &&
                checkTag(studyDescrip.getText(), "LO") &&
                checkTag(studyPhyRec.getText(), "PN") &&
                checkTag(studyPhyRead.getText(), "PN") &&
                checkTag(studyDiag.getText(), "LO") &&
                checkTag(studyAge.getText(), "AS") &&
                checkTag(studyWeight.getText(), "DS") &&
                checkTag(studySize.getText(), "DS") &&
                checkTag(studyOcc.getText(), "SH") &&
                checkTag(studyHist.getText(), "LT") &&
                checkTag(seriesNo.getText(), "IS") &&
                checkTag(seriesDate.getText(), "DA") &&
                checkTag(seriesTime.getText(), "TM") &&
                checkTag(seriesPerfPhy.getText(), "PN") &&
                checkTag(seriesProtocol.getText(), "LO") &&
                checkTag(seriesDescrip.getText(), "LO") &&
                checkTag(seriesOp.getText(), "PN") &&
                checkTag(seriesSmall.getText(), "USorSS") &&
                checkTag(seriesLarge.getText(), "USorSS") &&
                checkTag(seriesStepID.getText(), "SH") &&
                checkTag(seriesStepDate.getText(), "DA") &&
                checkTag(seriesStepTime.getText(), "TM") &&
                checkTag(seriesStepDescrip.getText(), "LO")) {
                ...
                dicomFileInfo.setValue("0010,2160", patientEthnicGroup.getText(), patientEthnicGroup.getText().length());
                dicomFileInfo.setValue("0010,4000", patientComments.getText(), patientComments.getText().length());
                dicomFileInfo.setValue("0020,0020", patientOrientation.getText(), patientOrientation.getText().length());
                ...
                switch (patientSex.getSelectedIndex()) {
                    case 0: dicomFileInfo.setValue("0010,0040", "", 0); break;
                    case 1: dicomFileInfo.setValue("0010,0040", "M ", 2); break;
                    case 2: dicomFileInfo.setValue("0010,0040", "F ", 2); break;
                    case 3: dicomFileInfo.setValue("0010,0040", "O ", 2); break;
                }

                switch (seriesMod.getSelectedIndex()) {
                    case 0: dicomFileInfo.setValue("0008,0060", "BI", 2); break;
   	                case 1: dicomFileInfo.setValue("0008,0060", "CD", 2); break;
                    case 2: dicomFileInfo.setValue("0008,0060", "CR", 2); break;
                    case 3: dicomFileInfo.setValue("0008,0060", "CT", 2); break;
                    case 4: dicomFileInfo.setValue("0008,0060", "DD", 2); break;
                    case 5: dicomFileInfo.setValue("0008,0060", "DG", 2); break;
                    case 6: dicomFileInfo.setValue("0008,0060", "DX", 2); break;
                    case 7: dicomFileInfo.setValue("0008,0060", "ES", 2); break;
                    case 8: dicomFileInfo.setValue("0008,0060", "GM", 2); break;
                    case 9: dicomFileInfo.setValue("0008,0060", "HC", 2); break;
                    case 10: dicomFileInfo.setValue("0008,0060", "IO", 2); break;
                    case 11: dicomFileInfo.setValue("0008,0060", "LS", 2); break;
                    case 12: dicomFileInfo.setValue("0008,0060", "MA", 2); break;
                    case 13: dicomFileInfo.setValue("0008,0060", "MG", 2); break;
                    case 14: dicomFileInfo.setValue("0008,0060", "MR", 2); break;
                    case 15: dicomFileInfo.setValue("0008,0060", "MS", 2); break;
                    case 16: dicomFileInfo.setValue("0008,0060", "NM", 2); break;
                    case 17: dicomFileInfo.setValue("0008,0060", "OT", 2); break;
                    case 18: dicomFileInfo.setValue("0008,0060", "PT", 2); break;
                    case 19: dicomFileInfo.setValue("0008,0060", "PX", 2); break;
                    case 20: dicomFileInfo.setValue("0008,0060", "RF", 2); break;
                    case 21: dicomFileInfo.setValue("0008,0060", "RG", 2); break;
                    case 22: dicomFileInfo.setValue("0008,0060", "RTDOSE", 6); break;
                    case 23: dicomFileInfo.setValue("0008,0060", "RTIMAGE ", 8); break;
                    case 24: dicomFileInfo.setValue("0008,0060", "RTPLAN", 6); break;
                    case 25: dicomFileInfo.setValue("0008,0060", "RTRECORD", 8); break;
                    case 26: dicomFileInfo.setValue("0008,0060", "RTSTRUCT", 8); break;
                    case 27: dicomFileInfo.setValue("0008,0060", "SM", 2); break;
                    case 28: dicomFileInfo.setValue("0008,0060", "ST", 2); break;
                    case 29: dicomFileInfo.setValue("0008,0060", "TG", 2); break;
                    case 30: dicomFileInfo.setValue("0008,0060", "US", 2); break;
                    case 31: dicomFileInfo.setValue("0008,0060", "XA", 2); break;
                    case 32: dicomFileInfo.setValue("0008,0060", "XC", 2); break;
                }

                switch (laterality.getSelectedIndex()) {
                    case 1: dicomFileInfo.setValue("0020,0060", "L ", 2); break;
                    case 2: dicomFileInfo.setValue("0020,0060", "R ", 2); break;
                }

                switch (seriesBody.getSelectedIndex()) {
                    case 1:  dicomFileInfo.setValue("0018,0015", "SKULL ", 6); break;
                    case 2:  dicomFileInfo.setValue("0018,0015", "CSPINE", 6); break;
                    case 3:  dicomFileInfo.setValue("0018,0015", "TSPINE", 6); break;
                    case 4:  dicomFileInfo.setValue("0018,0015", "LSPINE", 6); break;
                    case 5:  dicomFileInfo.setValue("0018,0015", "SSPINE", 6); break;
                    case 6:  dicomFileInfo.setValue("0018,0015", "COCCYX", 6); break;
                    case 7:  dicomFileInfo.setValue("0018,0015", "CHEST ", 6); break;
                    case 8:  dicomFileInfo.setValue("0018,0015", "CLAVICLE", 8); break;
                    case 9:  dicomFileInfo.setValue("0018,0015", "BREAST", 6); break;
                    case 10: dicomFileInfo.setValue("0018,0015", "ABDOMEN ", 8); break;
                    case 11: dicomFileInfo.setValue("0018,0015", "PELVIS", 6); break;
                    case 12: dicomFileInfo.setValue("0018,0015", "HIP ", 4); break;
                    case 13: dicomFileInfo.setValue("0018,0015", "SHOULDER", 8); break;
                    case 14: dicomFileInfo.setValue("0018,0015", "ELBOW ", 6); break;
                    case 15: dicomFileInfo.setValue("0018,0015", "KNEE", 4); break;
                    case 16: dicomFileInfo.setValue("0018,0015", "ANKLE ", 6); break;
                    case 17: dicomFileInfo.setValue("0018,0015", "HAND", 4); break;
                    case 18: dicomFileInfo.setValue("0018,0015", "FOOT", 4); break;
                    case 19: dicomFileInfo.setValue("0018,0015", "EXTREMITY ", 10); break;
                    case 20: dicomFileInfo.setValue("0018,0015", "HEAD", 4); break;
                    case 21: dicomFileInfo.setValue("0018,0015", "HEART ", 6); break;
                    case 22: dicomFileInfo.setValue("0018,0015", "NECK", 4); break;
                    case 23: dicomFileInfo.setValue("0018,0015", "LEG ", 4); break;
                    case 24: dicomFileInfo.setValue("0018,0015", "ARM ", 4); break;
                    case 25: dicomFileInfo.setValue("0018,0015", "JAW ", 4); break;
                }
                switch (seriesPos.getSelectedIndex()) {
                    case 1: dicomFileInfo.setValue("0018,5100", "HFP ", 4); break;
                    case 2: dicomFileInfo.setValue("0018,5100", "HFS ", 4); break;
                    case 3: dicomFileInfo.setValue("0018,5100", "FFP ", 4); break;
                    case 4: dicomFileInfo.setValue("0018,5100", "FFS ", 4); break;
                    case 5: dicomFileInfo.setValue("0018,5100", "HFDR", 4); break;
                    case 6: dicomFileInfo.setValue("0018,5100", "HFDL", 4); break;
                    case 7: dicomFileInfo.setValue("0018,5100", "FFDR", 4); break;
                    case 8: dicomFileInfo.setValue("0018,5100", "FFDL", 4); break;
                }
    ...
    /**
    *   Checks the text field data for the proper format.  For example,
    *   UIDs must be strings of numbers and periods, person's names must
    *   be in the format Doe^John, etc.
    ...
    */
    private boolean checkTag(String value, String type) {
        ...
        if (type.equals("UI")) { // Must be in the form 9.999.99999999.99.9999 etc.
            ...
            if (value.length() != 0) {
            	if (Integer.valueOf(value.substring(0,4)).intValue() < 0 || Integer.valueOf(value.substring(0,4)).intValue() > 2500) {
                    	MipavUtil.displayError("Date must be of the form yyyymmdd where yyyy contains the year,\n"+
                                        	"mm contains the month and dd contains the day.\n"+
                                        	"Year " + value.substring(0,4) + " is invalid.");
                    	return false;
            	}
            	if (Integer.valueOf(value.substring(4,6)).intValue() < 1 || Integer.valueOf(value.substring(4,6)).intValue() > 12) {
                    	MipavUtil.displayError("Date must be of the form yyyymmdd where yyyy contains the year,\n"+
                                        	"mm contains the month and dd contains the day.\n"+
                                        	"Month " + value.substring(4,6) + " is invalid.");
                    	return false;
            	}
            	if (Integer.valueOf(value.substring(6,8)).intValue() < 1 || Integer.valueOf(value.substring(6,8)).intValue() > 31) {
                    	MipavUtil.displayError("Date must be of the form yyyymmdd where yyyy contains the year,\n"+
                                        	"mm contains the month and dd contains the day.\n"+
                                        	"Day " + value.substring(6,8) + " is invalid.");
                    	return false;
            	}
            }
            return true;
            ...
            if (value.length() > 0) {
                ...
                if (value.charAt(3) != 'D' && value.charAt(3) != 'W' &&
                    value.charAt(3) != 'M' && value.charAt(3) != 'Y') {
                    MipavUtil.displayError("Age must be of the form nnnD, nnnW, nnnM, or nnnY, where nnn contains\n"+
                                           "the number of days for D, the number of weeks for W, the number\n" +
                                           "of months for M, or the number of years for Y (4 characters).");
                    return false;
                }
                if (!Character.isDigit(value.charAt(0)) || !Character.isDigit(value.charAt(1)) || !Character.isDigit(value.charAt(2))) {
                    MipavUtil.displayError("Age must be of the form nnnD, nnnW, nnnM, or nnnY, where nnn contains\n"+
                                           "the number of days for D, the number of weeks for W, the number\n"+
                                           "of months for M, or the number of years for Y (4 characters).");
                    return false;
            ...
            if (value.length() > 0) {
                try {
                    ...
                    MipavUtil.displayError(value + " is not a signed short.  It must be in the range " + Short.MIN_VALUE + " to " + Short.MAX_VALUE + ".");
                    return false;
                }
            }
            else return true;
            ...
            if (value.length() > 0) {
                try {
                    ...
                    try {
                        ...
                        if (s < 65536) return true;
                        MipavUtil.displayError(value + " must be in the range 0 to 65536.");
                        return false;
                    }
                    catch (NumberFormatException error2) {
                        MipavUtil.displayError(value + " is not an unsigned short.  It must be in the range 0 to 65536.");
                        return false;
                    }
                }
            }
            ...
            if (value.length() > 0) {
                try {
                    ...
                    try {
                        ...
                        MipavUtil.displayError(value + " is not an unsigned or signed short.  It must either be in the range 0 to 65536\n"+
                                               "or in the range " + Short.MIN_VALUE + " to " + Short.MAX_VALUE + ".");
                        return false;
                    }
                }
            ...
            if (value.length() > 0) {
                try {
                    ...
                    for (int i=0; i<array1.length; i++) {
                        if (array1[i] != 'A' && array1[i] != 'P' && array1[i] != 'R' &&
                            array1[i] != 'L' && array1[i] != 'H' && array1[i] != 'F') {
    ...
    /**
    *   Checks that all the characters of the string are in the default
    ...
    */
    ...
    private void fillDataFromTable(Hashtable table) {
        ...
        while (keys.hasMoreElements()) {
            ...
            if (tag.equals("(0008,0060)") || tag.equals("(0010,0040)") || tag.equals("(0018,0015)") || tag.equals("(0018,5100)")) {
    ...
    private void fillDataFromFile() {
        ...
        try {
        	...
        	while (tempString != null) {
                ...
                else if (tag.equals("(0010,0032)") || tag.equals("(0008,0030)") || tag.equals("(0008,0031)") || tag.equals("(0040,0245)")) {
                	if (value.length() > 0) {
                		String s = "";
                ...
                else if (tag.equals("(0008,0020)") || tag.equals("(0040,0024)") || tag.equals("(0008,0021)") || tag.equals("(0010,0030)")) {
                	if (value.length() == 10) {
    ...
    */
    private void resetSize(JTextField field) {
        field.setPreferredSize(new Dimension(field.getHorizontalVisibility().getMaximum()+5, field.getPreferredSize().height));
    }
    ...
    private void setChooserFromTag(String tag, String value) {
        if (tag.equals("(0008,0060)")) {
            ...
            if      (value.toLowerCase().equals("biomagnetic_imaging"))   seriesMod.setSelectedIndex(0);
            else if (value.toLowerCase().equals("color_flow_doppler"))    seriesMod.setSelectedIndex(1);
            else if (value.toLowerCase().equals("computed_radiography"))  seriesMod.setSelectedIndex(2);
            else if (value.toLowerCase().equals("computed_tomography"))   seriesMod.setSelectedIndex(3);
            else if (value.toLowerCase().equals("duplex_doppler"))        seriesMod.setSelectedIndex(4);
            else if (value.toLowerCase().equals("diaphanography"))        seriesMod.setSelectedIndex(5);
            else if (value.toLowerCase().equals("digital_radiography"))   seriesMod.setSelectedIndex(6);
            else if (value.toLowerCase().equals("endoscopy"))             seriesMod.setSelectedIndex(7);
            else if (value.toLowerCase().equals("general_microscopy"))    seriesMod.setSelectedIndex(8);
            else if (value.toLowerCase().equals("hardcody"))              seriesMod.setSelectedIndex(9);
            else if (value.toLowerCase().equals("intraoral_radiography")) seriesMod.setSelectedIndex(10);
            else if (value.toLowerCase().equals("laser_surface_scan"))    seriesMod.setSelectedIndex(11);
            else if (value.toLowerCase().equals("mr_angiography"))        seriesMod.setSelectedIndex(12);
            else if (value.toLowerCase().equals("mammography"))           seriesMod.setSelectedIndex(13);
            else if (value.toLowerCase().equals("magnetic_resonance"))    seriesMod.setSelectedIndex(14);
            else if (value.toLowerCase().equals("mr_spectroscopy"))       seriesMod.setSelectedIndex(15);
            else if (value.toLowerCase().equals("nuclear_medicine"))      seriesMod.setSelectedIndex(16);
            else if (value.toLowerCase().equals("other"))                 seriesMod.setSelectedIndex(17);
            else if (value.toLowerCase().equals("pet"))                   seriesMod.setSelectedIndex(18);
            else if (value.toLowerCase().equals("panoramic_xray"))        seriesMod.setSelectedIndex(19);
            else if (value.toLowerCase().equals("radio_fluoroscopy"))     seriesMod.setSelectedIndex(20);
            else if (value.toLowerCase().equals("radiographic_imaging"))  seriesMod.setSelectedIndex(21);
            else if (value.toLowerCase().equals("radiotherapy_dose"))     seriesMod.setSelectedIndex(22);
            else if (value.toLowerCase().equals("radiotherapy_image"))    seriesMod.setSelectedIndex(23);
            else if (value.toLowerCase().equals("radiotherapy_plan"))     seriesMod.setSelectedIndex(24);
            else if (value.toLowerCase().equals("radiotherapy_record"))   seriesMod.setSelectedIndex(25);
            else if (value.toLowerCase().equals("radiotherapy_structure")) seriesMod.setSelectedIndex(26);
            else if (value.toLowerCase().equals("slide_microscopy"))      seriesMod.setSelectedIndex(27);
            else if (value.toLowerCase().equals("spect"))                 seriesMod.setSelectedIndex(28);
            else if (value.toLowerCase().equals("thermography"))          seriesMod.setSelectedIndex(29);
            else if (value.toLowerCase().equals("ultrasound"))            seriesMod.setSelectedIndex(30);
            else if (value.toLowerCase().equals("xray_angiography"))      seriesMod.setSelectedIndex(31);
            else if (value.toLowerCase().equals("external_photography"))  seriesMod.setSelectedIndex(32);
            else                                                          seriesMod.setSelectedIndex(17);
        }
        else if (tag.equals("(0010,0040)")) {
            //set patient sex combo box
            if      (value.equals("Other"))  patientSex.setSelectedIndex(3);
            else if (value.equals("Male"))   patientSex.setSelectedIndex(1);
            else if (value.equals("Female")) patientSex.setSelectedIndex(2);
            else                             patientSex.setSelectedIndex(0);  // Unknown
        }
        else if (tag.equals("(0018,0015)")) {
            // set area examined combo box
            if      (value.equals("Skull"))     seriesBody.setSelectedIndex(1);
            else if (value.equals("CSpine"))    seriesBody.setSelectedIndex(2);
            else if (value.equals("TSpine"))    seriesBody.setSelectedIndex(3);
            else if (value.equals("LSpine"))    seriesBody.setSelectedIndex(4);
            else if (value.equals("SSpine"))    seriesBody.setSelectedIndex(5);
            else if (value.equals("Coccyx"))    seriesBody.setSelectedIndex(6);
            else if (value.equals("Chest"))     seriesBody.setSelectedIndex(7);
            else if (value.equals("Clavicle"))  seriesBody.setSelectedIndex(8);
            else if (value.equals("Breast"))    seriesBody.setSelectedIndex(9);
            else if (value.equals("Abdomen"))   seriesBody.setSelectedIndex(10);
            else if (value.equals("Pelvis"))    seriesBody.setSelectedIndex(11);
            else if (value.equals("Hip"))       seriesBody.setSelectedIndex(12);
            else if (value.equals("Shoulder"))  seriesBody.setSelectedIndex(13);
            else if (value.equals("Elbow"))     seriesBody.setSelectedIndex(14);
            else if (value.equals("Knee"))      seriesBody.setSelectedIndex(15);
            else if (value.equals("Ankle"))     seriesBody.setSelectedIndex(16);
            else if (value.equals("Hand"))      seriesBody.setSelectedIndex(17);
            else if (value.equals("Foot"))      seriesBody.setSelectedIndex(18);
            else if (value.equals("Extremity")) seriesBody.setSelectedIndex(19);
            else if (value.equals("Head"))      seriesBody.setSelectedIndex(20);
            else if (value.equals("Heart"))     seriesBody.setSelectedIndex(21);
            else if (value.equals("Neck"))      seriesBody.setSelectedIndex(22);
            else if (value.equals("Leg"))       seriesBody.setSelectedIndex(23);
            else if (value.equals("Arm"))       seriesBody.setSelectedIndex(24);
            else if (value.equals("Jaw"))       seriesBody.setSelectedIndex(25);
            else                                seriesBody.setSelectedIndex(0);
        }
        else if (tag.equals("(0018,5100)")) {
            // set patient position combo box
            if      (value.equals("Head First-Prone"))  seriesPos.setSelectedIndex(1);
            else if (value.equals("Head First-Supine")) seriesPos.setSelectedIndex(2);
            else if (value.equals("Feet First-Prone"))  seriesPos.setSelectedIndex(3);
            else if (value.equals("Feet First-Supine")) seriesPos.setSelectedIndex(4);
            else if (value.equals("HF-Decubitus Right")) seriesPos.setSelectedIndex(5);
            else if (value.equals("HF-Decubitus Left"))  seriesPos.setSelectedIndex(6);
            else if (value.equals("FF-Decubitus Right")) seriesPos.setSelectedIndex(7);
            else if (value.equals("FF-Decubitus Left"))  seriesPos.setSelectedIndex(8);
            else                                         seriesPos.setSelectedIndex(0);  // Unknown
        }
    }
}
