    ...
    if (image.getNDims() == 2) { // source image is 2D
      ...
      if (displayLoc == NEW) {
        try {
          ...
          // Make algorithm
          findEdgesAlgo2D = new AlgorithmMorphology2D(resultImage,
              AlgorithmMorphology2D.CONNECTED4, 0,
              AlgorithmMorphology2D.FIND_EDGES, 0, 0, 0, edgingType, regionFlag);
          if (regionFlag == false)
          ...
          MipavUtil.displayError(
              "Dialog FindEdges: unable to allocate enough memory");
          if (resultImage != null) {
        ...
        try {
          ...
          findEdgesAlgo2D = new AlgorithmMorphology2D(image,
              AlgorithmMorphology2D.CONNECTED4, 0,
              AlgorithmMorphology2D.FIND_EDGES, 0, 0, 0, edgingType, regionFlag);
          if (regionFlag == false)
            findEdgesAlgo2D.setMask(image.generateVOIMask());
          ...
          MipavUtil.displayError(
              "Dialog Find Edges: unable to allocate enough memory");
          return;
        }
      }
    }
      ...
      if (displayLoc == NEW) {
        try {
          ...
          resultImage.setImageName(name);
          // Make algorithm
          findEdgesAlgo3D = new AlgorithmMorphology3D(resultImage,
              AlgorithmMorphology3D.CONNECTED6, 0,
              AlgorithmMorphology3D.FIND_EDGES, 0, 0, 0, edgingType, regionFlag);
          if (regionFlag == false)
          ...
          MipavUtil.displayError(
              "Dialog FindEdges objects: unable to allocate enough memory");
          if (resultImage != null) {
        ...
        try {
          // Make algorithm
          findEdgesAlgo3D = new AlgorithmMorphology3D(image,
              AlgorithmMorphology3D.CONNECTED6, 0,
              AlgorithmMorphology3D.FIND_EDGES, 0, 0, 0, edgingType, regionFlag);
          if (regionFlag == false)
            findEdgesAlgo3D.setMask(image.generateVOIMask());
