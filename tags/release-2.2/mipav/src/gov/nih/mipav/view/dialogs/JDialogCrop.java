...
public class JDialogCrop extends JDialogBase implements AlgorithmInterface, ScriptableInterface
{
    ...
    /**
     *    @deprecated Use JDialogCrop(ModelImage) instead
    ...
    public void callAlgorithm()
    {
        try
        {
            ...
            {
                if (Math.abs(zBounds[1] - zBounds[0]) == 0)
                { // crop 3D image to 2D image
                    destExtents = new int[2];
                    destExtents[0] = Math.abs(xBounds[1] - xBounds[0]) + 1 +
                        2 * borderSize;
                    destExtents[1] = Math.abs(yBounds[1] - yBounds[0]) + 1 +
     ...
     //************************** Algorithm Events ****************************
      //************************************************************************
       ...
       public void algorithmPerformed(AlgorithmBase algorithm)
       {
           ...
           {
               if ( (cropAlgo.isCompleted() == true) && (resultImage != null))
               { // in StoreInDest; "new Image"
     ...
     * Init() method will call this method each time CROP region is selected.
     */
    ...
    /**
     * This method calculates the lower X, lower Y, and lower Z coordinates(millimeters) for
     * the CROP VOI region.
     */
