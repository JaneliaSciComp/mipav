...
/**
 *   Dialog to separate RGB channels into grayscale Hue, Saturation,
 *   and Brightness channels
 */
public class JDialogRGBtoHSB
    extends JDialogBase
  ...
  public void callAlgorithm() {
    try {
      if (imageA.getType() == ModelStorageBase.ARGB) {
        resultImageH = new ModelImage(ModelImage.UBYTE, imageA.getExtents(),
                                      "GrayHue",
                                      userInterface);
        resultImageS = new ModelImage(ModelImage.UBYTE, imageA.getExtents(),
                                      "GraySaturation",
                                      userInterface);
        ...
        resultImageH = new ModelImage(ModelImage.USHORT, imageA.getExtents(),
                                      "GrayHue",
                                      userInterface);
        resultImageS = new ModelImage(ModelImage.USHORT, imageA.getExtents(),
                                      "GraySaturation",
                                      userInterface);
        ...
        resultImageH = new ModelImage(ModelImage.FLOAT, imageA.getExtents(),
                                      "GrayHue",
                                      userInterface);
        resultImageS = new ModelImage(ModelImage.FLOAT, imageA.getExtents(),
                                      "GraySaturation",
                                      userInterface);
      ...
      // Make algorithm
      HSBAlgo = new AlgorithmRGBtoHSB(resultImageH, resultImageS,
                                        resultImageB, imageA);
      ...
      MipavUtil.displayError(
          "Dialog RGB to HSB: unable to allocate enough memory");
      return;
    }
  }
