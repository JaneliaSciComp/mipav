...
public abstract class ViewJComponentHLUTBase
    ...
    /**
     * Remove the point of the LUT transfer function which the mouse is hovering
     * over (determined by <code>mouseMotion</code>).
     */
    public abstract void removeClickedFunctionPoint();

    /**
     * Check to see if the position of the mouse is close to one of the points in the
     * LUT transfer function or the line drawn in between the points.
