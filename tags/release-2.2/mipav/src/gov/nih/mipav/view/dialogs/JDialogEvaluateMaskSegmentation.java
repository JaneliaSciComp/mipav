...
public class JDialogEvaluateMaskSegmentation extends JDialogBase implements AlgorithmInterface, ScriptableInterface {
    ...
    */
    ...
    public void scriptRun (AlgorithmScriptParser parser) throws IllegalArgumentException {
        ...
        if (im1.getType() != ModelImage.BOOLEAN &&
            im1.getType() != ModelImage.UBYTE &&
   ...
   */
    ...
    */
    private void constructLog() {
        String logString = new String( "EvaluateMaskSegmentation " + testImage.getImageName()+
    ...
    */
    protected void closingLog() {
        ...
        if (evalSeg.isCompleted() == true) {
            logString = new String("EvaluateMaskSegmentation " + testImage.getImageName()+
                                " to "+trueImage.getImageName()+
