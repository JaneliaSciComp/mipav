...
*
*/
public class JDialogColocalizationDENCLUE extends JDialogBase implements AlgorithmInterface {
    ...
    */
	public JDialogColocalizationDENCLUE(Frame theParentFrame, ModelImage im) {
		super(theParentFrame, true);
        firstImage = im;
		init();
	}

	public JDialogColocalizationDENCLUE(ViewUserInterface UI, ModelImage firstImage) {
	    super();
	    this.UI = UI;
    ...
    private void callAlgorithm() {
        ...
        try {
            ...
            if (firstImage.isColorImage()) {
                ...
                colocalizationAlgo= new AlgorithmColocalizationEM(resultImage,
                                       segImage, firstImage, secondImage,
                                       bin1, bin2, threshold1, threshold2, doOr,
                                       leftPad, rightPad,
                                       bottomPad, topPad,
                                       entireImage,
        ...
        if (colocalizationAlgo.isCompleted() == true) {
            if (secondImage != null) {
        	  if (UI.isScriptRecording()) {
        		UI.getScriptDialog().append("ColocalizationEM " + UI.getScriptDialog().getVar(firstImage.getImageName()) +
