            ...
            ListSelectionListener
{
    ...
    /** Flag is set if one of the controls changed a value and
     * the renderering needs to be redrawn when the mouse is released.
     */
    ...
    /**
     * Constructor.
     * @param kPanelSurface JPanelSurface Reference to the panel which
     * contains the surface view.  This may be a null reference to indicate
     * that there is no corresponding surface view panel.
     * @param kRenderSurface SurfaceRender Reference to view which contains
     * the surface rendered view.
     */
    public JPanelLights( JPanelSurface kPanelSurface, SurfaceRender kRenderSurface) {
        ...
        kLight = new GeneralLight(GeneralLight.MASK_ALL ^ GeneralLight.MASK_AMBIENT,
            maxBox/2.0f, maxBox/2.0f, maxBox/2.0f);
        ...
        m_akWorldLights = new GeneralLight[] {
            m_akLights[LIGHT_INDEX_STATIC],
        };
        m_akModelLights = new GeneralLight[] {
            m_akLights[LIGHT_INDEX_AMBIENT],
            m_akLights[LIGHT_INDEX_MODEL_X0Y0Z0],
            m_akLights[LIGHT_INDEX_MODEL_X1Y0Z0],
            m_akLights[LIGHT_INDEX_MODEL_X0Y1Z0],
            m_akLights[LIGHT_INDEX_MODEL_X1Y1Z0],
            m_akLights[LIGHT_INDEX_MODEL_X0Y0Z1],
            m_akLights[LIGHT_INDEX_MODEL_X1Y0Z1],
            m_akLights[LIGHT_INDEX_MODEL_X0Y1Z1],
    ...
    /**
     * Get the current SoftwareLight instances from each of the GeneralLight
     * instances -- for the world- and model-based lights.
     */
    ...
    /**
     *   Changes color of slices box frame and button if color
    ...
    /**
     *  Sets values of sliders and intensities appropriately based
    ...
    private void refreshControlPanel() {
        ...
        for (int i = 0; i < m_akLights.length; i++) {
            listModel.set(i,
                m_akLights[i].getDescription() + " - " +
                m_akLights[i].getTypeString() + " - " +
        ...
        boolean bEnableDirectional = bEnable &&
            (light.isTypeDirectional() || light.isTypeSpot());
     ...
     *	@param h     Gridheight
     */
    private void addControlPanel( JPanel panelControl, Component c,
