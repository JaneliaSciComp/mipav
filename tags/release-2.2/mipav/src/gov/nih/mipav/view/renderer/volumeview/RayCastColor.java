...
public abstract class RayCastColor
    extends RayCastRenderer
    implements RendererInterfaceColor
{
    /**
    ...
    /**
     * Specify the lookup table to use for mapping input RGB colors
     * to intensity.
    ...
    /**
     * Return indication as to whether or not a map has been defined for
     * mapping input colors to intensity.
     ...
     * @return The interpolated color value for the point.  If kP is not
     * within the bounding box of the image, a value of -1 is returned.
     * Each of the RGB colors is stored in 8 bits with red in bits 16-23,
     * green in bits 8-15, and blue in bits 0-7.
     */
