 ...
 *
 */
public class JDialogSkelGeom3D
    extends JDialogBase
  ...
  public void callAlgorithm() {
    ...
    try {
        ...
        skelGeom3DAlgo = new AlgorithmSkelGeom3D(image, minObjectValue, sliceHoleFilling,
                                                 estR, bad, defer, deep);
        ...
        if (runInSeparateThread) {
            ...
            MipavUtil.displayError(
                    "Dialog SkelGeom 3D : unable to allocate enough memory");
            return;
    }
  }
