...
public class BurnAttributes {
    ...
    /**
     *	Color of burn.  The element type is Color4f, although currently
    ...
    /**
     *	Volume of triangle mesh displayed associated with the burn.  Changes
     ...
     */
    public BurnAttributes( BranchGroup burnBG, String name, Color4f color, float volume, float opacity, Point3f radius, float burningTime ) {
     ...
     */
    public BurnAttributes( BranchGroup burnBG, String name, Color4f color, float volume, float opacity,
            Point3f diameter, float burningTime, Point3f center, boolean pickable,
            boolean clipping, boolean culling, BitSet burnMask,
            Point3f entryPoint, Vector3f burnPoint, Transform3D transform ) {
