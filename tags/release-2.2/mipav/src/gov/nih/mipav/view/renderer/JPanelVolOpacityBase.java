 ...
 */
public class JPanelVolOpacityBase extends JPanelRendererBase
    ...
    protected Hashtable getLabelTableGM_A() {
        ...
        if ( tfActiveIndex == componentOpacityGM_A.INACTIVE ) {
            ...
            opacitySliderLabelsGM_A[1].setText(
                    MipavUtil.makeFloatString( ( tf.getPoint( tfActiveIndex ).x ), 1 ) );
     ...
     *   @param  flag   true = imageA, false = imageB
     ...
     * @return int the value of the slider, or a default of 50 (the median value) if the slider has not been initialized
     */
    ...
    /**
     * This method will enable or disable the opacity panel's slider component and input text fields,
     * based on the value of the boolean parameter passed into it.
