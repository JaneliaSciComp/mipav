 ...
 *   thread.
 */
public class JDialogHessian extends JDialogBase
    ...
    private void ptHessian3D() {
        ...
        /*
         // add 1 into the zcomponent so the user thinks silce 0 is really slice 1
         System.out.println("\nLocation:  X: " + locationX +"  Y: " + locationY + "  Z: " + (locationZ+1));
         System.out.println("Hessian: " + fltFmt.format(hess[0][0]) + "  " + fltFmt.format(hess[0][1]) + "  " + fltFmt.format(hess[0][2]));
         System.out.println("         " + fltFmt.format(hess[1][0]) + "  " + fltFmt.format(hess[1][1]) + "  " + fltFmt.format(hess[1][2]));
         System.out.println("         " + fltFmt.format(hess[2][0]) + "  " + fltFmt.format(hess[2][1]) + "  " + fltFmt.format(hess[2][2]));
         */
        // set the text in the Dialog to reflect the values of the Hessian
        hess00.setText( fltFmt.format( hess[0][0] ) );
        hess01.setText( fltFmt.format( hess[0][1] ) );
        ...
        structureness = Math.sqrt(
                evals[lut[0]] * evals[lut[0]] + evals[lut[1]] * evals[lut[1]] + evals[lut[2]] * evals[lut[2]] );

        /*
         System.out.print("blobRatio: " + fltFmt.format(magEvals[lut[0]]) + " / sqrt( " + fltFmt.format(magEvals[lut[1]]) + " * " + fltFmt.format(magEvals[lut[2]]) + " )");
        ...
        /*
         ...
         System.out.println("expS: " + fltFmt.format(expS) + "  (1.0 - expS): " + fltFmt.format((1.0 - expS)));
        ...
        /*
         ...
         evecs[0][2] = eigenSystemAlgo.getEigenvector(0, 2);
         evecs[1][2] = eigenSystemAlgo.getEigenvector(1, 2);
         evecs[2][2] = eigenSystemAlgo.getEigenvector(2, 2);

         System.out.println("------------------------------------------------------------------");
         System.out.println("Eigenvalues             Eigenvectors");
         System.out.println(fltFmt.format(evals[lut[0]]) + "      [ " + fltFmt.format(evecs[0][lut[0]]) + "   "
         + fltFmt.format(evecs[1][lut[0]]) + "   " + fltFmt.format(evecs[2][lut[0]]) +" ]");
         System.out.println(fltFmt.format(evals[lut[1]]) + "      [ " + fltFmt.format(evecs[0][lut[1]]) + "   "
         + fltFmt.format(evecs[1][lut[1]]) + "   " + fltFmt.format(evecs[2][lut[1]]) +" ]");
         System.out.println(fltFmt.format(evals[lut[2]]) + "      [ " + fltFmt.format(evecs[0][lut[2]]) + "   "
         + fltFmt.format(evecs[1][lut[2]]) + "   " + fltFmt.format(evecs[2][lut[2]]) +" ]");
         System.out.println("");
         */
    } // end ptHessian3D()
