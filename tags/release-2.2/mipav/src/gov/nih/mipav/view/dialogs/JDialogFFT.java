...
public class JDialogFFT extends JDialogBase implements AlgorithmInterface, ScriptableInterface, ItemListener {
    ...
    */
    private void init() {
        ...
        gbc.gridwidth = 3; gbc.anchor = gbc.WEST; gbc.weightx = 1;
        ...
        gbc.gridx = 0; gbc.gridy = 0; gbc.gridwidth = 2; gbc.fill = gbc.HORIZONTAL;
        mainPanel.add(optionsPanel, gbc);
        gbc.gridy = 1;
        mainPanel.add(constructionPanel, gbc);
        gbc.gridy = 2; gbc.gridwidth = 1; gbc.weighty = 1; gbc.fill = gbc.BOTH;
        mainPanel.add(destinationPanel, gbc);
        gbc.gridx = 1;
        mainPanel.add(directionPanel, gbc);
        gbc.gridx = 0; gbc.gridy = 3; gbc.gridwidth = 2; gbc.fill = gbc.HORIZONTAL;
   ...
   *	@param diameter	Value to set the filter type to.
   */
  ...
  */
  ...
  private boolean setVariables() {
    ...
    if (replaceImage.isSelected())    displayLoc = REPLACE;
           ...
           else if (inverseFFT.isSelected()) transformDir = INVERSE;
  ...
  /**
   *	Once all the necessary variables are set, call the FFT
      ...
      image.setOriginalCropCheckbox(imageCrop);
            ...
            if (displayLoc == NEW) {
                try{
                    ...
                    // Make algorithm
                    FFTAlgo = new AlgorithmFFT(resultImage, image, transformDir,logMagDisplay,
                ...
                try{
                    ...
                    FFTAlgo = new AlgorithmFFT(image, transformDir,logMagDisplay,
        ...
        if ( algorithm instanceof AlgorithmFFT) {
            if(FFTAlgo.isCompleted() == true && resultImage != null) {
                ...
                if (parentFrame != null)
                    ...
                    parentLocation = new Dimension(Toolkit.getDefaultToolkit().
