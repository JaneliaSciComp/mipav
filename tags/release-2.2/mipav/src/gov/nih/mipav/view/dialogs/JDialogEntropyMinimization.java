 ...
 *
 */
public class JDialogEntropyMinimization
    extends JDialogBase
  ...
  private void init() {
    ...
    ma2Button = new JRadioButton("Multiplicative and additive quadratic noise",
                                 true);
    ...
    String name = makeImageName(image.getImageName(), "_entropyMin");
      if (displayLoc == NEW) {
        try {
          ...
          // Make algorithm
          emAlgo = new AlgorithmEntropyMinimization(resultImage, image, thresholdSelected,
                       thresholdLevel, subsample, noiseType);
          ...
          if (runInSeparateThread) {
            ...
            emAlgo.setActiveImage(isActiveImage);
          ...
          MipavUtil.displayError(
              "Dialog Entropy Minimization: unable to allocate enough memory");
          if (resultImage != null) {
        ...
        try {
          ...
          emAlgo = new AlgorithmEntropyMinimization(image, thresholdSelected,
                       thresholdLevel, subsample, noiseType);
          // This is very important. Adding this object as a listener allows the algorithm to
          // notify this object when it has completed of failed. See algorithm performed event.
          // This is made possible by implementing AlgorithmedPerformed interface
