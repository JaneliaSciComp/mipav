...
public class PlugInDialogSUV_PET extends JDialogBase implements AlgorithmInterface {
    ...
    /**
     * Creates new dialog for standardized uptake values within VOIs in a 3D PET
     * image.
     * 
            ...
            if (suvAlgo.isCompleted() == true) {
                if (UI.isScriptRecording()) {
                    UI.getScriptDialog().append(
                            "SUV_PET " + UI.getScriptDialog().getVar(image.getImageName()) + " " + "\n");
                }
            }
            dispose();
        }
    ...
    private void findValues() {
        ...
        // David Clunie wrote:
        /*
         * I was as surprised as you probably were when I first encountered this
         * inconsistency and asked the same question.
         * 
         * This discrepancy is well known, has been discussed by the various
         * vendor participants, and irritating though it may be, it has been
         * agreed that there will be no change to the standard.
         * 
         * In short, in NM instances, the units are MBA, and in PET instances
         * they are in Bq, and that is how the vendors have implemented it and
         * should implement it.
         * 
         * This creates a well defined but unambiguous inconsistency between the
         * two IODs.
         * 
         * To change this now would invalidate most existing implementations and
         * most images stored in archives, i.e. the cure would be worse than the
         * disease.
         * 
         * That is not to say that from time to time vendors do not make an
         * error, say when sending a PET image to a station that was primarily
         * intended for NM, and inadvertently re-encode the values in the wrong
         * units. Folks affected have generally addressed this concern by doing
         * a sanity check on the magnitude of the value.
         * 
         * But it is true to say that any vendor making such an error is in
         * violation of the standard, and hopefully will act expeditiously to
         * correct any such error.
         * 
         * Sorry if this is not the response that you wanted to hear.
         * 
         * David -- Dr. David A. Clunie mailto:dclunie@radpharm.com Chief
         * Technology Officer (RadPharm) http://www.radpharm.com/ Princeton
         * Radiology Pharmaceutical Research Phone 609-936-2600 103 Carnegie
         * Center Drive #300A Fax 609-936-2601 Princeton NJ 08540
         * http://www.dclunie.com/
         */
        // Jeff Polhammer wrote:
        /*
         * Hi Howard, WG3 decided not to change this, as it would break existing
         * implementations of either the PET or NM IOD. Therefore, a note will
         * be added to warn implementors of the difference in units. -Jeff
         */
        ...
        if (fileInfo[0] instanceof FileInfoDicom) {
            ...
            try {
                if (((FileInfoDicom) (fileInfo[0])).getTagsList().get("0054,0016") != null) {
                    if (((FileDicomTag) ((FileInfoDicom) fileInfo[0]).getTagsList().get("0054,0016")).getValue(true) != null) {
                    ...
                    if (((FileDicomTag) ((FileInfoDicom) fileInfo[0]).getTagsList().get("0054,0016")).getValue(true) != null) {
                        ...
                        if (!found) {
                            ...
                            try {
                                ...
                                Preferences
                                        .debug("Number format exception on Radiopharmaceutical Start Time hour string\n");
                            }
                            try {
                                ...
                                Preferences
                                        .debug("Number format exception on Radiopharmaceutical Start Time minute string\n");
                            }
                            try {
                                ...
                                Preferences
                                        .debug("Number format exception on Radiopharmaceutical Start Time second string\n");
                            }
