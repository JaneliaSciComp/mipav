...
public class PlugInAlgorithmRemoveBlinks
    ...
    private void removeBlinks() {
            ...
            if (!hitThreshold) {
                ...
                if (averages[i] < totalAverage * .75) {
                    ...
                    if (sliceMax[i] < thresholdMax) {
                        ...
                        System.err.println("Removing slice (max inten of " + sliceMax[i] +
                                           " below " + thresholdMax + "): " +
                                           (i + 1));
        ...
        ViewUserInterface.getReference().getMessageFrame().append("Removing " + numRemovedSlices + " slices from " + srcImage.getImageFileName() + "\n",
