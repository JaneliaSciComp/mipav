 ...
 * wants to be able to be called from the script parser in <code>AlgorithmScriptParser</code>.<br>
 * <br>
...
public interface ScriptableInterface {
     ...
     */
    void insertScriptLine(AlgorithmBase algo);
     ...
     */
    void scriptRun(AlgorithmScriptParser parser) throws IllegalArgumentException;
}
