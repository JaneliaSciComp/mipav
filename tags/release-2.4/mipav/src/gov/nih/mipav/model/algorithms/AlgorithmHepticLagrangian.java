...
/**
 This is a polynomial p of degree 7 which interpolates a given function f
 at the points x(-3), x(-2), x(-1), x(0), x(1), x(2), x(3), and x(4) and is given by
 p(x) = sum from i = -3 to i = 4 of li(x)*f(xi),
 where li, i = -3,-2,-1,0,1,2,3,4 which are called the fundamental polynomials, are given by
 li(x) = product from k = -3 to k = 4 for k != i of (x - xk)/(xi - xk).
 li(-3) = (x - -2)/(-3 - -2) * (x - -1)/(-3 - -1) * (x - 0)/(-3 - 0) * (x-1)/(-3 - 1) *
 (x - 2)/(-3 - 2) * (x - 3)/(-3 - 3) * (x - 4)/(-3 - 4) =
 (x * (x*x - 1) * (x*x - 4) * (x - 3) * (4 - x))/5040
 li(-2) = (x - -3)/(-2 - -3) * (x - -1)/(-2 - -1) * (x - 0)/(-2 - 0) * (x-1)/(-2 - 1) *
 (x-2)/(-2 - 2) * (x-3)/(-2 - 3) * (x - 4)/(-2 - 4) =
 (x * (x*x - 1) * (x - 2) * (x*x - 9) * (x - 4))/720
 li(-1) = (x - -3)/(-1 - -3) * (x - -2)/(-1 - -2) * (x - 0)/(-1 - 0)* (x-1)/(-1 - 1) *
 (x - 2)/(-1 - 2) * (x - 3)/(-1 - 3) * (x - 4)/(-1 - 4) =
 (x * (x - 1) * (x*x- 4) * (x*x - 9) * (4 - x)))/240
 li(0) =  (x - -3)/(0 - -3) * (x - -2)/(0 - -2) * (x - -1)/(0 - -1) * (x - 1)/(0 - 1) *
 (x - 2)/(0 - 2) * (x - 3)/(0 - 3) * (x - 4)/(0 - 4) =
 ((x*x - 1) * (x*x - 4) * (x*x - 9) * (x - 4))/144
 li(1) =  (x - -3)/(1 - -3) * (x - -2)/(1 - -2) * (x - -1)/(1 - -1) * (x - 0)/(1 - 0) *
 (x - 2)/(1 - 2) * (x - 3)/(1 - 3) * (x - 4)/(1 - 4) =
 (x * (x+1) * (x*x - 4) * (x*x - 9) * (4 - x))/144
 li(2) =  (x - -3)/(2 - -3) * (x - -2)/(2 - -2) * (x - -1)/(2 - -1) * (x - 0)/(2 - 0) *
 (x - 1)/(2 - 1) * (x - 3)/(2 - 3) * (x - 4)/(2 - 4) =
 (x * (x*x - 1) * (x+2) * (x*x - 9) * (x - 4))/240
 li(3) =  (x - -3)/(3 - -3) *(x - -2)/(3 - -2) * (x - -1)/(3 - -1) * (x - 0)/(3 - 0) *
 (x - 1)/(3 - 1) * (x - 2)/(3 - 2) * (x - 4)/(3 - 4) =
 (x * (x*x - 1) * (x*x - 4) * (x + 3) * (4 - x))/720
 li(4) =  (x - -3)/(4 - -3) * (x - -2)/(4 - -2) * (x - -1)/(4 - -1) * (x - 0)/(4 - 0) *
 (x - 1)/(4 - 1) * (x - 2)/(4 - 2) * (x - 3)/(4 - 3) =
 (x * (x*x - 1) * (x*x - 4) * (x*x - 9))/5040
 */
...
public class AlgorithmHepticLagrangian extends AlgorithmBase {
    ...
    public void setup2DHepticLagrangian( float[] vol, int[] extents, boolean clip ) {
        ...
        for ( i = 0; i < 1000; i++ ) {
            arg = i / 999.0;
            wt[0][i] = (float) ( ( arg * ( arg * arg - 1.0 ) * ( arg * arg - 4.0 ) * ( arg - 3.0 ) * ( 4.0 - arg ) )
                    / 5040.0 );
            wt[1][i] = (float) ( ( arg * ( arg * arg - 1.0 ) * ( arg - 2.0 ) * ( arg * arg - 9.0 ) * ( arg - 4.0 ) )
                    / 720.0 );
            wt[2][i] = (float) ( ( arg * ( arg - 1.0 ) * ( arg * arg - 4.0 ) * ( arg * arg - 9.0 ) * ( 4.0 - arg ) )
                    / 240.0 );
            wt[3][i] = (float) ( ( ( arg * arg - 1.0 ) * ( arg * arg - 4.0 ) * ( arg * arg - 9.0 ) * ( arg - 4.0 ) )
                    / 144.0 );
            wt[4][i] = (float) ( ( arg * ( arg + 1.0 ) * ( arg * arg - 4.0 ) * ( arg * arg - 9.0 ) * ( 4.0 - arg ) )
                    / 144.0 );
            wt[5][i] = (float) ( ( arg * ( arg * arg - 1.0 ) * ( arg + 2.0 ) * ( arg * arg - 9.0 ) * ( arg - 4.0 ) )
                    / 240.0 );
            wt[6][i] = (float) ( ( arg * ( arg * arg - 1.0 ) * ( arg * arg - 4.0 ) * ( arg + 3.0 ) * ( 4.0 - arg ) )
                    / 720.0 );
