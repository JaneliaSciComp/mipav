...
/**
 * This an abstract class implements a 4 byte item length (DICOM_PDUItemType 
 * implements 2 byte item length. See DICOM_PDUTypeBase for the methods that 
 * are required for new classes that extend this class.
 */
public abstract class DICOM_PDUType extends DICOM_PDUTypeBase {
    ...
    */
    public int calcSize() { return ( 1 + 1 +  4  + length() ); }   
