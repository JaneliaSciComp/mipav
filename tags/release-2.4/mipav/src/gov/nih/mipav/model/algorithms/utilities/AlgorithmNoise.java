...
/**
 *  Algorithm used to add Gaussian or Uniform noise to an image.
 *  The additive noise is clamped to the lowest or highest value
 *  is the source image type. For example a byte image where the
 *  source pixel = 120 + noise = 15 would be clamped to 127 the
 *  maximum pixel value for a byte image.
 *
 *
...
public class AlgorithmNoise extends AlgorithmBase {
    ...
    /**
     *   This function replaces the 2D source image with an image
     *   that has noise added to it.
     *
     */
    ...
    /**
     *   This function replaces the 3D source image with an image
     *   that has noise added to it.
     *
     */
    ...
    /**
     *   This function produces a new 2D image that is the sum
     *   of the source image and noise.
     */
    ...
    /**
     *   This function produces a new 3D image that is the sum
     *   of the source image and noise.
     */
