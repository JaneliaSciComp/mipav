...
public class AlgorithmCrop extends AlgorithmBase {
     ...
     */
    public AlgorithmCrop( ModelImage destImg, ModelImage srcImg, int _cushion,
    ...
    /**
     *   This function crops srcImage
     *   Must use getSrcImage after running
     */
    private void calcStoreInPlace2D() {
        ...
        if ( ( srcImage.getFileInfo()[0] ).getFileFormat() == FileBase.DICOM ) {
          ( (FileInfoDicom) ( srcImage.getFileInfo( 0 ) ) ).setValue( "0002,0002", "1.2.840.10008.5.1.4.1.1.7 ",
                        26 ); // Secondary Capture SOP UID
          ( (FileInfoDicom) ( srcImage.getFileInfo( 0 ) ) ).setValue( "0008,0016", "1.2.840.10008.5.1.4.1.1.7 ",
                        26 );
          ( (FileInfoDicom) ( srcImage.getFileInfo( 0 ) ) ).setValue( "0002,0012", "1.2.840.34379.17", 16 ); // bogus Implementation UID made up by Matt
          ( (FileInfoDicom) ( srcImage.getFileInfo( 0 ) ) ).setValue(
                        "0002,0013", "MIPAV--NIH", 10 ); //
          ( (FileInfoDicom) ( srcImage.getFileInfo( 0 ) ) ).setValue( "0028,0011",
                        new Short( (short) dimExtents[0] ), 2 ); // columns
          ( (FileInfoDicom) ( srcImage.getFileInfo( 0 ) ) ).setValue( "0028,0010",
                        new Short( (short) dimExtents[1] ), 2 ); // rows
          ( (FileInfoDicom) ( srcImage.getFileInfo( 0 ) ) ).setValue( "0020,0013",
                        Short.toString( (short) ( 1 ) ), Short.toString( (short) ( 1 ) ).length() ); // instance number
    ...
    private void calcStoreInPlace3D() {
        ...
        for (n = 0; n < nImages; n++) {
          ...
          originImgOrd = originLPS2Img(imgOriginLPS, srcImage);
          originImgOrd[0] = originImgOrd[0] +
              direct[0] * (x[0] - cushion) * resols[0];
          originImgOrd[1] = originImgOrd[1] +
              direct[1] * (y[0] - cushion) * resols[1];
          newImgOriginLPS = originImg2LPS(originImgOrd, srcImage);
...
System.out.println("anything");
        ...
        if ( ( srcImage.getFileInfo()[0] ).getFileFormat() == FileBase.DICOM ) {
          if (nDims == 2) {
            ( (FileInfoDicom) (srcImage.getFileInfo(0))).setValue("0002,0002",
                "1.2.840.10008.5.1.4.1.1.7 ",
                26); // Secondary Capture SOP UID
            ( (FileInfoDicom) (srcImage.getFileInfo(0))).setValue("0008,0016",
                "1.2.840.10008.5.1.4.1.1.7 ",
                26);
            ( (FileInfoDicom) (srcImage.getFileInfo(0))).setValue("0002,0012",
            ...
            ( (FileInfoDicom) (srcImage.getFileInfo(0))).setValue("0020,0013",
                Short.toString( (short) (1)), Short.toString( (short) (1)).length()); // instance number
            int imgOrient = ( (FileInfoDicom) (srcImage.getFileInfo(0))).
                getImageOrientation();

            startPos = originImgOrd[2];
            originImgOrd[2] = startPos + direct[2] * z[0] * resols[2];
            newImgOriginLPS = originImg2LPS(originImgOrd, srcImage);
            value = Float.toString(newImgOriginLPS[0]) + "\\" +
                Float.toString(newImgOriginLPS[1])
                + "\\" + Float.toString(newImgOriginLPS[2]);

            ( (FileInfoDicom) (srcImage.getFileInfo(0))).setValue("0020,0032",
                value, value.length());

            value = String.valueOf(originImgOrd[2]);
            ( (FileInfoDicom) (srcImage.getFileInfo(0))).setValue("0020,1041",
                value, value.length());
          } // if (nDims = 2)
          else { // nDims == 3
            for ( n = 0, slc = z[0]; slc <= z[1]; n++, slc++ ) {

                    ( (FileInfoDicom) ( srcImage.getFileInfo( n ) ) ).setValue( "0002,0002",
                            "1.2.840.10008.5.1.4.1.1.7 ", 26 ); // Secondary Capture SOP UID
                    ( (FileInfoDicom) ( srcImage.getFileInfo( n ) ) ).setValue( "0008,0016",
                    ...
                    ( (FileInfoDicom) ( srcImage.getFileInfo( n ) ) ).setValue(
                            "0002,0013", "MIPAV--NIH", 10 ); //
                    ( (FileInfoDicom) ( srcImage.getFileInfo( n ) ) ).setValue( "0028,0011",
                            new Short( (short) destExtents[0] ), 2 ); // columns
                    ( (FileInfoDicom) ( srcImage.getFileInfo( n ) ) ).setValue( "0028,0010",
                            new Short( (short) destExtents[1] ), 2 ); // rows
                    ( (FileInfoDicom) ( srcImage.getFileInfo( n ) ) ).setValue( "0020,0013",
                            Short.toString( (short) ( n + 1 ) ), Short.toString( (short) ( n + 1 ) ).length() ); // instance number
                    dicomInfoBuffer = (FileInfoDicom) srcImage.getFileInfo(
                            slc - z[0] );
    ...
    */
    ...
    /**
     *   Updates important image attributes (start locations, orientation )
     *   for the new cropped file by modifing the fileinfo fo the new
     *   ( destination ) image.
     *
     */
        ...
        if ( nDims == 2 ) {
            ...
            for ( int t = 0; t < srcImage.getExtents()[3]; t++ ) {
                for ( int m = 0; m <= Math.abs( z[1] - z[0] ); m++, slice++ ) {
                    destImage.setFileInfo(
                            (FileInfoBase) ( srcImage.getFileInfo()[start + m + t * srcImage.getExtents()[2]].clone() ),
                            slice );
                }
            }
    ...
    private void updateDICOM() {
        ...
        if ( ( destImage.getFileInfo()[0] ).getFileFormat() == FileBase.DICOM ) {
            if ( destImage.getNDims() == 2 || z[0] == z[1] ) {
                ( (FileInfoDicom) ( destImage.getFileInfo( 0 ) ) ).setValue( "0002,0002", "1.2.840.10008.5.1.4.1.1.7 ",
                        26 ); // Secondary Capture SOP UID
                ( (FileInfoDicom) ( destImage.getFileInfo( 0 ) ) ).setValue( "0008,0016", "1.2.840.10008.5.1.4.1.1.7 ",
                        26 );
                ( (FileInfoDicom) ( destImage.getFileInfo( 0 ) ) ).setValue( "0002,0012", "1.2.840.34379.17", 16 ); // bogus Implementation UID made up by Matt
                ( (FileInfoDicom) ( destImage.getFileInfo( 0 ) ) ).setValue(
                        "0002,0013", "MIPAV--NIH", 10 ); //
                ( (FileInfoDicom) ( destImage.getFileInfo( 0 ) ) ).setValue( "0028,0011",
                        new Short( (short) destExtents[0] ), 2 ); // columns
                ( (FileInfoDicom) ( destImage.getFileInfo( 0 ) ) ).setValue( "0028,0010",
                        new Short( (short) destExtents[1] ), 2 ); // rows
                ( (FileInfoDicom) ( destImage.getFileInfo( 0 ) ) ).setValue( "0020,0013",
                        Short.toString( (short) ( 1 ) ), Short.toString( (short) ( 1 ) ).length() ); // instance number
                ...
                for ( n = 0, slc = z[0]; slc <= z[1]; n++, slc++ ) {
                    ...
                    ( (FileInfoDicom) ( destImage.getFileInfo( n ) ) ).setValue( "0002,0002",
                            "1.2.840.10008.5.1.4.1.1.7 ", 26 ); // Secondary Capture SOP UID
                    ( (FileInfoDicom) ( destImage.getFileInfo( n ) ) ).setValue( "0008,0016",
                            "1.2.840.10008.5.1.4.1.1.7 ", 26 );
                    ( (FileInfoDicom) ( destImage.getFileInfo( n ) ) ).setValue( "0002,0012", "1.2.840.34379.17", 16 ); // bogus Implementation UID made up by Matt
                    ( (FileInfoDicom) ( destImage.getFileInfo( n ) ) ).setValue(
                            "0002,0013", "MIPAV--NIH", 10 ); //
                    ( (FileInfoDicom) ( destImage.getFileInfo( n ) ) ).setValue( "0028,0011",
                            new Short( (short) destExtents[0] ), 2 ); // columns
                    ( (FileInfoDicom) ( destImage.getFileInfo( n ) ) ).setValue( "0028,0010",
                            new Short( (short) destExtents[1] ), 2 ); // rows
                    ( (FileInfoDicom) ( destImage.getFileInfo( n ) ) ).setValue( "0020,0013",
                            Short.toString( (short) ( n + 1 ) ), Short.toString( (short) ( n + 1 ) ).length() ); // instance number
                    dicomInfoBuffer = (FileInfoDicom) destImage.getFileInfo(
                            slc - z[0] );
