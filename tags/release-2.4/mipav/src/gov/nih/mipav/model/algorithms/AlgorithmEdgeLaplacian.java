...
/**
 *  Calculates the EdgeLap of an image at a scale defined
 *  by the user. This algorithm produces an edge map of the
 *  zero crossings of the laplacian of the gaussian for 2D images and 2.5D
 *  images.
 *
...
public class AlgorithmEdgeLaplacian extends AlgorithmBase {
     ...
     *   Non-zero value indicates edge. Zero in the mask image is background.
     */
     ...
     * @param maskFlag Flag that indicates that the EdgeLap will be
     ...
     * @param loThres  used to define the lower threshold to reduce noise (edges) in the
     *                 laplacian image
     * @param hiThres  used to define the upper threshold to reduce noise (edges) in the
     *                 laplacian image
     */
    public AlgorithmEdgeLaplacian( ModelImage destImg, ModelImage srcImg, float[] sigmas, boolean maskFlag, boolean img25D,
            float loThres, float hiThres ) {
    ...
    private void constructLog() {
        ...
        historyString = new String(
                "EdgeLap(" + sigmaStr + String.valueOf( entireImage ) + ", " + String.valueOf( image25D ) + ", "
                + loThres + ", " + hiThres + ")\n" );
    ...
    /**
     * Generates a zero crossing mask for a 2D function sets a Bitset
     * object to 1 is a zero crossing is detected.
     ...
     */
    public static BitSet genLevelMask( int xDim, int yDim, float[] buffer,
            float level, int detectionType, float loThres, float hiThres ) {
        int i0, i1, i2, i3;
        float x0, x1, x2, x3;
        int i, j;
        int indexY;
     ...
     * Sets a ModelImage to 255 if a zero crossing is detected.
     ...
     *   @param nImages      number of images on which to find zero crossings.
