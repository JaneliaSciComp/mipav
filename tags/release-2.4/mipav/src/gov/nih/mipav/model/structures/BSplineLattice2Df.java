...
/**
 * This class manages a 2D lattice of control points given a discretized
 * B-Spline basis for each axis.
 */
public class BSplineLattice2Df {

    /**
     * Create 2D lattice of control points given a discretized B-Spline
     ...
     */
    public BSplineLattice2Df(BSplineBasisDiscretef kBasisX,
     ...
     * @param iControlX int Identifies control point in 2D lattice.
     * @param iControlY int Identifies control point in 2D lattice.
     * @param kPoint Point2f Where the current coordinates of the control
     ...
     * The evaluation is based on the 2D evaluation of the B-Spline basis
     * (one for each axis) and the 2D lattice of control points.
     ...
     * a mapping of the coordinates based on the 2D lattice of B-spline
     * control points.
     * @param iSizeX int Number of samples along x axis of image.
     * @param iSizeY int Number of samples along y axis of image.
     * @return ModelSimpleImage[] Array of two ModelSimpleImage instances.
     * The first one contains the x coordinate and the second contains the
     * y coordinate for the map.  Each image has default resolutions of 1
     * for each axis.
     */
