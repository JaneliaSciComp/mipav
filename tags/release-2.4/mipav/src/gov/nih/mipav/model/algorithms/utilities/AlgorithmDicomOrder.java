...
public class AlgorithmDicomOrder extends AlgorithmBase {
     ...
     *   @param orient   3 integer codes describing the spatial orientation
     *                   of the axes
     */
    ...
    /**
     *   Calculates the dicom ordered image and replaces the original image
     *   with the dicom ordered image
     */
    private void calcInPlace() {
        ...
        try {
            destImage = new ModelImage( srcImage.getType(), newExtents,
                    JDialogBase.makeImageName( srcImage.getImageName(), "_dicomImage" ), srcImage.getUserInterface() );
