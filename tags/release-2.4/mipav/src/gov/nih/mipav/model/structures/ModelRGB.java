...
/**
 *
 *   Model of a RGB Table.  256 length red, green, and blue tables are constructed
 *   from the red, green, and blue transfer functions.  A 256 indexedRGB integer array
 *   is returned by exportIndexedRGB with alpha always equal to 255 in the most
 *   significant byte, followed by red, green, and blue in the following bytes with
 *   the red, green , and blue values able to vary from 0 to 255.
 *
 *		@version 1.0
...
public class ModelRGB extends ModelStorageBase {
    ...
    /**
     * Creates the R, G, and B transfer functions to
     *                             produce a gray scale LUT.
     */
    ...
    /**
     * Creates the R, G, and B transfer functions to
     * produce a horizontal linear scale LUT.
     */
    ...
    public void setColor( int index, Color RGBcolor ) {
        ...
        indexedRGB[index] = ( 255 << 24 ) | ( RGBcolor.getRed() << 16 ) | ( RGBcolor.getGreen() << 8 )
                | RGBcolor.getBlue();
     ...
     *   Assumes RGB values that range between (0 and 255) are stored in the RGB table;
     */
