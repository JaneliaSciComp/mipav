...
// fft.run();
   ...
   public final static int FFT = 1;
   public final static int REALS = 2;
   public final static int REALT = 3;
   public final static int SELF_TEST = 4;
   ...
   public FFTUtility (double a[], double b[], int nseg, int n, int nspn,
                      int isn, int functionType) {
     this.a = a;
     this.b = b;
     this.nseg = nseg;
     this.n = n;
   ...
   public FFTUtility (int functionType) {
     ...
     if (functionType != SELF_TEST) {
       MipavUtil.displayError(
        "functionType in this constructor must be SELF_TEST");
     }
   }
   ...
   /**
    ...
    private void selfTest() {
      ...
      int nc[] = new int[] {
          2, 3, 5, 210, 1000, 2000, 1024, 2048, 4096, 2187, 3125, 2401,
          1331, 2197, 289, 361, 529};
      int ia[] = new int[64];
      int ib[] = new int[64];
    ...
    private void fft() {
      ...
      if ((m+kt) > 15) {
        MipavUtil.displayError("Error! FFT parameter n = " + n +
        " has more than 15 factors");
        disposeProgressBar();
        setCompleted(false);
        return;
      } // if ((m+kt) > 15)
...
//     COMPUTE FOURIER TRANSFORM
    ...
    double [] rms(double a[], double b[], double c[], double d[], int n) {
      ...
      // arrays c,d = original data
      // n = dimension of arrays a, b, c, and d
