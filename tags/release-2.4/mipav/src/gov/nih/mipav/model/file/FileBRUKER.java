...
*   second the reco header file, third the acqp file up tow parent directories,
...
public class FileBRUKER extends FileBase{
    ...
    */
    public void setFileDir(String fDir){ fileDir = fDir;}
    ...
    */
    ...
    /**
    *   This method reads one slice from the file into byteBuffer and
    *   then transfers into the float array imgBuffer
    ...
    public ModelImage readImage(boolean one)  throws IOException {
        ...
        try {
            ...
            progressBar = new ViewJProgressBar(ViewUserInterface.getReference().getProgressBarPrefix() + fileName,
                                               ViewUserInterface.getReference().getProgressBarPrefix() + "BRUKER image(s) ...", 0, 100,
                                                false, null,null);
