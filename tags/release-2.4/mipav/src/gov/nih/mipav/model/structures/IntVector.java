...
/**
 *  Integer Vector is very similar to the Vector class except that it
 *  is designed specifically to store integers. The Vector class could
 *  have been used but because this class is specifically used to store
 *  integers it is significantly faster. It was primarily used for the
 *  Watershed algorithm but is general in nature.  Remember to choose
 *  your initial capacity and chunk size wisely to reduce the time spent
 *  reallocating the int vector buffer.
 *
...
public class IntVector {
    ...
    /**
     * The number of elements to add to the total number allocated when more
     * space is needed to store the data in the vector.
     */
    ...
    /**
     *   Pushes a new value onto the array. Checks to make sure array has
     *   the capacity to store the new value. If not, this allocates the more
     *   memory by the size specified in the variable chunk.
