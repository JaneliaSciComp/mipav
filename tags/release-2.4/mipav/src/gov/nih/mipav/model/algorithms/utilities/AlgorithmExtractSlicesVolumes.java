 ...
 * <p>Description: Extracts individual slices from 3D or 4D images
 * and opens each slice in its own Frame </p>
 * @author ben link
 * @version 1.0
 */
                ...
                if ( extract[zSrc] ) {
                    ...
                    try {
                        ...
                        resultImage = new ModelImage( srcImage.getType(), newExtents,
                                srcImage.getImageName() + "_slice" + ( zSrc + 1 ), srcImage.getUserInterface() );
