 ...
 * is computed.  An integration of the image values along the segment is
 * computed and used as the gray scale value for the volume rendering.  The
 * image is trilinearly interpolated to allow subvoxel evaluations.
 *
    ...
    extends RayCastIntensity
{
    ...
    // Factor used to scale the computed sum along each ray
    // for the purpose of normalizing the integral.
