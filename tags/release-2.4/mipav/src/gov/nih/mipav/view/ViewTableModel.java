...
/**
*
*   This is a simple class that creates a DefaultTableModel with
*   uneditable cells.  With the cells uneditable, the table may react
*   to mouse events, such as double clicking on a row.
*
*
...
public class ViewTableModel extends DefaultTableModel implements Serializable {
    ...
    */
    public void updateBulbs(int selectedRow) {
        for (int r=0; r < getRowCount(); r++) {
            if (r == selectedRow) setValueAt(Boolean.TRUE, r, 0);
            else setValueAt(Boolean.FALSE, r, 0);
        }
    }
    ...
    */
    ...
    /**
    *   Sets the column name to the new name and fires the table
    *   event.  Table widths must be reset after this call.
    ...
    */
    public int getColumnIndex(String name) {
        for (int i=0; i<columnIdentifiers.size(); i++) {
            if (name.equals(columnIdentifiers.elementAt(i))) return i;
        }
        return -1;
    }
