...
/**
 *   This class produces a message frame where user data and program
 *   can be displayed. The frame can be resize and a scroll pane is
 ...
 *
 */
public class ViewJFrameMessageGraph extends JFrame
