...
*       <ul><li>3 comboboxes (hour, minute, second), </LI>
...
public class JPanelEditTime extends JPanelEdit {
    ...
    *                       date string will be in hh:mm:ss.frac format (anything to he
    *                       right of a colon may be left unset)
    */
    ...
    */
    ...
    /**
    *   gets the internal components to listen to themselves
    *   for panel self-verification.
    */
