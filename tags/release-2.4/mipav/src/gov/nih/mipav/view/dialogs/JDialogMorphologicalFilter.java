...
public class JDialogMorphologicalFilter extends JDialogBase
        ...
        if ( algo.isCompleted() ) {
            if ( userInterface.isScriptRecording() ) {
                ...
                userInterface.getScriptDialog().append(
                        "MorphologicalFilter " + userInterface.getScriptDialog().getVar( image.getImageName() ) + " " );
                if ( displayLoc == NEW ) {
    ...
    /**
     *	Once all the necessary variables are set, call the Sizeian Blur
            ...
            if ( displayLoc == NEW ) {
                try {
                    ...
                    if ( runInSeparateThread ) {
                        ...
                        mfAlgo.setActiveImage( isActiveImage );
