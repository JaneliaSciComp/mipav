 ...
 *   This class is used by mouse recorder to save values instantly.
 *
...
public class SceneState
    ...
    /**
     *   Construct the SceneState object associate with the current
     * visualization toobox values.
     *
     ...
     *  @param _isVolOpacityChanged boolean indicator for volume control
     *                              opacity changed.
     *  @param _isVolumeDisplayMode3D   current diaplay mode, volume render or
     *                                  slice render.
     *  @param _is6PlaceClipping    If clipping is 6-plane clipped, choose
     *                              <tt>true</tt>.
     ...
     *  @param _isClipArbiPicked    If clipping is arbitrarily picked, choose
     *                              <tt>true</tt>.
     */
    public SceneState( int x, int y, int z, int xOp, int yOp, int zOp,
            boolean xVisible, boolean yVisible, boolean zVisible,
            int surfaceOpacity,
            int clipA, int clipX, int clipY, int clipZ, int clipXNeg, int clipYNeg, int clipZNeg,
            boolean aClipV, boolean xClipV, boolean yClipV, boolean zClipV,
            boolean xNegClipV, boolean yNegClipV, boolean zNegClipV,
            int _whichComp,
            TransferFunction _transformFunc, boolean _isVolOpacityChanged,
            boolean _isVolumeDisplayMode3D,
            boolean _is6PlaneClipping,
            float _axisX, float _axisY, float _axisZ, float _axisAngle,
