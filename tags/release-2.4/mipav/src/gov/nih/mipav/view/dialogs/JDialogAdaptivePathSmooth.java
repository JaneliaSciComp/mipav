 ...
 */
public class JDialogAdaptivePathSmooth
    extends JDialogBase implements AlgorithmInterface, ScriptableInterface, DialogDefaultsInterface {
    ...
    /**
     *  Accessor that sets whether or not nearest neighbors of pixels along the
     *  low cost path are included
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals("OK")) {
            ...
            MipavUtil.showHelp(
                "filtersspatialAdaptivePathSmooth_filters_(spatial)_AdaptivePathSmooth_htm_toc_applying_the_AdaptivePathSmooth");
        }
        ...
        if (displayLoc == NEW) {
            try {
                ...
                adaptivePathSmoothAlgo = new AlgorithmAdaptivePathSmooth(resultImage, image, radiusY, radiusCr,
                    radiusCb, threshold, includeNeighbors, reduce, image25D);
