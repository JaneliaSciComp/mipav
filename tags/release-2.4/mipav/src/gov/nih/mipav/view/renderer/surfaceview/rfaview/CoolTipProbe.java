...
/**
 * The CoolTip probe has its own geometry and type of burning.  This class
 * builds the geometry shape of the CoolTip probe.
...
public class CoolTipProbe {
    ...
    /** Indicator is used by the CoolTip probe to switch color between gray and green.
