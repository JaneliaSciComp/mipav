    ...
    if (image.getNDims() == 2) { // source image is 2D
      ...
      if (displayLoc == NEW) {
        try {
          ...
          // Make algorithm
          erodeAlgo2D = new AlgorithmMorphology2D(resultImage,
                                                  AlgorithmMorphology2D.
                                                  CONNECTED8, 9,
                                                  AlgorithmMorphology2D.
                                                  ULTIMATE_ERODE, 0, 0, 0, 0,
                                                  regionFlag);
          ...
          System.gc();
          MipavUtil.displayError(
              "Dialog ultimate erode: unable to allocate enough memory");
          return;
        }
      }
      else {
        try {
          ...
          erodeAlgo2D = new AlgorithmMorphology2D(image,
                                                  AlgorithmMorphology2D.CONNECTED8,
                                                  9,
                                                  AlgorithmMorphology2D.
                                                  ULTIMATE_ERODE, 0, 0, 0, 0,
                                                  regionFlag);
      ...
      if (displayLoc == NEW) {
        try {
          ...
          // Make algorithm
          erodeAlgo3D = new AlgorithmMorphology3D(resultImage, 1, 0,
        ...
        try {
          // Make algorithm
          erodeAlgo3D = new AlgorithmMorphology3D(image, 0, 0,
                                                  AlgorithmMorphology3D.
                                                  ULTIMATE_ERODE, 0, 0, 0, 0,
                                                  regionFlag);
          erodeAlgo3D.setPixDistance(dist);
          ...
          System.gc();
          MipavUtil.displayError(
              "Dialog ultimage erode: unable to allocate enough memory");
          return;
        }
      }
    }
