...
public class JPanelVolOpacity extends JPanelVolOpacityBase
{
     ...
     *      Change the layout of the volume opacity change diagram.
     */
    ...
    /**
     *   Method that displays the histogram and controls to manipulate the opacity.
     *   Panel for image B.   Reset the layout.
     */
    private void buildPanelB()
    {
        ...
        mouseSliderB.setEnabled(componentOpacityB.getActiveIndex() != componentOpacityB.INACTIVE &&
                                !componentOpacityB.getOpacityTransferFunction().isEndpoint(componentOpacityB.
            getActiveIndex()));
    ...
    private void buildPanelGM_A()
    {
        ...
        mouseSliderGM_A.setEnabled(componentOpacityGM_A.getActiveIndex() != componentOpacityGM_A.INACTIVE &&
                                   !componentOpacityGM_A.getOpacityTransferFunction().isEndpoint(componentOpacityGM_A.
            getActiveIndex()));
    ...
    private void buildPanelGM_B()
    {
        ...
        mouseSliderGM_B.setEnabled(componentOpacityGM_B.getActiveIndex() != componentOpacityGM_B.INACTIVE &&
                                   !componentOpacityGM_B.getOpacityTransferFunction().isEndpoint(componentOpacityGM_B.
            getActiveIndex()));
    ...
    private void calcHistograms()
    {
        ...
        if (imageA != null)
        {
            ...
            histoAlgoA.setActiveImage(isActiveImage);
        ...
        if (imageB != null)
        {
            ...
            histoAlgoB.setActiveImage(isActiveImage);
        ...
        if (imageA != null)
        {
            ...
            if (!loadGMImage(ViewUserInterface.getReference().getDefaultDirectory(), imageA.getImageName() + "_gm_rescale" + ".xml", true))
            {
                ...
                AlgorithmChangeType changeTypeAlgo_A = new AlgorithmChangeType(gradMagRescale_A, gradMag_A,
                    gradMag_A.getMin(), gradMag_A.getMax(), 0, 1023, false);
                ...
                if (changeTypeAlgo_A.isCompleted())
                {
                    ...
                    if (gradMagRescale_A != null)
                    {
                        ...
                        histoAlgoGM_A.setActiveImage(isActiveImage);
        ...
        if (imageB != null)
        {
                             ...
                             false))
            {
                ...
                AlgorithmChangeType changeTypeAlgo_B = new AlgorithmChangeType(gradMagRescale_B, gradMag_B,
                    gradMag_B.getMin(), gradMag_B.getMax(), 0, 1023, false);
                ...
                if (changeTypeAlgo_B.isCompleted())
                {
                    ...
                    if (gradMagRescale_B != null)
                    {
                        ...
                        histoAlgoGM_B.setActiveImage(isActiveImage);
