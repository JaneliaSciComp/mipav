...
/**
 * Manages the adding of components to a panel, automatically tranlating between
 * logical element placement and the panel's layout.
 * 
 * @author mccreedy
 */
public class PanelManager {
     ...
     * Forces the panel to use a grid bag layout.
     * @param panel the panel to manage
     */
