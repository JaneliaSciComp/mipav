...
public class JDialogNonparametricSegmentation extends JDialogBase
  ...
  public void insertScriptLine (AlgorithmBase algo) {
    ...
    /**
   *	Once all the necessary variables are set, call the Entropy Minimization
      ...
      if (displayLoc == NEW) {
        try {
          ...
          if (image.isColorImage()) {
              resultImage = new ModelImage(ModelImage.SHORT,image.getExtents(), name,
                                           userInterface);
          }
          else {
          ...
          MipavUtil.displayError(
              "Dialog Nonparametric Segmentation: unable to allocate enough memory");
          if (resultImage != null) {
        ...
        try {
          ...
          MipavUtil.displayError(
              "Dialog Nonparametric Segemntation: unable to allocate enough memory");
          return;
        }
      }
