...
/**
 *  This behavior is supposed to "fly by pointer" - that is, zoom in, translate, and
 *  rotate to where the mouse is currently pointing.  The velocity shall be constant,
 *  and the user will be able to control it though a slider.
 */
public class PointerBehaviorRenderer
    extends MouseBehaviorRenderer {

  /**
   *   Creates new pointer behavior, sets parent dialog, and
   *   resets MAX_ANGLE to the true start value.
  ...
  /**
   *   Processes mouse event.  For the left mouse button, changes
   *   translation; for the right mouse button, changes spin or
   *   pitch.  If ALT key is down, zooms out.
  ...
  /**
   *   Creates a new transform for the image by multiplying
   *   the appropriate rotations and translations.
   */
