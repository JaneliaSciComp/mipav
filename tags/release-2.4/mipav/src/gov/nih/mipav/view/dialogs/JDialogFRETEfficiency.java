...
public class JDialogFRETEfficiency
  ...
  // The source image must be the image taken with the donor fluorescent
  // peak filter
      ...
      if (algo.isCompleted()) {
          if (userInterface.isScriptRecording()) {
              ...
              userInterface.getScriptDialog().append("FRETEfficiency " +
                  ...
                  userInterface.getScriptDialog().append(userInterface.
                                                         getScriptDialog().getVar(acceptorImage.getImageName()) +
                                                         " ");
  ...
  private void init() {
    ...
    JLabel nameLabel = new JLabel("DFP/AFP image taken with DFP filter: " +
  ...
  private boolean checkImage(ModelImage testImage) {
    ...
    if ((acceptorImage != null) && (FRETImage != null) &&
     ...
     MipavUtil.displayError(
      "Cannot use same image for FRET and acceptor filters");
     return false;
   }
  ...
  private void callAlgorithm() {
    ...
    try {
      ...
      feffAlgo = new AlgorithmFRETEfficiency(srcImage,
          FRETImage, acceptorImage, useRed, useGreen, useBlue,
          DFPintoFRET, AFPintoFRET, DFPintoAFP, AFPintoDFP,
          fDivDImage, fDivAImage, efficiencyImage);
      ...
      System.gc();
      MipavUtil.displayError(
          "Dialog FRET Efficiency: unable to allocate enough memory");
      return;
    }
