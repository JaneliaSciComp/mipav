...
/**
 * A renderer for composition of voxel RGB color values with alpha
 * blending and no lighting.
 */
public class ShearWarpColorComposite
    extends ShearWarpColor
{
    ...
    // To avoid memory reallocations.  These are used in the bilinearly
    // interpolation of a 2x2 block of voxels in the current slice.
