 ...
 * - specular (optional)
 *
 * The optional properties are specified by setting their references
 * to null.  In this case, the value will be determined from the
 * SoftwareMaterial reference that is specified.
 */
public class SoftwareVertexProperty {
     ...
     * Must call this method to enable the property before calling
     * the setDiffuse method to change its value.  If enabling
     * the property, the default color is set to white.
     ...
     * Must call this method to enable the property before calling
     * the setSpecular method to change its value.  If enabling
     * the property, the default color is set to white.
     * @param bEnable boolean True to enable; false to disable.
     */
    ...
    /**
     * Query current optional diffuse color for vertex.  Can also be
     * used to determine if this property is enabled.
     * @return Color3f Non-null reference to vertex diffuse color if
     * it is defined.
     */
    ...
    /**
     * Query current optional specular color for vertex.  Can also be
     * used to determine if this property is enabled.
     * @return Color3f Non-null reference to vertex specular color if
     * it is defined.
     */
    ...
    /**
     * Set the diffuse color for the vertex.  The vertex diffuse color
    ...
    /**
     * Set the specular color for the vertex.  The vertex specular color
     * property must be enabled.
