...
public class LseShapeDetection3 extends LseEvolve3
{
     ...
     */
    public LseShapeDetection3 (int iXBound, int iYBound, int iZBound,
        float fXSpacing, float fYSpacing, float fZSpacing, float[] afData,
        boolean[] abMask, float fBorderValue, int eScaleType,
        float[] afFeature, float fPropagationWeight, float fCurvatureWeight)
    {
        super(iXBound,iYBound,iZBound,fXSpacing,fYSpacing,fZSpacing,
            afData,abMask,fBorderValue,eScaleType);
