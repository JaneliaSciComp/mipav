...
public class ModelSurfaceExtractor {
            ...
            for (int iY = 0, iYP = 1; iY < (m_iYBound - 1); iY++, iYP++) {
                ...
                for (int iX = 0, iXP = 1; iX < (m_iXBound - 1); iX++, iXP++) {
                    ...
                    if ((iXParity ^ iYParity ^ iZParity) != 0) {
                        ...
                        // 1205
                        processTetrahedron(iLevel, iXP, iY, iZ, iF100, iXP, iYP, iZ, iF110, iX, iY, iZ, iF000, iXP, iY,
                                           iZP, iF101);

                        // 3027
                        processTetrahedron(iLevel, iX, iYP, iZ, iF010, iX, iY, iZ, iF000, iXP, iYP, iZ, iF110, iX, iYP,
                                           iZP, iF011);

                        // 4750
                        processTetrahedron(iLevel, iX, iY, iZP, iF001, iX, iYP, iZP, iF011, iXP, iY, iZP, iF101, iX, iY,
                                           iZ, iF000);

                        // 6572
                        processTetrahedron(iLevel, iXP, iYP, iZP, iF111, iXP, iY, iZP, iF101, iX, iYP, iZP, iF011, iXP,
                                           iYP, iZ, iF110);

                        // 0752
                        processTetrahedron(iLevel, iX, iY, iZ, iF000, iX, iYP, iZP, iF011, iXP, iY, iZP, iF101, iXP,
                                           iYP, iZ, iF110);
                    } else {

                        // 0134
                        processTetrahedron(iLevel, iX, iY, iZ, iF000, iXP, iY, iZ, iF100, iX, iYP, iZ, iF010, iX, iY,
                                           iZP, iF001);

                        // 2316
                        processTetrahedron(iLevel, iXP, iYP, iZ, iF110, iX, iYP, iZ, iF010, iXP, iY, iZ, iF100, iXP,
                                           iYP, iZP, iF111);

                        // 5461
                        processTetrahedron(iLevel, iXP, iY, iZP, iF101, iX, iY, iZP, iF001, iXP, iYP, iZP, iF111, iXP,
                                           iY, iZ, iF100);

                        // 7643
                        processTetrahedron(iLevel, iX, iYP, iZP, iF011, iXP, iYP, iZP, iF111, iX, iY, iZP, iF001, iX,
                                           iYP, iZ, iF010);

                        // 6314
                        processTetrahedron(iLevel, iXP, iYP, iZP, iF111, iX, iYP, iZ, iF010, iXP, iY, iZ, iF100, iX, iY,
                                           iZP, iF001);
                    }
                }
            }
    ...
    public float getFunction(Point3f kP) {
        ...
        if (((iX & 1) ^ (iY & 1) ^ (iZ & 1)) != 0) {
            ...
            if ((fDX - fDY - fDZ) >= 0.0f) {
                ...
                // 1205
                fInterp = ((1.0f - (1.0f - fDX) - fDY - fDZ) * fF100) + ((1.0f - fDX) * fF000) + (fDY * fF110) +
                          (fDZ * fF101);
            } else if ((fDX - fDY + fDZ) <= 0.0f) {

                // 3027
                fInterp = ((1.0f - fDX - (1.0f - fDY) - fDZ) * fF010) + (fDX * fF110) + ((1.0f - fDY) * fF000) +
                          (fDZ * fF011);
            } else if ((fDX + fDY - fDZ) <= 0.0f) {

                // 4750
                fInterp = ((1.0f - fDX - fDY - (1 - fDZ)) * fF001) + (fDX * fF101) + (fDY * fF011) +
                          ((1.0f - fDZ) * fF000);
            } else if ((fDX + fDY + fDZ) >= 2.0f) {

                // 6572
                fInterp = ((1.0f - (1.0f - fDX) - (1.0f - fDY) - (1.0f - fDZ)) * fF111) + ((1.0f - fDX) * fF011) +
                          ((1.0f - fDY) * fF101) + ((1.0f - fDZ) * fF110);
            } else {
            ...
            if ((fDX + fDY + fDZ) <= 1.0f) {
                ...
                // 2316
                fInterp = ((1.0f - (1.0f - fDX) - (1.0f - fDY) - fDZ) * fF110) + ((1.0f - fDX) * fF010) +
                          ((1.0f - fDY) * fF100) + (fDZ * fF111);
            } else if ((fDX - fDY + fDZ) >= 1.0f) {

                // 5461
                fInterp = ((1.0f - (1.0f - fDX) - fDY - (1.0f - fDZ)) * fF101) + ((1.0f - fDX) * fF001) +
                          (fDY * fF111) + ((1.0f - fDZ) * fF100);
            } else if ((-fDX + fDY + fDZ) >= 1.0f) {

                // 7643
                fInterp = ((1.0f - fDX - (1.0f - fDY) - (1.0f - fDZ)) * fF011) + (fDX * fF111) +
                          ((1.0f - fDY) * fF001) + ((1.0f - fDZ) * fF010);
            } else {
    ...
    /**
     * Interpolation of the gradient vector of the image. The voxel containing the input point is determined. Within
     * that voxel, the correct tetrahedron containing the point is determined. A barycentric combination of the gradient
     * values at the vertices of the tetrahedron is used for the interpolated value. The barycentric coordinates are
     * those of the input point relative to the vertices of the tetrahedron.<br>
     * This vector is used to determine consistent normals for the triangles in the mesh representing the level surface.
     * This is faster than using ModelSurfaceTopology.getConsistentComponents(), but may fail on some pathological
     * cases. These cases are rare in 3D images from real applications.
     *
     ...
     *
     * @param  iXN0  a vertex in rational form
     * @param  iXD0  a vertex in rational form
     * @param  iYN0  a vertex in rational form
     * @param  iYD0  DOCUMENT ME!
     * @param  iZN0  DOCUMENT ME!
     * @param  iZD0  DOCUMENT ME!
     * @param  iXN1  DOCUMENT ME!
     * @param  iXD1  DOCUMENT ME!
     * @param  iYN1  DOCUMENT ME!
     * @param  iYD1  DOCUMENT ME!
     * @param  iZN1  DOCUMENT ME!
     * @param  iZD1  DOCUMENT ME!
     * @param  iXN2  DOCUMENT ME!
     * @param  iXD2  DOCUMENT ME!
     * @param  iYN2  DOCUMENT ME!
     * @param  iYD2  DOCUMENT ME!
     * @param  iZN2  DOCUMENT ME!
     * @param  iZD2  DOCUMENT ME!
     */
    private void addTriangle(int iXN0, int iXD0, int iYN0, int iYD0, int iZN0, int iZD0, int iXN1, int iXD1, int iYN1,
                             int iYD1, int iZN1, int iZD1, int iXN2, int iXD2, int iYN2, int iYD2, int iZN2, int iZD2) {
     ...
     *
     * @param   iXN  the vertex in rational form
     * @param   iXD  DOCUMENT ME!
     * @param   iYN  DOCUMENT ME!
     * @param   iYD  DOCUMENT ME!
     * @param   iZN  DOCUMENT ME!
     * @param   iZD  DOCUMENT ME!
     *
     * @return  the index of that added vertex, used in addTriangle
     */
    private int addVertex(int iXN, int iXD, int iYN, int iYD, int iZN, int iZD) {
     ...
     * @param  iX0     a tetrahedron vertex and function value
     * @param  iY0     a tetrahedron vertex and function value
     * @param  iZ0     a tetrahedron vertex and function value
     * @param  iF0     a tetrahedron vertex and function value
     * @param  iX1     DOCUMENT ME!
     * @param  iY1     DOCUMENT ME!
     * @param  iZ1     DOCUMENT ME!
     * @param  iF1     DOCUMENT ME!
     * @param  iX2     DOCUMENT ME!
     * @param  iY2     DOCUMENT ME!
     * @param  iZ2     DOCUMENT ME!
     * @param  iF2     DOCUMENT ME!
     * @param  iX3     DOCUMENT ME!
     * @param  iY3     DOCUMENT ME!
     * @param  iZ3     DOCUMENT ME!
     * @param  iF3     DOCUMENT ME!
     */
    private void processTetrahedron(float iLevel, int iX0, int iY0, int iZ0, int iF0, int iX1, int iY1, int iZ1,
                                    int iF1, int iX2, int iY2, int iZ2, int iF2, int iX3, int iY3, int iZ3, int iF3) {
        ...
        if (iF0 != 0) {
            ...
            if (iF1 > 0) {
                ...
                if (iF2 > 0) {
                    ...
                    if (iF3 > 0) {
                        ...
                        addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iXN1, iD1, iYN1, iD1, iZN1, iD1, iXN2, iD2, iYN2,
                                    iD2, iZN2, iD2);
                    } else {
                        // +++0
                    ...
                    if (iF3 > 0) {
                        ...
                        addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iXN1, iD1, iYN1, iD1, iZN1, iD1, iXN2, iD2, iYN2,
                                    iD2, iZN2, iD2);
                        addTriangle(iXN1, iD1, iYN1, iD1, iZN1, iD1, iXN3, iD3, iYN3, iD3, iZN3, iD3, iXN2, iD2, iYN2,
                                    iD2, iZN2, iD2);
                    } else {

                        // ++-0
                        addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iXN1, iD1, iYN1, iD1, iZN1, iD1, iX3, 1, iY3, 1,
                                    iZ3, 1);
                    }
                } else {
                    ...
                    if (iF3 > 0) {
                        ...
                        iYN1 = (iF1 * iY3) - (iF3 * iY1);
                        iZN1 = (iF1 * iZ3) - (iF3 * iZ1);
                        addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iXN1, iD1, iYN1, iD1, iZN1, iD1, iX2, 1, iY2, 1,
                                    iZ2, 1);
                    } else {
                        // ++00
                ...
                if (iF2 > 0) {
                    ...
                    if (iF3 > 0) {
                        ...
                        // +-00
                        addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iX2, 1, iY2, 1, iZ2, 1, iX3, 1, iY3, 1, iZ3, 1);
                    }
                }
            } else {
                ...
                if (iF2 > 0) {
                    ...
                    if (iF3 > 0) {
                        ...
                        addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iXN1, iD1, iYN1, iD1, iZN1, iD1, iX1, 1, iY1, 1,
                                    iZ1, 1);
                    } else {
                        // +0+0
                    ...
                    if (iF3 > 0) {
                        ...
                        // +0-0
                        addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iX1, 1, iY1, 1, iZ1, 1, iX3, 1, iY3, 1, iZ3, 1);
                    }
                } else {
                    ...
                    if (iF3 > 0) {
                        ...
                        iYN0 = (iF0 * iY3) - (iF3 * iY0);
                        iZN0 = (iF0 * iZ3) - (iF3 * iZ0);
                        addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iX1, 1, iY1, 1, iZ1, 1, iX2, 1, iY2, 1, iZ2, 1);
                    } else {

                        // +000
                        addTriangle(iX1, 1, iY1, 1, iZ1, 1, iX2, 1, iY2, 1, iZ2, 1, iX3, 1, iY3, 1, iZ3, 1);
                    }
                }
            }
        } else if (iF1 != 0) {
            ...
            if (iF2 > 0) {
                ...
                if (iF3 > 0) {
                    ...
                    iYN1 = (iF1 * iY3) - (iF3 * iY1);
                    iZN1 = (iF1 * iZ3) - (iF3 * iZ1);
                    addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iXN1, iD1, iYN1, iD1, iZN1, iD1, iX0, 1, iY0, 1, iZ0,
                                1);
                } else {
                    // 0++0
                ...
                if (iF3 > 0) {
                    ...
                    // 0+-0
                    addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iX0, 1, iY0, 1, iZ0, 1, iX3, 1, iY3, 1, iZ3, 1);
                }
            } else {
                ...
                if (iF3 > 0) {
                    ...
                    addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iX0, 1, iY0, 1, iZ0, 1, iX2, 1, iY2, 1, iZ2, 1);
                } else {

                    // 0+00
                    addTriangle(iX0, 1, iY0, 1, iZ0, 1, iX2, 1, iY2, 1, iZ2, 1, iX3, 1, iY3, 1, iZ3, 1);
                }
            }
        } else if (iF2 != 0) {
            ...
            if (iF3 > 0) {
                ...
                iYN0 = (iF2 * iY3) - (iF3 * iY2);
                iZN0 = (iF2 * iZ3) - (iF3 * iZ2);
                addTriangle(iXN0, iD0, iYN0, iD0, iZN0, iD0, iX0, 1, iY0, 1, iZ0, 1, iX1, 1, iY1, 1, iZ1, 1);
            } else {

                // 00+0
                addTriangle(iX0, 1, iY0, 1, iZ0, 1, iX1, 1, iY1, 1, iZ1, 1, iX3, 1, iY3, 1, iZ3, 1);
            }
        } else if (iF3 != 0) {

            // cases 000+ or 000-
            addTriangle(iX0, 1, iY0, 1, iZ0, 1, iX1, 1, iY1, 1, iZ1, 1, iX2, 1, iY2, 1, iZ2, 1);
        } else {
    ...
    /**
     * A rational representation of a level set triangle. The triangle just stores vertex indices and is unconcerned
     * about the actual vertex locations. The class extends Object for hashing support.
     */
    ...
    /**
     * A rational representation of a level set vertex. The rational form allows for exact look-ups in a hash map of
     * vertices. The class extends Object for hashing support.
     */
    private class Vertex extends Object {

        /**
         * Vertices are stored as rational numbers (xn/xd,yn/yd,zn/zd). This supports removing redundant vertices that
         * occur because of extraction in adjacent voxels.
         */
         ...
         * Create a vertex.
         *
         * @param  iXNumer  a vertex in rational form
         * @param  iXDenom  DOCUMENT ME!
         * @param  iYNumer  DOCUMENT ME!
         * @param  iYDenom  DOCUMENT ME!
         * @param  iZNumer  DOCUMENT ME!
         * @param  iZDenom  DOCUMENT ME!
         */
