...
public class CustomHashtable extends java.util.Hashtable {
    ...
    /**
     * Ensures that the key is unique for this hashtable, then invokes the super.put() method generate a key and add a
     ...
     *
     * @exception  NullPointerException  thrown when a unique key cannot be found or generated for this hashtable.
     */
    ...
    /**
     * Ensures that the key is unique for this hashtable, then invokes the super.put() method to add the key and value
     * to the table.
     *
    ...
    /**
     * Creates a key for a value based on the value's hashcode. If the key exists in the hashtable already, then it is
     * appended to try and get to a unique key. Throws a NullPointer Exception if a unique key can't be found after
     * appending.
     *
     * @param      key    DOCUMENT ME!
     ...
     *
     * @exception  NullPointerException  thrown when a unique key cannot be generated.
     */
