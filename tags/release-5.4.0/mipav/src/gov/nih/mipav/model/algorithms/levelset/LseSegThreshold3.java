...
public class LseSegThreshold3 extends LseSegmenter
{
     ...
     */
    public LseSegThreshold3 (int iXBound, int iYBound, int iZBound,
    ...
    */
        ...
        float fLaplacianWeight, float fTimeStep)
    {
        ...
        m_kLevelSetEvolver = new LseThreshold3(m_iXBound,m_iYBound,
            ...
            m_afFeature,m_fLower,m_fUpper,fPropagationWeight,fCurvatureWeight);
