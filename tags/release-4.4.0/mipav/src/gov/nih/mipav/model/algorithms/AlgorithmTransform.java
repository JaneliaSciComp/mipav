...
public class AlgorithmTransform extends AlgorithmBase {
     ...
     * @param xfrm Transformation matrix to be applied
     */
    private void transform2DVOI(final ModelImage image, final float[] imgBuffer, final TransMatrix kTM) {
     ...
     */
    private void transform25DVOI(final ModelImage image, final float[] imgBuffer, final TransMatrix kTM) {
        ...
        final int mod = Math.max(1, iZdim / 50);
     ...
     * @param kTM Transformation matrix to be applied
     */
    private void transform3DVOI(final ModelImage image, final float[] imgBuffer, final TransMatrix kTM) {
     ...
     */
    private void transformBilinear(final float[] imgBuf, final TransMatrix kTM) {
        int i, j;
        int iAdj, jAdj;
        float X, Y;
        int x0, y0;
     ...
     * @param kTM Matrix to be applied
     */
    private void transformBilinear3D(final float[] imgBuf, final TransMatrix kTM) {
        int i, j, k;
        int iAdj, jAdj;
        int X0pos, Y0pos;
        int X1pos, Y1pos;
     ...
     * @param kTM Matrix to be applied
     */
    private void transformBilinear3DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM) {
        int i, j, k;
        int iAdj, jAdj;
        int X0pos, Y0pos;
        int X1pos, Y1pos;
     ...
     * @param kTM Transformation matrix to be applied
     */
    private void transformBilinear4D(final float[] imgBuf, final TransMatrix kTM) {
        int i, j, k, l;
        int iAdj, jAdj;
        int X0pos, Y0pos;
        int X1pos, Y1pos;
     ...
     * @param kTM Matrix to be applied
     */
    private void transformBilinear4DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM) {
        int i, j, k, l;
        int iAdj, jAdj;
        int X0pos, Y0pos;
        int X1pos, Y1pos;
     ...
     * @param kTM Matrix to be applied
     */
    private void transformBilinearC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM) {
        int i, j;
        int iAdj, jAdj;
        int X0pos, Y0pos;
        int X1pos, Y1pos;
            ...
            for (j = 0; (j < oYdim) && !threadStopped; j++) {
                ...
                for (i = 0; (i < oXdim) && !threadStopped; i++) {
                    ...
                    if ( (X > -0.5f) && (X < iXdim)) {
                        ...
                        if ( (Y > -0.5f) && (Y < iYdim)) {
                            value = splineAlg.interpolatedValue(img2D, X, Y, iXdim, iYdim, degree);
        ...
        for (z = 0; z < nz; z++) {
            ...
            for (c = 0; c < 4; c++) {
                ...
                for (j = 0; (j < oYdim) && !threadStopped; j++) {
                    ...
                    if ( ( (j % mod) == 0)) {
                        fireProgressStateChanged((int) ( ( ((float) z / nz * 100) + ((float) c / (4 * nz) * 100) + ((float) j
                                / (4 * oYdim * nz) * 100)) + 0.5f));
                    }
    ...
    private void transformBspline3DC(final float[] imgBuf, final TransMatrix kTM, final int degree) {
        ...
        int x, y, z;
        BSplineProcessing splineAlg;
        final float[] imageMin = new float[4];
        final float[] imageMax = new float[4];
        int c;
    ...
    private void transformBspline4DC(final float[] imgBuf, final TransMatrix kTM, final int degree) {
        ...
        int x, y, z, c;
        BSplineProcessing splineAlg;
        final float volMin[] = new float[4];
        final float volMax[] = new float[4];
        int t;
                        ...
                        for (i = 0; (i < oXdim) && !threadStopped; i++) {
                            ...
                            if ( (X > -0.5f) && (X < iXdim)) {
                                ...
                                if ( (Y > -0.5f) && (Y < iYdim)) {
                                    ...
                                    if ( (Z > -0.5f) && (Z < iZdim)) {
                                        value = splineAlg
                                                .interpolatedValue(image, X, Y, Z, iXdim, iYdim, iZdim, degree);
     ...
     */
    /*
     * private void transformBspline2D(float[] imgBuf, TransMatrix kTM, int degree) { AlgorithmBSpline Bspline = new
     * AlgorithmBSpline(); int i, j; float X, Y; float value; float imm, jmm; int[] inVolExtents = { iXdim, iYdim }; int
     * mod = Math.max(1, oYdim / 50); float j1, j2; float T00, T01, T02, T10, T11, T12, T20, T21, T22;
     * 
     * T00 = kTM.M00; T01 = kTM.M01; T02 = kTM.M02; T10 = kTM.M10; T11 = kTM.M11; T12 = kTM.M12; T20 = kTM.M20; T21 =
     * kTM.M21; T22 = (float) xfrm[2][2];
     * 
     ...
     * 
     * for (i = 0; (i < oXdim) && !threadStopped; i++) { // transform i,j,k value = (float) srcImage.getMin(); //
     * remains zero if voxel is transformed out of bounds imm = i * oXres; X = (j1 + (imm * T00)) * invXRes;
     * 
     ...
     */
    /*
     * private void transformBspline2DC(float[] imgBuf, float[] imgBuf2, TransMatrix kTM, int degree) { AlgorithmBSpline
     * Bspline = new AlgorithmBSpline(); int i, j; float X, Y; float[] value = new float[4]; float imm, jmm; int[]
     * inVolExtents = { iXdim, iYdim }; int mod = Math.max(1, oXdim / 50); int counter = 0; // used for progress bar
     * float temp1, temp2; int temp3; float T00, T01, T02, T10, T11, T12;
     * 
     * T00 = kTM.M00; T01 = kTM.M01; T02 = kTM.M02; T10 = kTM.M10; T11 = kTM.M11; T12 = kTM.M12;
     * 
     ...
     * 
     * for (j = 0; (j < oYdim) && !threadStopped; j++) { // convert to mm value[0] = 0; // will remain zero if boundary
     * conditions not met value[1] = 0; value[2] = 0; value[3] = 0;
     * 
     * jmm = (float) j * oYres; // transform i,j X = (temp1 + (jmm * T01)) / iXres;
     * 
     * if ((X >= 0) && (X < iXdim)) { // check bounds Y = (temp2 + (jmm * T11)) / iYres;
     * 
     * if ((Y >= 0) && (Y < iYdim)) { value = Bspline.bSpline2DC(0, 0, X, Y); } }
     * 
     * temp3 = 4 * (i + (j * oXdim)); imgBuf2[temp3] = value[0]; imgBuf2[temp3 + 1] = value[1]; imgBuf2[temp3 + 2] =
     * value[2]; imgBuf2[temp3 + 3] = value[3]; counter++; } }
     * 
     ...
     */
    /*
     * private void transformBspline3D(float[] imgBuf, TransMatrix kTM, int degree) { AlgorithmBSpline Bspline = new
     * AlgorithmBSpline(); int i, j, k; float X, Y, Z; float value; int sliceSize; float imm, jmm, kmm; int[]
     * inVolExtents = { iXdim, iYdim, iZdim }; int mod = Math.max(1, oZdim / 50);
     * 
     * sliceSize = iXdim * iYdim;
     * 
     * float k1, k2, k3, j1, j2, j3;
     ...
     * float T00, T01, T02, T03, T10, T11, T12, T13, T20, T21, T22, T23;
     * 
     * T00 = kTM.M00; T01 = kTM.M01; T02 = kTM.M02; T03 = kTM.M03; T10 = kTM.M10; T11 = kTM.M11; T12 = kTM.M12; T13 =
     * kTM.M13; T20 = (float) xfrm[2][0]; T21 = kTM.M21; T22 = kTM.M22; T23 = kTM.M23;
     * 
     ...
     * 
     * for (j = 0; (j < oYdim) && !threadStopped; j++) { jmm = j * oYres; j1 = (jmm * T01) + k1; j2 = (jmm * T11) + k2;
     * j3 = (jmm * T21) + k3;
     * 
     * for (i = 0; (i < oXdim) && !threadStopped; i++) { // transform i,j,k value = (float) srcImage.getMin(); //
     * remains zero if voxel is transformed out of bounds imm = i * oXres; X = (j1 + (imm * T00)) * invXRes;
     ...
     */
    /*
     * private void transformBspline3DC(float[] imgBuf, float[] imgBuf2, TransMatrix kTM, int degree) { AlgorithmBSpline
     * Bspline = new AlgorithmBSpline(); int i, j, k; float X, Y, Z; float[] value = new float[4]; float imm, jmm, kmm;
     * int[] inVolExtents = { iXdim, iYdim, iZdim }; int mod = Math.max(1, oXdim / 50); int counter = 0; // used for
     * progress bar
     * 
     * int osliceSize = oXdim * oYdim; float i1, i2, i3, j1, j2, j3; float temp1, temp2, temp3; int temp4; float T00,
     * T01, T02, T03, T10, T11, T12, T13, T20, T21, T22, T23;
     * 
     * T00 = kTM.M00; T01 = kTM.M01; T02 = kTM.M02; T03 = kTM.M03; T10 = kTM.M10; T11 = kTM.M11; T12 = kTM.M12; T13 =
     * kTM.M13; T20 = (float) xfrm[2][0]; T21 = kTM.M21; T22 = kTM.M22; T23 = kTM.M23;
     * 
     ...
     * 
     * for (j = 0; (j < oYdim) && !threadStopped; j++) { jmm = (float) j * oYres; j1 = jmm * T01; j2 = jmm * T11; j3 =
     * jmm * T21; temp1 = i3 + j3; temp2 = i2 + j2; temp3 = i1 + j1;
     * 
     * for (k = 0; (k < oZdim) && !threadStopped; k++) { // convert to mm value[0] = 0; // will remain zero if boundary
     * conditions not met value[1] = 0; value[2] = 0; value[3] = 0; kmm = (float) k * oZres; // transform i,j,k X =
     * (temp3 + (kmm * T02)) / iXres; // convert back to pixels if ((X >= 0) && (X < iXdim)) { // check bounds Y =
     * (temp2 + (kmm * T12)) / iYres;
     * 
     ...
     * 
     * temp4 = 4 * (i + (j * oXdim) + (k * osliceSize)); imgBuf2[temp4] = value[0]; imgBuf2[temp4 + 1] = value[1];
     * imgBuf2[temp4 + 2] = value[2]; imgBuf2[temp4 + 3] = value[3]; counter++; } } }
     * 
     * if (threadStopped) { return; }
     * 
     * try { destImage.importData(0, imgBuf2, true); } catch (IOException error) {
     ...
     */
    /*
     * private void transformBspline3Dim2D(float[] imgBuf, TransMatrix kTM, int degree) { AlgorithmBSpline Bspline = new
     * AlgorithmBSpline(); int i, j, k; float X, Y; float value; float imm, jmm; int[] inVolExtents = { iXdim, iYdim };
     * 
     ...
     * 
     * T00 = kTM.M00; T01 = kTM.M01; T02 = kTM.M02; T10 = kTM.M10; T11 = kTM.M11; T12 = kTM.M12; T20 = kTM.M20; T21 =
     * kTM.M21; T22 = (float) xfrm[2][2]; // System.out.println("oZdim = "); for (k = 0; (k < oZdim) && !threadStopped;
     * k++) {
     * 
     ...
     * Bspline.setup2DBSpline(imgBuf, inVolExtents, degree);
     * 
     * for (i = 0; (i < oXdim) && !threadStopped; i++) { imm = (float) i * oXres; temp1 = (imm * T00) + T02; temp2 =
     * (imm * T10) + T12;
     * 
     * for (j = 0; (j < oYdim) && !threadStopped; j++) { // convert to mm value = (float) srcImage.getMin(); // will
     * remain zero if boundary conditions not met jmm = (float) j * oYres; // transform i,j X = (temp1 + (jmm * T01)) /
     * iXres;
     * 
     * if ((X >= 0) && (X < iXdim)) { // check bounds Y = (temp2 + (jmm * T11)) / iYres;
     * 
     ...
     * 
     * temp3 = 4 * (i + (j * oXdim)); imgBuf2[temp3] = value[0]; imgBuf2[temp3 + 1] = value[1]; imgBuf2[temp3 + 2] =
     * value[2]; imgBuf2[temp3 + 3] = value[3]; counter++; } // for i } // for j
     * 
     ...
     */
    /*
     * private void transformBspline4D(float[] imgBuf, TransMatrix kTM, int degree) { AlgorithmBSpline Bspline = new
     * AlgorithmBSpline(); int i, j, k, l; float X, Y, Z; float value; float imm, jmm, kmm; int[] inVolExtents = {
     * iXdim, iYdim, iZdim }; int mod = Math.max(1, oTdim / 50); int counter = 0; // used for progress bar
     * 
     ...
     * Bspline.setup3DBSpline(imgBuf, inVolExtents, degree);
     * 
     * for (i = 0; (i < oXdim) && !threadStopped; i++) { imm = (float) i * oXres; i1 = (imm * T00) + T03; i2 = (imm *
     * T10) + T13; i3 = (imm * T20) + T23;
     * 
     * for (j = 0; (j < oYdim) && !threadStopped; j++) { jmm = (float) j * oYres; j1 = jmm T01; j2 = jmm * T11; j3 = jmm *
     * T21; temp1 = i3 + j3; temp2 = i2 + j2; temp3 = i1 + j1;
     * 
     * for (k = 0; (k < oZdim) && !threadStopped; k++) { // convert to mm value = (float) srcImage.getMin(); // will
     * remain zero if boundary conditions not met kmm = (float) k * oZres; // transform i,j,k X = (temp3 + (kmm * T02)) /
     * iXres;
     * 
     ...
     */
    /*
     * private void transformBspline4Dim2D(float[] imgBuf, TransMatrix kTM, int degree) { AlgorithmBSpline Bspline = new
     * AlgorithmBSpline(); int i, j, k, l; float X, Y; float value; int sliceSize; float imm, jmm; int[] inVolExtents = {
     * iXdim, iYdim };
     * 
     * sliceSize = iXdim * iYdim;
     * 
     ...
     * if ((k < (oZdim - 1)) || (l < (oTdim - 1))) {
     * 
     * try { srcImage.exportData((l * oZdim * imgLength) + ((k + 1) * imgLength), imgLength, imgBuf); } catch
     * (IOException error) { displayError("Algorithm Transform: Image(s) locked"); setCompleted(false);
     * 
     ...
     * 
     * temp3 = 4 * (i + (j * oXdim)); imgBuf2[temp3] = value[0]; imgBuf2[temp3 + 1] = value[1]; imgBuf2[temp3 + 2] =
     * value[2]; imgBuf2[temp3 + 3] = value[3]; counter++; } // for j } // for i
     * 
     * try { destImage.importData((4 * l * oXdim * oYdim * oZdim) + (4 * k * oXdim * oYdim), imgBuf2, true); } catch
     * (IOException error) { MipavUtil.displayError("AlgorithmTransform: IOException Error on importData"); }
     * 
     * if ((k < (oZdim - 1)) || (l < (oTdim - 1))) {
     * 
     * try { srcImage.exportData((l * oZdim * imgLength) + ((k + 1) * imgLength), imgLength, imgBuf); } catch
     * (IOException error) { displayError("Algorithm Transform: IOException Error on exportData"); setCompleted(false);
     * 
     * return; } } // end if ((k < (oZdim - 1))|| (l < (oTdim - 1))) } // end for k } // end for l
     * 
     * Bspline.finalize(); Preferences.debug("finished Bspline");}
     ...
     */
    private void transformCubicLagrangian2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
     ...
     */
    private void transformCubicLagrangian2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j;
        int iAdj, jAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformCubicLagrangian3D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j, k;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformCubicLagrangian3DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j, k;
        int iAdj, jAdj, kAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformCubicLagrangian3Dim2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j, k;
        int iAdj, jAdj;
        float X, Y;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformCubicLagrangian3Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j, k;
        int iAdj, jAdj;
     ...
     * @param clip if <code>true</code> clip output values to be within input range
     */
    private void transformCubicLagrangian4D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
     ...
     * @param clip if <code>true</code> clip output values to be within input range
     */
    private void transformCubicLagrangian4DC(final float[] imgBuf, final float imgBuffer2[], final TransMatrix kTM,
            final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformCubicLagrangian4Dim2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j, k, l;
        int iAdj, jAdj;
        float X, Y;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformCubicLagrangian4Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmCubicLagrangian CLag = new AlgorithmCubicLagrangian();
        int i, j, k, l;
        int iAdj, jAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformHepticLagrangian2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformHepticLagrangian2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j;
        int iAdj, jAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformHepticLagrangian3D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j, k;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformHepticLagrangian3DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j, k;
        int iAdj, jAdj, kAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformHepticLagrangian3Dim2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j, k;
        int iAdj, jAdj;
        float X, Y;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformHepticLagrangian3Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j, k;
        int iAdj, jAdj;
     ...
     * @param clip if true clip output values to be within input range
     */
    private void transformHepticLagrangian4D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
     ...
     * @param clip if true clip output values to be within input range
     */
    private void transformHepticLagrangian4DC(final float[] imgBuf, final float imgBuffer2[], final TransMatrix kTM,
            final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformHepticLagrangian4Dim2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j, k, l;
        int iAdj, jAdj;
        float X, Y;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformHepticLagrangian4Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmHepticLagrangian HLag = new AlgorithmHepticLagrangian();
        int i, j, k, l;
        int iAdj, jAdj;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor2D(final float[] imgBuf, final TransMatrix kTM) {
        int i, j;
        int iAdj, jAdj;
        float X, Y;
        int roundX, roundY;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM) {
        int i, j;
        int iAdj, jAdj;
        float X, Y;
        int roundX, roundY;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor3D(final float[] imgBuf, final TransMatrix kTM) {
        int i, j, k;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
        int xOffset, yOffset, zOffset;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor3DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM) {
        int i, j, k;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
        int roundX, roundY, roundZ;
            ...
            for (j = 0; (j < oYdim) && !threadStopped; j++) {
                ...
                for (k = 0; (k < oZdim) && !threadStopped; k++) {
                    ...
                    if ( (X < -0.5) || (X >= iXdim) || (Y < -0.5) || (Y >= iYdim) || (Z < -0.5) || (Z >= iZdim)) {
                        ...
                        imgBuf2[ (4 * (i + (oXdim * j) + (oXdim * oYdim * k))) + 1] = imgBuf[ (4 * (xOffset + yOffset + zOffset)) + 1];
                        imgBuf2[ (4 * (i + (oXdim * j) + (oXdim * oYdim * k))) + 2] = imgBuf[ (4 * (xOffset + yOffset + zOffset)) + 2];
                        imgBuf2[ (4 * (i + (oXdim * j) + (oXdim * oYdim * k))) + 3] = imgBuf[ (4 * (xOffset + yOffset + zOffset)) + 3];
                    }
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor3Dim2D(final float[] imgBuf, final TransMatrix kTM) {
        int i, j, k;
        int iAdj, jAdj;
        float X, Y;
        int roundX, roundY;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor3Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM) {
        int i, j, k;
        int iAdj, jAdj;
        float X, Y;
        int roundX, roundY;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor4D(final float[] imgBuf, final TransMatrix kTM) {
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
        int xOffset, yOffset, zOffset;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor4DC(final float[] imgBuf, final float imgBuffer2[], final TransMatrix kTM) {
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
        int xOffset, yOffset, zOffset;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor4Dim2D(final float[] imgBuf, final TransMatrix kTM) {
        int i, j, k, l;
        int iAdj, jAdj;
        float X, Y;
        int roundX, roundY;
     ...
     * @param kTM transformation matrix to be applied
     */
    private void transformNearestNeighbor4Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM) {
        int i, j, k, l;
        int iAdj, jAdj;
        float X, Y;
        int roundX, roundY;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j;
        int iAdj, jAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian3D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j, k;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian3DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j, k;
        int iAdj, jAdj, kAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian3Dim2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j, k;
        int iAdj, jAdj;
        float X, Y;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian3Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j, k;
        int iAdj, jAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian4DC(final float[] imgBuf, final float[] imgBuffer2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian4D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian4Dim2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j, k, l;
        int iAdj, jAdj;
        float X, Y;
     ...
     * @param clip if <code>true</code> clip output values to be within input range
     */
    private void transformQuinticLagrangian4Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmQuinticLagrangian QLag = new AlgorithmQuinticLagrangian();
        int i, j, k, l;
        int iAdj, jAdj;
     ...
     * @param kTM Transformation matrix to be applied
     */
    private void transformTrilinear(final float[] imgBuffer, final TransMatrix kTM) {
        int i, j, k;
        int iAdj, jAdj, kAdj;
        float[] tempBuf;
        float X, Y, Z;
        ...
        final float invXRes = 1.f / iXres;
        final float invYRes = 1.f / iYres;
        final float invZRes = 1.f / iZres;
     ...
     * @param kTM Transformation matrix to be applied
     */
    private void transformTrilinear4D(final float[] imgBuffer, final TransMatrix kTM) {
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
        int x0, y0, z0;
     ...
     * @param kTM Transformation matrix to be applied
     */
    private void transformTrilinear4DC(final float[] imgBuffer, final float[] imgBuffer2, final TransMatrix kTM) {
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
        int x0, y0, z0;
     ...
     * @param kTM Transformation matrix to be applied
     */
    private void transformTrilinearC(final float[] imgBuffer, final float[] imgBuffer2, final TransMatrix kTM) {
        int i, j, k;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
        int x0, y0, z0;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j;
        int iAdj, jAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc3D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j, k;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc3DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j, k;
        int iAdj, jAdj, kAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc3Dim2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j, k;
        int iAdj, jAdj;
        float X, Y;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc3Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j, k;
        int iAdj, jAdj;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc4D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
        float X, Y, Z;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc4DC(final float[] imgBuf, final float[] imgBuffer2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j, k, l;
        int iAdj, jAdj, kAdj;
     ...
     */
    private void transformWSinc4Dim2D(final float[] imgBuf, final TransMatrix kTM, final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j, k, l;
        int iAdj, jAdj;
        float X, Y;
     ...
     * @param clip If <code>true</code> clip output values to be within input range
     */
    private void transformWSinc4Dim2DC(final float[] imgBuf, final float[] imgBuf2, final TransMatrix kTM,
            final boolean clip) {
        AlgorithmWSinc WSinc = new AlgorithmWSinc();
        int i, j, k, l;
        int iAdj, jAdj;
