...
public class JPanelClip_WM
    ...
    protected GPUVolumeRender_WM rayBasedRenderWM;
     ...
     */
    public JPanelClip_WM(VolumeViewer parent, GPUVolumeRender_WM kRayBasedRenderWM) {
        //super(parent);
        rayBasedRenderWM = kRayBasedRenderWM;
        xDim = parent.getImageA().getExtents()[0];
        yDim = parent.getImageA().getExtents()[1];
        zDim = parent.getImageA().getExtents()[2];
        xSlice = (xDim - 1) / 2;
        ySlice = (yDim - 1) / 2;
        zSlice = (zDim - 1) / 2;
