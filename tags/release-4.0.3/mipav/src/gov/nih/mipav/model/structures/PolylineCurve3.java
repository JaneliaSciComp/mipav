...
/**
 * This is an implementation for a curve in 3D defined by a set of straight line segments for any range of time values.
 */
public class PolylineCurve3 extends MultipleCurve3 {
    ...
    /**
     * Create a polyline curve in 3D through the set of input points. Automatically compute the "times" associated with
     * each point based on the accumulated distance between the points.
     *
     ...
     * @param  akPoint  Point3f[] Array of 3D points. The size of this array must match the size of the input afTime
     *                  array.
     */
