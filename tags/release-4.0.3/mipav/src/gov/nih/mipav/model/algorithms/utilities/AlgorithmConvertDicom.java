 ...
 * @version  1.0
 */
public class AlgorithmConvertDicom extends AlgorithmBase {
     ...
     */
    public AlgorithmConvertDicom(String dir, String outputDir, int compression) {
        this.dirPath = dir;
    ...
    private void runConversion(String fileName) {
        ...
        try {
            ...
            if (dicomImage == null) {
                ...
                return;
            } else if ((dicomImage.getNDims() == 2) || (compression == -1)) {
                ...
                if (dicomFile.exists() || dicomFile.mkdirs()) {
                    ...
                    opts.setFileType(FileUtility.TIFF_MULTIFILE);
                    ...
                    if (dicomImage.getNDims() == 3) {
                        ...
                        opts.setStartNumber(0);
                        opts.setEndSlice(dicomImage.getExtents()[2] - 1);
                        opts.setDigitNumber(Integer.toString(opts.getEndSlice()).length());
                    }
