        ...
        try {
            ...
            menuBar.add(menuObj.makeMenu("File", 'F', false,
                                         new JComponent[] {
                                             ...
                                             new JSeparator(),
                                             menuObj.buildMenuItem("Open user defined LUT", "OpenUDLUT", 0,
                                                                   "userlutopen.gif", true),
                                             menuObj.buildMenuItem("Save user defined LUT", "SaveUDLUT", 0,
                                                                   "userlutsave.gif", true), new JSeparator(),
