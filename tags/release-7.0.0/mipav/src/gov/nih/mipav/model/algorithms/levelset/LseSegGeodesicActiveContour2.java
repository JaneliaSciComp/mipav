...
public class LseSegGeodesicActiveContour2 extends LseSegmenter
{
     ...
     */
    public LseSegGeodesicActiveContour2 (int iXBound, int iYBound,
        float fXSpacing, float fYSpacing, float[] afData, boolean[] abMask)
    {
        ...
        m_akNegGradient = new float[m_iQuantity][2];
    }
    ...
    */
        ...
        float fLaplacianWeight, float fTimeStep)
    {
        ...
        m_kLevelSetEvolver = new LseGeodesicActiveContour2(m_iXBound,
            m_iYBound,m_fXSpacing,m_fYSpacing,m_afSignedDistance,
            m_abSignedDistanceMask,m_fBorderValue,LsePdeFilter2.PRESERVE_ZERO,
            m_afFeature,m_akNegGradient,fAdvectionWeight,fPropagationWeight,
            fCurvatureWeight);
