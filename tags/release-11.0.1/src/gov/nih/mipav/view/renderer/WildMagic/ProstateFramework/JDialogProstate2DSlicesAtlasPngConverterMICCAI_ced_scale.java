 ...
 * 
 */
public class JDialogProstate2DSlicesAtlasPngConverterMICCAI_ced_scale extends JDialogBase
	 ...
	 */
	public JDialogProstate2DSlicesAtlasPngConverterMICCAI_ced_scale(Frame theParentFrame) {
	...
	public void runTransform() {
		...
		for (int i = 0; i < keyImageVOIs.size(); i++) {
			try {
				ModelImage voiImage = keyImageVOIs.get(i);
	...
	public void readFile() {
		...
		try {
			...
			for (int imageIndex = start; imageIndex < len; imageIndex++) {
				...
				// new ViewJFrameImage(keyImageVOIs.get(currentIndex));
