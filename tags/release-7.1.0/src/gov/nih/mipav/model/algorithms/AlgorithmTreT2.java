...
public class AlgorithmTreT2 extends AlgorithmTProcess {
    ...
    public AlgorithmTreT2(final ModelImage destImage, final ModelImage srcImage, final JDialogTreT2 dialog, final double[] treFAPhase0,
            final double[] treFAPhase180, final int[] ssfpImageIndexPhase0, final int[] ssfpImageIndexPhase180, final int t1ImageIndex, final int b1ImageIndex,
            final double[] simplexLineValues, final double[] simplexResiduals, final double[] simplexCentre, final double[] reflection,
    ...
    public void runAlgorithm() {
        if (dialog.isPerformFullModelling() == true || dialog.isPerformApproxModelling() == true) {
            if (dialog.isPerformFullModelling() == true) {
                calculateT2withFullModelling();
            } else {
                calculateT2withApproximateModelling();
            }
        } else {
