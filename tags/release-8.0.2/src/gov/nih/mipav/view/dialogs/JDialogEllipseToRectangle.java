 ...
 */
public class JDialogEllipseToRectangle extends JDialogBase implements AlgorithmInterface, ItemListener, WindowListener {
    ...
    /** DOCUMENT ME! */
    private AlgorithmEllipseToRectangle erAlgo = null;
     ...
     */
    public JDialogEllipseToRectangle(ModelImage image) {
        super();
        this.image = image;
     ...
     */
    public JDialogEllipseToRectangle(Frame theParentFrame, ModelImage im) {
    ...
    private void callAlgorithm() {
        ...
        try {
            ...
            if (isRunInSeparateThread()) {
                ...
                if (erAlgo.startMethod(Thread.MIN_PRIORITY) == false) {
            ...
            System.gc();
            MipavUtil.displayError("Dialog Ellipse To Rectangle: unable to allocate enough memory");
    ...
    private void init() {
        ...
        setTitle("Ellipse To Rectangle Conformal Mapping");
