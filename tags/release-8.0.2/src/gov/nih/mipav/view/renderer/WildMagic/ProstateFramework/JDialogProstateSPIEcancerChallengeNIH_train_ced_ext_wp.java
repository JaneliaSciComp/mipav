 ...
 * 
 * For the challenge, we apply this class to whole prostate segmentation for the challenge testing data. 
 * 
 * steps:
 ...
 * 
 */
public class JDialogProstateSPIEcancerChallengeNIH_train_ced_ext_wp extends JDialogBase
	 ...
	 */
	public JDialogProstateSPIEcancerChallengeNIH_train_ced_ext_wp(Frame theParentFrame) {
	...
	private void readKeyImageDir() {
		...
		File fileDir = new File("/scratch/backup/SPIEChallenge/NetherlandTrainDataPng/wp_ced_150_voi_modified/");
	...
	public void runScaleIntensity() {
		...
		Set<String> keys = imageHashtableWp.keySet();

		for (String key : keys) {

			ModelImage keyImage = imageHashtableWp.get(key);
