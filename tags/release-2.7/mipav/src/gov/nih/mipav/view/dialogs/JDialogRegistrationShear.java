 ...
 */
public class JDialogRegistrationShear extends JDialogBase implements AlgorithmInterface, ScriptableInterface {

    //~ Static fields/initializers -------------------------------------------------------------------------------------

    /** Use serialVersionUID for interoperability. */
    private static final long serialVersionUID = -7570232901882743190L;
    ...
    /**
     * Creates a new dialog for getting information to run the registration.
     *
    ...
    public void insertScriptLine(AlgorithmBase algo) {
        ...
        if (algo.isCompleted()) {
            ...
            if (UI.isScriptRecording()) {
                ...
                UI.getScriptDialog().append("RegistrationShear " + UI.getScriptDialog().getVar(imageB.getImageName()) +
    ...
    protected void closingLog() {
        ...
        if (RegShear.isCompleted() == true) {
            logString = new String("Register " + imageB.getImageName() + " to " + imageA.getImageName() +
    ...
    private void constructLog() {
        ...
        String logString = new String("Register " + imageB.getImageName() + " to " + imageA.getImageName() + "\n");
        // Preferences.log(imageB.getUserInterface(), logString);
    }
