...
public class JDialogAdaptiveSmooth extends JDialogBase implements AlgorithmInterface, ScriptableInterface {
    ...
    private static final long serialVersionUID = 6866748103120947968L;
    ...
    /**
     * Creates a new JDialogAdaptiveSmooth object.
     *
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals("OK")) {
            ...
            MipavUtil.showHelp("filtersspatialAdaptiveSmooth_filters_(spatial)_AdaptiveSmooth_htm_toc_applying_the_AdaptiveSmooth");
        }
