                                                    ...
                                                    for (j = 0, intensitySum = 0; j
                                                        ...
                                                        if ( ( (VOIContour) VOIs.VOIAt(i).getCurves()[s].elementAt(j)).
                                                            ...
                                                            intensitySum += ( (VOIContour) (VOIs.VOIAt(i).getCurves()[
                                                                ...
                                                                graphImgBuff, compImage.getActiveImage().getExtents()[0], c);
                                            ...
                                            try {
                                                ...
                                                for (j = 0, intensitySum = 0; j < VOIs.VOIAt(i).getCurves()[s].size();
                                                    ...
                                                    if (isActive || foundCurve) {
                                                        if (!foundCurve) {
                                                            compImage.getActiveImage().exportData(s * length, length, graphImgBuff);
                                                        } // locks and releases lock
                                                        intensitySum +=
                                                            ( (VOIContour) (VOIs.VOIAt(i).getCurves()[s].elementAt(j))).
                                                            calcIntensity(
                                                            graphImgBuff, compImage.getActiveImage().getExtents()[0]);
                                                        numPixels +=
                                                            ( (VOIContour) (VOIs.VOIAt(i).getCurves()[s].elementAt(j))).
                                                            getLastNumPixels();
                                                        foundCurve = true;
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.POINT) {
                            ...
                            for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                                if ( ( (VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).isActive()) {
                                    pt = ( (VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).getActivePt();
                                    ...
                                    if (compImage.getActiveImage().getNDims() == 3) {
                                        ...
                                        if (compImage.getActiveImage().isColorImage() == true) {
                                            ...
                                            for (int s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                                ...
                                                for (int c = 0; c < 3; c++) {
                                                    if (ptRGBPositions != null && ptRGBIntensities != null) {
                                                        ...
                                                        ptRGBIntensities[c][s] = compImage.getActiveImage().getFloat(
                                                            (int) (4
                                                            * (s * compImage.getActiveImage().getExtents()[0]
                                                            * compImage.getActiveImage().getExtents()[1]
                                                            + pt.y * compImage.getActiveImage().getExtents()[0]
                                                            + pt.x)
                                                            + c
                                                            + 1));
                                                    }
                                            ...
                                            for (int s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                                ...
                                                if (ptPosition != null && ptIntensity != null) {
                                                    ptPosition[s] = s;
                                                    ptIntensity[s] = compImage.getActiveImage().getFloat(
                                                        (int) (s * compImage.getActiveImage().getExtents()[0]
                                                        * compImage.getActiveImage().getExtents()[1]
                                                        + pt.y * compImage.getActiveImage().getExtents()[0] + pt.x));
                                                }
                                            }
                                            if (VOIs.VOIAt(i).getContourGraph() != null) {
                                        ...
                                        for (int t = 0; t < compImage.getActiveImage().getExtents()[3]; t++) {
                                            ...
                                            if (ptPosition != null && ptIntensity != null) {
                                                ptPosition[t] = t;
                                                ptIntensity[t] = compImage.getActiveImage().getFloat(
...
//System.err.println("move point");
    ...
    public void mouseMoved(MouseEvent mouseEvent) {
        ...
        if (compImage.getGraphics() == null || compImage.getModifyFlag() == false || compImage.getSlice() == -99) {
            return;
        }
                ...
                if (VOIs.VOIAt(i).isActive() && VOIs.VOIAt(i).isVisible()) {
                    ...
                    if (mouseEvent.isShiftDown() &&
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR
                            ...
                            // VOIs.VOIAt(i).drawVertices(compImage.getZoomX(), getZoomY(), compImage.getResolutionX(), compImage.getResolutionY(), compImage.getSlice(), g);
                            VOIs.VOIAt(i).drawVertices(compImage.getZoomX(), compImage.getZoomY(), compImage.getResolutionX(), compImage.getResolutionY(),
                                compImage.getActiveImage().getFileInfo(0).getResolutions(),
                                compImage.getActiveImage().getFileInfo(0).getUnitsOfMeasure(), compImage.getSlice(), compImage.getOrientation(), g, j);
                            compImage.getGraphics().dispose();
                            return;
                        }
                    }
                    else if (VOIs.VOIAt(i).nearPoint(x, y, compImage.getSlice(), compImage.getZoomX(), compImage.getResolutionX(), compImage.getResolutionY())
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE_SLICE) {
                            ...
                            for (j = 0; j < nCurves; j++) {
                                if (VOIs.VOIAt(i).nearPoint(x, y, compImage.getSlice(), j, compImage.getZoomX(), compImage.getResolutionX(),
                            ...
                            if (VOIs.VOIAt(i).getCurveType() != VOI.LINE) {
                                // Displays contour with the active point highlighted
                                VOIs.VOIAt(i).drawVertices(compImage.getZoomX(), compImage.getZoomY(), compImage.getResolutionX(),
                                                           compImage.getResolutionY(),
                                                           compImage.getActiveImage().getFileInfo(0).getResolutions(),
            ...
            if (curveType == VOI.CONTOUR || curveType == VOI.POLYLINE || curveType == VOI.PROTRACTOR
                ...
                for (j = 0; j < curves[compImage.getSlice()].size(); j++) {
                    ...
                    if (curveType == VOI.CONTOUR || curveType == VOI.POLYLINE) {
                        isContained = ( (VOIContour) (curves[compImage.getSlice()].elementAt(j))).contains(xS, yS, false);
                    }
                    else if (curveType == VOI.PROTRACTOR) {
                        isContained = ( (VOIProtractor) (curves[compImage.getSlice()].elementAt(j))).contains(xS, yS, false);
                        ...
                        isContained = ( (VOIText) (curves[compImage.getSlice()].elementAt(j))).contains(xS, yS, compImage.getZoomX(),
                            compImage.getZoomY(), compImage.getActiveImage().getFileInfo(0).getResolutions(), g);
                    }
                    ...
                    if (VOIs.VOIAt(i).isActive() && (VOIs.VOIAt(i).isVisible() == true)) {
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR) {
                            ...
                            for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                                ...
                                if (((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).contains(xS, yS,
                                                                                                                true)) {
                                    return;
                                }
                            }
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.LINE) {
                            ...
                            for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                                ...
                                if (((VOILine) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).nearLine(xS, yS)) {
                                    ...
                                    if ((mouseEvent.getModifiers() &
                                        ...
                                        startPt = (Point3Df) ((VOILine) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                                      .elementAt(0);
                                        endPt = (Point3Df) ((VOILine) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                                    .elementAt(1);

                                        double angle = ((VOILine) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                                           .getAngle();
                            ...
                            if (VOIs.VOIAt(i).nearPoint(x, y, compImage.getSlice(), compImage.getZoomX(), compImage.getResolutionX(), compImage.getResolutionY())) {
                                compImage.addMouseListener(popupPt);
                            }
                        }
                    }
    ...
    public void mouseReleased(MouseEvent mouseEvent) {
        ...
        if (mode == ViewJComponentEditImage.POINT_VOI) {
            ...
            if ( (mouseEvent.getModifiers() & mouseEvent.BUTTON1_MASK) != 0) {
                if (isNewVoiNeeded(VOI.POLYLINE_SLICE)) { // create new VOI
                    try {
                        ...
                        if (compImage.getActiveImage().getNDims() > 2) {
                            newPolySliceVOI = new VOI( (short) colorID, "Polyline_slice", compImage.getActiveImage().getExtents()[2],
            ...
            if ( (mouseEvent.getModifiers() & mouseEvent.BUTTON1_MASK) != 0) {
                ...
                if (compImage.getActiveImage().getNDims() > 2) {
                    newTextVOI = new VOI( (short) colorID, "annotation3d.voi", compImage.getActiveImage().getExtents()[2],
                                         VOI.ANNOTATION, -1.0f);
                }
                else {
            ...
            if (mouseEvent.isShiftDown()) {
                ...
                ( (VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(index))).insertElement(xS, yS, compImage.getSlice());
                compImage.getActiveImage().notifyImageDisplayListeners(null, true);
            ...
            for (i = 0; i < nVOI; i++) {
                ...
                for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                    ...
                    if (selectedCurve instanceof VOIPoint) {
                        ...
                        else if (((VOIPoint) selectedCurve).nearPoint(xR, yR, compImage.getZoomX(), compImage.getResolutionX(),
                                                                 compImage.getResolutionY())) {
                        ...
                        compImage.getActiveImage().getFileInfo()[0].getResolutions(), g)) {
                ...
                if (VOIs.VOIAt(i).isActive() && VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR
                    ...
                    for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                        if ( ( (VOIBase) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).isActive()) {
                            Point3Df pt = ( (VOIBase) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).getActivePt();
                            compImage.setPixelInformationAtLocation((int)pt.x, (int)pt.y);
                            break;
                        }
                    }

                    VOIs.VOIAt(i).nearPoint(0, 0, compImage.getSlice(), compImage.getZoomX(), compImage.getResolutionX(), compImage.getResolutionY());
                }
                    ...
                    for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                        if ( ( (VOIBase) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).isActive()) {
                            ...
                            if (VOIs.VOIAt(i).getCurveType() == VOI.PROTRACTOR) {
                                ( (VOIProtractor) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).setShowLength(
                                    true);
                            }
    ...
    public boolean copyVOItoClipBrd() {
        ...
        for (i = 0; i < nVOI; i++) {
            ...
            if (VOIs.VOIAt(i).isActive() == true) {
                ...
                ViewUserInterface.getReference().addClippedVOI(voi, compImage.getSlice());
                didCopy = true;
            }
        }
        ...
        if (compImage.getActiveImage().getNDims() == 3) {
            ...
            if (compImage.getActiveImage().isColorImage() == true) {
                ...
                for (s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                    ...
                    for (int c = 0; c < 3; c++) {
                        ...
                        ptRGBIntensities[c][s] = compImage.getActiveImage().getFloat(((4 *
                                                                            ((s * compImage.getActiveImage().getSliceSize()) +
                                                                                 ((int) pt.y *
                                                                                      compImage.getActiveImage().getExtents()[0]) +
                                                                                 (int) pt.x)) + c + 1));
                    }
                ...
                try {
                    ...
                    for (s = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                        ...
                        pt = voiPt.exportPoint();
                        ptPosition[s] = s;
                        ptIntensity[s] = compImage.getActiveImage().getFloat((int) ((s * compImage.getActiveImage().getSliceSize()) +
                                                                     (pt.y * compImage.getActiveImage().getExtents()[0]) + pt.x));
                    }
            ...
            try {
                ...
                for (t = 0; t < compImage.getActiveImage().getExtents()[3]; t++) {
                    ...
                    pt = voiPt.exportPoint();
                    ptPosition[t] = t;
                    ptIntensity[t] = compImage.getActiveImage().getFloat((int) ((t * xDim * yDim * zDim) + (pt.z * xDim * yDim) +
                                                                 (pt.y * xDim) + pt.x));
                }
                ...
                for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                    ...
                    if (compImage.getActiveImage().getNDims() == 3) {
                        ...
                        if (compImage.getActiveImage().isColorImage() == true) {
                            ...
                            graphPointVOI(VOIs.VOIAt(i), (VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)), j);
                        } else {
                    ...
                    if (VOIs.VOIAt(i).isActive() && (VOIs.VOIAt(i).isVisible() == true)) {
                        ...
                        if ((VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR) ||
                            ...
                            for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                                ...
                                if (((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).isActive()) {
                                    length = (int) MipavMath.round(((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                        ...
                        if ((VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR) ||
                            ...
                            for (j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                                ...
                                if (((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).isActive()) {
                                    ...
                                    intensity = new float[(length * 2) + 1];
                                    pt = ((VOIContour) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)))
                                             .findPositionAndIntensity(position, intensity, compImage.getActiveImageBuffer(),
                                                                           compImage.getActiveImage().getFileInfo()[compImage.getSlice()].getResolutions(),
                                                                           compImage.getActiveImage().getExtents()[0],
                                                                           compImage.getActiveImage().getExtents()[1]);
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.CONTOUR) {
                            ...
                            for (int t = 0; t < compImage.getActiveImage().getExtents()[3]; t++) {
                                ...
                                try {
                                    ...
                                    for (s = 0, intensitySum = 0; s < compImage.getActiveImage().getExtents()[2]; s++) {
                                        compImage.getActiveImage().exportData((t * xDim * yDim * zDim) + (s * xDim * yDim), length,
                ...
                if ((VOIs.VOIAt(i).getCurveType() == VOI.POINT) && (VOIs.VOIAt(i).getContourGraph() != null)) {
                    ...
                    if (compImage.getActiveImage().isColorImage() == true) {
                        ...
                        for (int j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                            ...
                            if (((VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).isActive()) {
                                graphPointVOI(VOIs.VOIAt(i), (VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j)),
                                              j);
                            }
                        }
                    }
                        ...
                        if (VOIs.VOIAt(i).getCurveType() == VOI.POLYLINE_SLICE) {
                            if (doMove) {
                                VOIs.VOIAt(i).moveVOI(compImage.getSlice(), xDim, yDim,
                                        compImage.getActiveImage().getExtents()[2], 0, 0,
                                        keyCode);
                                Point3Df pt = VOIs.VOIAt(i).exportPSlicePoint(compImage.getSlice());
                                if (pt != null) {
                                    compImage.setPixelInformationAtLocation( (int) pt.x, (int) pt.y);
            ...
            if (newVOI.getCurveType() == VOI.POLYLINE_SLICE &&
                ...
                if ((z[1] - z[0]) != 0 ||
                    ...
                    if ((z[1] - z[0] + 1) == zExt) {
                        ...
                        outVOI.importNewVOI(compImage.getSlice(), newSlice, newVOI, zExt); // add only contour in compImage.getSlice()
                        compImage.getActiveImage().getVOIs().addElement(outVOI);
                    }
                } else {
        ...
        for (int i = 0; i < nVOI; i++) {
            ...
            if (VOIs.VOIAt(i).getCurveType() == VOI.POINT) {
                ...
                for (int j = 0; j < VOIs.VOIAt(i).getCurves()[compImage.getSlice()].size(); j++) {
                    ...
                    if (((VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).isActive()) {
                        pt = ((VOIPoint) (VOIs.VOIAt(i).getCurves()[compImage.getSlice()].elementAt(j))).exportPoint();
                        new JDialogPointArea(compImage.getFrame(), compImage.getActiveImage(), (int) pt.x, (int) pt.y, true);
                    }
                }
            }
        }
        ...
        if (compImage.getOrientation() == ViewJComponentEditImage.NA) {
            ...
            if (VOIs != null) {
                ...
                if (compImage.getSlice() != -99) {
                    ...
                    for (int i = 0; i < nVOI; i++) {
                        VOIs.VOIAt(i).drawSelf(compImage.getZoomX(), compImage.getZoomY(), compImage.getResolutionX(), compImage.getResolutionY(), originX, originY,
                                               compImage.getActiveImage().getFileInfo(0).getResolutions(),
                                               compImage.getActiveImage().getFileInfo(0).getUnitsOfMeasure(), compImage.getSlice(), compImage.getOrientation(),
                                               compImage.getActiveImage().getFileInfo(0), compImage.getActiveImage().getNDims(), graphics);
                    }
                }
            } // if (VOIs != null)
            ...
            if (mode == ViewJComponentEditImage.LEVELSET) {
                ...
                if (rbLevelSet.getLevelSetPolygon() != null) {
                    ...
                    graphics.drawPolygon(zoomPolygon(rbLevelSet.getLevelSetPolygon(), compImage.getZoomX() * compImage.getResolutionX(),
        ...
        if (VOIs != null) {
            ...
            if (compImage.getSlice() != -99) {
                ...
                for (int i = nVOI - 1; i >= 0; i--) {
                    VOIs.VOIAt(i).drawBlendSelf(1, 1, 1, 1, compImage.getSlice(), compImage.getPixBuffer(),
                                                graphics, compImage.getActiveImage().getExtents()[0],
                                                compImage.getActiveImage().getExtents()[1]);
                }
            }
        }
    ...
    protected void showOverlay(Graphics g) {
        ...
        if (compImage.getActiveImage().getFileInfo(0) instanceof FileInfoDicom) {
            ...
            try {
                ...
                reconDiameter = compImage.getActiveImage().getExtents()[0] * fileInfo.getResolutions()[0];
            }

            String[] values = compImage.setOverlayValues(compImage.getActiveImage().getImageOrientation(), MipavMath.round(fileInfo.xLocation),
            ...
            for (int i = 0; i < values[0].length(); i++) {
                compImage.drawStringBW(String.valueOf(values[0].charAt(i)), g, 5, (getHeight() / 2) - ((index - i) * 15));
            }

            index = values[1].length() / 2;

            for (int i = 0; i < values[1].length(); i++) {
                compImage.drawStringBW(String.valueOf(values[1].charAt(i)), g, rightOffset - 10,
                             (getHeight() / 2) - ((index - i) * 15));
            }

            len = g.getFontMetrics(g.getFont()).stringWidth(values[2]);
            compImage.drawStringBW(values[2], g, (getWidth() / 2) - (len / 2), 15);
