 ...
 */
public class JDialogBGDistanceMap extends JDialogBase implements AlgorithmInterface, ScriptableInterface {
     ...
     * @param  im  Source image.
     */
    public JDialogBGDistanceMap(ViewUserInterface UI, ModelImage im) {
        super();
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof AlgorithmMorphology2D) {
            ...
            insertScriptLine(distanceMapAlgo2D);
            ...
            insertScriptLine(distanceMapAlgo3D);
        }
    ...
    public void insertScriptLine(AlgorithmBase algo) {
        ...
        if (algo.isCompleted()) {
            ...
            if (userInterface.isScriptRecording()) {
                ...
                userInterface.getScriptDialog().append("BGDistanceMap " +
     ...
     *
     * @param  flag  <code>true</code> indicates the whole image is used for a background distance map, <code>
     *               false</code> indicates a region.
     */
