 ...
 */
public class PlugInDialogVolumeRenderDual extends JFrame implements ActionListener, RendererListener,
...
//						testForceGraph();
				...
				if (batchFlipLattice.isSelected()) {
					...
					try {
						PlugInAlgorithmWormUntwisting.generateModelMesh(batchProgress, includeRange, baseFileDir,
