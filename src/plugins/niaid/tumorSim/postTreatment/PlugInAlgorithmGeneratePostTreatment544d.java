...
public class PlugInAlgorithmGeneratePostTreatment544d extends AlgorithmBase {
    ...
    public void runAlgorithm() {
        ...
        if(image1cVOI) {
            PlugInAlgorithmCreateSpheres701a.createVOI(image1c, image1Intensity-stdDevNum*image1IntensityStd, image1Intensity+stdDevNum*image1IntensityStd);
        }
        ...
        if(image2cVOI) {
            PlugInAlgorithmCreateSpheres701a.createVOI(image2c, image2Intensity-stdDevNum*image2IntensityStd, image2Intensity+stdDevNum*image2IntensityStd);
        }
        ...
        if(postVOI) {
            ...
            PlugInAlgorithmCreateSpheres701a.createVOI(postTreatment, postIntensity-stdDevNum*postStdDev, postIntensity+stdDevNum*postStdDev);
        }
