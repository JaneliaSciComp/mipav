...
public class PlugInCreateSpheres701a implements PlugInGeneric {

	public static final String[] CATEGORY = {"Parametric Maps", "Simulation", "701"};
     ...
     */
    public void run() {
        new PlugInDialogCreateSpheres701a(false, true);
