 ...
 */
public class PlugInAlgorithmWormUntwistingJanelia
{
			...
			for ( int i = 0; i < includeRange.size(); i++ )
			{
				...
				if ( voiFile.exists() )
				{
					...
					{				
						...
						TriMesh mesh = model.generateTriMesh2( true, true, 1);
			...
			final int xSize, final int ySize, final int zSize )
	{
		...
		{						
			...
			for ( int i = 0; i < includeRange.size(); i++ )
			{
				...
				File imageFile = new File(baseFileDir[0] + File.separator + subDirName + subDirNameResults + PlugInAlgorithmWormUntwistingJanelia.outputImages + File.separator + imageName);
				File imageFile2 = new File(baseFileDir[1] + File.separator + subDirName + subDirNameResults + PlugInAlgorithmWormUntwistingJanelia.outputImages + File.separator + imageName);
				File imageFile3 = new File(baseFileDir[2] + File.separator + subDirName + subDirNameResults + PlugInAlgorithmWormUntwistingJanelia.outputImages + File.separator + imageName);
...
//					true, true, true, false, 2, 3);
	...
	public PlugInAlgorithmWormUntwistingJanelia()	{}
