...
//    AutoItkLoader m_kAutoItkLoader = null;
    ...
    public void actionPerformed(final ActionEvent event) {
         ...
         */
        ...
        } else if (command.equals("Guided filter")) {
            new JDialogGuidedFilter(this, getActiveImage());
        } else if (command.equals("waveletFuse")) {
        	new JDialogWaveletFuse(this, getActiveImage());
        } else if (command.equals("Bilateral filter")) {
            new JDialogBilateralFilter(this, getActiveImage());
        } else if (command.equals("MultiResBilateral filter")) {
            new JDialogMultiResolutionBilateralFilter(this, getActiveImage());
        } else if (command.equals("Trilateral filter")) {
            new JDialogTrilateralFilter(this, getActiveImage());
        } else if (command.equals("MultiResGuided filter")) {
            new JDialogMultiResolutionGuidedFilter(this, getActiveImage());
        } else if (command.equals("BM3D")) {
            new JDialogBM3D(this, getActiveImage());
        } else if (command.equals("Markov smooth")) {
            new JDialogMarkovSmooth(this, getActiveImage());
        	...
        	new JDialogDiscreteSineTransform(this, getActiveImage());
        } else if (command.equals("discreteCosine")) {
        	new JDialogDiscreteCosineTransform(this, getActiveImage());
        } else if (command.equals("hartley")) {
        ...
        } else if (command.equals("writeIsolines")) {
        	new JDialogGenerateIsolines(this, getActiveImage());
        ...
        } else if (command.equals("CropTiltedCuboid")) {
            new JDialogCropTiltedCuboid(this, getActiveImage());
        } else if (command.equals("CropTiltedRect")) {
            new JDialogCropTiltedRectangle(this, getActiveImage());
        ...
        } else if (command.equals("RegPOC")) {
        	if (isMultipleImages()) {
        		if (getActiveImage().getNDims() == 2) {
                    new JDialogImRegPOC(this, getActiveImage());
                }	
        	}
            else {
                MipavUtil.displayError("There are no other images to register.");
        ...
        } else if (command.equals("SIFT3DReg")) {

            if (isMultipleImages() == true) {

                if (getActiveImage().getNDims() >= 3) {
                    new JDialogRegistrationSIFT3D(this, getActiveImage());
                }
            } else {
                MipavUtil.displayError("There are no other images to register.");
            }
        ...
        } else if (command.equals("PolygonsToAnnulus")) {
        	new JDialogDoublyConnectedSC(this, getActiveImage());
        ...
        } else if (command.equals("EllipseToRectangle")) {
            new JDialogEllipseToRectangle(this, getActiveImage());
