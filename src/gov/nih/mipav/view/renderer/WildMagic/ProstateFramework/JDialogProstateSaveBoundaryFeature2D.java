...
public class JDialogProstateSaveBoundaryFeature2D extends JDialogBase
    ...
    private AlgorithmProstateBoundaryFeature2D textureAlgo;
	 ...
	 */
	public JDialogProstateSaveBoundaryFeature2D() {
	}
	 ...
	 *            Source image.
	 */
	public JDialogProstateSaveBoundaryFeature2D(Frame theParentFrame, ModelImage im, boolean testSample) {
	...
	protected void callAlgorithm() {
		...
		try {
				...
				textureAlgo = new AlgorithmProstateBoundaryFeature2D(resultImage,
